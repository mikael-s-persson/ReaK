...
struct get_type_info<std::vector<T>, Tail> {
  using type = type_id<std::vector<T>, typename get_type_info<T, Tail>::type>;
...
struct get_type_info<std::list<T>, Tail> {
  using type = type_id<std::list<T>, typename get_type_info<T, Tail>::type>;
  static constexpr auto type_name =
...
struct get_type_info<std::set<T>, Tail> {
  using type = type_id<std::set<T>, typename get_type_info<T, Tail>::type>;
  static constexpr auto type_name =
...
struct get_type_info<std::multiset<T>, Tail> {
  using type = type_id<std::multiset<T>, typename get_type_info<T, Tail>::type>;
  static constexpr auto type_name =
...
struct get_type_info<std::forward_list<T>, Tail> {
  using type =
      type_id<std::forward_list<T>, typename get_type_info<T, Tail>::type>;
  static constexpr auto type_name =
...
struct get_type_info<std::array<T, N>, Tail> {
  using type =
      type_id<std::array<T, N>,
              typename get_type_info<
                  T, get_type_info<std::integral_constant<unsigned int, N>,
                                   Tail>>::type>;
...
struct get_type_info<std::unordered_map<Key, T>, Tail> {
  using type =
      type_id<std::unordered_map<Key, T>,
              typename get_type_info<Key, get_type_info<T, Tail>>::type>;
  static constexpr auto type_name =
...
struct get_type_info<std::unordered_multimap<Key, T>, Tail> {
  using type =
      type_id<std::unordered_multimap<Key, T>,
              typename get_type_info<Key, get_type_info<T, Tail>>::type>;
  static constexpr auto type_name =
...
struct get_type_info<std::unordered_set<T>, Tail> {
  using type =
      type_id<std::unordered_set<T>, typename get_type_info<T, Tail>::type>;
  static constexpr auto type_name =
...
struct get_type_info<std::unordered_multiset<T>, Tail> {
  using type = type_id<std::unordered_multiset<T>,
