...
#ifdef RK_RTTI_USE_CONSTEXPR_STRINGS
  BOOST_STATIC_CONSTEXPR auto type_name = get_type_id< std::vector< T > >::type_name + lsl_left_bracket
...
#ifdef RK_RTTI_USE_CONSTEXPR_STRINGS
  BOOST_STATIC_CONSTEXPR auto type_name = get_type_id< std::list< T > >::type_name + lsl_left_bracket
                                          + get_type_id< T >::type_name + lsl_right_bracket
                                          + get_type_name_tail< Tail >::value;
#else
  static std::string type_name() {
...
#ifdef RK_RTTI_USE_CONSTEXPR_STRINGS
  BOOST_STATIC_CONSTEXPR auto type_name = get_type_id< std::map< Key, T > >::type_name + lsl_left_bracket
                                          + get_type_id< Key >::type_name + lsl_comma + get_type_id< T >::type_name
...
#ifdef RK_RTTI_USE_CONSTEXPR_STRINGS
  BOOST_STATIC_CONSTEXPR auto type_name = get_type_id< std::multimap< Key, T > >::type_name + lsl_left_bracket
                                          + get_type_id< Key >::type_name + lsl_comma + get_type_id< T >::type_name
                                          + lsl_right_bracket + get_type_name_tail< Tail >::value;
#else
  static std::string type_name() {
...
#ifdef RK_RTTI_USE_CONSTEXPR_STRINGS
  BOOST_STATIC_CONSTEXPR auto type_name = get_type_id< std::set< T > >::type_name + lsl_left_bracket
                                          + get_type_id< T >::type_name + lsl_right_bracket
                                          + get_type_name_tail< Tail >::value;
#else
  static std::string type_name() {
...
#ifdef RK_RTTI_USE_CONSTEXPR_STRINGS
  BOOST_STATIC_CONSTEXPR auto type_name = get_type_id< std::multiset< T > >::type_name + lsl_left_bracket
                                          + get_type_id< T >::type_name + lsl_right_bracket
                                          + get_type_name_tail< Tail >::value;
#else
  static std::string type_name() {
...
#ifdef RK_RTTI_USE_CONSTEXPR_STRINGS
  BOOST_STATIC_CONSTEXPR auto type_name = get_type_id< std::pair< T1, T2 > >::type_name + lsl_left_bracket
                                          + get_type_id< T1 >::type_name + lsl_comma + get_type_id< T2 >::type_name
                                          + lsl_right_bracket + get_type_name_tail< Tail >::value;
#else
  static std::string type_name() {
...
#ifdef RK_RTTI_USE_CONSTEXPR_STRINGS
  BOOST_STATIC_CONSTEXPR auto type_name = get_type_id< std::forward_list< T > >::type_name + lsl_left_bracket
                                          + get_type_id< T >::type_name + lsl_right_bracket
                                          + get_type_name_tail< Tail >::value;
#else
  static std::string type_name() {
...
struct get_type_info< std::array< T, N >, Tail > {
  typedef type_id< std::array< T, N >,
                   typename get_type_info< T, get_type_info< boost::mpl::integral_c< unsigned int, N >, Tail > >::type >
    type;
#ifdef RK_RTTI_USE_CONSTEXPR_STRINGS
  BOOST_STATIC_CONSTEXPR auto type_name = get_type_id< std::array< T, N > >::type_name + lsl_left_bracket
                                          + get_type_id< T >::type_name + lsl_comma
                                          + get_type_id< boost::mpl::integral_c< unsigned int, N > >::type_name
                                          + lsl_right_bracket + get_type_name_tail< Tail >::value;
#else
  static std::string type_name() {
...
struct get_type_info< std::tuple< T... >, Tail > {
  typedef type_id< std::tuple< T... >, typename get_type_info_seq< T... >::template with_tail< Tail >::type::type >
    type;
#ifdef RK_RTTI_USE_CONSTEXPR_STRINGS
  BOOST_STATIC_CONSTEXPR auto type_name = get_type_id< std::tuple< T... > >::type_name + lsl_left_bracket
...
#ifdef RK_RTTI_USE_CONSTEXPR_STRINGS
  BOOST_STATIC_CONSTEXPR auto type_name = get_type_id< std::unordered_map< Key, T > >::type_name + lsl_left_bracket
                                          + get_type_id< Key >::type_name + lsl_comma + get_type_id< T >::type_name
                                          + lsl_right_bracket + get_type_name_tail< Tail >::value;
#else
  static std::string type_name() {
...
struct get_type_info< std::unordered_multimap< Key, T >, Tail > {
  typedef type_id< std::unordered_multimap< Key, T >, typename get_type_info< Key, get_type_info< T, Tail > >::type >
    type;
#ifdef RK_RTTI_USE_CONSTEXPR_STRINGS
  BOOST_STATIC_CONSTEXPR auto type_name = get_type_id< std::unordered_multimap< Key, T > >::type_name + lsl_left_bracket
                                          + get_type_id< Key >::type_name + lsl_comma + get_type_id< T >::type_name
                                          + lsl_right_bracket + get_type_name_tail< Tail >::value;
#else
  static std::string type_name() {
...
#ifdef RK_RTTI_USE_CONSTEXPR_STRINGS
  BOOST_STATIC_CONSTEXPR auto type_name = get_type_id< std::unordered_set< T > >::type_name + lsl_left_bracket
                                          + get_type_id< T >::type_name + lsl_right_bracket
                                          + get_type_name_tail< Tail >::value;
#else
  static std::string type_name() {
...
#ifdef RK_RTTI_USE_CONSTEXPR_STRINGS
  BOOST_STATIC_CONSTEXPR auto type_name = get_type_id< std::unordered_multiset< T > >::type_name + lsl_left_bracket
                                          + get_type_id< T >::type_name + lsl_right_bracket
                                          + get_type_name_tail< Tail >::value;
#else
  static std::string type_name() {
