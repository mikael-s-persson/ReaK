...
#else
  static const char* type_name() BOOST_NOEXCEPT {
    static char type_name_buf[32];
    std::sprintf( type_name_buf, "%d", ID );
...
struct get_type_info_seq< T1, T... > {
  template < typename Tail = null_type_info >
  struct with_tail {
    typedef get_type_info< T1, typename get_type_info_seq< T... >::template with_tail< Tail >::type > type;
  };

#ifdef RK_RTTI_USE_CONSTEXPR_STRINGS
  BOOST_STATIC_CONSTEXPR auto type_name = get_type_id< T1 >::type_name + lsl_comma
...
struct get_type_info_seq {
  template < typename Tail = null_type_info >
  struct with_tail {
    typedef get_type_info< T1, typename get_type_info_seq< T2, T3, T4, T5, T6, T7, T8, T9,
                                                           T10 >::template with_tail< Tail >::type > type;
  };
...
struct get_type_info< U< T... >, Tail > {
  typedef type_id< U< T... >, typename get_type_info_seq< T... >::template with_tail< Tail >::type::type > type;
#ifdef RK_RTTI_USE_CONSTEXPR_STRINGS
  BOOST_STATIC_CONSTEXPR auto type_name = get_type_id< U< T... > >::type_name + lsl_left_bracket
...
template < template < typename, typename > class U, typename T1, typename T2, typename Tail >
struct get_type_info< U< T1, T2 >, Tail > {
  typedef type_id< U< T1, T2 >, typename get_type_info_seq< T1, T2 >::template with_tail< Tail >::type::type > type;
#ifdef RK_RTTI_USE_CONSTEXPR_STRINGS
  BOOST_STATIC_CONSTEXPR auto type_name = get_type_id< U< T1, T2 > >::type_name + lsl_left_bracket
                                          + get_type_info_seq< T1, T2 >::type_name + lsl_right_bracket
                                          + get_type_name_tail< Tail >::value;
#else
  static std::string type_name() {
...
template < template < typename, typename, typename > class U, typename T1, typename T2, typename T3, typename Tail >
struct get_type_info< U< T1, T2, T3 >, Tail > {
  typedef type_id< U< T1, T2, T3 >, typename get_type_info_seq< T1, T2, T3 >::template with_tail< Tail >::type::type >
    type;
#ifdef RK_RTTI_USE_CONSTEXPR_STRINGS
  BOOST_STATIC_CONSTEXPR auto type_name = get_type_id< U< T1, T2, T3 > >::type_name + lsl_left_bracket
                                          + get_type_info_seq< T1, T2, T3 >::type_name + lsl_right_bracket
                                          + get_type_name_tail< Tail >::value;
#else
  static std::string type_name() {
...
template < template < typename, typename, typename, typename > class U, typename T1, typename T2, typename T3,
...
#ifdef RK_RTTI_USE_CONSTEXPR_STRINGS
  BOOST_STATIC_CONSTEXPR auto type_name = get_type_id< U< T1, T2, T3, T4 > >::type_name + lsl_left_bracket
                                          + get_type_info_seq< T1, T2, T3, T4 >::type_name + lsl_right_bracket
                                          + get_type_name_tail< Tail >::value;
#else
  static std::string type_name() {
...
template < template < typename, typename, typename, typename, typename > class U, typename T1, typename T2, typename T3,
           typename T4, typename T5, typename Tail >
...
#ifdef RK_RTTI_USE_CONSTEXPR_STRINGS
  BOOST_STATIC_CONSTEXPR auto type_name = get_type_id< U< T1, T2, T3, T4, T5 > >::type_name + lsl_left_bracket
                                          + get_type_info_seq< T1, T2, T3, T4, T5 >::type_name + lsl_right_bracket
                                          + get_type_name_tail< Tail >::value;
#else
  static std::string type_name() {
...
template < template < typename, typename, typename, typename, typename, typename > class U, typename T1, typename T2,
           typename T3, typename T4, typename T5, typename T6, typename Tail >
...
#ifdef RK_RTTI_USE_CONSTEXPR_STRINGS
  BOOST_STATIC_CONSTEXPR auto type_name = get_type_id< U< T1, T2, T3, T4, T5, T6 > >::type_name + lsl_left_bracket
                                          + get_type_info_seq< T1, T2, T3, T4, T5, T6 >::type_name + lsl_right_bracket
                                          + get_type_name_tail< Tail >::value;
#else
  static std::string type_name() {
...
template < template < typename, typename, typename, typename, typename, typename, typename > class U, typename T1,
           typename T2, typename T3, typename T4, typename T5, typename T6, typename T7, typename Tail >
struct get_type_info< U< T1, T2, T3, T4, T5, T6, T7 >, Tail > {
  typedef type_id< U< T1, T2, T3, T4, T5, T6, T7 >,
                   typename get_type_info_seq< T1, T2, T3, T4, T5, T6, T7 >::template with_tail< Tail >::type::type >
    type;
#ifdef RK_RTTI_USE_CONSTEXPR_STRINGS
  BOOST_STATIC_CONSTEXPR auto type_name = get_type_id< U< T1, T2, T3, T4, T5, T6, T7 > >::type_name + lsl_left_bracket
                                          + get_type_info_seq< T1, T2, T3, T4, T5, T6, T7 >::type_name
...
struct get_type_info< U< T1, T2, T3, T4, T5, T6, T7, T8 >, Tail > {
  typedef type_id< U< T1, T2, T3, T4, T5, T6, T7, T8 >,
                   typename get_type_info_seq< T1, T2, T3, T4, T5, T6, T7,
                                               T8 >::template with_tail< Tail >::type::type > type;
#ifdef RK_RTTI_USE_CONSTEXPR_STRINGS
  BOOST_STATIC_CONSTEXPR auto type_name = get_type_id< U< T1, T2, T3, T4, T5, T6, T7, T8 > >::type_name
                                          + lsl_left_bracket
                                          + get_type_info_seq< T1, T2, T3, T4, T5, T6, T7, T8 >::type_name
                                          + lsl_right_bracket + get_type_name_tail< Tail >::value;
#else
  static std::string type_name() {
...
template < template < typename, typename, typename, typename, typename, typename, typename, typename, typename >
           class U, typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7,
...
struct get_type_info< U< T1, T2, T3, T4, T5, T6, T7, T8, T9 >, Tail > {
  typedef type_id< U< T1, T2, T3, T4, T5, T6, T7, T8, T9 >,
                   typename get_type_info_seq< T1, T2, T3, T4, T5, T6, T7, T8,
                                               T9 >::template with_tail< Tail >::type::type > type;
#ifdef RK_RTTI_USE_CONSTEXPR_STRINGS
  BOOST_STATIC_CONSTEXPR auto type_name = get_type_id< U< T1, T2, T3, T4, T5, T6, T7, T8, T9 > >::type_name
                                          + lsl_left_bracket
                                          + get_type_info_seq< T1, T2, T3, T4, T5, T6, T7, T8, T9 >::type_name
                                          + lsl_right_bracket + get_type_name_tail< Tail >::value;
#else
  static std::string type_name() {
...
#ifdef RK_RTTI_USE_CONSTEXPR_STRINGS
  BOOST_STATIC_CONSTEXPR auto type_name = get_type_id< U< T1, T2, T3, T4, T5, T6, T7, T8, T9, T10 > >::type_name
                                          + lsl_left_bracket
                                          + get_type_info_seq< T1, T2, T3, T4, T5, T6, T7, T8, T9, T10 >::type_name
                                          + lsl_right_bracket + get_type_name_tail< Tail >::value;
#else
  static std::string type_name() {
...
#ifdef RK_RTTI_USE_CONSTEXPR_STRINGS
  BOOST_STATIC_CONSTEXPR auto type_name = get_type_id< boost::mpl::integral_c< unsigned int, U > >::type_name
                                          + get_type_name_tail< Tail >::value;
#else
  static std::string type_name() {
...
#ifdef RK_RTTI_USE_CONSTEXPR_STRINGS
  BOOST_STATIC_CONSTEXPR auto type_name = get_type_id< boost::mpl::true_ >::type_name
                                          + get_type_name_tail< Tail >::value;
#else
  static std::string type_name() {
...
#ifdef RK_RTTI_USE_CONSTEXPR_STRINGS
  BOOST_STATIC_CONSTEXPR auto type_name = get_type_id< boost::mpl::false_ >::type_name
                                          + get_type_name_tail< Tail >::value;
#else
  static std::string type_name() {
...
#ifdef RK_RTTI_USE_CONSTEXPR_STRINGS
  BOOST_STATIC_CONSTEXPR auto type_name = get_type_id< boost::mpl::int_< I > >::type_name
                                          + get_type_name_tail< Tail >::value;
#else
  static std::string type_name() {
...
public:
  static so_type* createTypeInfo( unsigned int aTypeVersion, unsigned int* aTypeID, const std::string& aTypeName,
...
#else
  return so_type_ptr(
    so_type::createTypeInfo( aVersion, typeID, get_type_info< T >::type_name(), get_type_id< T >::CreatePtr() ) );
#endif
};
};
