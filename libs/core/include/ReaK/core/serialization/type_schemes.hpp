...
public:
  type_scheme( const std::string& aTypeName, const unsigned int* aTypeIDPtr, unsigned int aTypeVersion = 1 )
      : shared_object(), m_type_name( aTypeName ), m_type_ID_ptr( aTypeIDPtr ), m_type_version( aTypeVersion ){};
  ...
  *******************************************************************************/
  ...
  virtual void RK_CALL save( serialization::oarchive& A, unsigned int ) const {
    ...
    ID_vect.push_back( 0 );
    A& RK_SERIAL_SAVE_WITH_ALIAS( "TypeName", m_type_name ) & RK_SERIAL_SAVE_WITH_ALIAS( "TypeID", ID_vect )
  ...
  virtual void RK_CALL load( serialization::iarchive& A, unsigned int ) {
    ...
    std::vector< unsigned int > ID_vect;
    A& RK_SERIAL_LOAD_WITH_ALIAS( "TypeName", m_type_name ) & RK_SERIAL_LOAD_WITH_ALIAS( "TypeID", ID_vect )
...
public:
  ...
  virtual ~primitive_scheme() { delete[] m_type_ID_ptr; };
...
public:
  ...
  *******************************************************************************/
  ...
  virtual void RK_CALL save( serialization::oarchive& A, unsigned int ) const {
    type_scheme::save( A, type_scheme::getStaticObjectType()->TypeVersion() );
    A& RK_SERIAL_SAVE_WITH_ALIAS( "KeyType", m_key_type ) & RK_SERIAL_SAVE_WITH_ALIAS( "ValueType", m_value_type );
  };

  virtual void RK_CALL load( serialization::iarchive& A, unsigned int ) {
    type_scheme::load( A, type_scheme::getStaticObjectType()->TypeVersion() );
    A& RK_SERIAL_LOAD_WITH_ALIAS( "KeyType", m_key_type ) & RK_SERIAL_LOAD_WITH_ALIAS( "ValueType", m_value_type );
  };
...
public:
  ...
  virtual std::pair< std::string, shared_ptr< type_scheme > > get_field( std::size_t i ) const { return m_fields[i]; };
