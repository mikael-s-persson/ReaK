...
template < class T >
inline std::pair< std::string, typename ReaK::rtti::get_type_id< T >::save_type > make_save_nvp( const std::string& s,
                                                                                                 const T& v ) {
...
template < class T >
inline std::pair< std::string, typename ReaK::rtti::get_type_id< T >::load_type > make_load_nvp( const std::string& s,
                                                                                                 T& v ) {
...
#define RK_SERIAL_SAVE_WITH_NAME( VARIABLE ) \
  ReaK::serialization::make_save_nvp( std::string( BOOST_PP_STRINGIZE( VARIABLE ) ), VARIABLE )
...
#define RK_SERIAL_LOAD_WITH_NAME( VARIABLE ) \
  ReaK::serialization::make_load_nvp( std::string( BOOST_PP_STRINGIZE( VARIABLE ) ), VARIABLE )
...
public:
  ...
  archive() : shared_object_base(), mObjRegistry() { mObjRegistry.push_back( serializable_shared_pointer() ); };
...
public:
  ...
  /// Loading a serializable object with a name.
  friend iarchive& RK_CALL
    operator&( iarchive& in, const std::pair< std::string, serializable_shared_pointer& >& Item ) {
    return in.load_serializable_ptr( Item );
  };

  /// Loading a serializable object by reference.
  friend iarchive& RK_CALL operator>>( iarchive& in, serializable& Item ) { return in.load_serializable( Item ); };
  ...
  /// Loading a char value.
  friend iarchive& RK_CALL operator>>( iarchive& in, char& i ) { return in.load_char( i ); };
  ...
  /// Loading an unsigned char value.
  friend iarchive& RK_CALL operator>>( iarchive& in, unsigned char& u ) { return in.load_unsigned_char( u ); };
  ...
  /// Loading an integer value.
  friend iarchive& RK_CALL operator>>( iarchive& in, int& i ) { return in.load_int( i ); };
  ...
  /// Loading an unsigned integer value.
  friend iarchive& RK_CALL operator>>( iarchive& in, unsigned int& u ) { return in.load_unsigned_int( u ); };
  ...
  /// Loading a float value.
  friend iarchive& RK_CALL operator>>( iarchive& in, float& f ) { return in.load_float( f ); };
  ...
  /// Loading a double value.
  friend iarchive& RK_CALL operator>>( iarchive& in, double& d ) { return in.load_double( d ); };
  ...
  /// Loading a boolean value.
  friend iarchive& RK_CALL operator>>( iarchive& in, bool& b ) { return in.load_bool( b ); };
  ...
  /// Loading a string value.
  friend iarchive& RK_CALL operator>>( iarchive& in, std::string& s ) { return in.load_string( s ); };
  ...
  template < typename T >
  friend typename boost::enable_if< boost::is_convertible< T*, serializable* >, iarchive& >::type
    operator>>( iarchive& in, shared_ptr< T >& Item ) {
    in.signal_polymorphic_field( T::getStaticObjectType()->TypeName(), T::getStaticObjectType()->TypeID_begin(),
                                 "Item" );
  ...
  template < typename T >
  friend typename boost::enable_if< boost::is_convertible< T*, serializable* >, iarchive& >::type
    operator&( iarchive& in, const std::pair< std::string, shared_ptr< T >& >& Item ) {
    in.signal_polymorphic_field( T::getStaticObjectType()->TypeName(), T::getStaticObjectType()->TypeID_begin(),
                                 Item.first );
    serializable_shared_pointer tmp;
  ...
  template < typename T >
  friend typename boost::disable_if< boost::is_convertible< T*, serializable* >, iarchive& >::type
    operator>>( iarchive& in, shared_ptr< T >& Item ) {
  ...
  template < typename T >
  friend typename boost::enable_if< boost::is_convertible< T*, serializable* >, iarchive& >::type
    operator>>( iarchive& in, weak_ptr< T >& Item ) {
    in.signal_polymorphic_field( T::getStaticObjectType()->TypeName(), T::getStaticObjectType()->TypeID_begin(),
                                 "Item" );
    serializable_shared_pointer tmp;
    in >> tmp;
  ...
  template < typename T >
  friend typename boost::enable_if< boost::is_convertible< T*, serializable* >, iarchive& >::type
    operator&( iarchive& in, const std::pair< std::string, weak_ptr< T >& >& Item ) {
    in.signal_polymorphic_field( T::getStaticObjectType()->TypeName(), T::getStaticObjectType()->TypeID_begin(),
                                 Item.first );
    serializable_shared_pointer tmp;
    in& std::pair< std::string, serializable_shared_pointer& >( Item.first, tmp );
  ...
  template < typename T >
  friend typename boost::enable_if< boost::is_convertible< T&, serializable& >, iarchive& >::type
    operator&( iarchive& in, const std::pair< std::string, T& >& Item ) {
...
protected:
  ...
  virtual oarchive& RK_CALL
    saveToNewArchive_impl( const serializable_shared_pointer& Item, const std::string& FileName ) = 0;
  ...
  virtual oarchive& RK_CALL
    save_serializable_ptr( const std::pair< std::string, const serializable_shared_pointer& >& Item ) = 0;
...
public:
  ...
  /// Saving a serializable object with a name to an external archive.
  oarchive& RK_CALL saveToNewArchiveNamed( const std::pair< std::string, const serializable_shared_pointer& >& Item,
  ...
  /// Saving a serializable object with a name.
  friend oarchive& RK_CALL
    operator&( oarchive& out, const std::pair< std::string, const serializable_shared_pointer& >& Item ) {
    return out.save_serializable_ptr( Item );
  };
  ...
  friend oarchive& RK_CALL operator<<( oarchive& out, char i ) { return out.save_char( i ); };
  ...
  /// Saving an unsigned char value.
  friend oarchive& RK_CALL operator<<( oarchive& out, unsigned char u ) { return out.save_unsigned_char( u ); };
  ...
  /// Saving an integer value.
  friend oarchive& RK_CALL operator<<( oarchive& out, int i ) { return out.save_int( i ); };
  ...
  /// Saving an unsigned integer value.
  friend oarchive& RK_CALL operator<<( oarchive& out, unsigned int u ) { return out.save_unsigned_int( u ); };
  ...
  /// Saving a float value.
  friend oarchive& RK_CALL operator<<( oarchive& out, float f ) { return out.save_float( f ); };
  ...
  /// Saving a double value.
  friend oarchive& RK_CALL operator<<( oarchive& out, double d ) { return out.save_double( d ); };
  ...
  /// Saving a boolean value.
  friend oarchive& RK_CALL operator<<( oarchive& out, bool b ) { return out.save_bool( b ); };
  ...
  /// Saving a string value.
  friend oarchive& RK_CALL operator<<( oarchive& out, const std::string& s ) { return out.save_string( s ); };
  ...
  template < typename T >
  friend typename boost::enable_if< boost::is_convertible< const T*, const serializable* >, oarchive& >::type
    operator<<( oarchive& out, const shared_ptr< T >& Item ) {
    out.signal_polymorphic_field( T::getStaticObjectType()->TypeName(), T::getStaticObjectType()->TypeID_begin(),
                                  "Item" );
    serializable_shared_pointer tmp;
    if( Item )
  ...
  template < typename T >
  friend typename boost::enable_if< boost::is_convertible< const T*, const serializable* >, oarchive& >::type
    operator&( oarchive& out, const std::pair< std::string, const shared_ptr< T >& >& Item ) {
    out.signal_polymorphic_field( T::getStaticObjectType()->TypeName(), T::getStaticObjectType()->TypeID_begin(),
                                  Item.first );
    serializable_shared_pointer tmp;
    if( Item.second )
  ...
  template < typename T >
  friend typename boost::disable_if< boost::is_convertible< const T*, const serializable* >, oarchive& >::type
    operator<<( oarchive& out, const shared_ptr< T >& Item ) {
    if( Item )
      out << *Item;
    return out;
  ...
  template < typename T >
  friend typename boost::enable_if< boost::is_convertible< const T*, const serializable* >, oarchive& >::type
    operator<<( oarchive& out, const weak_ptr< T >& Item ) {
    out.signal_polymorphic_field( T::getStaticObjectType()->TypeName(), T::getStaticObjectType()->TypeID_begin(),
                                  "Item" );
    serializable_shared_pointer tmp;
    if( !Item.expired() )
  ...
  template < typename T >
  friend typename boost::enable_if< boost::is_convertible< const T*, const serializable* >, oarchive& >::type
    operator&( oarchive& out, const std::pair< std::string, const weak_ptr< T >& >& Item ) {
    out.signal_polymorphic_field( T::getStaticObjectType()->TypeName(), T::getStaticObjectType()->TypeID_begin(),
                                  Item.first );
    serializable_shared_pointer tmp;
  ...
  template < typename T >
  friend typename boost::enable_if< boost::is_convertible< const T&, const serializable& >, oarchive& >::type
    operator<<( oarchive& in, const T& Item ) {
  ...
  template < typename T >
  friend typename boost::enable_if< boost::is_convertible< const T&, const serializable& >, oarchive& >::type
    operator&( oarchive& in, const std::pair< std::string, const T& >& Item ) {
