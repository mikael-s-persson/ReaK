...
//
#if !defined(__GLIBCXX__) || (__GLIBCXX__ < 20080305) || !(defined(__GXX_EXPERIMENTAL_CXX0X__) || (__cplusplus >= 201103L))
#else
...
//
#if !defined(__GLIBCXX__) || (__GLIBCXX__ < 20090421) || !(defined(__GXX_EXPERIMENTAL_CXX0X__) || (__cplusplus >= 201103L))
#else
...
//
#if !defined(__GLIBCXX__) || (__GLIBCXX__ < 20100414) || !(defined(__GXX_EXPERIMENTAL_CXX0X__) || (__cplusplus >= 201103L))
#else
...
//
#if !defined(__GLIBCXX__) || (__GLIBCXX__ < 20110325) || !(defined(__GXX_EXPERIMENTAL_CXX0X__) || (__cplusplus >= 201103L))
#else
...
//
#if !defined(__GLIBCXX__) || (__GLIBCXX__ < 20120322) || !(defined(__GXX_EXPERIMENTAL_CXX0X__) || (__cplusplus >= 201103L))
#else
...
#if !defined(__GLIBCXX__) || (__GLIBCXX__ < 20130510) || !(defined(__GXX_EXPERIMENTAL_CXX0X__) || (__cplusplus >= 201103L))
#else
