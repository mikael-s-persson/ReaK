...
void generate_random_seq( int* first, int* last ) { std::generate( first, last, rand_int_generator( RANGE ) ); };
...
int main( int argc, char** argv ) {
  ...
  GenFuncType generators[]
    = {&generate_random_seq, &generate_almost_sorted, &generate_almost_reversed, &generate_partly_sorted};
  ...
  for( std::size_t i = 0; i < 4; ++i ) {
    for( std::size_t j = 10; j < max_size; j *= 2 ) {
      ...
      std::cout << std::setw( 10 ) << sort_and_get_us( j, std::bind( quick_sort< int*, std::less< int >, random_pivot >,
                                                                     std::placeholders::_1, std::placeholders::_2,
                                                                     std::less< int >(), random_pivot() ),
                                                       generators[i] );

      std::cout << std::setw( 10 ) << sort_and_get_us( j, std::bind( quick_sort< int*, std::less< int >, first_pivot >,
                                                                     std::placeholders::_1, std::placeholders::_2,
      ...
      std::cout << std::setw( 10 ) << sort_and_get_us( j, std::bind( intro_sort< int*, std::less< int >, random_pivot >,
                                                                     std::placeholders::_1, std::placeholders::_2,
                                                                     std::less< int >(), random_pivot() ),
                                                       generators[i] );

      std::cout << std::setw( 10 ) << sort_and_get_us( j, std::bind( intro_sort< int*, std::less< int >, first_pivot >,
                                                                     std::placeholders::_1, std::placeholders::_2,
                                                                     std::less< int >(), first_pivot() ),
                                                       generators[i] );
