...
int main( int argc, char** argv ) {
  ...
  rpc::function< std::string( std::string ) > print_sv_name, print_sv_name_remote;

  print_sv_name.publish( "print_sv_name", [&sv_name]( std::string s ) -> std::string {
  ...
  std::cout << "Got server name from remote host as: " << print_sv_name_remote( sv_name ) << std::endl;
