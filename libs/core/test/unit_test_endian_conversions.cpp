...
BOOST_AUTO_TEST_CASE( endian_conversions_test ) {
  ...
  if( 1000 != htonl( 1000 ) ) {
    ...
    u32.u = 0x0A0B0C0D;
    hton_any( u32.u );
    if( ( u32.c[0] != 0x0A ) || ( u32.c[1] != 0x0B ) || ( u32.c[2] != 0x0C ) || ( u32.c[3] != 0x0D ) )
    ...
    hton_any( u64.u );
    if( ( u64.c[0] != 0x00 ) || ( u64.c[1] != 0x00 ) || ( u64.c[2] != 0x0A ) || ( u64.c[3] != 0x0B )
        || ( u64.c[4] != 0x0C ) || ( u64.c[5] != 0x0D ) || ( u64.c[6] != 0x0E ) || ( u64.c[7] != 0x0F ) )
