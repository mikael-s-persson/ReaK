...
public:
  ...
  virtual void RK_CALL save( ReaK::serialization::oarchive& A, unsigned int ) const {
    ...
    A& RK_SERIAL_SAVE_WITH_NAME( m_uint ) & RK_SERIAL_SAVE_WITH_NAME( m_int ) & RK_SERIAL_SAVE_WITH_NAME( m_float )
      & RK_SERIAL_SAVE_WITH_NAME( m_double ) & RK_SERIAL_SAVE_WITH_NAME( m_char ) & RK_SERIAL_SAVE_WITH_NAME( m_bool )
      & RK_SERIAL_SAVE_WITH_NAME( m_str ) & RK_SERIAL_SAVE_WITH_NAME( m_vect ) & RK_SERIAL_SAVE_WITH_NAME( m_list )
      & RK_SERIAL_SAVE_WITH_NAME( m_set ) & RK_SERIAL_SAVE_WITH_NAME( m_map );
  };
  virtual void RK_CALL load( ReaK::serialization::iarchive& A, unsigned int ) {
    ReaK::named_object::load( A, ReaK::named_object::getStaticObjectType()->TypeVersion() );
    A& RK_SERIAL_LOAD_WITH_NAME( m_uint ) & RK_SERIAL_LOAD_WITH_NAME( m_int ) & RK_SERIAL_LOAD_WITH_NAME( m_float )
      & RK_SERIAL_LOAD_WITH_NAME( m_double ) & RK_SERIAL_LOAD_WITH_NAME( m_char ) & RK_SERIAL_LOAD_WITH_NAME( m_bool )
      & RK_SERIAL_LOAD_WITH_NAME( m_str ) & RK_SERIAL_LOAD_WITH_NAME( m_vect ) & RK_SERIAL_LOAD_WITH_NAME( m_list )
      & RK_SERIAL_LOAD_WITH_NAME( m_set ) & RK_SERIAL_LOAD_WITH_NAME( m_map );
  };
...
public:
  ...
  virtual void RK_CALL save( ReaK::serialization::oarchive& A, unsigned int ) const {
    ReaK::named_object::save( A, ReaK::named_object::getStaticObjectType()->TypeVersion() );
    A << m_uint << m_int << m_float << m_double << m_char << m_bool << m_str << m_vect << m_list << m_set << m_map;
  };
  virtual void RK_CALL load( ReaK::serialization::iarchive& A, unsigned int ) {
    ReaK::named_object::load( A, ReaK::named_object::getStaticObjectType()->TypeVersion() );
    A >> m_uint >> m_int >> m_float >> m_double >> m_char >> m_bool >> m_str >> m_vect >> m_list >> m_set >> m_map;
