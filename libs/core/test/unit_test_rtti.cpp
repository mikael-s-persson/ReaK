...
struct get_type_info< dummy_rtti_template< N, T >, Tail > {
  typedef type_id< dummy_rtti_template< N, T >,
                   typename get_type_info< boost::mpl::int_< N >, get_type_info< T, Tail > >::type > type;
#ifdef RK_RTTI_USE_CONSTEXPR_STRINGS
  BOOST_STATIC_CONSTEXPR auto type_name = get_type_id< dummy_rtti_template< N, T > >::type_name + lsl_left_bracket
                                          + get_type_id< boost::mpl::int_< N > >::type_name + lsl_comma
...
public:
  ...
  RK_RTTI_MAKE_CONCRETE_2BASE( dummy_rtti_multi_inherit, 0xFFFFFFF5, 1, "dummy_rtti_multi_inherit", dummy_rtti_base1,
                               dummy_rtti_base2 )
};
...
BOOST_AUTO_TEST_CASE( rtti_test ) {
...

  {
    ...
    shared_ptr< dummy_rtti_template< 10, dummy_rtti_test > > p_obj_statcast
      = rtti::rk_static_ptr_cast< dummy_rtti_template< 10, dummy_rtti_test > >( p_obj );
    BOOST_CHECK( p_obj_statcast );
    BOOST_CHECK_EQUAL( p_obj_statcast.get(), p_obj_raw );

    shared_ptr< dummy_rtti_template< 10, dummy_rtti_test > > p_obj_dyncast
      = rtti::rk_dynamic_ptr_cast< dummy_rtti_template< 10, dummy_rtti_test > >( p_obj );
    BOOST_CHECK( p_obj_dyncast );
    BOOST_CHECK_EQUAL( p_obj_dyncast.get(), p_obj_statcast.get() );
    BOOST_CHECK_EQUAL( p_obj_dyncast.get(), p_obj_raw );
  };
...

  {
    ...
    shared_ptr< dummy_rtti_template2< int, dummy_rtti_test > > p_obj_statcast
      = rtti::rk_static_ptr_cast< dummy_rtti_template2< int, dummy_rtti_test > >( p_obj );
    BOOST_CHECK( p_obj_statcast );
    BOOST_CHECK_EQUAL( p_obj_statcast.get(), p_obj_raw );

    shared_ptr< dummy_rtti_template2< int, dummy_rtti_test > > p_obj_dyncast
      = rtti::rk_dynamic_ptr_cast< dummy_rtti_template2< int, dummy_rtti_test > >( p_obj );
    BOOST_CHECK( p_obj_dyncast );
    BOOST_CHECK_EQUAL( p_obj_dyncast.get(), p_obj_statcast.get() );
    BOOST_CHECK_EQUAL( p_obj_dyncast.get(), p_obj_raw );
  };

  {
    ...
    shared_ptr< dummy_rtti_multi_inherit > p_obj_dyncast
