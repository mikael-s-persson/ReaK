...
BOOST_AUTO_TEST_CASE( cnst_string_test ) {
  ...
  if( ( s3[0] != compare_s3[0] ) || ( s3[6] != compare_s3[6] ) || ( s3[13] != compare_s3[13] )
      || ( s3[sizeof( compare_s3 ) - 1] != '\0' ) )
  ...
  if( ( h_54582[0] != '5' ) || ( h_54582[1] != '4' ) || ( h_54582[2] != '5' ) || ( h_54582[3] != '8' )
      || ( h_54582[4] != '2' ) || ( h_54582[5] != '\0' ) )
