  ...
  udp_server_impl( unsigned short port_num )
...

    {
      ...
      boost::asio::ip::tcp::acceptor tcp_acceptor(
        tcp_io_service, boost::asio::ip::tcp::endpoint( boost::asio::ip::tcp::v4(), port_num ) );
...
network_recorder::network_recorder( const std::string& aFileName ) { setFileName( aFileName ); };

network_recorder::~network_recorder() { closeRecordProcess(); };
...
network_extractor::~network_extractor() { closeExtractProcess(); };
