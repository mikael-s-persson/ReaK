...
QWidget* ObjPropertiesQtDelegate::createEditor(QWidget* parent, const QStyleOptionViewItem& option, const QModelIndex& index) const {
  if((!index.isValid()) || (index.column() != 1))
...
void ObjPropertiesQtDelegate::setModelData(QWidget* editor, QAbstractItemModel* model, const QModelIndex& index) const {
  if((!index.isValid()) || (index.column() != 1))
...
void ObjPropertiesQtDelegate::updateEditorGeometry(QWidget* editor, const QStyleOptionViewItem& option, const QModelIndex& index) const {
