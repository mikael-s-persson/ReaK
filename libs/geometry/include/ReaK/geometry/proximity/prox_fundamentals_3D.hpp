...
struct box_slacking_func {
  ...
  box_slacking_func( const box& aBox, const pose_3D< double >& aGblPose ) : mBox( &aBox ), mGblPose( &aGblPose ){};
...
struct box_slacking_jac {
  ...
  box_slacking_jac( const box& aBox, const pose_3D< double >& aGblPose ) : mBox( &aBox ), mGblPose( &aGblPose ){};
...
struct box_boundary_func {
  ...
  box_boundary_func( const box& aBox, const pose_3D< double >& aGblPose ) : mBox( &aBox ), mGblPose( &aGblPose ){};
...
struct box_boundary_jac {
  ...
  box_boundary_jac( const box& aBox, const pose_3D< double >& aGblPose ) : mBox( &aBox ), mGblPose( &aGblPose ){};
...
struct box_support_func : support_func_base {
  ...
  box_support_func( const box& aBox, const pose_3D< double >& aGblPose ) : mBox( &aBox ), mGblPose( &aGblPose ){};
