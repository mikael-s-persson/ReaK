...
int main(int argc, char** argv) {
  ...
  std::shared_ptr<colored_model_3D> one_building =
      std::shared_ptr<colored_model_3D>(
          new colored_model_3D("one_building_render"));
  std::shared_ptr<proxy_query_model_3D> one_building_proxy =
      std::shared_ptr<proxy_query_model_3D>(
          new proxy_query_model_3D("one_building_proxy"));
  {

    std::shared_ptr<plane> floor = std::shared_ptr<plane>(new plane(
    ...
    std::shared_ptr<box> building = std::shared_ptr<box>(new box(
    ...
    (*one_building)
        .addElement(
            color(0, 0, 0),
            std::shared_ptr<coord_arrows_3D>(new coord_arrows_3D(
  ...
  std::shared_ptr<colored_model_3D> window_crossing =
      std::shared_ptr<colored_model_3D>(
          new colored_model_3D("window_crossing_render"));
  std::shared_ptr<proxy_query_model_3D> window_crossing_proxy =
      std::shared_ptr<proxy_query_model_3D>(
          new proxy_query_model_3D("window_crossing_proxy"));
  {
