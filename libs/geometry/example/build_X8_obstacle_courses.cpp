...
int main( int argc, char** argv ) {
  ...
  shared_ptr< colored_model_3D > one_building
    = shared_ptr< colored_model_3D >( new colored_model_3D( "one_building_render" ) );
  shared_ptr< proxy_query_model_3D > one_building_proxy
    = shared_ptr< proxy_query_model_3D >( new proxy_query_model_3D( "one_building_proxy" ) );
  {

    shared_ptr< plane > floor = shared_ptr< plane >(
      new plane( "floor", shared_ptr< pose_3D< double > >(),
                 pose_3D< double >( weak_ptr< pose_3D< double > >(), vect< double, 3 >( 2.5, 2.5, 0.0 ),
                                    quaternion< double >::xrot( M_PI ).getQuaternion() ),
                 vect< double, 2 >( 5.0, 5.0 ) ) );

    shared_ptr< box > building = shared_ptr< box >( new box(
      "building", shared_ptr< pose_3D< double > >(),
      pose_3D< double >( weak_ptr< pose_3D< double > >(), vect< double, 3 >( 2.5, 2.5, -2.5 ), quaternion< double >() ),
      vect< double, 3 >( 1.0, 1.0, 5.0 ) ) );

    ( *one_building )
      .addElement( color( 0, 0, 0 ),
                   shared_ptr< coord_arrows_3D >( new coord_arrows_3D(
                     "global_frame_arrows", shared_ptr< pose_3D< double > >(), pose_3D< double >(), 0.3 ) ) )
  ...
  shared_ptr< colored_model_3D > window_crossing
    = shared_ptr< colored_model_3D >( new colored_model_3D( "window_crossing_render" ) );
  shared_ptr< proxy_query_model_3D > window_crossing_proxy
    = shared_ptr< proxy_query_model_3D >( new proxy_query_model_3D( "window_crossing_proxy" ) );
  {

    shared_ptr< plane > floor = shared_ptr< plane >(
      new plane( "floor", shared_ptr< pose_3D< double > >(),
                 pose_3D< double >( weak_ptr< pose_3D< double > >(), vect< double, 3 >( 5.0, 5.0, 0.0 ),
                                    quaternion< double >::xrot( M_PI ).getQuaternion() ),
                 vect< double, 2 >( 10.0, 10.0 ) ) );

    shared_ptr< box > wall1 = shared_ptr< box >( new box(
      "wall1", shared_ptr< pose_3D< double > >(),
      pose_3D< double >( weak_ptr< pose_3D< double > >(), vect< double, 3 >( 3.0, 1.5, -5.0 ), quaternion< double >() ),
      vect< double, 3 >( 0.2, 3.0, 10.0 ) ) );

    shared_ptr< box > wall2 = shared_ptr< box >( new box(
      "wall2", shared_ptr< pose_3D< double > >(),
      pose_3D< double >( weak_ptr< pose_3D< double > >(), vect< double, 3 >( 3.0, 4.5, -2.5 ), quaternion< double >() ),
      vect< double, 3 >( 0.2, 3.0, 5.0 ) ) );

    shared_ptr< box > wall3 = shared_ptr< box >( new box(
      "wall3", shared_ptr< pose_3D< double > >(),
      pose_3D< double >( weak_ptr< pose_3D< double > >(), vect< double, 3 >( 3.0, 4.5, -9.0 ), quaternion< double >() ),
      vect< double, 3 >( 0.2, 3.0, 2.0 ) ) );

    shared_ptr< box > wall4 = shared_ptr< box >( new box(
      "wall4", shared_ptr< pose_3D< double > >(),
      pose_3D< double >( weak_ptr< pose_3D< double > >(), vect< double, 3 >( 3.0, 8.0, -5.0 ), quaternion< double >() ),
      vect< double, 3 >( 0.2, 4.0, 10.0 ) ) );

    shared_ptr< box > wall5 = shared_ptr< box >( new box(
      "wall5", shared_ptr< pose_3D< double > >(),
      pose_3D< double >( weak_ptr< pose_3D< double > >(), vect< double, 3 >( 7.0, 2.0, -5.0 ), quaternion< double >() ),
      vect< double, 3 >( 0.2, 4.0, 10.0 ) ) );

    shared_ptr< box > wall6 = shared_ptr< box >( new box(
      "wall6", shared_ptr< pose_3D< double > >(),
      pose_3D< double >( weak_ptr< pose_3D< double > >(), vect< double, 3 >( 7.0, 5.5, -1.0 ), quaternion< double >() ),
      vect< double, 3 >( 0.2, 3.0, 2.0 ) ) );

    shared_ptr< box > wall7 = shared_ptr< box >( new box(
      "wall7", shared_ptr< pose_3D< double > >(),
      pose_3D< double >( weak_ptr< pose_3D< double > >(), vect< double, 3 >( 7.0, 5.5, -7.5 ), quaternion< double >() ),
      vect< double, 3 >( 0.2, 3.0, 5.0 ) ) );

    shared_ptr< box > wall8 = shared_ptr< box >( new box(
      "wall8", shared_ptr< pose_3D< double > >(),
