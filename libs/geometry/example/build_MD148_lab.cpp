...
int main(int argc, char ** argv) {
  ...
  io_options.add_options()
    ...
    ("output-name,o", po::value< std::string >()->default_value("MD148_lab"), "specify the output base-name (default is 'MD148_lab')")
  ...
  shared_ptr< plane > lab_floor(new plane("MD148_floor", 
  ...
  shared_ptr< plane > lab_n_wall(new plane("MD148_north_wall", 
    shared_ptr< pose_3D<double> >(), 
  ...
  shared_ptr< plane > lab_w_wall(new plane("MD148_west_wall", 
    shared_ptr< pose_3D<double> >(), 
  ...
  shared_ptr< box > lab_robot_track(new box("MD148_robot_track", 
    shared_ptr< pose_3D<double> >(), 
  ...
  shared_ptr< capped_cylinder > lab_robot_track_right(new capped_cylinder("MD148_robot_track_right", 
    shared_ptr< pose_3D<double> >(), 
    pose_3D<double>(weak_ptr< pose_3D<double> >(), vect<double,3>(-0.1,-1.71,0.15), axis_angle<double>(M_PI * 0.5, vect<double,3>(1.0,0.0,0.0)).getQuaternion()),
    3.42, 0.18));
  
  shared_ptr< coord_arrows_3D > lab_global_arrows(new coord_arrows_3D("global_frame_arrows",
    shared_ptr< pose_3D<double> >(),
    pose_3D<double>(),1.0));
