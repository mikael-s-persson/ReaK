...
int main() {
  ...
  shared_ptr< frame_3D< double > > out_frame( new frame_3D< double >() );

  shared_ptr< coord_arrows_3D > body_frame_arrows(
    new coord_arrows_3D( "body_frame_arrows", out_frame, pose_3D< double >(), 0.3 ) );

  pose_3D< double > xz_pose( weak_ptr< pose_3D< double > >(), vect< double, 3 >( 0.0, 0.0, 0.0 ),
                             quaternion< double >::xrot( M_PI * 0.5 ).getQuaternion() );

  pose_3D< double > armLF_pose = xz_pose;
  armLF_pose.addBefore( pose_3D< double >( weak_ptr< pose_3D< double > >(), vect< double, 3 >( 0.117, 0.0, -0.117 ),
  ...
  armRF_pose.addBefore( pose_3D< double >( weak_ptr< pose_3D< double > >(), vect< double, 3 >( 0.117, 0.0, 0.117 ),
  ...
  armRB_pose.addBefore( pose_3D< double >( weak_ptr< pose_3D< double > >(), vect< double, 3 >( -0.117, 0.0, 0.117 ),
                                           quaternion< double >::yrot( -M_PI * 0.25 ).getQuaternion() ) );
  ...
  armLB_pose.addBefore( pose_3D< double >( weak_ptr< pose_3D< double > >(), vect< double, 3 >( -0.117, 0.0, -0.117 ),
                                           quaternion< double >::yrot( -M_PI * 0.75 ).getQuaternion() ) );

  shared_ptr< capped_cylinder > armLB( new capped_cylinder( "X8_armLB", out_frame, armLB_pose, 0.331, 0.02 ) );

  armLF_pose.addBefore( pose_3D< double >( weak_ptr< pose_3D< double > >(), vect< double, 3 >( 0.0, 0.0, 0.1655 ),
                                           quaternion< double >::xrot( M_PI * 0.5 ).getQuaternion() ) );
  armRF_pose.addBefore( pose_3D< double >( weak_ptr< pose_3D< double > >(), vect< double, 3 >( 0.0, 0.0, 0.1655 ),
                                           quaternion< double >::xrot( M_PI * 0.5 ).getQuaternion() ) );
  armRB_pose.addBefore( pose_3D< double >( weak_ptr< pose_3D< double > >(), vect< double, 3 >( 0.0, 0.0, 0.1655 ),
                                           quaternion< double >::xrot( M_PI * 0.5 ).getQuaternion() ) );
  armLB_pose.addBefore( pose_3D< double >( weak_ptr< pose_3D< double > >(), vect< double, 3 >( 0.0, 0.0, 0.1655 ),
                                           quaternion< double >::xrot( M_PI * 0.5 ).getQuaternion() ) );
  ...
  armLF_pose.addBefore(
    pose_3D< double >( weak_ptr< pose_3D< double > >(), vect< double, 3 >( 0.0, 0.0, 0.05 ), quaternion< double >() ) );
  armRF_pose.addBefore(
    pose_3D< double >( weak_ptr< pose_3D< double > >(), vect< double, 3 >( 0.0, 0.0, 0.05 ), quaternion< double >() ) );
  armRB_pose.addBefore(
    pose_3D< double >( weak_ptr< pose_3D< double > >(), vect< double, 3 >( 0.0, 0.0, 0.05 ), quaternion< double >() ) );
  armLB_pose.addBefore(
    pose_3D< double >( weak_ptr< pose_3D< double > >(), vect< double, 3 >( 0.0, 0.0, 0.05 ), quaternion< double >() ) );
  ...
  armLF_pose.addBefore(
    pose_3D< double >( weak_ptr< pose_3D< double > >(), vect< double, 3 >( 0.0, 0.0, -0.1 ), quaternion< double >() ) );
  armRF_pose.addBefore(
    pose_3D< double >( weak_ptr< pose_3D< double > >(), vect< double, 3 >( 0.0, 0.0, -0.1 ), quaternion< double >() ) );
  armRB_pose.addBefore(
    pose_3D< double >( weak_ptr< pose_3D< double > >(), vect< double, 3 >( 0.0, 0.0, -0.1 ), quaternion< double >() ) );
  ...
  shared_ptr< box > body_case(
    new box( "X8_box", out_frame, pose_3D< double >(), vect< double, 3 >( 0.15, 0.15, 0.15 ) ) );

  pose_3D< double > skid_pose = xz_pose;
  skid_pose.addBefore( pose_3D< double >( weak_ptr< pose_3D< double > >(), vect< double, 3 >( 0.0, 0.25, 0.0 ),
                                          quaternion< double >::yrot( M_PI * 0.5 ).getQuaternion() ) );

  skid_pose.addBefore(
    pose_3D< double >( weak_ptr< pose_3D< double > >(), vect< double, 3 >( 0.15, 0.0, 0.0 ), quaternion< double >() ) );

  shared_ptr< capped_cylinder > Lskid( new capped_cylinder( "X8_Lskid", out_frame, skid_pose, 0.3, 0.01 ) );

  skid_pose.addBefore(
    pose_3D< double >( weak_ptr< pose_3D< double > >(), vect< double, 3 >( -0.3, 0.0, 0.0 ), quaternion< double >() ) );
  ...
  shared_ptr< colored_model_3D > geom_model
    = shared_ptr< colored_model_3D >( new colored_model_3D( "X8_model_render" ) );
  ...
  shared_ptr< proxy_query_model_3D > proxy_model
    = shared_ptr< proxy_query_model_3D >( new proxy_query_model_3D( "X8_model_proxy" ) );
