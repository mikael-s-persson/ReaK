...
int main() {
  ...
  shared_ptr< colored_model_3D > geom_model = shared_ptr< colored_model_3D >(new colored_model_3D("X8_model_render"));
  ...
  shared_ptr< proxy_query_model_3D > proxy_model = shared_ptr< proxy_query_model_3D >(new proxy_query_model_3D("X8_model_proxy"));
