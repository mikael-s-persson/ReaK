...
pose_3D< double > a5 = pose_3D< double >( shared_ptr< pose_3D< double > >(), vect< double, 3 >( 0.0, 0.0, 0.0 ),
                                          quaternion< double >( vect< double, 4 >( 1.0, 0.0, 0.0, 0.0 ) ) );
pose_3D< double > a6 = pose_3D< double >( shared_ptr< pose_3D< double > >(), vect< double, 3 >( 0.5, 0.0, 4.0 ),
                                          quaternion< double >( vect< double, 4 >( 1.0, 0.0, 0.0, 0.0 ) ) );
...
shared_ptr< geom::cylinder > cy7
  = shared_ptr< geom::cylinder >( new geom::cylinder( "cy7", shared_ptr< pose_3D< double > >(), a6, 5.0, 0.5 ) );
...
shared_ptr< geom::box > bx7 = shared_ptr< geom::box >(
  new geom::box( "bx7", shared_ptr< pose_3D< double > >(), a5, vect< double, 3 >( 4.0, 2.0, 4.0 ) ) );
  ...
  void operator()() {
    ...
    if( mShape1->getObjectType() == geom::box::getStaticObjectType() ) {
      ...
      if( mShape2->getObjectType() == geom::box::getStaticObjectType() ) {
        ...
        std::cout << " which has brute-force approximate min-dist of: " << get_brute_force_dist( bf1, bf2 )
                  << std::endl;
    ...
    std::cout << "  -- Distance between pt-1 and pt-2 is: " << norm_2( result.mPoint1 - result.mPoint2 ) << std::endl;
  };
};
