...
pose_3D< double > a1 = pose_3D< double >( shared_ptr< pose_3D< double > >(), vect< double, 3 >( 0.0, 0.0, 0.0 ),
                                          quaternion< double >( vect< double, 4 >( 0.8, 0.0, 0.6, 0.0 ) ) );
pose_3D< double > a2 = pose_3D< double >( shared_ptr< pose_3D< double > >(), vect< double, 3 >( 0.0, 3.0, 5.0 ),
                                          quaternion< double >( vect< double, 4 >( 0.8, -0.6, 0.0, 0.0 ) ) );
pose_3D< double > a3 = pose_3D< double >( shared_ptr< pose_3D< double > >(), vect< double, 3 >( 10.0, -3.0, -2.0 ),
                                          quaternion< double >( vect< double, 4 >( 1.0, 0.0, 0.0, 0.0 ) ) );
pose_3D< double > a4 = pose_3D< double >(
  shared_ptr< pose_3D< double > >(), vect< double, 3 >( -3.0, -3.0, 6.0 ),
  quaternion< double >( vect< double, 4 >( sqrt( 3.0 ) / 3.0, 0.0, -sqrt( 3.0 ) / 3.0, sqrt( 3.0 ) / 3.0 ) ) );

shared_ptr< geom::cylinder > cy1
  = shared_ptr< geom::cylinder >( new geom::cylinder( "cy1", shared_ptr< pose_3D< double > >(), a1, 5.0, 0.5 ) );
shared_ptr< geom::cylinder > cy2
  = shared_ptr< geom::cylinder >( new geom::cylinder( "cy2", shared_ptr< pose_3D< double > >(), a1, 10.0, 0.25 ) );
shared_ptr< geom::cylinder > cy3
  = shared_ptr< geom::cylinder >( new geom::cylinder( "cy3", shared_ptr< pose_3D< double > >(), a1, 1.0, 2.0 ) );
shared_ptr< geom::cylinder > cy4
  = shared_ptr< geom::cylinder >( new geom::cylinder( "cy4", shared_ptr< pose_3D< double > >(), a2, 5.0, 0.5 ) );
shared_ptr< geom::cylinder > cy5
  = shared_ptr< geom::cylinder >( new geom::cylinder( "cy5", shared_ptr< pose_3D< double > >(), a3, 5.0, 0.5 ) );
shared_ptr< geom::cylinder > cy6
  = shared_ptr< geom::cylinder >( new geom::cylinder( "cy6", shared_ptr< pose_3D< double > >(), a4, 5.0, 0.5 ) );

shared_ptr< geom::box > bx1 = shared_ptr< geom::box >(
  new geom::box( "bx1", shared_ptr< pose_3D< double > >(), a1, vect< double, 3 >( 1.0, 2.0, 1.0 ) ) );
shared_ptr< geom::box > bx2 = shared_ptr< geom::box >(
  new geom::box( "bx2", shared_ptr< pose_3D< double > >(), a1, vect< double, 3 >( 4.0, 1.0, 10.0 ) ) );
shared_ptr< geom::box > bx3 = shared_ptr< geom::box >(
  new geom::box( "bx3", shared_ptr< pose_3D< double > >(), a1, vect< double, 3 >( 4.0, 4.0, 1.0 ) ) );
shared_ptr< geom::box > bx4 = shared_ptr< geom::box >(
  new geom::box( "bx4", shared_ptr< pose_3D< double > >(), a2, vect< double, 3 >( 4.0, 2.0, 2.0 ) ) );
shared_ptr< geom::box > bx5 = shared_ptr< geom::box >(
  new geom::box( "bx5", shared_ptr< pose_3D< double > >(), a3, vect< double, 3 >( 4.0, 2.0, 2.0 ) ) );
shared_ptr< geom::box > bx6 = shared_ptr< geom::box >(
  new geom::box( "bx6", shared_ptr< pose_3D< double > >(), a4, vect< double, 3 >( 4.0, 2.0, 2.0 ) ) );
...
struct proximity_solver {
  ...
  proximity_solver( const shared_ptr< geom::shape_3D >& aShape1, const shared_ptr< geom::shape_3D >& aShape2 )
  ...
  vect< double, 3 > operator()() {
    ...
    if( mShape1->getObjectType() == geom::box::getStaticObjectType() ) {
      ...
      if( mShape2->getObjectType() == geom::box::getStaticObjectType() ) {
        ...
        std::cout << "Checking proximity between Box '" << bx1->getName() << "' and Box '" << bx2->getName() << "'..."
                  << std::endl;

        try {
          optim::make_nlip_newton_tr( geom::slack_minimize_func(), geom::slack_minimize_grad(),
            ...
            .set_ineq_constraints(
              ...
              geom::dual_slacking_jac< geom::box_slacking_jac, geom::box_slacking_jac >(
                geom::box_slacking_jac( *bx1, bx1_pose ), geom::box_slacking_jac( *bx2, bx2_pose ) ) )( x );
        } catch( ... ) {
        };

        std::cout << "  -- The raw solution obtained was: " << x << std::endl;
        std::cout << "  -- The shape1 boundary functions give: " << geom::box_slacking_func ( *bx1, bx1_pose )( x )
                  << std::endl;
        std::cout << "  -- The shape2 boundary functions give: " << geom::box_slacking_func ( *bx2, bx2_pose )( x )
                  << std::endl;
        ...
        std::cout << "Checking proximity between Box '" << bx1->getName() << "' and Cylinder '" << cy2->getName()
                  << "'..." << std::endl;
          ...
          optim::make_nlip_newton_tr( geom::slack_minimize_func(), geom::slack_minimize_grad(),
            ...
            .set_ineq_constraints(
              ...
              geom::dual_slacking_jac< geom::box_slacking_jac, geom::cylinder_slacking_jac >(
                geom::box_slacking_jac( *bx1, bx1_pose ), geom::cylinder_slacking_jac( *cy2, cy2_pose ) ) )( x );
        } catch( ... ) {
        };
        ...
        std::cout << "  -- The shape1 boundary functions give: " << geom::box_slacking_func ( *bx1, bx1_pose )( x )
                  << std::endl;
        std::cout << "  -- The shape2 boundary functions give: " << geom::cylinder_slacking_func ( *cy2, cy2_pose )( x )
                  << std::endl;
      };
    } else {
      ...
      if( mShape2->getObjectType() == geom::box::getStaticObjectType() ) {
        ...
        std::cout << "Checking proximity between Cylinder '" << cy1->getName() << "' and Box '" << bx2->getName()
                  << "'..." << std::endl;
          ...
          optim::make_nlip_newton_tr( geom::slack_minimize_func(), geom::slack_minimize_grad(),
            ...
            .set_ineq_constraints(
              ...
              geom::dual_slacking_jac< geom::cylinder_slacking_jac, geom::box_slacking_jac >(
                geom::cylinder_slacking_jac( *cy1, cy1_pose ), geom::box_slacking_jac( *bx2, bx2_pose ) ) )( x );
        } catch( ... ) {
        };

        std::cout << "  -- The raw solution obtained was: " << x << std::endl;
        std::cout << "  -- The shape1 boundary functions give: " << geom::cylinder_slacking_func ( *cy1, cy1_pose )( x )
                  << std::endl;
        std::cout << "  -- The shape2 boundary functions give: " << geom::box_slacking_func ( *bx2, bx2_pose )( x )
                  << std::endl;
        ...
        std::cout << "Checking proximity between Cylinder '" << cy1->getName() << "' and Cylinder '" << cy2->getName()
                  << "'..." << std::endl;
          ...
          optim::make_nlip_newton_tr( geom::slack_minimize_func(), geom::slack_minimize_grad(),
            ...
            .set_ineq_constraints(
              ...
              geom::dual_slacking_jac< geom::cylinder_slacking_jac, geom::cylinder_slacking_jac >(
                geom::cylinder_slacking_jac( *cy1, cy1_pose ), geom::cylinder_slacking_jac( *cy2, cy2_pose ) ) )( x );
        } catch( ... ) {
        };
    ...
    if( x[0] > 1e-6 ) {
      ...
      std::cout << "  -- The center points of the shapes are coincident! At " << vect< double, 3 >( x[1], x[2], x[3] )
                << std::endl;
    };
