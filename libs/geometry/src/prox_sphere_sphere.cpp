...
proximity_record_3D prox_sphere_sphere::computeProximity( const shape_3D_precompute_pack& aPack1,
...
prox_sphere_sphere::prox_sphere_sphere( const sphere* aSphere1, const sphere* aSphere2 )
    : proximity_finder_3D(), mSphere1( aSphere1 ), mSphere2( aSphere2 ){};
};
};
