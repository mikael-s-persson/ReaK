...
proximity_record_2D prox_circle_circle::computeProximity( const shape_2D_precompute_pack& aPack1,
...
prox_circle_circle::prox_circle_circle( const circle* aCircle1, const circle* aCircle2 )
    : proximity_finder_2D(), mCircle1( aCircle1 ), mCircle2( aCircle2 ){};
};
};
