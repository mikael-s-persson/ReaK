...
proximity_record_3D prox_ccylinder_box::computeProximity( const shape_3D_precompute_pack& aPack1,
...
prox_ccylinder_box::prox_ccylinder_box( const capped_cylinder* aCCylinder, const box* aBox )
    : proximity_finder_3D(), mCCylinder( aCCylinder ), mBox( aBox ){};
};
};
