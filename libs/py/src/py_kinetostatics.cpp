...
void export_kinetostatics() {
  ...
  class_< ReaK::gen_coord< double >, bases< ReaK::shared_object >, ReaK::shared_ptr< ReaK::gen_coord< double > > >(
    "GenCoord" )
  ...
  def( "create_gen_coord",
       ReaK::rk_create< ReaK::gen_coord< double >, const double&, const double&, const double&, const double& > );
  ...
  class_< ReaK::rot_mat_2D< double > >( "Rotation2D" )
    ...
    .def( "transpose",
          static_cast< ReaK::rot_mat_2D< double >(*)( const ReaK::rot_mat_2D< double >& ) >( &ReaK::transpose ) )
  ...
  class_< ReaK::trans_mat_2D< double > >( "Transform2D" )
    ...
    .def( "invert",
          static_cast< ReaK::trans_mat_2D< double >(*)( const ReaK::trans_mat_2D< double >& ) >( &ReaK::invert ) )
  ...
  class_< ReaK::pose_2D< double >, bases< ReaK::shared_object >, ReaK::shared_ptr< ReaK::pose_2D< double > > >(
    "Pose2D" )
    ...
    .def( "is_parent_pose", static_cast< bool (ReaK::pose_2D< double >::*)( const ReaK::pose_2D< double >& ) const >(
                              &ReaK::pose_2D< double >::isParentPose ) )
    .def( "is_parent_pose",
          static_cast< bool (ReaK::pose_2D< double >::*)( const ReaK::shared_ptr< const ReaK::pose_2D< double > >& )
                       const >( &ReaK::pose_2D< double >::isParentPose ) )
    .def( "get_pose_relative_to",
          static_cast< ReaK::pose_2D< double >(ReaK::pose_2D< double >::*)( const ReaK::pose_2D< double >& ) const >(
            &ReaK::pose_2D< double >::getPoseRelativeTo ) )
    .def( "get_pose_relative_to",
          static_cast< ReaK::pose_2D< double >(
            ReaK::pose_2D< double >::*)( const ReaK::shared_ptr< const ReaK::pose_2D< double > >& ) const >(
            &ReaK::pose_2D< double >::getPoseRelativeTo ) )
  ...
  implicitly_convertible< ReaK::shared_ptr< ReaK::pose_2D< double > >, ReaK::weak_ptr< ReaK::pose_2D< double > > >();

  def( "create_pose_2d", ReaK::rk_create< ReaK::pose_2D< double > > );
  def( "create_pose_2d", ReaK::rk_create< ReaK::pose_2D< double >, const ReaK::shared_ptr< ReaK::pose_2D< double > >&,
                                          const ReaK::vect< double, 2 >&, const ReaK::rot_mat_2D< double >& > );


  class_< ReaK::frame_2D< double >, bases< ReaK::pose_2D< double > >, ReaK::shared_ptr< ReaK::frame_2D< double > > >(
    "Frame2D" )
    .def( init< ReaK::shared_ptr< ReaK::pose_2D< double > >, ReaK::vect< double, 2 >, ReaK::rot_mat_2D< double >,
                ReaK::vect< double, 2 >, double, ReaK::vect< double, 2 >, double, ReaK::vect< double, 2 >, double >() )
    ...
    .def( "get_frame_relative_to",
          static_cast< ReaK::frame_2D< double >(ReaK::frame_2D< double >::*)( const ReaK::pose_2D< double >& ) const >(
            &ReaK::frame_2D< double >::getFrameRelativeTo ) )
    .def( "get_frame_relative_to",
          static_cast< ReaK::frame_2D< double >(
            ReaK::frame_2D< double >::*)( const ReaK::shared_ptr< const ReaK::pose_2D< double > >& ) const >(
            &ReaK::frame_2D< double >::getFrameRelativeTo ) )
  ...
  implicitly_convertible< ReaK::shared_ptr< ReaK::frame_2D< double > >, ReaK::weak_ptr< ReaK::frame_2D< double > > >();

  def( "create_frame_2d", ReaK::rk_create< ReaK::frame_2D< double > > );
  def( "create_frame_2d",
       ReaK::rk_create< ReaK::frame_2D< double >, const ReaK::shared_ptr< ReaK::pose_2D< double > >&,
                        const ReaK::vect< double, 2 >&, const ReaK::rot_mat_2D< double >&,
                        const ReaK::vect< double, 2 >&, const double&, const ReaK::vect< double, 2 >&, const double&,
  ...
  class_< ReaK::rot_mat_3D< double > >( "Rotation3D" )
    ...
    .def( "transpose",
          static_cast< ReaK::rot_mat_3D< double >(*)( const ReaK::rot_mat_3D< double >& ) >( &ReaK::transpose ) )
  ...
  class_< ReaK::quaternion< double > >( "QuaternionRot" )
    ...
    .def( self * other< ReaK::vect< double, 3 > >() )
    .def( "transpose",
          static_cast< ReaK::quaternion< double >(*)( const ReaK::quaternion< double >& ) >( &ReaK::transpose ) )
  ...
  class_< ReaK::euler_angles_TB< double > >( "EulerAngles" )
    ...
    .def( self *= other< ReaK::quaternion< double > >() )
    .def( self * other< ReaK::vect< double, 3 > >() )
    .def( "transpose", static_cast< ReaK::euler_angles_TB< double >(*)( const ReaK::euler_angles_TB< double >& ) >(
                         &ReaK::transpose ) )
    .def( "invert",
          static_cast< ReaK::euler_angles_TB< double >(*)( const ReaK::euler_angles_TB< double >& ) >( &ReaK::invert ) )
  ...
  class_< ReaK::axis_angle< double > >( "AxisAngle" )
    ...
    .def( self * other< ReaK::vect< double, 3 > >() )
    .def( "transpose",
          static_cast< ReaK::axis_angle< double >(*)( const ReaK::axis_angle< double >& ) >( &ReaK::transpose ) )
  ...
  class_< ReaK::trans_mat_3D< double > >( "Transform3D" )
    ...
    .add_property( "euler_angles", &ReaK::trans_mat_3D< double >::getEulerAnglesTB,
    ...
    .def( "invert",
          static_cast< ReaK::trans_mat_3D< double >(*)( const ReaK::trans_mat_3D< double >& ) >( &ReaK::invert ) )
  ...
  class_< ReaK::pose_3D< double >, bases< ReaK::shared_object >, ReaK::shared_ptr< ReaK::pose_3D< double > > >(
    "Pose3D" )
    ...
    .def( "is_parent_pose", static_cast< bool (ReaK::pose_3D< double >::*)( const ReaK::pose_3D< double >& ) const >(
                              &ReaK::pose_3D< double >::isParentPose ) )
    .def( "is_parent_pose",
          static_cast< bool (ReaK::pose_3D< double >::*)( const ReaK::shared_ptr< const ReaK::pose_3D< double > >& )
                       const >( &ReaK::pose_3D< double >::isParentPose ) )
    .def( "get_pose_relative_to",
          static_cast< ReaK::pose_3D< double >(ReaK::pose_3D< double >::*)( const ReaK::pose_3D< double >& ) const >(
            &ReaK::pose_3D< double >::getPoseRelativeTo ) )
    .def( "get_pose_relative_to",
          static_cast< ReaK::pose_3D< double >(
            ReaK::pose_3D< double >::*)( const ReaK::shared_ptr< const ReaK::pose_3D< double > >& ) const >(
            &ReaK::pose_3D< double >::getPoseRelativeTo ) )
  ...
  implicitly_convertible< ReaK::shared_ptr< ReaK::pose_3D< double > >, ReaK::weak_ptr< ReaK::pose_3D< double > > >();

  def( "create_pose_3d", ReaK::rk_create< ReaK::pose_3D< double > > );
  def( "create_pose_3d", ReaK::rk_create< ReaK::pose_3D< double >, const ReaK::shared_ptr< ReaK::pose_3D< double > >&,
                                          const ReaK::vect< double, 3 >&, const ReaK::quaternion< double >& > );


  class_< ReaK::frame_3D< double >, bases< ReaK::pose_3D< double > >, ReaK::shared_ptr< ReaK::frame_3D< double > > >(
    "Frame3D" )
    .def( init< ReaK::shared_ptr< ReaK::pose_3D< double > >, ReaK::vect< double, 3 >, ReaK::quaternion< double >,
                ReaK::vect< double, 3 >, ReaK::vect< double, 3 >, ReaK::vect< double, 3 >, ReaK::vect< double, 3 >,
    ...
    .def( "get_frame_relative_to",
          static_cast< ReaK::frame_3D< double >(ReaK::frame_3D< double >::*)( const ReaK::pose_3D< double >& ) const >(
            &ReaK::frame_3D< double >::getFrameRelativeTo ) )
    .def( "get_frame_relative_to",
          static_cast< ReaK::frame_3D< double >(
            ReaK::frame_3D< double >::*)( const ReaK::shared_ptr< const ReaK::pose_3D< double > >& ) const >(
            &ReaK::frame_3D< double >::getFrameRelativeTo ) )
    .def( "add_frame_before",
          static_cast< ReaK::frame_3D< double >& (ReaK::frame_3D< double >::*)( const ReaK::pose_3D< double >& ) >(
    ...
    .def( "add_frame_after",
          ...
          return_internal_reference<>() )
    .def( "add_frame_before",
          static_cast< ReaK::frame_3D< double >& (ReaK::frame_3D< double >::*)( const ReaK::frame_3D< double >& ) >(
            &ReaK::frame_3D< double >::addBefore ),
          return_internal_reference<>() )
    .def( "add_frame_after",
          static_cast< ReaK::frame_3D< double >& (ReaK::frame_3D< double >::*)( const ReaK::frame_3D< double >& ) >(
  ...
  implicitly_convertible< ReaK::shared_ptr< ReaK::frame_3D< double > >, ReaK::weak_ptr< ReaK::frame_3D< double > > >();

  def( "create_frame_3d", ReaK::rk_create< ReaK::frame_3D< double > > );
  def(
    "create_frame_3d",
    ReaK::rk_create< ReaK::frame_3D< double >, const ReaK::shared_ptr< ReaK::pose_3D< double > >&,
                     const ReaK::vect< double, 3 >&, const ReaK::quaternion< double >&, const ReaK::vect< double, 3 >&,
                     const ReaK::vect< double, 3 >&, const ReaK::vect< double, 3 >&, const ReaK::vect< double, 3 >&,
  ...
  class_< ReaK::jacobian_gen_gen< double >, bases< ReaK::shared_object >,
          ReaK::shared_ptr< ReaK::jacobian_gen_gen< double > > >( "JacobianGenGen" )
  ...
  class_< ReaK::jacobian_gen_2D< double >, bases< ReaK::shared_object >,
          ReaK::shared_ptr< ReaK::jacobian_gen_2D< double > > >( "JacobianGen2D" )
  ...
  class_< ReaK::jacobian_gen_3D< double >, bases< ReaK::shared_object >,
          ReaK::shared_ptr< ReaK::jacobian_gen_3D< double > > >( "JacobianGen3D" )
  ...
  class_< ReaK::jacobian_2D_gen< double >, bases< ReaK::shared_object >,
          ReaK::shared_ptr< ReaK::jacobian_2D_gen< double > > >( "Jacobian2DGen" )
  ...
  class_< ReaK::jacobian_2D_2D< double >, bases< ReaK::shared_object >,
          ReaK::shared_ptr< ReaK::jacobian_2D_2D< double > > >( "Jacobian2D2D" )
  ...
  class_< ReaK::jacobian_2D_3D< double >, bases< ReaK::shared_object >,
          ReaK::shared_ptr< ReaK::jacobian_2D_3D< double > > >( "Jacobian2D3D" )
  ...
  class_< ReaK::jacobian_3D_gen< double >, bases< ReaK::shared_object >,
          ReaK::shared_ptr< ReaK::jacobian_3D_gen< double > > >( "Jacobian3DGen" )
  ...
  class_< ReaK::jacobian_3D_2D< double >, bases< ReaK::shared_object >,
          ReaK::shared_ptr< ReaK::jacobian_3D_2D< double > > >( "Jacobian3D2D" )
  ...
  class_< ReaK::jacobian_3D_3D< double >, bases< ReaK::shared_object >,
          ReaK::shared_ptr< ReaK::jacobian_3D_3D< double > > >( "Jacobian3D3D" )
  ...
  class_< ReaK::quat< double > >( "Quat" )
    ...
    .def( self * other< ReaK::vect< double, 3 > >() )
    .def( other< ReaK::vect< double, 3 > >() * self )
    .def( "__pow__", static_cast< ReaK::quat< double >(*)( const ReaK::quat< double >&, const ReaK::quat< double >& ) >(
                       &ReaK::pow ) );
  ...
  def( "colinear",
       static_cast< bool (*)( const ReaK::quat< double >&, const ReaK::quat< double >& ) >( &ReaK::colinear ) );
  ...
  def( "atan2", static_cast< ReaK::quat< double >(*)( const ReaK::quat< double >&, const ReaK::quat< double >& ) >(
                  &ReaK::atan2 ) );
  ...
  class_< ReaK::unit_quat< double >, bases< ReaK::quat< double > > >( "UnitQuat" )
    ...
    .def( -self )
    .def( self * self )
    .def( "__pow__", static_cast< ReaK::unit_quat< double >(*)( const ReaK::unit_quat< double >&, const double& ) >(
                       &ReaK::pow ) );
  ...
  implicitly_convertible< ReaK::shared_ptr< ReaK::gen_coord< double > >, ReaK::shared_ptr< ReaK::shared_object > >();
  implicitly_convertible< ReaK::shared_ptr< ReaK::pose_2D< double > >, ReaK::shared_ptr< ReaK::shared_object > >();
  implicitly_convertible< ReaK::shared_ptr< ReaK::frame_2D< double > >, ReaK::shared_ptr< ReaK::pose_2D< double > > >();
  implicitly_convertible< ReaK::shared_ptr< ReaK::pose_3D< double > >, ReaK::shared_ptr< ReaK::shared_object > >();
  implicitly_convertible< ReaK::shared_ptr< ReaK::frame_3D< double > >, ReaK::shared_ptr< ReaK::pose_3D< double > > >();
