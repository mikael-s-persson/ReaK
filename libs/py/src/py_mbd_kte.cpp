...
template < typename FrameType,
           const std::vector< ReaK::shared_ptr< FrameType > >& ( ReaK::kte::mass_matrix_calc::*MemFuncPtr )() const >
struct py_mmc_frame_vector {
  ...
  std::size_t size() const { return ( mmc->*MemFuncPtr )().size(); };

  ReaK::shared_ptr< FrameType > get( std::size_t i ) const { return ( mmc->*MemFuncPtr )()[i]; };
};
...
void export_mbd_kte() {
  ...
  class_< ReaK::kte::kte_map, boost::noncopyable, bases< ReaK::named_object >, ReaK::shared_ptr< ReaK::kte::kte_map > >(
    "KTEMap", no_init )
  ...
  class_< ReaK::kte::kte_map_chain, boost::noncopyable, bases< ReaK::kte::kte_map >,
          ReaK::shared_ptr< ReaK::kte::kte_map_chain > >( "KTEMapChain" )
    .def( init< std::string >() )
  ...
  class_< ReaK::kte::system_input, boost::noncopyable, bases< ReaK::named_object >,
          ReaK::shared_ptr< ReaK::kte::system_input > >( "KTESystemInput", no_init )
  ...
  class_< ReaK::kte::system_output, boost::noncopyable, bases< ReaK::named_object >,
          ReaK::shared_ptr< ReaK::kte::system_output > >( "KTESystemOutput", no_init )
  ...
  class_< ReaK::kte::damper_gen, boost::noncopyable, bases< ReaK::kte::kte_map >,
          ReaK::shared_ptr< ReaK::kte::damper_gen > >( "KTEDamperGen" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::gen_coord< double > >,
                ReaK::shared_ptr< ReaK::gen_coord< double > >, double >() )
  ...
  class_< ReaK::kte::damper_2D, boost::noncopyable, bases< ReaK::kte::kte_map >,
          ReaK::shared_ptr< ReaK::kte::damper_2D > >( "KTEDamper2D" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::frame_2D< double > >, ReaK::shared_ptr< ReaK::frame_2D< double > >,
                double >() )
  ...
  class_< ReaK::kte::damper_3D, boost::noncopyable, bases< ReaK::kte::kte_map >,
          ReaK::shared_ptr< ReaK::kte::damper_3D > >( "KTEDamper3D" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::frame_3D< double > >, ReaK::shared_ptr< ReaK::frame_3D< double > >,
                double >() )
  ...
  class_< ReaK::kte::spring_gen, boost::noncopyable, bases< ReaK::kte::kte_map >,
          ReaK::shared_ptr< ReaK::kte::spring_gen > >( "KTESpringGen" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::gen_coord< double > >,
                ReaK::shared_ptr< ReaK::gen_coord< double > >, double, double, double >() )
  ...
  class_< ReaK::kte::spring_2D, boost::noncopyable, bases< ReaK::kte::kte_map >,
          ReaK::shared_ptr< ReaK::kte::spring_2D > >( "KTESpring2D" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::frame_2D< double > >, ReaK::shared_ptr< ReaK::frame_2D< double > >,
  ...
  class_< ReaK::kte::spring_3D, boost::noncopyable, bases< ReaK::kte::kte_map >,
          ReaK::shared_ptr< ReaK::kte::spring_3D > >( "KTESpring3D" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::frame_3D< double > >, ReaK::shared_ptr< ReaK::frame_3D< double > >,
                double, double, double >() )
  ...
  class_< ReaK::kte::torsion_damper_2D, boost::noncopyable, bases< ReaK::kte::kte_map >,
          ReaK::shared_ptr< ReaK::kte::torsion_damper_2D > >( "KTETorsionDamper2D" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::frame_2D< double > >, ReaK::shared_ptr< ReaK::frame_2D< double > >,
                double >() )
  ...
  class_< ReaK::kte::torsion_damper_3D, boost::noncopyable, bases< ReaK::kte::kte_map >,
          ReaK::shared_ptr< ReaK::kte::torsion_damper_3D > >( "KTETorsionDamper3D" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::frame_3D< double > >, ReaK::shared_ptr< ReaK::frame_3D< double > >,
                double >() )
  ...
  class_< ReaK::kte::torsion_spring_2D, boost::noncopyable, bases< ReaK::kte::kte_map >,
          ReaK::shared_ptr< ReaK::kte::torsion_spring_2D > >( "KTETorsionSpring2D" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::frame_2D< double > >, ReaK::shared_ptr< ReaK::frame_2D< double > >,
                double, double >() )
  ...
  class_< ReaK::kte::torsion_spring_3D, boost::noncopyable, bases< ReaK::kte::kte_map >,
          ReaK::shared_ptr< ReaK::kte::torsion_spring_3D > >( "KTETorsionSpring3D" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::frame_3D< double > >, ReaK::shared_ptr< ReaK::frame_3D< double > >,
                double, double >() )
  ...
  class_< ReaK::kte::flexible_beam_2D, boost::noncopyable, bases< ReaK::kte::kte_map >,
          ReaK::shared_ptr< ReaK::kte::flexible_beam_2D > >( "KTEFlexibleBeam2D" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::frame_2D< double > >, ReaK::shared_ptr< ReaK::frame_2D< double > >,
                ReaK::shared_ptr< ReaK::frame_2D< double > >, double, double, double >() )
    ...
    .add_property( "torsion_stiffness", &ReaK::kte::flexible_beam_2D::TorsionStiffness,
                   &ReaK::kte::flexible_beam_2D::setTorsionStiffness );

  class_< ReaK::kte::flexible_beam_3D, boost::noncopyable, bases< ReaK::kte::kte_map >,
          ReaK::shared_ptr< ReaK::kte::flexible_beam_3D > >( "KTEFlexibleBeam3D" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::frame_3D< double > >, ReaK::shared_ptr< ReaK::frame_3D< double > >,
                ReaK::shared_ptr< ReaK::frame_3D< double > >, double, double, double >() )
    ...
    .add_property( "torsion_stiffness", &ReaK::kte::flexible_beam_3D::TorsionStiffness,
                   &ReaK::kte::flexible_beam_3D::setTorsionStiffness );


  class_< ReaK::kte::line_point_mindist_2D, boost::noncopyable, bases< ReaK::kte::kte_map >,
          ReaK::shared_ptr< ReaK::kte::line_point_mindist_2D > >( "KTELinePointMinDist2D" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::frame_2D< double > >, ReaK::shared_ptr< ReaK::frame_2D< double > >,
    ...
    .add_property( "origin_mindist", &ReaK::kte::line_point_mindist_2D::OriginMinDist,
                   &ReaK::kte::line_point_mindist_2D::setOriginMinDist );

  class_< ReaK::kte::line_point_mindist_3D, boost::noncopyable, bases< ReaK::kte::kte_map >,
          ReaK::shared_ptr< ReaK::kte::line_point_mindist_3D > >( "KTELinePointMinDist3D" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::frame_3D< double > >, ReaK::shared_ptr< ReaK::frame_3D< double > >,
    ...
    .add_property( "origin_mindist", &ReaK::kte::line_point_mindist_3D::OriginMinDist,
                   &ReaK::kte::line_point_mindist_3D::setOriginMinDist );

  class_< ReaK::kte::plane_point_mindist_3D, boost::noncopyable, bases< ReaK::kte::kte_map >,
          ReaK::shared_ptr< ReaK::kte::plane_point_mindist_3D > >( "KTEPlanePointMinDist3D" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::frame_3D< double > >, ReaK::shared_ptr< ReaK::frame_3D< double > >,
  ...
  class_< ReaK::kte::reacting_kte_gen, boost::noncopyable, bases< ReaK::kte::kte_map >,
          ReaK::shared_ptr< ReaK::kte::reacting_kte_gen > >( "KTEReactingGen", no_init )
    .def( "apply_reaction_force", pure_virtual( &ReaK::kte::reacting_kte_gen::applyReactionForce ) );

  class_< ReaK::kte::reacting_kte_2D, boost::noncopyable, bases< ReaK::kte::kte_map >,
          ReaK::shared_ptr< ReaK::kte::reacting_kte_2D > >( "KTEReacting2D", no_init )
    .def( "apply_reaction_force", pure_virtual( &ReaK::kte::reacting_kte_2D::applyReactionForce ) );

  class_< ReaK::kte::reacting_kte_3D, boost::noncopyable, bases< ReaK::kte::kte_map >,
          ReaK::shared_ptr< ReaK::kte::reacting_kte_3D > >( "KTEReacting3D", no_init )
    .def( "apply_reaction_force", pure_virtual( &ReaK::kte::reacting_kte_3D::applyReactionForce ) );


  class_< ReaK::kte::revolute_joint_2D, boost::noncopyable, bases< ReaK::kte::reacting_kte_gen >,
          ReaK::shared_ptr< ReaK::kte::revolute_joint_2D > >( "KTERevoluteJoint2D" )
    .def( init< std::string >() )
    .def(
       init< std::string, ReaK::shared_ptr< ReaK::gen_coord< double > >, ReaK::shared_ptr< ReaK::frame_2D< double > >,
             ReaK::shared_ptr< ReaK::frame_2D< double > >, ReaK::shared_ptr< ReaK::jacobian_gen_2D< double > > >() )
  ...
  class_< ReaK::kte::revolute_joint_3D, boost::noncopyable, bases< ReaK::kte::reacting_kte_gen >,
          ReaK::shared_ptr< ReaK::kte::revolute_joint_3D > >( "KTERevoluteJoint3D" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::gen_coord< double > >, ReaK::vect< double, 3 >,
                ReaK::shared_ptr< ReaK::frame_3D< double > >, ReaK::shared_ptr< ReaK::frame_3D< double > >,
  ...
  class_< ReaK::kte::dry_revolute_joint_2D, boost::noncopyable, bases< ReaK::kte::revolute_joint_2D >,
          ReaK::shared_ptr< ReaK::kte::dry_revolute_joint_2D > >( "KTEDryRevoluteJoint2D" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::gen_coord< double > >,
                ReaK::shared_ptr< ReaK::frame_2D< double > >, ReaK::shared_ptr< ReaK::frame_2D< double > >,
                ReaK::shared_ptr< ReaK::jacobian_gen_2D< double > >, double, double, double >() )
    ...
    .add_property( "stiction_coef", &ReaK::kte::dry_revolute_joint_2D::StictionCoefficient,
                   &ReaK::kte::dry_revolute_joint_2D::setStictionCoefficient )
    .add_property( "slip_coef", &ReaK::kte::dry_revolute_joint_2D::SlipCoefficient,
                   &ReaK::kte::dry_revolute_joint_2D::setSlipCoefficient )
    .add_property( "slip_velocity", &ReaK::kte::dry_revolute_joint_2D::SlipVelocity,
                   &ReaK::kte::dry_revolute_joint_2D::setSlipVelocity );

  class_< ReaK::kte::dry_revolute_joint_3D, boost::noncopyable, bases< ReaK::kte::revolute_joint_3D >,
          ReaK::shared_ptr< ReaK::kte::dry_revolute_joint_3D > >( "KTEDryRevoluteJoint3D" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::gen_coord< double > >, ReaK::vect< double, 3 >,
                ReaK::shared_ptr< ReaK::frame_3D< double > >, ReaK::shared_ptr< ReaK::frame_3D< double > >,
                ReaK::shared_ptr< ReaK::jacobian_gen_3D< double > >, double, double, double >() )
    ...
    .add_property( "stiction_coef", &ReaK::kte::dry_revolute_joint_3D::StictionCoefficient,
                   &ReaK::kte::dry_revolute_joint_3D::setStictionCoefficient )
    .add_property( "slip_coef", &ReaK::kte::dry_revolute_joint_3D::SlipCoefficient,
                   &ReaK::kte::dry_revolute_joint_3D::setSlipCoefficient )
    .add_property( "slip_velocity", &ReaK::kte::dry_revolute_joint_3D::SlipVelocity,
                   &ReaK::kte::dry_revolute_joint_3D::setSlipVelocity );


  class_< ReaK::kte::prismatic_joint_2D, boost::noncopyable, bases< ReaK::kte::reacting_kte_gen >,
          ReaK::shared_ptr< ReaK::kte::prismatic_joint_2D > >( "KTEPrismaticJoint2D" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::gen_coord< double > >, ReaK::vect< double, 2 >,
                ReaK::shared_ptr< ReaK::frame_2D< double > >, ReaK::shared_ptr< ReaK::frame_2D< double > >,
  ...
  class_< ReaK::kte::prismatic_joint_3D, boost::noncopyable, bases< ReaK::kte::reacting_kte_gen >,
          ReaK::shared_ptr< ReaK::kte::prismatic_joint_3D > >( "KTEPrismaticJoint3D" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::gen_coord< double > >, ReaK::vect< double, 3 >,
                ReaK::shared_ptr< ReaK::frame_3D< double > >, ReaK::shared_ptr< ReaK::frame_3D< double > >,
                ReaK::shared_ptr< ReaK::jacobian_gen_3D< double > > >() )
  ...
  class_< ReaK::kte::free_joint_2D, boost::noncopyable, bases< ReaK::kte::reacting_kte_2D >,
          ReaK::shared_ptr< ReaK::kte::free_joint_2D > >( "KTEFreeJoint2D" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::frame_2D< double > >, ReaK::shared_ptr< ReaK::frame_2D< double > >,
                ReaK::shared_ptr< ReaK::frame_2D< double > >, ReaK::shared_ptr< ReaK::jacobian_2D_2D< double > > >() )
  ...
  class_< ReaK::kte::free_joint_3D, boost::noncopyable, bases< ReaK::kte::reacting_kte_3D >,
          ReaK::shared_ptr< ReaK::kte::free_joint_3D > >( "KTEFreeJoint3D" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::frame_3D< double > >, ReaK::shared_ptr< ReaK::frame_3D< double > >,
                ReaK::shared_ptr< ReaK::frame_3D< double > >, ReaK::shared_ptr< ReaK::jacobian_3D_3D< double > > >() )
  ...
  class_< ReaK::kte::rigid_link_gen, boost::noncopyable, bases< ReaK::kte::kte_map >,
          ReaK::shared_ptr< ReaK::kte::rigid_link_gen > >( "KTERigidLinkGen" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::gen_coord< double > >,
                ReaK::shared_ptr< ReaK::gen_coord< double > >, double >() )
  ...
  class_< ReaK::kte::rigid_link_2D, boost::noncopyable, bases< ReaK::kte::kte_map >,
          ReaK::shared_ptr< ReaK::kte::rigid_link_2D > >( "KTERigidLink2D" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::frame_2D< double > >, ReaK::shared_ptr< ReaK::frame_2D< double > >,
                ReaK::pose_2D< double > >() )
  ...
  class_< ReaK::kte::rigid_link_3D, boost::noncopyable, bases< ReaK::kte::kte_map >,
          ReaK::shared_ptr< ReaK::kte::rigid_link_3D > >( "KTERigidLink3D" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::frame_3D< double > >, ReaK::shared_ptr< ReaK::frame_3D< double > >,
                ReaK::pose_3D< double > >() )
  ...
  class_< ReaK::kte::position_control_gen, boost::noncopyable, bases< ReaK::kte::kte_map, ReaK::kte::system_input >,
          ReaK::shared_ptr< ReaK::kte::position_control_gen > >( "KTEPositionCtrlGen" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::gen_coord< double > > >() )
    ...
    .add_property( "position_desired", &ReaK::kte::position_control_gen::PosDesired,
                   &ReaK::kte::position_control_gen::setPosDesired );

  class_< ReaK::kte::position_control_2D, boost::noncopyable, bases< ReaK::kte::kte_map, ReaK::kte::system_input >,
          ReaK::shared_ptr< ReaK::kte::position_control_2D > >( "KTEPositionCtrl2D" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::frame_2D< double > > >() )
    ...
    .add_property( "position_desired", &ReaK::kte::position_control_2D::PosDesired,
                   &ReaK::kte::position_control_2D::setPosDesired );

  class_< ReaK::kte::position_control_3D, boost::noncopyable, bases< ReaK::kte::kte_map, ReaK::kte::system_input >,
          ReaK::shared_ptr< ReaK::kte::position_control_3D > >( "KTEPositionCtrl3D" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::frame_3D< double > > >() )
    ...
    .add_property( "position_desired", &ReaK::kte::position_control_3D::PosDesired,
                   &ReaK::kte::position_control_3D::setPosDesired );


  class_< ReaK::kte::rotation_control_2D, boost::noncopyable, bases< ReaK::kte::kte_map, ReaK::kte::system_input >,
          ReaK::shared_ptr< ReaK::kte::rotation_control_2D > >( "KTERotationCtrl2D" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::frame_2D< double > > >() )
    ...
    .add_property( "rotation_desired", &ReaK::kte::rotation_control_2D::AngleDesired,
                   &ReaK::kte::rotation_control_2D::setAngleDesired );

  class_< ReaK::kte::rotation_control_3D, boost::noncopyable, bases< ReaK::kte::kte_map, ReaK::kte::system_input >,
          ReaK::shared_ptr< ReaK::kte::rotation_control_3D > >( "KTERotationCtrl3D" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::frame_3D< double > > >() )
    ...
    .add_property( "rotation_desired", &ReaK::kte::rotation_control_3D::QuatDesired,
                   &ReaK::kte::rotation_control_3D::setQuatDesired );


  class_< ReaK::kte::velocity_control_gen, boost::noncopyable, bases< ReaK::kte::kte_map, ReaK::kte::system_input >,
          ReaK::shared_ptr< ReaK::kte::velocity_control_gen > >( "KTEVelocityCtrlGen" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::gen_coord< double > > >() )
    ...
    .add_property( "velocity_desired", &ReaK::kte::velocity_control_gen::VelDesired,
                   &ReaK::kte::velocity_control_gen::setVelDesired );

  class_< ReaK::kte::velocity_control_2D, boost::noncopyable, bases< ReaK::kte::kte_map, ReaK::kte::system_input >,
          ReaK::shared_ptr< ReaK::kte::velocity_control_2D > >( "KTEVelocityCtrl2D" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::frame_2D< double > > >() )
    ...
    .add_property( "velocity_desired", &ReaK::kte::velocity_control_2D::VelDesired,
                   &ReaK::kte::velocity_control_2D::setVelDesired );

  class_< ReaK::kte::velocity_control_3D, boost::noncopyable, bases< ReaK::kte::kte_map, ReaK::kte::system_input >,
          ReaK::shared_ptr< ReaK::kte::velocity_control_3D > >( "KTEVelocityCtrl3D" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::frame_3D< double > > >() )
    ...
    .add_property( "velocity_desired", &ReaK::kte::velocity_control_3D::VelDesired,
                   &ReaK::kte::velocity_control_3D::setVelDesired );


  class_< ReaK::kte::ang_velocity_control_2D, boost::noncopyable, bases< ReaK::kte::kte_map, ReaK::kte::system_input >,
          ReaK::shared_ptr< ReaK::kte::ang_velocity_control_2D > >( "KTEAngVelocityCtrl2D" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::frame_2D< double > > >() )
    ...
    .add_property( "ang_velocity_desired", &ReaK::kte::ang_velocity_control_2D::AngVelDesired,
                   &ReaK::kte::ang_velocity_control_2D::setAngVelDesired );

  class_< ReaK::kte::ang_velocity_control_3D, boost::noncopyable, bases< ReaK::kte::kte_map, ReaK::kte::system_input >,
          ReaK::shared_ptr< ReaK::kte::ang_velocity_control_3D > >( "KTEAngVelocityCtrl3D" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::frame_3D< double > > >() )
    ...
    .add_property( "ang_velocity_desired", &ReaK::kte::ang_velocity_control_3D::AngVelDesired,
                   &ReaK::kte::ang_velocity_control_3D::setAngVelDesired );


  class_< ReaK::kte::position_measure_gen, boost::noncopyable, bases< ReaK::kte::kte_map, ReaK::kte::system_output >,
          ReaK::shared_ptr< ReaK::kte::position_measure_gen > >( "KTEPositionMeasGen" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::gen_coord< double > > >() )
    ...
    .add_property( "position_measure", &ReaK::kte::position_measure_gen::PosMeasure,
                   &ReaK::kte::position_measure_gen::setPosMeasure );

  class_< ReaK::kte::position_measure_2D, boost::noncopyable, bases< ReaK::kte::kte_map, ReaK::kte::system_output >,
          ReaK::shared_ptr< ReaK::kte::position_measure_2D > >( "KTEPositionMeas2D" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::frame_2D< double > > >() )
    ...
    .add_property( "position_measure", &ReaK::kte::position_measure_2D::PosMeasure,
                   &ReaK::kte::position_measure_2D::setPosMeasure );

  class_< ReaK::kte::position_measure_3D, boost::noncopyable, bases< ReaK::kte::kte_map, ReaK::kte::system_output >,
          ReaK::shared_ptr< ReaK::kte::position_measure_3D > >( "KTEPositionMeas3D" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::frame_3D< double > > >() )
    ...
    .add_property( "position_measure", &ReaK::kte::position_measure_3D::PosMeasure,
                   &ReaK::kte::position_measure_3D::setPosMeasure );


  class_< ReaK::kte::rotation_measure_2D, boost::noncopyable, bases< ReaK::kte::kte_map, ReaK::kte::system_output >,
          ReaK::shared_ptr< ReaK::kte::rotation_measure_2D > >( "KTERotationMeas2D" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::frame_2D< double > > >() )
    ...
    .add_property( "rotation_measure", &ReaK::kte::rotation_measure_2D::AngleMeasure,
                   &ReaK::kte::rotation_measure_2D::setAngleMeasure );

  class_< ReaK::kte::rotation_measure_3D, boost::noncopyable, bases< ReaK::kte::kte_map, ReaK::kte::system_output >,
          ReaK::shared_ptr< ReaK::kte::rotation_measure_3D > >( "KTERotationMeas3D" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::frame_3D< double > > >() )
    ...
    .add_property( "rotation_measure", &ReaK::kte::rotation_measure_3D::QuatMeasure,
                   &ReaK::kte::rotation_measure_3D::setQuatMeasure );


  class_< ReaK::kte::velocity_measure_gen, boost::noncopyable, bases< ReaK::kte::kte_map, ReaK::kte::system_output >,
          ReaK::shared_ptr< ReaK::kte::velocity_measure_gen > >( "KTEVelocityMeasGen" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::gen_coord< double > > >() )
    ...
    .add_property( "velocity_measure", &ReaK::kte::velocity_measure_gen::VelMeasure,
                   &ReaK::kte::velocity_measure_gen::setVelMeasure );

  class_< ReaK::kte::velocity_measure_2D, boost::noncopyable, bases< ReaK::kte::kte_map, ReaK::kte::system_output >,
          ReaK::shared_ptr< ReaK::kte::velocity_measure_2D > >( "KTEVelocityMeas2D" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::frame_2D< double > > >() )
    ...
    .add_property( "velocity_measure", &ReaK::kte::velocity_measure_2D::VelMeasure,
                   &ReaK::kte::velocity_measure_2D::setVelMeasure );

  class_< ReaK::kte::velocity_measure_3D, boost::noncopyable, bases< ReaK::kte::kte_map, ReaK::kte::system_output >,
          ReaK::shared_ptr< ReaK::kte::velocity_measure_3D > >( "KTEVelocityMeas3D" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::frame_3D< double > > >() )
    ...
    .add_property( "velocity_measure", &ReaK::kte::velocity_measure_3D::VelMeasure,
                   &ReaK::kte::velocity_measure_3D::setVelMeasure );


  class_< ReaK::kte::ang_velocity_measure_2D, boost::noncopyable, bases< ReaK::kte::kte_map, ReaK::kte::system_output >,
          ReaK::shared_ptr< ReaK::kte::ang_velocity_measure_2D > >( "KTEAngVelocityMeas2D" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::frame_2D< double > > >() )
    ...
    .add_property( "ang_velocity_measure", &ReaK::kte::ang_velocity_measure_2D::AngVelMeasure,
                   &ReaK::kte::ang_velocity_measure_2D::setAngVelMeasure );

  class_< ReaK::kte::ang_velocity_measure_3D, boost::noncopyable, bases< ReaK::kte::kte_map, ReaK::kte::system_output >,
          ReaK::shared_ptr< ReaK::kte::ang_velocity_measure_3D > >( "KTEAngVelocityMeas3D" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::frame_3D< double > > >() )
    ...
    .add_property( "ang_velocity_measure", &ReaK::kte::ang_velocity_measure_3D::AngVelMeasure,
  ...
  class_< ReaK::kte::joint_dependent_gen_coord, bases< ReaK::shared_object >,
          ReaK::shared_ptr< ReaK::kte::joint_dependent_gen_coord > >( "JointDependentGenCoord" )
    .def( init< ReaK::shared_ptr< ReaK::gen_coord< double > >, const ReaK::kte::jacobian_joint_map_gen& >() )
    .def( init< ReaK::shared_ptr< ReaK::gen_coord< double > >, const ReaK::kte::jacobian_joint_map_gen&,
                const ReaK::kte::jacobian_joint2D_map_gen& >() )
    .def( init< ReaK::shared_ptr< ReaK::gen_coord< double > >, const ReaK::kte::jacobian_joint_map_gen&,
                const ReaK::kte::jacobian_joint2D_map_gen&, const ReaK::kte::jacobian_joint3D_map_gen& >() )
    ...
    .def( "add_joint",
          static_cast< ReaK::kte::joint_dependent_gen_coord& (
            ReaK::kte::joint_dependent_gen_coord::*)( const ReaK::shared_ptr< ReaK::gen_coord< double > >&,
                                                      const ReaK::shared_ptr< ReaK::jacobian_gen_gen< double > >& ) >(
            &ReaK::kte::joint_dependent_gen_coord::add_joint ),
          return_internal_reference<>() )
    .def( "add_2Djoint",
          static_cast< ReaK::kte::joint_dependent_gen_coord& (
            ReaK::kte::joint_dependent_gen_coord::*)( const ReaK::shared_ptr< ReaK::frame_2D< double > >&,
                                                      const ReaK::shared_ptr< ReaK::jacobian_2D_gen< double > >& ) >(
            &ReaK::kte::joint_dependent_gen_coord::add_joint ),
          return_internal_reference<>() )
    .def( "add_3Djoint",
          static_cast< ReaK::kte::joint_dependent_gen_coord& (
            ReaK::kte::joint_dependent_gen_coord::*)( const ReaK::shared_ptr< ReaK::frame_3D< double > >&,
                                                      const ReaK::shared_ptr< ReaK::jacobian_3D_gen< double > >& ) >(
            &ReaK::kte::joint_dependent_gen_coord::add_joint ),
          return_internal_reference<>() )
    .def( "remove_joint",
          static_cast< ReaK::kte::joint_dependent_gen_coord& (
  ...
  class_< ReaK::kte::joint_dependent_frame_2D, bases< ReaK::shared_object >,
          ReaK::shared_ptr< ReaK::kte::joint_dependent_frame_2D > >( "JointDependentFrame2D" )
    .def( init< ReaK::shared_ptr< ReaK::frame_2D< double > >, const ReaK::kte::jacobian_joint_map_2D& >() )
    .def( init< ReaK::shared_ptr< ReaK::frame_2D< double > >, const ReaK::kte::jacobian_joint_map_2D&,
                const ReaK::kte::jacobian_joint2D_map_2D& >() )
    .def( init< ReaK::shared_ptr< ReaK::frame_2D< double > >, const ReaK::kte::jacobian_joint_map_2D&,
                const ReaK::kte::jacobian_joint2D_map_2D&, const ReaK::kte::jacobian_joint3D_map_2D& >() )
    ...
    .def( "add_joint",
          static_cast< ReaK::kte::joint_dependent_frame_2D& (
            ReaK::kte::joint_dependent_frame_2D::*)( const ReaK::shared_ptr< ReaK::gen_coord< double > >&,
                                                     const ReaK::shared_ptr< ReaK::jacobian_gen_2D< double > >& ) >(
            &ReaK::kte::joint_dependent_frame_2D::add_joint ),
          return_internal_reference<>() )
    .def( "add_2Djoint",
          static_cast< ReaK::kte::joint_dependent_frame_2D& (
            ReaK::kte::joint_dependent_frame_2D::*)( const ReaK::shared_ptr< ReaK::frame_2D< double > >&,
                                                     const ReaK::shared_ptr< ReaK::jacobian_2D_2D< double > >& ) >(
            &ReaK::kte::joint_dependent_frame_2D::add_joint ),
          return_internal_reference<>() )
    .def( "add_3Djoint",
          static_cast< ReaK::kte::joint_dependent_frame_2D& (
            ReaK::kte::joint_dependent_frame_2D::*)( const ReaK::shared_ptr< ReaK::frame_3D< double > >&,
                                                     const ReaK::shared_ptr< ReaK::jacobian_3D_2D< double > >& ) >(
            &ReaK::kte::joint_dependent_frame_2D::add_joint ),
          return_internal_reference<>() )
    .def( "remove_joint",
          static_cast< ReaK::kte::joint_dependent_frame_2D& (
  ...
  class_< ReaK::kte::joint_dependent_frame_3D, bases< ReaK::shared_object >,
          ReaK::shared_ptr< ReaK::kte::joint_dependent_frame_3D > >( "JointDependentFrame3D" )
    .def( init< ReaK::shared_ptr< ReaK::frame_3D< double > >, const ReaK::kte::jacobian_joint_map_3D& >() )
    .def( init< ReaK::shared_ptr< ReaK::frame_3D< double > >, const ReaK::kte::jacobian_joint_map_3D&,
                const ReaK::kte::jacobian_joint2D_map_3D& >() )
    .def( init< ReaK::shared_ptr< ReaK::frame_3D< double > >, const ReaK::kte::jacobian_joint_map_3D&,
                const ReaK::kte::jacobian_joint2D_map_3D&, const ReaK::kte::jacobian_joint3D_map_3D& >() )
    ...
    .def( "add_joint",
          static_cast< ReaK::kte::joint_dependent_frame_3D& (
            ReaK::kte::joint_dependent_frame_3D::*)( const ReaK::shared_ptr< ReaK::gen_coord< double > >&,
                                                     const ReaK::shared_ptr< ReaK::jacobian_gen_3D< double > >& ) >(
            &ReaK::kte::joint_dependent_frame_3D::add_joint ),
          return_internal_reference<>() )
    .def( "add_2Djoint",
          static_cast< ReaK::kte::joint_dependent_frame_3D& (
            ReaK::kte::joint_dependent_frame_3D::*)( const ReaK::shared_ptr< ReaK::frame_2D< double > >&,
                                                     const ReaK::shared_ptr< ReaK::jacobian_2D_3D< double > >& ) >(
            &ReaK::kte::joint_dependent_frame_3D::add_joint ),
          return_internal_reference<>() )
    .def( "add_3Djoint",
          static_cast< ReaK::kte::joint_dependent_frame_3D& (
            ReaK::kte::joint_dependent_frame_3D::*)( const ReaK::shared_ptr< ReaK::frame_3D< double > >&,
                                                     const ReaK::shared_ptr< ReaK::jacobian_3D_3D< double > >& ) >(
            &ReaK::kte::joint_dependent_frame_3D::add_joint ),
          return_internal_reference<>() )
    .def( "remove_joint",
          static_cast< ReaK::kte::joint_dependent_frame_3D& (
  ...
  class_< ReaK::kte::inertia_gen, boost::noncopyable, bases< ReaK::kte::kte_map >,
          ReaK::shared_ptr< ReaK::kte::inertia_gen > >( "KTEInertiaGen" )
    .def( init< std::string >() )
  ...
  class_< ReaK::kte::inertia_2D, boost::noncopyable, bases< ReaK::kte::kte_map >,
          ReaK::shared_ptr< ReaK::kte::inertia_2D > >( "KTEInertia2D" )
    .def( init< std::string >() )
    ...
    .add_property( "moment_of_inertia", &ReaK::kte::inertia_2D::MomentOfInertia,
  ...
  class_< ReaK::kte::inertia_3D, boost::noncopyable, bases< ReaK::kte::kte_map >,
          ReaK::shared_ptr< ReaK::kte::inertia_3D > >( "KTEInertia3D" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::kte::joint_dependent_frame_3D >, double,
  ...
  class_< ReaK::kte::force_actuator_gen, boost::noncopyable, bases< ReaK::kte::kte_map >,
          ReaK::shared_ptr< ReaK::kte::force_actuator_gen > >( "KTEForceActuatorGen" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::gen_coord< double > >,
  ...
  class_< ReaK::kte::force_actuator_2D, boost::noncopyable, bases< ReaK::kte::kte_map >,
          ReaK::shared_ptr< ReaK::kte::force_actuator_2D > >( "KTEForceActuator2D" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::frame_2D< double > >,
  ...
  class_< ReaK::kte::force_actuator_3D, boost::noncopyable, bases< ReaK::kte::kte_map >,
          ReaK::shared_ptr< ReaK::kte::force_actuator_3D > >( "KTEForceActuator3D" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::frame_3D< double > >,
  ...
  class_< ReaK::kte::driving_actuator_gen, boost::noncopyable,
          ...
          ReaK::shared_ptr< ReaK::kte::driving_actuator_gen > >( "KTEDrivingActuatorGen" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::gen_coord< double > >,
                ReaK::shared_ptr< ReaK::kte::reacting_kte_gen > >() )
  ...
  class_< ReaK::kte::driving_actuator_2D, boost::noncopyable,
          ...
          ReaK::shared_ptr< ReaK::kte::driving_actuator_2D > >( "KTEDrivingActuator2D" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::frame_2D< double > >,
                ReaK::shared_ptr< ReaK::kte::reacting_kte_2D > >() )
    ...
    .add_property( "drive_torque", &ReaK::kte::driving_actuator_2D::DriveTorque,
  ...
  class_< ReaK::kte::driving_actuator_3D, boost::noncopyable,
          ...
          ReaK::shared_ptr< ReaK::kte::driving_actuator_3D > >( "KTEDrivingActuator3D" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::frame_3D< double > >,
                ReaK::shared_ptr< ReaK::kte::reacting_kte_3D > >() )
    ...
    .add_property( "drive_torque", &ReaK::kte::driving_actuator_3D::DriveTorque,
                   &ReaK::kte::driving_actuator_3D::setDriveTorque );


  class_< ReaK::kte::inertial_beam_2D, boost::noncopyable, bases< ReaK::kte::kte_map >,
          ReaK::shared_ptr< ReaK::kte::inertial_beam_2D > >( "KTEInertialBeam2D" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::frame_2D< double > >, ReaK::shared_ptr< ReaK::frame_2D< double > >,
                double >() )
  ...
  class_< ReaK::kte::inertial_beam_3D, boost::noncopyable, bases< ReaK::kte::kte_map >,
          ReaK::shared_ptr< ReaK::kte::inertial_beam_3D > >( "KTEInertialBeam3D" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::frame_3D< double > >, ReaK::shared_ptr< ReaK::frame_3D< double > >,
                double >() )
  ...
  class_< ReaK::kte::virtual_kte_interface_gen, boost::noncopyable, bases< ReaK::kte::kte_map >,
          ReaK::shared_ptr< ReaK::kte::virtual_kte_interface_gen > >( "KTEVirtualInterfaceGen" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::gen_coord< double > >,
    ...
    .add_property( "base_frame", &ReaK::kte::virtual_kte_interface_gen::BaseFrame,
                   &ReaK::kte::virtual_kte_interface_gen::setBaseFrame )
    .add_property( "end_frame", &ReaK::kte::virtual_kte_interface_gen::EndFrame,
                   &ReaK::kte::virtual_kte_interface_gen::setEndFrame );

  class_< ReaK::kte::virtual_kte_interface_2D, boost::noncopyable, bases< ReaK::kte::kte_map >,
          ReaK::shared_ptr< ReaK::kte::virtual_kte_interface_2D > >( "KTEVirtualInterface2D" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::frame_2D< double > >,
    ...
    .add_property( "base_frame", &ReaK::kte::virtual_kte_interface_2D::BaseFrame,
  ...
  class_< ReaK::kte::virtual_kte_interface_3D, boost::noncopyable, bases< ReaK::kte::kte_map >,
          ReaK::shared_ptr< ReaK::kte::virtual_kte_interface_3D > >( "KTEVirtualInterface3D" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::frame_3D< double > >,
    ...
    .add_property( "base_frame", &ReaK::kte::virtual_kte_interface_3D::BaseFrame,
  ...
  class_< ReaK::kte::vmc_revolute_joint_2D, boost::noncopyable, bases< ReaK::kte::revolute_joint_2D >,
          ReaK::shared_ptr< ReaK::kte::vmc_revolute_joint_2D > >( "KTEVMCRevoluteJoint2D" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::gen_coord< double > >,
                ReaK::shared_ptr< ReaK::frame_2D< double > >, ReaK::shared_ptr< ReaK::frame_2D< double > >,
                ReaK::shared_ptr< ReaK::jacobian_gen_2D< double > >, double, double, double >() )
    ...
    .add_property( "stiction_coef", &ReaK::kte::vmc_revolute_joint_2D::StictionCoefficient,
                   &ReaK::kte::vmc_revolute_joint_2D::setStictionCoefficient )
    .add_property( "slip_coef", &ReaK::kte::vmc_revolute_joint_2D::SlipCoefficient,
                   &ReaK::kte::vmc_revolute_joint_2D::setSlipCoefficient )
    .add_property( "slip_velocity", &ReaK::kte::vmc_revolute_joint_2D::SlipVelocity,
                   &ReaK::kte::vmc_revolute_joint_2D::setSlipVelocity );

  class_< ReaK::kte::vmc_revolute_joint_3D, boost::noncopyable, bases< ReaK::kte::revolute_joint_3D >,
          ReaK::shared_ptr< ReaK::kte::vmc_revolute_joint_3D > >( "KTEVMCRevoluteJoint3D" )
    .def( init< std::string >() )
    .def( init< std::string, ReaK::shared_ptr< ReaK::gen_coord< double > >, ReaK::vect< double, 3 >,
                ReaK::shared_ptr< ReaK::frame_3D< double > >, ReaK::shared_ptr< ReaK::frame_3D< double > >,
                ReaK::shared_ptr< ReaK::jacobian_gen_3D< double > >, double, double, double >() )
    ...
    .add_property( "stiction_coef", &ReaK::kte::vmc_revolute_joint_3D::StictionCoefficient,
                   &ReaK::kte::vmc_revolute_joint_3D::setStictionCoefficient )
    .add_property( "slip_coef", &ReaK::kte::vmc_revolute_joint_3D::SlipCoefficient,
                   &ReaK::kte::vmc_revolute_joint_3D::setSlipCoefficient )
    .add_property( "slip_velocity", &ReaK::kte::vmc_revolute_joint_3D::SlipVelocity,
                   &ReaK::kte::vmc_revolute_joint_3D::setSlipVelocity );


  class_< py_mmc_frame_vector< ReaK::gen_coord< double >, &ReaK::kte::mass_matrix_calc::Coords > >( "MMCGenCoordVector",
                                                                                                    no_init )
  ...
  class_< py_mmc_frame_vector< ReaK::frame_2D< double >, &ReaK::kte::mass_matrix_calc::Frames2D > >( "MMCFrame2DVector",
                                                                                                     no_init )
    .def( "__len__", &py_mmc_frame_vector< ReaK::frame_2D< double >, &ReaK::kte::mass_matrix_calc::Frames2D >::size )
    .def( "__getitem__",
          &py_mmc_frame_vector< ReaK::frame_2D< double >, &ReaK::kte::mass_matrix_calc::Frames2D >::get );

  class_< py_mmc_frame_vector< ReaK::frame_3D< double >, &ReaK::kte::mass_matrix_calc::Frames3D > >( "MMCFrame3DVector",
                                                                                                     no_init )
    .def( "__len__", &py_mmc_frame_vector< ReaK::frame_3D< double >, &ReaK::kte::mass_matrix_calc::Frames3D >::size )
    .def( "__getitem__",
          &py_mmc_frame_vector< ReaK::frame_3D< double >, &ReaK::kte::mass_matrix_calc::Frames3D >::get );


  class_< ReaK::kte::mass_matrix_calc, boost::noncopyable, bases< ReaK::named_object >,
          ReaK::shared_ptr< ReaK::kte::mass_matrix_calc > >( "KTEMassMatrixCalc" )
    .def( init< std::string >() )
    .def( "add_inertia_gen", static_cast< ReaK::kte::mass_matrix_calc& (
                               ReaK::kte::mass_matrix_calc::*)( const ReaK::shared_ptr< ReaK::kte::inertia_gen >& ) >(
                               &ReaK::kte::mass_matrix_calc::operator<<),
          return_internal_reference<>() )
    .def( "add_inertia_2D", static_cast< ReaK::kte::mass_matrix_calc& (
                              ReaK::kte::mass_matrix_calc::*)( const ReaK::shared_ptr< ReaK::kte::inertia_2D >& ) >(
                              &ReaK::kte::mass_matrix_calc::operator<<),
          return_internal_reference<>() )
    .def( "add_inertia_3D", static_cast< ReaK::kte::mass_matrix_calc& (
                              ReaK::kte::mass_matrix_calc::*)( const ReaK::shared_ptr< ReaK::kte::inertia_3D >& ) >(
                              &ReaK::kte::mass_matrix_calc::operator<<),
          return_internal_reference<>() )
    .def( "add_frame_gen", static_cast< ReaK::kte::mass_matrix_calc& (
                             ReaK::kte::mass_matrix_calc::*)( const ReaK::shared_ptr< ReaK::gen_coord< double > >& ) >(
                             &ReaK::kte::mass_matrix_calc::operator<<),
          return_internal_reference<>() )
    .def( "add_frame_2D", static_cast< ReaK::kte::mass_matrix_calc& (
                            ReaK::kte::mass_matrix_calc::*)( const ReaK::shared_ptr< ReaK::frame_2D< double > >& ) >(
                            &ReaK::kte::mass_matrix_calc::operator<<),
          return_internal_reference<>() )
    .def( "add_frame_3D", static_cast< ReaK::kte::mass_matrix_calc& (
                            ReaK::kte::mass_matrix_calc::*)( const ReaK::shared_ptr< ReaK::frame_3D< double > >& ) >(
                            &ReaK::kte::mass_matrix_calc::operator<<),
          return_internal_reference<>() )
    .def( "coords", &py_mmc_frame_vector< ReaK::gen_coord< double >, &ReaK::kte::mass_matrix_calc::Coords >::create )
    .def( "frames_2D",
          &py_mmc_frame_vector< ReaK::frame_2D< double >, &ReaK::kte::mass_matrix_calc::Frames2D >::create )
    .def( "frames_3D",
          &py_mmc_frame_vector< ReaK::frame_3D< double >, &ReaK::kte::mass_matrix_calc::Frames3D >::create );


#ifndef BOOST_NO_CXX11_SMART_PTR
  implicitly_convertible< ReaK::shared_ptr< ReaK::kte::kte_map >, ReaK::shared_ptr< ReaK::named_object > >();
  implicitly_convertible< ReaK::shared_ptr< ReaK::kte::kte_map_chain >, ReaK::shared_ptr< ReaK::kte::kte_map > >();
  implicitly_convertible< ReaK::shared_ptr< ReaK::kte::system_input >, ReaK::shared_ptr< ReaK::named_object > >();
  implicitly_convertible< ReaK::shared_ptr< ReaK::kte::system_output >, ReaK::shared_ptr< ReaK::named_object > >();

  implicitly_convertible< ReaK::shared_ptr< ReaK::kte::damper_gen >, ReaK::shared_ptr< ReaK::kte::kte_map > >();
  implicitly_convertible< ReaK::shared_ptr< ReaK::kte::damper_2D >, ReaK::shared_ptr< ReaK::kte::kte_map > >();
  implicitly_convertible< ReaK::shared_ptr< ReaK::kte::damper_3D >, ReaK::shared_ptr< ReaK::kte::kte_map > >();

  implicitly_convertible< ReaK::shared_ptr< ReaK::kte::spring_gen >, ReaK::shared_ptr< ReaK::kte::kte_map > >();
  implicitly_convertible< ReaK::shared_ptr< ReaK::kte::spring_2D >, ReaK::shared_ptr< ReaK::kte::kte_map > >();
  implicitly_convertible< ReaK::shared_ptr< ReaK::kte::spring_3D >, ReaK::shared_ptr< ReaK::kte::kte_map > >();

  implicitly_convertible< ReaK::shared_ptr< ReaK::kte::torsion_damper_2D >, ReaK::shared_ptr< ReaK::kte::kte_map > >();
  implicitly_convertible< ReaK::shared_ptr< ReaK::kte::torsion_damper_3D >, ReaK::shared_ptr< ReaK::kte::kte_map > >();

  implicitly_convertible< ReaK::shared_ptr< ReaK::kte::torsion_spring_2D >, ReaK::shared_ptr< ReaK::kte::kte_map > >();
  implicitly_convertible< ReaK::shared_ptr< ReaK::kte::torsion_spring_3D >, ReaK::shared_ptr< ReaK::kte::kte_map > >();

  implicitly_convertible< ReaK::shared_ptr< ReaK::kte::flexible_beam_2D >, ReaK::shared_ptr< ReaK::kte::kte_map > >();
  implicitly_convertible< ReaK::shared_ptr< ReaK::kte::flexible_beam_3D >, ReaK::shared_ptr< ReaK::kte::kte_map > >();
  ...
  implicitly_convertible< ReaK::shared_ptr< ReaK::kte::reacting_kte_gen >, ReaK::shared_ptr< ReaK::kte::kte_map > >();
  implicitly_convertible< ReaK::shared_ptr< ReaK::kte::reacting_kte_2D >, ReaK::shared_ptr< ReaK::kte::kte_map > >();
  implicitly_convertible< ReaK::shared_ptr< ReaK::kte::reacting_kte_3D >, ReaK::shared_ptr< ReaK::kte::kte_map > >();
  ...
  implicitly_convertible< ReaK::shared_ptr< ReaK::kte::rigid_link_gen >, ReaK::shared_ptr< ReaK::kte::kte_map > >();
  implicitly_convertible< ReaK::shared_ptr< ReaK::kte::rigid_link_2D >, ReaK::shared_ptr< ReaK::kte::kte_map > >();
  implicitly_convertible< ReaK::shared_ptr< ReaK::kte::rigid_link_3D >, ReaK::shared_ptr< ReaK::kte::kte_map > >();
  ...
  implicitly_convertible< ReaK::shared_ptr< ReaK::kte::inertia_gen >, ReaK::shared_ptr< ReaK::kte::kte_map > >();
  implicitly_convertible< ReaK::shared_ptr< ReaK::kte::inertia_2D >, ReaK::shared_ptr< ReaK::kte::kte_map > >();
  implicitly_convertible< ReaK::shared_ptr< ReaK::kte::inertia_3D >, ReaK::shared_ptr< ReaK::kte::kte_map > >();

  implicitly_convertible< ReaK::shared_ptr< ReaK::kte::force_actuator_gen >, ReaK::shared_ptr< ReaK::kte::kte_map > >();
  implicitly_convertible< ReaK::shared_ptr< ReaK::kte::force_actuator_2D >, ReaK::shared_ptr< ReaK::kte::kte_map > >();
  implicitly_convertible< ReaK::shared_ptr< ReaK::kte::force_actuator_3D >, ReaK::shared_ptr< ReaK::kte::kte_map > >();
  ...
  implicitly_convertible< ReaK::shared_ptr< ReaK::kte::inertial_beam_2D >, ReaK::shared_ptr< ReaK::kte::kte_map > >();
  implicitly_convertible< ReaK::shared_ptr< ReaK::kte::inertial_beam_3D >, ReaK::shared_ptr< ReaK::kte::kte_map > >();
  ...
  implicitly_convertible< ReaK::shared_ptr< ReaK::kte::mass_matrix_calc >, ReaK::shared_ptr< ReaK::named_object > >();
