...
void decompose_BandCholesky_impl( Matrix1& A, typename mat_traits< Matrix1 >::size_type p,
...
typename boost::enable_if_c< is_readable_matrix< Matrix1 >::value&&(
                             ...
                             && is_resizable_matrix< Matrix2 >::value&&( mat_traits< Matrix2 >::structure
...
typename boost::enable_if_c< is_readable_matrix< Matrix >::value, typename mat_traits< Matrix >::value_type >::type
  determinant_Cholesky( const Matrix& A, typename mat_traits< Matrix >::value_type NumTol = 1E-8 ) {
...
typename boost::enable_if_c< is_readable_matrix< Matrix1 >::value&&(
                               ...
                               || ( mat_traits< Matrix1 >::structure == mat_structure::symmetric )
                               || ( mat_traits< Matrix1 >::structure == mat_structure::tridiagonal ) )
                             && is_writable_matrix< Matrix2 >::value && !is_fully_writable_matrix< Matrix2 >::value,
                             void >::type
  linsolve_Cholesky( const Matrix1& A, Matrix2& b, typename mat_traits< Matrix1 >::value_type NumTol = 1E-8 ) {
  if( b.get_row_count() != A.get_col_count() )
    throw std::range_error( "For linear equation solution, matrix b must have same row count as A!" );
 ...
 */
template < typename Matrix1, typename Matrix2 >
typename boost::enable_if_c< is_readable_matrix< Matrix1 >::value&&( mat_traits< Matrix1 >::structure
...
template < typename Matrix >
typename boost::enable_if_c< is_readable_matrix< Matrix >::value, typename mat_traits< Matrix >::value_type >::type
  determinant_BandCholesky( const Matrix& A, typename mat_traits< Matrix >::size_type bandwidth,
...
template < typename Matrix1, typename Matrix2, typename Matrix3 >
typename boost::enable_if_c< is_readable_matrix< Matrix1 >::value && is_square_matrix< Matrix1 >::value
                             && is_fully_writable_matrix< Matrix2 >::value && is_writable_matrix< Matrix3 >::value,
                             void >::type
...
template < typename Matrix >
typename boost::enable_if_c< is_readable_matrix< Matrix >::value, typename mat_traits< Matrix >::value_type >::type
  determinant_LDL( const Matrix& A, typename mat_traits< Matrix >::value_type NumTol = 1E-8 ) {
  typedef typename mat_traits< Matrix >::value_type ValueType;
  typedef typename mat_traits< Matrix >::value_type SizeType;
  mat< ValueType, mat_structure::square > L( A );
  try {
...
template < typename Matrix >
typename boost::enable_if_c< is_readable_matrix< Matrix >::value, typename mat_traits< Matrix >::value_type >::type
  determinant_TriDiagLDL( const Matrix& A, typename mat_traits< Matrix >::value_type NumTol = 1E-8 ) {
  typedef typename mat_traits< Matrix >::value_type ValueType;
  typedef typename mat_traits< Matrix >::value_type SizeType;
  mat< ValueType, mat_structure::square > L( A );
  try {
...
extern template void decompose_Cholesky( const mat< double, mat_structure::square >& A,
                                         mat< double, mat_structure::square >& L, double NumTol );
extern template void decompose_Cholesky( const mat< double, mat_structure::symmetric >& A,
                                         mat< double, mat_structure::square >& L, double NumTol );

extern template void linsolve_Cholesky( const mat< double, mat_structure::square >& A,
                                        mat< double, mat_structure::square >& b, double NumTol );
extern template void linsolve_Cholesky( const mat< double, mat_structure::symmetric >& A,
                                        mat< double, mat_structure::square >& b, double NumTol );
...
extern template void invert_Cholesky( const mat< double, mat_structure::square >& A,
                                      mat< double, mat_structure::square >& A_inv, double NumTol );
extern template void invert_Cholesky( const mat< double, mat_structure::symmetric >& A,
                                      mat< double, mat_structure::symmetric >& A_inv, double NumTol );


extern template void decompose_Cholesky( const mat< float, mat_structure::square >& A,
                                         mat< float, mat_structure::square >& L, float NumTol );
extern template void decompose_Cholesky( const mat< float, mat_structure::symmetric >& A,
                                         mat< float, mat_structure::square >& L, float NumTol );

extern template void linsolve_Cholesky( const mat< float, mat_structure::square >& A,
                                        mat< float, mat_structure::square >& b, float NumTol );
extern template void linsolve_Cholesky( const mat< float, mat_structure::symmetric >& A,
                                        mat< float, mat_structure::square >& b, float NumTol );
...
extern template void invert_Cholesky( const mat< float, mat_structure::square >& A,
                                      mat< float, mat_structure::square >& A_inv, float NumTol );
extern template void invert_Cholesky( const mat< float, mat_structure::symmetric >& A,
