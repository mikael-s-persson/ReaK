...
public:
  ...
  *******************************************************************************/
   ...
   * \test PASSED
   */
  mat( const allocator_type& aAlloc = allocator_type() ) : q( 0, value_type(), aAlloc ), rowCount( 0 ){};
   ...
   */
  mat( const container_type& Q, size_type aRowCount ) : q( Q ), rowCount( aRowCount ){};
   ...
   * \test PASSED
   */
  mat( const_reference a11, const_reference a12, const_reference a21, const_reference a22 ) : q( 4 ), rowCount( 2 ) {
    q[0] = a11;
    q[1] = a21;
    q[2] = a12;
    q[3] = a22;
   ...
   * \test PASSED
   */
  mat( const_reference a11, const_reference a12, const_reference a13, const_reference a21, const_reference a22,
       const_reference a23, const_reference a31, const_reference a32, const_reference a33 )
      : q( 9 ), rowCount( 3 ) {
    q[0] = a11;
    q[1] = a21;
    q[2] = a31;
   ...
   * \test PASSED
   */
  mat( const_reference a11, const_reference a12, const_reference a13, const_reference a14, const_reference a21,
       const_reference a22, const_reference a23, const_reference a24, const_reference a31, const_reference a32,
       const_reference a33, const_reference a34, const_reference a41, const_reference a42, const_reference a43,
       const_reference a44 )
      : q( 16 ), rowCount( 4 ) {
    q[0] = a11;
    q[1] = a21;
  ...
  *******************************************************************************/
   ...
   * \test PASSED
   */
  void set_col_count( size_type aColCount, bool aPreserveData = false ) { set_row_count( aColCount, aPreserveData ); };
  ...
  col_iterator last_col() { return col_iterator( q.begin() + rowCount * rowCount, rowCount ); };
  const_col_iterator last_col() const { return const_col_iterator( q.begin() + rowCount * rowCount, rowCount ); };
...
public:
  ...
  *******************************************************************************/
   ...
   * \test PASSED
   */
  void resize( const std::pair< size_type, size_type >& sz ) { set_col_count( sz.first, true ); };
   ...
   * \test PASSED
   */
  void set_row_count( size_type aRowCount, bool aPreserveData = false ) { set_col_count( aRowCount, aPreserveData ); };

  row_iterator first_row() { return row_iterator( q.begin(), rowCount ); };
  const_row_iterator first_row() const { return const_row_iterator( q.begin(), rowCount ); };
  row_iterator last_row() { return row_iterator( q.begin() + rowCount * rowCount, rowCount ); };
  const_row_iterator last_row() const { return const_row_iterator( q.begin() + rowCount * rowCount, rowCount ); };
  row_iterator first_row( col_iterator cit ) {
  ...
  col_iterator last_col() { return col_iterator( q.begin() + rowCount * rowCount ); };
  const_col_iterator last_col() const { return const_col_iterator( q.begin() + rowCount * rowCount ); };
  col_iterator first_col( row_iterator rit ) {
...
extern template mat< double, mat_structure::square, mat_alignment::column_major >&
...
extern template mat< double, mat_structure::square, mat_alignment::column_major >&
  mat< double, mat_structure::square, mat_alignment::column_major >::
    operator*=( const mat< double, mat_structure::square, mat_alignment::column_major >& M );
extern template mat< double, mat_structure::square, mat_alignment::row_major >&
...
extern template mat< float, mat_structure::square, mat_alignment::column_major >&
...
extern template mat< float, mat_structure::square, mat_alignment::column_major >&
  mat< float, mat_structure::square, mat_alignment::column_major >::
    operator*=( const mat< float, mat_structure::square, mat_alignment::column_major >& M );
extern template mat< float, mat_structure::square, mat_alignment::row_major >&
