...
#ifndef REAK_MAT_COMPOSITE_ADAPTOR_HPP
...
public:
  ...
  typename boost::enable_if_c< is_readable_matrix< Matrix >::value && !boost::is_same< Matrix, self >::value,
    ...
    mr = sub( rhs )( range( 0, mr.get_row_count() ),
  ...
  *******************************************************************************/
  ...
  std::pair< size_type, size_type > size() const throw() {
    return std::make_pair( ml.get_row_count(), ml.get_col_count() + mr.get_col_count() );
  };
  ...
  self& operator+=( const Matrix& M ) {
    ...
    mr += sub( M )( range( 0, mr.get_row_count() ),
                    range( ml.get_col_count(), ml.get_col_count() + mr.get_col_count() ) );
    return *this;
  };
...
struct is_readable_matrix< mat_horiz_cat< LeftMatrix, RightMatrix > > {
  BOOST_STATIC_CONSTANT( bool,
                         value = is_readable_matrix< LeftMatrix >::value && is_readable_matrix< RightMatrix >::value );
...
struct is_writable_matrix< mat_horiz_cat< LeftMatrix, RightMatrix > > {
  BOOST_STATIC_CONSTANT( bool,
                         value = is_writable_matrix< LeftMatrix >::value && is_writable_matrix< RightMatrix >::value );
...
struct is_fully_writable_matrix< mat_horiz_cat< LeftMatrix, RightMatrix > > {
  BOOST_STATIC_CONSTANT( bool, value = is_fully_writable_matrix< LeftMatrix >::value
                                       && is_fully_writable_matrix< RightMatrix >::value );
...
typename boost::enable_if_c< is_readable_matrix< LeftMatrix >::value && is_readable_matrix< RightMatrix >::value,
  ...
  return mat_horiz_cat< LeftMatrix, mat_const_sub_block< RightMatrix > >( std::move( ML ),
                                                                          mat_const_sub_block< RightMatrix >( MR ) );
};
...
public:
  ...
  typename boost::enable_if_c< is_readable_matrix< Matrix >::value && !boost::is_same< Matrix, self >::value,
    ...
    ml = sub( rhs )( range( mu.get_row_count(), mu.get_row_count() + ml.get_row_count() ),
  ...
  *******************************************************************************/
   ...
   */
  std::pair< size_type, size_type > size() const throw() {
    return std::make_pair( mu.get_row_count() + ml.get_row_count(), mu.get_col_count() );
  };
  ...
  self& operator+=( const Matrix& M ) {
    ...
    ml += sub( M )( range( mu.get_row_count(), mu.get_row_count() + ml.get_row_count() ),
                    range( 0, ml.get_col_count() ) );
    return *this;
  };
...
struct is_readable_matrix< mat_vert_cat< UpperMatrix, LowerMatrix > > {
  BOOST_STATIC_CONSTANT( bool,
                         value = is_readable_matrix< UpperMatrix >::value && is_readable_matrix< LowerMatrix >::value );
...
struct is_writable_matrix< mat_vert_cat< UpperMatrix, LowerMatrix > > {
  BOOST_STATIC_CONSTANT( bool,
                         value = is_writable_matrix< UpperMatrix >::value && is_writable_matrix< LowerMatrix >::value );
...
struct is_fully_writable_matrix< mat_vert_cat< UpperMatrix, LowerMatrix > > {
  BOOST_STATIC_CONSTANT( bool, value = is_fully_writable_matrix< UpperMatrix >::value
                                       && is_fully_writable_matrix< LowerMatrix >::value );
...
typename boost::enable_if_c< is_readable_matrix< UpperMatrix >::value && is_readable_matrix< LowerMatrix >::value,
  ...
  return mat_vert_cat< UpperMatrix, mat_const_sub_block< LowerMatrix > >( std::move( MU ),
                                                                          mat_const_sub_block< LowerMatrix >( ML ) );
};
