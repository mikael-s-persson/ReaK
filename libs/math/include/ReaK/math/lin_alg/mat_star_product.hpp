...
typename boost::enable_if_c< is_readable_matrix< Matrix1 >::value && is_readable_matrix< Matrix2 >::value,
  ...
  mat< ValueType, mat_structure::square > WInvt( mat_const_sub_block< Matrix2 >( M2, N, N, 0, 0 )
                                                 * transpose_move( Inv1 ) );

  return result_type(
    mat_horiz_cat< mat< ValueType, mat_structure::square >, mat< ValueType, mat_structure::symmetric > >(
      ...
      mat< ValueType, mat_structure::symmetric >( mat_const_sub_block< Matrix2 >( M2, N, N, 0, N )
                                                  + WInvt * mat_const_sub_block< Matrix1 >( M1, N, N, 0, N )
                                                    * mat_const_sub_block< Matrix2 >( M2, N, N, N, N ) ) ),
    mat_horiz_cat< mat< ValueType, mat_structure::symmetric >, mat< ValueType, mat_structure::square > >(
      mat< ValueType, mat_structure::symmetric >( mat_const_sub_block< Matrix1 >( M1, N, N, N, 0 )
                                                  + DInv * mat_const_sub_block< Matrix2 >( M2, N, N, N, 0 )
