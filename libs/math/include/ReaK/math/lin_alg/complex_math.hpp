...
public:
  ...
  *******************************************************************************/
  ...
  /** Negation operator. */
  complex< T > operator-() const BOOST_NOEXCEPT { return complex< T >( -Re, -Im ); };
  ...
  friend complex< T > operator/( const complex< T >& C1, const complex< T >& C2 ) BOOST_NOEXCEPT {
    ...
    return complex< T >( sqr_mag_inv * ( C1.Re * C2.Re + C1.Im * C2.Im ),
  ...
  *******************************************************************************/
  ...
  friend complex< T > conj( const complex< T >& x ) BOOST_NOEXCEPT { return complex< T >( x.Re, -x.Im ); };

  /** Complex square magnitude for a complex value. */
  friend T sqr_mag( const complex< T >& x ) BOOST_NOEXCEPT { return x.Re * x.Re + x.Im * x.Im; };
  ...
  friend complex< T > log10( const complex< T >& x ) BOOST_NOEXCEPT { return log( x ) / log( T( 10.0 ) ); };
  ...
  friend complex< T > atan2( const complex< T >& y, const complex< T >& x ) BOOST_NOEXCEPT { return atan( y / x ); };
  ...
  friend T fabs( const complex< T >& x ) BOOST_NOEXCEPT { return sqrt( x.Re * x.Re + x.Im * x.Im ); };
  ...
  friend serialization::iarchive& RK_CALL
    operator&( serialization::iarchive& in, const std::pair< std::string, complex< T >& >& f ) {
  ...
  friend serialization::oarchive& RK_CALL
    operator&( serialization::oarchive& out, const std::pair< std::string, const complex< T >& >& C ) {
