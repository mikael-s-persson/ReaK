...
#ifndef REAK_STRIDE_ITERATOR_HPP
#define REAK_STRIDE_ITERATOR_HPP
...
class stride_iterator<RAIter, 0> {
 ...
 public:
   ...
   * Copy-constructor.
   */
  stride_iterator<RAIter, 0>(const self& rhs)
   ...
   */
  stride_iterator<RAIter, 0>(RAIter aPos, difference_type aStride)
