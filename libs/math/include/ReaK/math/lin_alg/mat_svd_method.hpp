...
typename boost::
  enable_if< boost::mpl::and_< is_readable_matrix< Matrix1 >, is_fully_writable_matrix< Matrix2 >,
...
typename boost::
  enable_if< boost::mpl::
               and_< is_readable_matrix< Matrix1 >, is_writable_matrix< Matrix2 >,
                     boost::mpl::and_< is_writable_matrix< Matrix3 >,
                                       boost::mpl::bool_< ( mat_traits< Matrix3 >::structure
                                                            == mat_structure::diagonal ) > >,
                     boost::mpl::and_< is_writable_matrix< Matrix4 >,
                                       boost::mpl::or_< boost::mpl::not_< is_fully_writable_matrix< Matrix2 > >,
