...
public:
   ...
   */
  euler_integrator( const std::string& aName, const ReaK::vect_n< T >& aState, double aStartTime, double aStepSize,
...
public:
   ...
   * ReaK::state_rate_function).
   */
  midpoint_integrator( const std::string& aName, const ReaK::vect_n< T >& aState, double aStartTime, double aStepSize,
                       const weak_ptr< state_rate_function< T > >& aGetStateRate )
      : integrator< T >( aName, aState, aStartTime, aStepSize, aGetStateRate ){};
  /**
   * Default destructor.
...
public:
   ...
   * ReaK::state_rate_function).
   */
  runge_kutta4_integrator( const std::string& aName, const ReaK::vect_n< T >& aState, double aStartTime,
...
void RK_CALL runge_kutta4_integrator< T >::integrate( double aEndTime ) {
  ...
  while( ( ( integrator< T >::mStepSize > 0.0 ) && ( integrator< T >::mTime < aEndTime ) )
    ...
    integrator< T >::mTime += integrator< T >::mStepSize * 0.5;
    func_ptr->computeStateRate( integrator< T >::mTime, integrator< T >::mState, integrator< T >::mStateRate );
    integrator< T >::mState += ( k1 + k2 * T( 2.0 ) + integrator< T >::mStateRate * T( integrator< T >::mStepSize ) )
                               / T( 6.0 ) - k3 * T( 2.0 / 3.0 );
...
public:
   ...
   * ReaK::state_rate_function).
   */
  runge_kutta5_integrator( const std::string& aName, const ReaK::vect_n< T >& aState, double aStartTime,
                           double aStepSize, const weak_ptr< state_rate_function< T > >& aGetStateRate )
      : integrator< T >( aName, aState, aStartTime, aStepSize, aGetStateRate ){};
  /**
   * Default destructor.
...
void RK_CALL runge_kutta5_integrator< T >::integrate( double aEndTime ) {
  ...
  while( ( ( integrator< T >::mStepSize > 0.0 ) && ( integrator< T >::mTime < aEndTime ) )
    ...
    func_ptr->computeStateRate( integrator< T >::mTime, integrator< T >::mState, integrator< T >::mStateRate );
    integrator< T >::mState += ( ( k2 = integrator< T >::mStateRate * T( integrator< T >::mStepSize ) ) * T( 9.0 )
                                 - k1 * T( 5.0 ) ) / T( 32.0 );
    ...
    integrator< T >::mState
      += ( k1* T( 276165.0 ) - k2* T( 1250865.0 )
           + ( k3 = integrator< T >::mStateRate * T( integrator< T >::mStepSize ) ) * T( 1167360.0 ) ) / T( 351520.0 );

    integrator< T >::mTime += 57.0 * integrator< T >::mStepSize / 104.0;
    func_ptr->computeStateRate( integrator< T >::mTime, integrator< T >::mState, integrator< T >::mStateRate );
    integrator< T >::mState = w + k1* T( 439.0 / 216.0 ) - k2* T( 8.0 ) + k3* T( 3680.0 / 513.0 )
    ...
    func_ptr->computeStateRate( integrator< T >::mTime, integrator< T >::mState, integrator< T >::mStateRate );
    integrator< T >::mState
      = w - k1* T( 8.0 / 27.0 ) + k2* T( 2.0 ) - k3* T( 3544.0 / 2565.0 ) + k4* T( 1859.0 / 4104.0 )
        - ( k5 = integrator< T >::mStateRate * T( integrator< T >::mStepSize ) ) * T( 11.0 / 40.0 );

    integrator< T >::mTime -= integrator< T >::mStepSize * 0.5;
    func_ptr->computeStateRate( integrator< T >::mTime, integrator< T >::mState, integrator< T >::mStateRate );
    integrator< T >::mState = w + k1 * T( 16.0 / 135.0 ) + k3 * T( 6656.0 / 12825.0 ) + k4 * T( 28561.0 / 56430.0 )
                              - k5 * T( 9.0 / 50.0 )
