...
public:
   ...
   */
  jacobian_gen_gen( const value_type& aQdQd = value_type(), const value_type& aQdQdd = value_type() )
      : qd_qd( aQdQd ), qd_qdd( aQdQdd ){};

  self get_jac_relative_to( const shared_ptr< gen_coord< value_type > >& ) const { return *this; };

  template < typename Matrix1, typename Matrix2 >
  typename boost::enable_if< boost::mpl::and_< is_fully_writable_matrix< Matrix1 >,
                                               is_fully_writable_matrix< Matrix2 > >,
                             void >::type
    write_to_matrices( Matrix1& Jac, Matrix2& JacDot ) const {
    if( ( Jac.get_row_count() != 1 ) || ( Jac.get_col_count() != 1 ) || ( JacDot.get_row_count() != 1 )
        || ( JacDot.get_col_count() != 1 ) )
  ...
  typename boost::enable_if< is_fully_writable_matrix< Matrix1 >, void >::type write_to_matrices( Matrix1& Jac ) const {
...
public:
  ...
  jacobian_gen_2D( const weak_ptr< frame_2D< value_type > >& aParent = weak_ptr< frame_2D< value_type > >(),
      ...
      : Parent( aParent ), qd_vel( aQdVel ), qd_avel( aQdAVel ), qd_acc( aQdAcc ), qd_aacc( aQdAAcc ){};
  ...
  self get_jac_relative_to( const shared_ptr< frame_2D< value_type > >& aFrame ) const {
    ...
    return self( aFrame, v_tmp, qd_avel,
  ...
  typename boost::enable_if< boost::mpl::and_< is_fully_writable_matrix< Matrix1 >,
                             ...
                             void >::type
    write_to_matrices( Matrix1& Jac, Matrix2& JacDot ) const {
    if( ( Jac.get_row_count() != 3 ) || ( Jac.get_col_count() != 1 ) || ( JacDot.get_row_count() != 3 )
        || ( JacDot.get_col_count() != 1 ) )
      throw std::range_error( "Jacobian and JacobianDot matrices have the wrong size!" );
  ...
  *******************************************************************************/
  ...
  virtual void RK_CALL save( ReaK::serialization::oarchive& A, unsigned int ) const {
    ...
    A& RK_SERIAL_SAVE_WITH_NAME( qd_vel ) & RK_SERIAL_SAVE_WITH_NAME( qd_avel ) & RK_SERIAL_SAVE_WITH_NAME( qd_acc )
      & RK_SERIAL_SAVE_WITH_NAME( qd_aacc );
  };
  virtual void RK_CALL load( ReaK::serialization::iarchive& A, unsigned int ) {
    shared_ptr< frame_2D< value_type > > tmp;
    A& RK_SERIAL_LOAD_WITH_ALIAS( "Parent", tmp ) & RK_SERIAL_LOAD_WITH_NAME( qd_vel )
      & RK_SERIAL_LOAD_WITH_NAME( qd_avel ) & RK_SERIAL_LOAD_WITH_NAME( qd_acc ) & RK_SERIAL_LOAD_WITH_NAME( qd_aacc );
    Parent = tmp;
  };
...
public:
  ...
  vect< value_type, 3 >
    qd_aacc; ///< Holds how much angular acceleration is generated at output from the input velocity.
  ...
  typename boost::enable_if< boost::mpl::and_< is_fully_writable_matrix< Matrix1 >,
                             ...
                             void >::type
    write_to_matrices( Matrix1& Jac, Matrix2& JacDot ) const {
    if( ( Jac.get_row_count() != 6 ) || ( Jac.get_col_count() != 1 ) || ( JacDot.get_row_count() != 6 )
        || ( JacDot.get_col_count() != 1 ) )
      throw std::range_error( "Jacobian and JacobianDot matrices have the wrong size!" );
...
public:
  ...
  jacobian_2D_gen( const vect< value_type, 2 >& aVelQd = ( vect< value_type, 2 >() ),
      ...
      : vel_qd( aVelQd ), avel_qd( aAVelQd ), vel_qdd( aVelQdd ), avel_qdd( aAVelQdd ){};
  ...
  typename boost::enable_if< boost::mpl::and_< is_fully_writable_matrix< Matrix1 >,
                             ...
                             void >::type
    write_to_matrices( Matrix1& Jac, Matrix2& JacDot ) const {
    if( ( Jac.get_row_count() != 1 ) || ( Jac.get_col_count() != 3 ) || ( JacDot.get_row_count() != 1 )
        || ( JacDot.get_col_count() != 3 ) )
      throw std::range_error( "Jacobian and JacobianDot matrices have the wrong size!" );
  ...
  *******************************************************************************/
  ...
  virtual void RK_CALL save( ReaK::serialization::oarchive& A, unsigned int ) const {
    A& RK_SERIAL_SAVE_WITH_NAME( vel_qd ) & RK_SERIAL_SAVE_WITH_NAME( avel_qd ) & RK_SERIAL_SAVE_WITH_NAME( vel_qdd )
      & RK_SERIAL_SAVE_WITH_NAME( avel_qdd );
  };
  virtual void RK_CALL load( ReaK::serialization::iarchive& A, unsigned int ) {
    A& RK_SERIAL_LOAD_WITH_NAME( vel_qd ) & RK_SERIAL_LOAD_WITH_NAME( avel_qd ) & RK_SERIAL_LOAD_WITH_NAME( vel_qdd )
...
public:
  ...
  vect< vect< value_type, 2 >, 2 >
    vel_acc; ///< Holds how much acceleration is generated at output from the input velocity.
  vect< value_type, 2 >
    vel_aacc; ///< Holds how much angular acceleration is generated at output from the input velocity.
  vect< value_type, 2 >
    avel_acc;           ///< Holds how much acceleration is generated at output from the input angular velocity.
  ...
  jacobian_2D_2D( const weak_ptr< frame_2D< value_type > >& aParent = weak_ptr< frame_2D< value_type > >(),
      ...
      : Parent( aParent ), vel_vel( aVelVel ), vel_avel( aVelAVel ), avel_vel( aAVelVel ), avel_avel( aAVelAVel ),
        vel_acc( aVelAcc ), vel_aacc( aVelAAcc ), avel_acc( aAVelAcc ), avel_aacc( aAVelAAcc ){};
  ...
  self get_jac_relative_to( const shared_ptr< frame_2D< value_type > >& aFrame ) const {
    ...
    return self(
      ...
      avel_avel,    // AVelAVel
      vect< vect< value_type, 2 >, 2 >( ( vel_avel[0] % f2.Velocity + vel_aacc[0] % f2.Position + vel_acc[0] )
                                        * f2.Rotation - f2.AngVelocity % new_vel_vel[0],
                                        ( vel_avel[1] % f2.Velocity + vel_aacc[1] % f2.Position + vel_acc[1] )
                                        * f2.Rotation - f2.AngVelocity % new_vel_vel[1] ), // VelAcc
      vel_aacc,                                                                            // VelAAcc
  ...
  typename boost::enable_if< boost::mpl::and_< is_fully_writable_matrix< Matrix1 >,
                             ...
                             void >::type
    write_to_matrices( Matrix1& Jac, Matrix2& JacDot ) const {
    if( ( Jac.get_row_count() != 3 ) || ( Jac.get_col_count() != 3 ) || ( JacDot.get_row_count() != 3 )
        || ( JacDot.get_col_count() != 3 ) )
      throw std::range_error( "Jacobian and JacobianDot matrices have the wrong size!" );
  ...
  *******************************************************************************/
  ...
  virtual void RK_CALL save( ReaK::serialization::oarchive& A, unsigned int ) const {
    if( Parent.expired() )
      ...
      A& RK_SERIAL_SAVE_WITH_ALIAS( "Parent", Parent.lock() );
    A& RK_SERIAL_SAVE_WITH_NAME( vel_vel ) & RK_SERIAL_SAVE_WITH_NAME( vel_avel ) & RK_SERIAL_SAVE_WITH_NAME( avel_vel )
      & RK_SERIAL_SAVE_WITH_NAME( avel_avel ) & RK_SERIAL_SAVE_WITH_NAME( vel_acc )
      & RK_SERIAL_SAVE_WITH_NAME( vel_aacc ) & RK_SERIAL_SAVE_WITH_NAME( avel_acc )
      & RK_SERIAL_SAVE_WITH_NAME( avel_aacc );
  };
  virtual void RK_CALL load( ReaK::serialization::iarchive& A, unsigned int ) {
    shared_ptr< frame_2D< value_type > > tmp;
    A& RK_SERIAL_LOAD_WITH_ALIAS( "Parent", tmp ) & RK_SERIAL_LOAD_WITH_NAME( vel_vel )
      & RK_SERIAL_LOAD_WITH_NAME( vel_avel ) & RK_SERIAL_LOAD_WITH_NAME( avel_vel )
      & RK_SERIAL_LOAD_WITH_NAME( avel_avel ) & RK_SERIAL_LOAD_WITH_NAME( vel_acc )
      & RK_SERIAL_LOAD_WITH_NAME( vel_aacc ) & RK_SERIAL_LOAD_WITH_NAME( avel_acc )
...
public:
  ...
  vect< vect< value_type, 3 >, 2 >
    vel_avel;                     ///< Holds how much angular velocity is generated at output from the input velocity.
  vect< value_type, 3 > avel_vel; ///< Holds how much velocity is generated at output from the input angular velocity.
  vect< value_type, 3 >
    avel_avel; ///< Holds how much angular velocity is generated at output from the input angular velocity.
  vect< vect< value_type, 3 >, 2 >
    vel_acc; ///< Holds how much acceleration is generated at output from the input velocity.
  vect< vect< value_type, 3 >, 2 >
    vel_aacc; ///< Holds how much angular acceleration is generated at output from the input velocity.
  vect< value_type, 3 >
    avel_acc; ///< Holds how much acceleration is generated at output from the input angular velocity.
  vect< value_type, 3 >
    avel_aacc; ///< Holds how much angular acceleration is generated at output from the input angular velocity.
  ...
  self get_jac_relative_to( const shared_ptr< frame_3D< value_type > >& aFrame ) const {
    ...
    vect< vect< value_type, 3 >, 2 > new_vel_acc(
      ( vel_avel[0] % f2.Velocity + vel_aacc[0] % f2.Position + vel_acc[0] ) * R - f2.AngVelocity % new_vel_vel[0],
    ...
    vect< value_type, 3 > new_avel_acc( ( avel_avel % f2.Velocity + avel_aacc % f2.Position + avel_acc ) * R
                                        - f2.AngVelocity % new_avel_vel );

    return self( aFrame, new_vel_vel, new_vel_avel, new_avel_vel, new_avel_avel, new_vel_acc, new_vel_aacc,
                 new_avel_acc, new_avel_aacc );
  };
  ...
  typename boost::enable_if< boost::mpl::and_< is_fully_writable_matrix< Matrix1 >,
                             ...
                             void >::type
    write_to_matrices( Matrix1& Jac, Matrix2& JacDot ) const {
    if( ( Jac.get_row_count() != 6 ) || ( Jac.get_col_count() != 3 ) || ( JacDot.get_row_count() != 6 )
        || ( JacDot.get_col_count() != 3 ) )
      throw std::range_error( "Jacobian and JacobianDot matrices have the wrong size!" );
...
public:
  ...
  vect< value_type, 3 >
    avel_qdd; ///< Holds how much acceleration is generated at output from the input angular velocity.
  ...
  typename boost::enable_if< boost::mpl::and_< is_fully_writable_matrix< Matrix1 >,
                             ...
                             void >::type
    write_to_matrices( Matrix1& Jac, Matrix2& JacDot ) const {
    if( ( Jac.get_row_count() != 1 ) || ( Jac.get_col_count() != 6 ) || ( JacDot.get_row_count() != 1 )
        || ( JacDot.get_col_count() != 6 ) )
      throw std::range_error( "Jacobian and JacobianDot matrices have the wrong size!" );
...
public:
  ...
  vect< vect< value_type, 2 >, 3 >
    avel_vel; ///< Holds how much velocity is generated at output from the input angular velocity.
  vect< value_type, 3 >
    avel_avel; ///< Holds how much angular velocity is generated at output from the input angular velocity.
  vect< vect< value_type, 2 >, 3 >
    vel_acc; ///< Holds how much acceleration is generated at output from the input velocity.
  ...
  self get_jac_relative_to( const shared_ptr< frame_2D< value_type > >& aFrame ) const {
    ...
    vect< vect< value_type, 2 >, 3 > new_vel_acc( ( vel_avel[0] % f2.Velocity + vel_aacc[0] % f2.Position + vel_acc[0] )
                                                  * f2.Rotation - f2.AngVelocity % new_vel_vel[0],
                                                  ( vel_avel[1] % f2.Velocity + vel_aacc[1] % f2.Position + vel_acc[1] )
                                                  * f2.Rotation - f2.AngVelocity % new_vel_vel[1],
                                                  ( vel_avel[2] % f2.Velocity + vel_aacc[2] % f2.Position + vel_acc[2] )
                                                  * f2.Rotation - f2.AngVelocity % new_vel_vel[2] );
    ...
    vect< vect< value_type, 2 >, 3 > new_avel_acc( ( avel_avel[0] % f2.Velocity + avel_aacc[0] % f2.Position
                                                     + avel_acc[0] ) * f2.Rotation - f2.AngVelocity % new_avel_vel[0],
                                                   ( avel_avel[1] % f2.Velocity + avel_aacc[1] % f2.Position
                                                     + avel_acc[1] ) * f2.Rotation - f2.AngVelocity % new_avel_vel[1],
                                                   ( avel_avel[2] % f2.Velocity + avel_aacc[2] % f2.Position
                                                     + avel_acc[2] ) * f2.Rotation - f2.AngVelocity % new_avel_vel[2] );
  ...
  typename boost::enable_if< boost::mpl::and_< is_fully_writable_matrix< Matrix1 >,
                             ...
                             void >::type
    write_to_matrices( Matrix1& Jac, Matrix2& JacDot ) const {
    if( ( Jac.get_row_count() != 3 ) || ( Jac.get_col_count() != 6 ) || ( JacDot.get_row_count() != 3 )
        || ( JacDot.get_col_count() != 6 ) )
      throw std::range_error( "Jacobian and JacobianDot matrices have the wrong size!" );
...
public:
  ...
  self get_jac_relative_to( const shared_ptr< frame_3D< value_type > >& aFrame ) const {
    ...
    vect< vect< value_type, 3 >, 3 > new_vel_avel( vel_avel[0] * R, vel_avel[1] * R, vel_avel[2] * R );
    ...
    vect< vect< value_type, 3 >, 3 > new_avel_avel( avel_avel[0] * R, avel_avel[1] * R, avel_avel[2] * R );
    ...
    vect< vect< value_type, 3 >, 3 > new_vel_acc(
      ( vel_avel[0] % f2.Velocity + vel_aacc[0] % f2.Position + vel_acc[0] ) * R - f2.AngVelocity % new_vel_vel[0],
      ( vel_avel[1] % f2.Velocity + vel_aacc[1] % f2.Position + vel_acc[1] ) * R - f2.AngVelocity % new_vel_vel[1],
      ( vel_avel[2] % f2.Velocity + vel_aacc[2] % f2.Position + vel_acc[2] ) * R - f2.AngVelocity % new_vel_vel[2] );
    ...
    vect< vect< value_type, 3 >, 3 > new_avel_acc(
      ( avel_avel[0] % f2.Velocity + avel_aacc[0] % f2.Position + avel_acc[0] ) * R - f2.AngVelocity % new_avel_vel[0],
      ( avel_avel[1] % f2.Velocity + avel_aacc[1] % f2.Position + avel_acc[1] ) * R - f2.AngVelocity % new_avel_vel[1],
  ...
  typename boost::enable_if< boost::mpl::and_< is_fully_writable_matrix< Matrix1 >,
                             ...
                             void >::type
    write_to_matrices( Matrix1& Jac, Matrix2& JacDot ) const {
    if( ( Jac.get_row_count() != 6 ) || ( Jac.get_col_count() != 6 ) || ( JacDot.get_row_count() != 6 )
        || ( JacDot.get_col_count() != 6 ) )
      throw std::range_error( "Jacobian and JacobianDot matrices have the wrong size!" );
