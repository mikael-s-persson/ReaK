...
BOOST_AUTO_TEST_CASE(mat_fullrank_inversion_tests) {
  ...
  BOOST_CHECK((is_null_mat(m_gauss_inv - m_gauss_trueinv,
                           std::numeric_limits<double>::epsilon())));
  BOOST_CHECK((is_identity_mat((m_gauss * m_gauss_inv),
                               std::numeric_limits<double>::epsilon())));
  ...
  BOOST_CHECK((is_null_mat(m_plu_inv - m_gauss_trueinv,
                           std::numeric_limits<double>::epsilon())));
  BOOST_CHECK((is_identity_mat((m_gauss * m_plu_inv),
                               std::numeric_limits<double>::epsilon())));

  mat<double, mat_structure::symmetric> m_gauss2_inv(3);
  BOOST_CHECK_NO_THROW(invert_gaussian(m_gauss, m_gauss2_inv, double(1E-15)));
  BOOST_CHECK((is_null_mat(m_gauss2_inv - m_gauss_trueinv,
                           std::numeric_limits<double>::epsilon())));
  BOOST_CHECK((is_identity_mat((m_gauss * m_gauss2_inv),
                               std::numeric_limits<double>::epsilon())));

  mat<double, mat_structure::symmetric> m_plu2_inv(
      mat<double, mat_structure::identity>(3));
  BOOST_CHECK_NO_THROW(invert_PLU(m_gauss, m_plu2_inv, double(1E-15)));
  BOOST_CHECK((is_null_mat(m_plu2_inv - m_gauss_trueinv,
                           std::numeric_limits<double>::epsilon())));
  BOOST_CHECK((is_identity_mat((m_gauss * m_plu2_inv),
                               std::numeric_limits<double>::epsilon())));
  ...
  BOOST_CHECK((is_null_mat(m_cholesky_inv - m_gauss_trueinv,
                           2.0 * std::numeric_limits<double>::epsilon())));
  BOOST_CHECK((is_identity_mat((m_gauss * m_cholesky_inv),
  ...
  BOOST_CHECK_NO_THROW(
      invert_Cholesky(m_gauss, m_cholesky2_inv, double(1E-15)));
  BOOST_CHECK((is_null_mat(m_cholesky2_inv - m_gauss_trueinv,
                           2.0 * std::numeric_limits<double>::epsilon())));
  BOOST_CHECK((is_identity_mat((m_gauss * m_cholesky2_inv),
                               4.0 * std::numeric_limits<double>::epsilon())));
  ...
  BOOST_CHECK((is_null_mat(m_cholesky3_inv - m_gauss_diag_trueinv,
                           std::numeric_limits<double>::epsilon())));
  BOOST_CHECK((is_identity_mat((m_gauss_diag * m_cholesky3_inv),
                               std::numeric_limits<double>::epsilon())));
  ...
  BOOST_CHECK((is_null_mat(m_cholesky4_inv - m_gauss_diag_trueinv,
                           std::numeric_limits<double>::epsilon())));
  BOOST_CHECK((is_identity_mat((m_gauss_diag * m_cholesky4_inv),
                               std::numeric_limits<double>::epsilon())));

  mat<double, mat_structure::symmetric> m_jacobi_pinv(3);
  BOOST_CHECK_NO_THROW(
      pseudoinvert_Jacobi(m_gauss, m_jacobi_pinv, double(1E-15)));
  BOOST_CHECK((is_null_mat(m_jacobi_pinv - m_gauss_trueinv,
                           32.0 * std::numeric_limits<double>::epsilon())));
  BOOST_CHECK((is_identity_mat((m_gauss * m_jacobi_pinv),
                               32.0 * std::numeric_limits<double>::epsilon())));

  mat<double, mat_structure::square> m_qr_inv(3);
  BOOST_CHECK_NO_THROW(pseudoinvert_QR(m_gauss, m_qr_inv, double(1E-15)));
  BOOST_CHECK((is_null_mat(m_qr_inv - m_gauss_trueinv,
                           std::numeric_limits<double>::epsilon())));
  BOOST_CHECK((is_identity_mat((m_gauss * m_qr_inv),
                               std::numeric_limits<double>::epsilon())));

  mat<double, mat_structure::square> m_svd_inv(3);
  BOOST_CHECK_NO_THROW(pseudoinvert_SVD(m_gauss, m_svd_inv, double(1E-15)));
  BOOST_CHECK((is_null_mat(m_svd_inv - m_gauss_trueinv,
                           4.0 * std::numeric_limits<double>::epsilon())));
  BOOST_CHECK((is_identity_mat((m_gauss * m_svd_inv),
                               4.0 * std::numeric_limits<double>::epsilon())));

  mat<double, mat_structure::square> m_ldl_inv(3);
  BOOST_CHECK_NO_THROW(invert_LDL(m_gauss, m_ldl_inv, double(1E-15)));
  BOOST_CHECK((is_null_mat(m_ldl_inv - m_gauss_trueinv,
                           std::numeric_limits<double>::epsilon())));
  BOOST_CHECK((is_identity_mat((m_gauss * m_ldl_inv),
                               std::numeric_limits<double>::epsilon())));

  mat<double, mat_structure::square> m_bandchol_inv(3);
  BOOST_CHECK_NO_THROW(
      invert_BandCholesky(m_gauss, m_bandchol_inv, 1, double(1E-15)));
  BOOST_CHECK((is_null_mat(m_bandchol_inv - m_gauss_trueinv,
                           4.0 * std::numeric_limits<double>::epsilon())));
  BOOST_CHECK((is_identity_mat((m_gauss * m_bandchol_inv),
                               4.0 * std::numeric_limits<double>::epsilon())));

  mat<double, mat_structure::square> m_symqr_pinv(3);
  BOOST_CHECK_NO_THROW(
      pseudoinvert_SymQR(m_gauss, m_symqr_pinv, double(1E-15)));
  BOOST_CHECK((is_null_mat(m_symqr_pinv - m_gauss_trueinv,
                           4.0 * std::numeric_limits<double>::epsilon())));
  BOOST_CHECK((is_identity_mat((m_gauss * m_symqr_pinv),
                               4.0 * std::numeric_limits<double>::epsilon())));

  mat<double, mat_structure::square> m_tridiagldl_inv(3);
  BOOST_CHECK_NO_THROW(
      invert_TriDiagLDL(m_gauss, m_tridiagldl_inv, double(1E-15)));
  BOOST_CHECK((is_null_mat(m_tridiagldl_inv - m_gauss_trueinv,
                           std::numeric_limits<double>::epsilon())));
  BOOST_CHECK((is_identity_mat((m_gauss * m_tridiagldl_inv),
                               std::numeric_limits<double>::epsilon())));
};
...
BOOST_AUTO_TEST_CASE(mat_left_pseudoinversion_tests) {
  ...
  BOOST_CHECK_NO_THROW(
      pseudoinvert_SVD(m_rankdef_test, m_svd_rankdef_inv, 1e-10));
  ...
  BOOST_CHECK_NO_THROW(linlsq_RRQR(m_rankdef_test, m_rrqr_rankdef_inv,
...
BOOST_AUTO_TEST_CASE(mat_right_pseudoinversion_tests) {
  ...
  BOOST_CHECK(is_identity_mat(m_test_Q * transpose(m_test_Q),
                              std::numeric_limits<double>::epsilon()));
  BOOST_CHECK(
      is_upper_triangular(m_test_R, std::numeric_limits<double>::epsilon()));
  BOOST_CHECK(is_null_mat((m_test_Q * m_test_R - m_test),
                          4.0 * std::numeric_limits<double>::epsilon()));
  ...
  BOOST_CHECK_NO_THROW((minnorm_RRQR(m_rankdef_test, m_rankdef_minnormRRQR_x,
  ...
  BOOST_CHECK_NO_THROW(
      pseudoinvert_SVD(m_rankdef_test, m_rankdef_svd_pinv, 1e-6));
...
BOOST_AUTO_TEST_CASE(mat_eigenvalues_tests) {
  ...
  BOOST_CHECK_NO_THROW(
      eigensolve_SymQR(m_gauss, m_qr_Q, m_qr_E, double(1E-15)));
  ...
  BOOST_CHECK((norm_inf(m_svd_Es - m_gauss_trueeig) <
               10.0 * std::numeric_limits<double>::epsilon()));
  BOOST_CHECK((is_null_mat((m_svd_U * m_svd_E * transpose(m_svd_V) - m_gauss),
                           10.0 * std::numeric_limits<double>::epsilon())));
};
...
BOOST_AUTO_TEST_CASE(mat_decompositions_tests) {
  ...
  BOOST_CHECK_NO_THROW(
      (orthogonalize_StableGramSchmidt(m_test_Gram, true, 1e-6)));
  ...
  BOOST_CHECK_NO_THROW(
      (detail::symmetric_QRalg_impl(m_test_R, &m_test_Q, 1e-6)));
  BOOST_CHECK(is_identity_mat(m_test_Q * transpose(m_test_Q),
                              4.0 * std::numeric_limits<double>::epsilon()));
  BOOST_CHECK(
      is_upper_triangular(m_test_R, std::numeric_limits<double>::epsilon()));
  ...
  m_test_Q = mat<double, mat_structure::identity>(3);
  BOOST_CHECK_NO_THROW(
      (detail::decompose_TriDiag_impl(m_test_R, &m_test_Q, 1e-6)));
  BOOST_CHECK(is_identity_mat(m_test_Q * transpose(m_test_Q),
                              4.0 * std::numeric_limits<double>::epsilon()));
  BOOST_CHECK(
  ...
  BOOST_CHECK_NO_THROW(
      (detail::symmetric_QRalg_impl(m_test4_R, &m_test4_Q, 1e-6)));
  BOOST_CHECK(is_identity_mat(m_test4_Q * transpose(m_test4_Q),
                              4.0 * std::numeric_limits<double>::epsilon()));
  BOOST_CHECK(
...
BOOST_AUTO_TEST_CASE(mat_ctrl_reduction_tests) {
  ...
  BOOST_CHECK(is_identity_mat(Q * transpose(Q),
                              4.0 * std::numeric_limits<double>::epsilon()));
  BOOST_CHECK(is_identity_mat(Z * transpose(Z),
                              4.0 * std::numeric_limits<double>::epsilon()));
  BOOST_CHECK((is_null_mat((Q * Ar * transpose(Q) - A),
                           10.0 * std::numeric_limits<double>::epsilon())));
  BOOST_CHECK((is_null_mat((Q * Br * transpose(Z) - B),
                           10.0 * std::numeric_limits<double>::epsilon())));
  ...
  BOOST_CHECK((is_null_mat((sub(Cr)(range(num_rank, 6), range(0, 12))),
                           10.0 * std::numeric_limits<double>::epsilon())));
  ...
  BOOST_CHECK_NO_THROW(decompose_SVD(sub(Cr)(range(0, num_rank), range(0, 12)),
                                     Ur, Er, Vr, double(1E-15)));
...
BOOST_AUTO_TEST_CASE(mat_balancing_tests) {
  ...
  BOOST_CHECK_NO_THROW(
      balance_pencil(A_penbal, B_penbal, Dl_penbal, Dr_penbal));
  ...
  BOOST_CHECK_NO_THROW(decompose_SVD(A_penbal, A_penbal_U, A_penbal_E,
                                     A_penbal_V, double(1E-15)));
  ...
  BOOST_CHECK_NO_THROW(decompose_SVD(B_penbal, B_penbal_U, B_penbal_E,
                                     B_penbal_V, double(1E-15)));
  ...
  BOOST_CHECK_NO_THROW(decompose_SVD(M_penbal, M_penbal_U, M_penbal_E,
                                     M_penbal_V, double(1E-15)));
