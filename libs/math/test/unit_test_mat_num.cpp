...
BOOST_AUTO_TEST_CASE( mat_fullrank_inversion_tests ) {
  ...
  mat< double, mat_structure::symmetric > m_gauss_trueinv( 0.75, 0.5, 0.25, 1.0, 0.5, 0.75 );
...
BOOST_AUTO_TEST_CASE( mat_left_pseudoinversion_tests ) {
  ...
  BOOST_CHECK_NO_THROW(
    linlsq_RRQR( m_rankdef_test, m_rrqr_rankdef_inv, mat< double, mat_structure::identity >( 4 ), 1e-10 ) );
...
BOOST_AUTO_TEST_CASE( mat_right_pseudoinversion_tests ) {
  ...
  BOOST_CHECK_NO_THROW(
    ( detail::decompose_QR_impl< mat< double, mat_structure::rectangular >, mat< double, mat_structure::square > >(
...
BOOST_AUTO_TEST_CASE( mat_decompositions_tests ) {
  ...
  BOOST_CHECK( is_null_mat( ( m_test_Q * m_test_R * transpose_view( m_test_Q ) - m_test ),
...
BOOST_AUTO_TEST_CASE( mat_ctrl_reduction_tests ) {
  ...
  BOOST_CHECK_NO_THROW(
    decompose_SVD( sub( Cr )( range( 0, num_rank ), range( 0, 12 ) ), Ur, Er, Vr, double( 1E-15 ) ) );
