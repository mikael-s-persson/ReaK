...
typedef void ( *HessFunctionPtr )( mat< double, mat_structure::symmetric >&, const vect_n< double >&, double,
                                   const vect_n< double >& );
typedef vect_n< double >( *GFunctionPtr )( const vect_n< double >& );
typedef void ( *GJacFunctionPtr )( mat< double, mat_structure::rectangular >&, const vect_n< double >&,
                                   const vect_n< double >& );
typedef vect_n< double >( *HFunctionPtr )( const vect_n< double >& );
typedef void ( *HJacFunctionPtr )( mat< double, mat_structure::rectangular >&, const vect_n< double >&,
                                   const vect_n< double >& );
...
void p01_H( mat< double, mat_structure::symmetric >& H, const vect_n< double >& x, double f,
...
vect_n< double > p01_g( const vect_n< double >& ) { return vect_n< double >( 0 ); };
...
vect_n< double > p01_lower = vect_n< double >(
  vect< double, 2 >( -std::numeric_limits< double >::infinity(), -std::numeric_limits< double >::infinity() ) );
vect_n< double > p01_upper = vect_n< double >(
  vect< double, 2 >( std::numeric_limits< double >::infinity(), std::numeric_limits< double >::infinity() ) );
...
vect_n< double > p02_lower = vect_n< double >(
  vect< double, 2 >( -std::numeric_limits< double >::infinity(), -std::numeric_limits< double >::infinity() ) );
vect_n< double > p02_upper = vect_n< double >(
  vect< double, 2 >( std::numeric_limits< double >::infinity(), std::numeric_limits< double >::infinity() ) );
...
void p03_H( mat< double, mat_structure::symmetric >& H, const vect_n< double >& x, double f,
            const vect_n< double >& x_grad ) {
  H.set_col_count( 2 );
  H( 0, 0 ) = 2.0e-5;
  H( 0, 1 ) = -2.0e-5;
...
vect_n< double > p03_g( const vect_n< double >& ) { return vect_n< double >( 0 ); };
...
vect_n< double > p03_lower = vect_n< double >(
  vect< double, 2 >( -std::numeric_limits< double >::infinity(), -std::numeric_limits< double >::infinity() ) );
vect_n< double > p03_upper = vect_n< double >(
  vect< double, 2 >( std::numeric_limits< double >::infinity(), std::numeric_limits< double >::infinity() ) );
...
void p04_H( mat< double, mat_structure::symmetric >& H, const vect_n< double >& x, double f,
            const vect_n< double >& x_grad ) {
  H.set_col_count( 2 );
  H( 0, 0 ) = 2.0 * ( x[0] + 1.0 );
  H( 0, 1 ) = 0.0;
...
vect_n< double > p04_g( const vect_n< double >& ) { return vect_n< double >( 0 ); };
...
vect_n< double > p04_lower = vect_n< double >(
  vect< double, 2 >( -std::numeric_limits< double >::infinity(), -std::numeric_limits< double >::infinity() ) );
vect_n< double > p04_upper = vect_n< double >(
  vect< double, 2 >( std::numeric_limits< double >::infinity(), std::numeric_limits< double >::infinity() ) );
...
void p05_H( mat< double, mat_structure::symmetric >& H, const vect_n< double >& x, double f,
            const vect_n< double >& x_grad ) {
  H.set_col_count( 2 );
...
vect_n< double > p05_g( const vect_n< double >& ) { return vect_n< double >( 0 ); };
...
vect_n< double > p05_sol
  = vect_n< double >( vect< double, 2 >( 0.5 - 4.0 * atan( 1.0 ) / 3.0, 0.5 - 4.0 * atan( 1.0 ) / 3.0 - 1.0 ) );
vect_n< double > p05_start = vect_n< double >( vect< double, 2 >( 0.0, 0.0 ) );
vect_n< double > p05_lower = vect_n< double >(
  vect< double, 2 >( -std::numeric_limits< double >::infinity(), -std::numeric_limits< double >::infinity() ) );
vect_n< double > p05_upper = vect_n< double >(
  vect< double, 2 >( std::numeric_limits< double >::infinity(), std::numeric_limits< double >::infinity() ) );
...
void p06_H( mat< double, mat_structure::symmetric >& H, const vect_n< double >& x, double f,
            const vect_n< double >& x_grad ) {
  H.set_col_count( 2 );
  H( 0, 0 ) = 2.0;
  H( 0, 1 ) = 0.0;
...
vect_n< double > p06_h( const vect_n< double >& ) { return vect_n< double >( 0 ); };
...
vect_n< double > p06_lower = vect_n< double >(
  vect< double, 2 >( -std::numeric_limits< double >::infinity(), -std::numeric_limits< double >::infinity() ) );
vect_n< double > p06_upper = vect_n< double >(
  vect< double, 2 >( std::numeric_limits< double >::infinity(), std::numeric_limits< double >::infinity() ) );
...
void p07_H( mat< double, mat_structure::symmetric >& H, const vect_n< double >& x, double f,
            const vect_n< double >& x_grad ) {
  H.set_col_count( 2 );
  double x2 = x[0] * x[0];
...
vect_n< double > p07_h( const vect_n< double >& ) { return vect_n< double >( 0 ); };
...
vect_n< double > p07_lower = vect_n< double >(
  vect< double, 2 >( -std::numeric_limits< double >::infinity(), -std::numeric_limits< double >::infinity() ) );
vect_n< double > p07_upper = vect_n< double >(
  vect< double, 2 >( std::numeric_limits< double >::infinity(), std::numeric_limits< double >::infinity() ) );
...
void p10_H( mat< double, mat_structure::symmetric >& H, const vect_n< double >& x, double f,
            const vect_n< double >& x_grad ) {
  H.set_col_count( 2 );
  H( 0, 0 ) = 0.0;
  H( 0, 1 ) = 0.0;
...
vect_n< double > p10_g( const vect_n< double >& ) { return vect_n< double >( 0 ); };
...
vect_n< double > p10_lower = vect_n< double >(
  vect< double, 2 >( -std::numeric_limits< double >::infinity(), -std::numeric_limits< double >::infinity() ) );
vect_n< double > p10_upper = vect_n< double >(
  vect< double, 2 >( std::numeric_limits< double >::infinity(), std::numeric_limits< double >::infinity() ) );
...
vect_n< double > p11_g( const vect_n< double >& ) { return vect_n< double >( 0 ); };
...
vect_n< double > p11_lower = vect_n< double >(
  vect< double, 2 >( -std::numeric_limits< double >::infinity(), -std::numeric_limits< double >::infinity() ) );
vect_n< double > p11_upper = vect_n< double >(
  vect< double, 2 >( std::numeric_limits< double >::infinity(), std::numeric_limits< double >::infinity() ) );
...
void p12_H( mat< double, mat_structure::symmetric >& H, const vect_n< double >& x, double f,
            const vect_n< double >& x_grad ) {
  H.set_col_count( 2 );
  H( 0, 0 ) = 1.0;
  H( 0, 1 ) = -1.0;
...
vect_n< double > p12_g( const vect_n< double >& ) { return vect_n< double >( 0 ); };
...
vect_n< double > p12_lower = vect_n< double >(
  vect< double, 2 >( -std::numeric_limits< double >::infinity(), -std::numeric_limits< double >::infinity() ) );
vect_n< double > p12_upper = vect_n< double >(
  vect< double, 2 >( std::numeric_limits< double >::infinity(), std::numeric_limits< double >::infinity() ) );
...
void p14_H( mat< double, mat_structure::symmetric >& H, const vect_n< double >& x, double f,
            const vect_n< double >& x_grad ) {
  H.set_col_count( 2 );
  H( 0, 0 ) = 2.0;
  H( 0, 1 ) = 0.0;
...
vect_n< double > p14_sol
  = vect_n< double >( vect< double, 2 >( ( sqrt( 7.0 ) - 1.0 ) * 0.5, ( sqrt( 7.0 ) + 1.0 ) * 0.25 ) );
vect_n< double > p14_start = vect_n< double >( vect< double, 2 >( 2.0, 2.0 ) );
vect_n< double > p14_lower = vect_n< double >(
  vect< double, 2 >( -std::numeric_limits< double >::infinity(), -std::numeric_limits< double >::infinity() ) );
vect_n< double > p14_upper = vect_n< double >(
  vect< double, 2 >( std::numeric_limits< double >::infinity(), std::numeric_limits< double >::infinity() ) );
...
void p15_H( mat< double, mat_structure::symmetric >& H, const vect_n< double >& x, double f,
            const vect_n< double >& x_grad ) {
  H.set_col_count( 2 );
  H( 0, 0 ) = 2.0;
  H( 0, 1 ) = 0.0;
...
vect_n< double > p15_g( const vect_n< double >& ) { return vect_n< double >( 0 ); };
...
vect_n< double > p15_lower = vect_n< double >(
  vect< double, 2 >( -std::numeric_limits< double >::infinity(), -std::numeric_limits< double >::infinity() ) );
vect_n< double > p15_upper = vect_n< double >(
  vect< double, 2 >( std::numeric_limits< double >::infinity(), std::numeric_limits< double >::infinity() ) );
...
double robot1_f( const vect_n< double >& x ) {
  ++evalCount;
  return x[4] * x[4] + x[5] * x[5] + x[6] * x[6] + x[7] * x[7] + 0.001 * cos( x[2] ) * cos( x[2] )
         + 0.001 * cos( x[3] ) * cos( x[3] );
};
...
void robot1_H( mat< double, mat_structure::symmetric >& H, const vect_n< double >& x, double f,
               const vect_n< double >& x_grad ) {
  H.set_col_count( 8 );
  H = mat< double, mat_structure::nil >( 8, 8 );
  H( 0, 0 ) = 0.0;
  H( 1, 1 ) = 0.0;
  H( 2, 2 ) = 2.0 * 0.001 * sin( x[2] ) * sin( x[2] ) - 2.0 * 0.001 * cos( x[2] ) * cos( x[2] );
  H( 3, 3 ) = 2.0 * 0.001 * sin( x[3] ) * sin( x[3] ) - 2.0 * 0.001 * cos( x[3] ) * cos( x[3] );
  H( 4, 4 ) = 2.0;
  H( 5, 5 ) = 2.0;
  H( 6, 6 ) = 2.0;
  H( 7, 7 ) = 2.0;
...
void robot2_H( mat< double, mat_structure::symmetric >& H, const vect_n< double >& x, double,
               const vect_n< double >& ) {
  H.set_col_count( 4 );
...
void robot2_g_jac( mat< double, mat_structure::rectangular >& J, const vect_n< double >& x, const vect_n< double >& ) {
  J.set_col_count( 4 );
  J.set_row_count( 3 );
  vect_n< double > l = get_robot2_lengths();
  double s1 = l[1] * sin( x[1] );
...
void robot2_h_jac( mat< double, mat_structure::rectangular >& J, const vect_n< double >&, const vect_n< double >& ) {
  J.set_col_count( 4 );
  J.set_row_count( 2 );
  J( 0, 0 ) = 1.0;
  J( 0, 1 ) = 0.0;
...
vect_n< double > robot2_lower = vect_n< double >( 4, -std::numeric_limits< double >::infinity() );
vect_n< double > robot2_upper = vect_n< double >( 4, std::numeric_limits< double >::infinity() );
...
int main() {
  ...
  for( std::size_t i = 0; i < funcs_f.size(); ++i ) {
    ...
    std::cout << "Searching for minimum of function #" << i << " which has N = " << x.size() << " M = " << M
              << " K = " << K << std::endl;
    ...
    gradCount = 0;
    try {
      optim::make_newton_method_tr( funcs_f[i], funcs_grad[i], funcs_hess[i], 2.0, 300, 1e-6, 1e-6, 1e-3 )( x );
      std::cout << "  Newton method (unconstrained) gives:\n"
                ...
                << "    f(x) = " << funcs_f[i]( x ) << " with f(x_opt) = " << funcs_f[i]( funcs_sol[i] )
                << " |f(x) - f(x_opt)| = " << fabs( funcs_f[i](x)-funcs_f[i]( funcs_sol[i] ) ) << "\n"
                << "    g(x) = " << funcs_g[i]( x ) << " and h(x) = " << funcs_h[i]( x ) << std::endl;
    } catch( std::exception& e ) {
      std::cout << "  Newton method (unconstrained) failed with error: " << e.what() << std::endl << "    x = " << x
    ...
    try {
      optim::make_constraint_newton_method_tr( funcs_f[i], funcs_grad[i], funcs_hess[i], 2.0, 300, 1e-6, 1e-6, 1e-3 )
        .set_limiter(
           boost::bind( optim::box_limit_function< vect_n< double > >, _1, _2, funcs_lower[i], funcs_upper[i] ) )
      ...
      std::cout << "  Augmented Lagrangian method failed with error: " << e.what() << std::endl << "    x = " << x
                << " with error = " << norm_2( x - funcs_sol[i] ) << "\n"
                << "    eval-count = " << evalCount << " and grad-eval-count = " << gradCount << "\n"
                << "    f(x) = " << funcs_f[i]( x ) << " with f(x_opt) = " << funcs_f[i]( funcs_sol[i] )
                << " |f(x) - f(x_opt)| = " << fabs( funcs_f[i](x)-funcs_f[i]( funcs_sol[i] ) ) << "\n"
    ...
    try {
      ...
      std::cout << "  NL Interior-point method failed with error: " << e.what() << std::endl << "    x = " << x
                << " with error = " << norm_2( x - funcs_sol[i] ) << "\n"
                << "    eval-count = " << evalCount << " and grad-eval-count = " << gradCount << "\n"
                << "    f(x) = " << funcs_f[i]( x ) << " with f(x_opt) = " << funcs_f[i]( funcs_sol[i] )
                << " |f(x) - f(x_opt)| = " << fabs( funcs_f[i](x)-funcs_f[i]( funcs_sol[i] ) ) << "\n"
    ...
    try {
      ...
      std::cout << "  NL Interior-point Quasi-Newton method with Line-search failed with error: " << e.what()
                << std::endl << "    x = " << x << " with error = " << norm_2( x - funcs_sol[i] ) << "\n"
                << "    eval-count = " << evalCount << " and grad-eval-count = " << gradCount << "\n"
                << "    f(x) = " << funcs_f[i]( x ) << " with f(x_opt) = " << funcs_f[i]( funcs_sol[i] )
                << " |f(x) - f(x_opt)| = " << fabs( funcs_f[i](x)-funcs_f[i]( funcs_sol[i] ) ) << "\n"
                << "    g(x) = " << funcs_g[i]( x ) << " and h(x) = " << funcs_h[i]( x ) << std::endl;
    ...
    if( K == 0 ) {
      ...
      try {
        ...
        std::cout << "  Byrd-Omojokun SQP method failed with error: " << e.what() << std::endl << "    x = " << x
                  << " with error = " << norm_2( x - funcs_sol[i] ) << "\n"
                  << "    eval-count = " << evalCount << " and grad-eval-count = " << gradCount << "\n"
                  << "    f(x) = " << funcs_f[i]( x ) << " with f(x_opt) = " << funcs_f[i]( funcs_sol[i] )
                  << " |f(x) - f(x_opt)| = " << fabs( funcs_f[i](x)-funcs_f[i]( funcs_sol[i] ) ) << "\n"
