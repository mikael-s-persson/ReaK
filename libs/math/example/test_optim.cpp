...
int main() {
  ...
  std::cout << "Testing optimization methods on the Banana Function (optimum at (1,1), with value "
            << banana_function( ReaK::vect< double, 2 >( 1.0, 1.0 ) ) << ")" << std::endl;
  ...
  std::cout << "    found optimum: " << x_2D << " after " << evalCount << " function evaluations and " << gradCount
  ...
  ReaK::optim::quasi_newton_trust_region( banana_function, banana_function_grad, x_2D, 0.5, 100,
                                          ReaK::optim::trust_region_solver_dogleg(), ReaK::optim::hessian_update_sr1(),
                                          ReaK::optim::no_limit_functor(), 1e-7, 1e-7 );
  std::cout << "    found optimum: " << x_2D << " after " << evalCount << " function evaluations and " << gradCount
            << " gradient evaluations." << std::endl;
  std::cout << "    function gives: " << banana_function( x_2D ) << " gradient gives: " << banana_function_grad( x_2D )
            << std::endl;
  ...
  std::cout << "    found optimum: " << x_2D << " after " << evalCount << " function evaluations." << std::endl;
  std::cout << "    function gives: " << easy_function( x_2D ) << " gradient gives: " << easy_function_grad( x_2D )
            << std::endl;
  ...
  x_2D = ReaK::vect< double, 2 >( 0.5, 1.0 );
  std::cout << "  DY CG method started at " << x_2D << std::endl;
  ReaK::optim::non_linear_conj_grad_method( easy_function, easy_function_grad, x_2D, 100, ReaK::optim::dai_yuan_beta(),
                                            ReaK::optim::line_search_expand_and_zoom< double >( 1e-4, 0.1 ), 1e-7 );
  std::cout << "    found optimum: " << x_2D << " after " << evalCount << " function evaluations and " << gradCount
            << " gradient evaluations." << std::endl;
  std::cout << "    function gives: " << easy_function( x_2D ) << " gradient gives: " << easy_function_grad( x_2D )
