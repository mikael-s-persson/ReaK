...
int main( int argc, char** argv ) {
  ...
  if( argc < 11 ) {
    ...
    std::cout << "Error: Arguments to the program were incorrect!" << std::endl << "Usage:" << std::endl
              << "\t\t./test_interp [time_step] [interp_time_step] [min_time] [max_time] [max_vel] [max_accel] "
                 "[start_pt] [start_vel] [end_pt] [end_vel]" << std::endl;
  ...
  ReaK::shared_ptr< TempTopoType > topo = ReaK::shared_ptr< TempTopoType >( new TempTopoType(
    "temporal_space", SpaceTupleType( ReaK::pp::line_segment_topology< double >( "pos_topo", -20.0, 20.0 ),
  ...
  typedef ReaK::arithmetic_tuple< TopoType, TopoType > SpaceTupleType2;
  ...
  ReaK::shared_ptr< TempTopoType2 > topo2 = ReaK::shared_ptr< TempTopoType2 >( new TempTopoType2(
    "temporal_space_tuple",
    SpaceTupleType2( SpaceTupleType( ReaK::pp::line_segment_topology< double >( "pos_topo", -20.0, 20.0 ),
                                     ReaK::pp::line_segment_topology< double >( "vel_topo", -max_vel, max_vel ),
                                     ReaK::pp::line_segment_topology< double >( "acc_topo", -max_accel, max_accel ),
                                     ReaK::pp::line_segment_topology< double >( "jerk_topo", -20.0, 20.0 ) ),
  ...
  pts2.push_back( TempPointType2(
    0.0, PointType2( PointType( start_pt, start_vel, 0.0, 0.0 ), PointType( start_pt, start_vel, 0.0, 0.0 ) ) ) );
  pts2.push_back( TempPointType2(
    min_time, PointType2( PointType( end_pt, end_vel, 0.0, 0.0 ), PointType( end_pt, end_vel, 0.0, 0.0 ) ) ) );
