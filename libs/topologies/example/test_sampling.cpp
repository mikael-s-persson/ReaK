...
int main( int argc, char** argv ) {
  ...
  try {
    ...
    ReaK::pp::hyperbox_topology< ReaK::vect< double, 2 > > topo( "hyperbox", ReaK::vect< double, 2 >( 0.01, 0.01 ),
  ...
  try {
    ...
    ReaK::pp::hyperball_topology< ReaK::vect< double, 2 > > topo( "hyperball", ReaK::vect< double, 2 >( 256.0, 256.0 ),
                                                                  255.99 );
