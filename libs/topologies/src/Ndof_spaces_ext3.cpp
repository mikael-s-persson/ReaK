...
\
template Ndof_rl_space<double,NDOF,0>::type joint_limits_mapping<double>::make_rl_joint_space(const Ndof_space<double,NDOF,0>::type&) const;\
template Ndof_rl_space<double,NDOF,1>::type joint_limits_mapping<double>::make_rl_joint_space(const Ndof_space<double,NDOF,1>::type&) const;\
template Ndof_rl_space<double,NDOF,2>::type joint_limits_mapping<double>::make_rl_joint_space(const Ndof_space<double,NDOF,2>::type&) const;\
\
template Ndof_space<double,NDOF,0>::type joint_limits_mapping<double>::make_normal_joint_space(const Ndof_rl_space<double,NDOF,0>::type&) const;\
template Ndof_space<double,NDOF,1>::type joint_limits_mapping<double>::make_normal_joint_space(const Ndof_rl_space<double,NDOF,1>::type&) const;\
template Ndof_space<double,NDOF,2>::type joint_limits_mapping<double>::make_normal_joint_space(const Ndof_rl_space<double,NDOF,2>::type&) const;\
\
template \
