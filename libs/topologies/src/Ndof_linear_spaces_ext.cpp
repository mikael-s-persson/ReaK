...
#define RK_NDOF_LINEAR_SPACES_MAKE_NORMAL_EXTERN_DEFS( NDOF )                                                          \
  ...
  template class interpolated_topology< Ndof_rl_space< double, NDOF, 2 >::type, linear_interpolation_tag >;            \
                                                                                                                       \
  template class interpolated_topology< temporal_space< Ndof_rl_space< double, NDOF, 0 >::type, time_poisson_topology, \
...
template class interpolated_topology< temporal_space< Ndof_rl_space< double, 0, 0 >::type, time_poisson_topology,
                                                      reach_plus_time_metric >,
                                      linear_interpolation_tag >;
