...
\
template Ndof_0th_order_rl_space<double,NDOF>::type joint_limits_mapping<double>::make_rl_joint_space(const Ndof_0th_order_space<double,NDOF>::type&) const;\
template Ndof_1st_order_rl_space<double,NDOF>::type joint_limits_mapping<double>::make_rl_joint_space(const Ndof_1st_order_space<double,NDOF>::type&) const;\
template Ndof_2nd_order_rl_space<double,NDOF>::type joint_limits_mapping<double>::make_rl_joint_space(const Ndof_2nd_order_space<double,NDOF>::type&) const;\
\
template Ndof_0th_order_space<double,NDOF>::type joint_limits_mapping<double>::make_normal_joint_space(const Ndof_0th_order_rl_space<double,NDOF>::type&) const;\
template Ndof_1st_order_space<double,NDOF>::type joint_limits_mapping<double>::make_normal_joint_space(const Ndof_1st_order_rl_space<double,NDOF>::type&) const;\
template Ndof_2nd_order_space<double,NDOF>::type joint_limits_mapping<double>::make_normal_joint_space(const Ndof_2nd_order_rl_space<double,NDOF>::type&) const;\
\
template \
