...
#define RK_MANIP_FREE_WORKSPACE_MAKE_LIN_QSTAT_ENV_FOR_JOINTS_DEFS(NDOF)  \
  template class manip_quasi_static_env<                                  \
  ...
  template class manip_quasi_static_env<                                  \
      ...
      linear_interpolation_tag>;                                          \
                                                                          \
  template class manip_quasi_static_env<Ndof_rl_space_t<double, NDOF, 0>, \
                                        linear_interpolation_tag>;        \
  template class manip_quasi_static_env<Ndof_rl_space_t<double, NDOF, 1>, \
                                        linear_interpolation_tag>;        \
  template class manip_quasi_static_env<Ndof_rl_space_t<double, NDOF, 2>, \
                                        linear_interpolation_tag>;
