...
#define RK_MANIP_FREE_WORKSPACE_MAKE_LIN_QSTAT_ENV_FOR_JOINTS_DEFS( NDOF )                                        \
  template class manip_quasi_static_env< Ndof_0th_order_rl_space< double, NDOF, euclidean_tuple_distance >::type, \
                                         linear_interpolation_tag >;                                              \
  template class manip_quasi_static_env< Ndof_1st_order_rl_space< double, NDOF, euclidean_tuple_distance >::type, \
                                         linear_interpolation_tag >;                                              \
  template class manip_quasi_static_env< Ndof_2nd_order_rl_space< double, NDOF, euclidean_tuple_distance >::type, \
                                         linear_interpolation_tag >;                                              \
                                                                                                                  \
  template class manip_quasi_static_env< Ndof_0th_order_rl_space< double, NDOF, inf_norm_tuple_distance >::type,  \
                                         linear_interpolation_tag >;                                              \
  template class manip_quasi_static_env< Ndof_1st_order_rl_space< double, NDOF, inf_norm_tuple_distance >::type,  \
                                         linear_interpolation_tag >;                                              \
  template class manip_quasi_static_env< Ndof_2nd_order_rl_space< double, NDOF, inf_norm_tuple_distance >::type,  \
                                         linear_interpolation_tag >;                                              \
                                                                                                                  \
