...
template se3_0th_order_topology< double >::type
...
template se3_1st_order_topology< double >::type
  make_se3_space( const std::string& aName, const vect< double, 3 >& aMinCorner, const vect< double, 3 >& aMaxCorner,
...
template se3_2nd_order_topology< double >::type
  make_se3_space( const std::string& aName, const vect< double, 3 >& aMinCorner, const vect< double, 3 >& aMaxCorner,
...
template se3_0th_order_rl_topology< double >::type
...
template se3_1st_order_rl_topology< double >::type
  make_rl_se3_space( const std::string& aName, const vect< double, 3 >& aMinCorner, const vect< double, 3 >& aMaxCorner,
                     const double& aMaxSpeed, const double& aMaxAngularSpeed, const double& aMaxAcceleration,
                     const double& aMaxAngularAccel );
...
template se3_2nd_order_rl_topology< double >::type
  make_rl_se3_space( const std::string& aName, const vect< double, 3 >& aMinCorner, const vect< double, 3 >& aMaxCorner,
                     const double& aMaxSpeed, const double& aMaxAngularSpeed, const double& aMaxAcceleration,
...
template metric_space_array< se3_0th_order_rl_topology< double >::type, 1 >::type
  joint_limits_mapping< double >::make_rl_joint_space(
    const metric_space_array< se3_0th_order_topology< double >::type, 1 >::type& ) const;
template metric_space_array< se3_1st_order_rl_topology< double >::type, 1 >::type
  joint_limits_mapping< double >::make_rl_joint_space(
    const metric_space_array< se3_1st_order_topology< double >::type, 1 >::type& ) const;
template metric_space_array< se3_2nd_order_rl_topology< double >::type, 1 >::type
  joint_limits_mapping< double >::make_rl_joint_space(
    const metric_space_array< se3_2nd_order_topology< double >::type, 1 >::type& ) const;

template metric_space_array< se3_0th_order_topology< double >::type, 1 >::type
...
template metric_space_array< se3_1st_order_topology< double >::type, 1 >::type
  joint_limits_mapping< double >::make_normal_joint_space(
    const metric_space_array< se3_1st_order_rl_topology< double >::type, 1 >::type& ) const;
template metric_space_array< se3_2nd_order_topology< double >::type, 1 >::type
  joint_limits_mapping< double >::make_normal_joint_space(
    const metric_space_array< se3_2nd_order_rl_topology< double >::type, 1 >::type& ) const;

template topology_traits< metric_space_array< se3_0th_order_rl_topology< double >::type, 1 >::type >::point_type
  joint_limits_mapping< double >::map_to_space(
    ...
    const metric_space_array< se3_0th_order_rl_topology< double >::type, 1 >::type& ) const;
template topology_traits< metric_space_array< se3_1st_order_rl_topology< double >::type, 1 >::type >::point_type
  joint_limits_mapping< double >::map_to_space(
    ...
    const metric_space_array< se3_1st_order_rl_topology< double >::type, 1 >::type& ) const;
template topology_traits< metric_space_array< se3_2nd_order_rl_topology< double >::type, 1 >::type >::point_type
  joint_limits_mapping< double >::map_to_space(
...
template topology_traits< metric_space_array< se3_0th_order_topology< double >::type, 1 >::type >::point_type
  joint_limits_mapping< double >::map_to_space(
    ...
    const metric_space_array< se3_0th_order_topology< double >::type, 1 >::type& ) const;
template topology_traits< metric_space_array< se3_1st_order_topology< double >::type, 1 >::type >::point_type
  joint_limits_mapping< double >::map_to_space(
    ...
    const metric_space_array< se3_1st_order_topology< double >::type, 1 >::type& ) const;
template topology_traits< metric_space_array< se3_2nd_order_topology< double >::type, 1 >::type >::point_type
  joint_limits_mapping< double >::map_to_space(
...
template void set_frame_3D( arithmetic_tuple< arithmetic_tuple< vect< double, 3 >, vect< double, 3 > >,
                                              arithmetic_tuple< unit_quat< double >, vect< double, 3 > > >& pt,
                            const frame_3D< double >& p );
...
template const unit_quat< double >&
...
template void set_quaternion( arithmetic_tuple< arithmetic_tuple< vect< double, 3 >, vect< double, 3 > >,
                                                arithmetic_tuple< unit_quat< double >, vect< double, 3 > > >& pt,
                              const unit_quat< double >& q );
...
template void set_position( arithmetic_tuple< arithmetic_tuple< vect< double, 3 >, vect< double, 3 > >,
                                              arithmetic_tuple< unit_quat< double >, vect< double, 3 > > >& pt,
                            const vect< double, 3 >& p );
...
template void set_ang_velocity( arithmetic_tuple< arithmetic_tuple< vect< double, 3 >, vect< double, 3 > >,
                                                  arithmetic_tuple< unit_quat< double >, vect< double, 3 > > >& pt,
                                const vect< double, 3 >& p );
...
template void set_velocity( arithmetic_tuple< arithmetic_tuple< vect< double, 3 >, vect< double, 3 > >,
                                              arithmetic_tuple< unit_quat< double >, vect< double, 3 > > >& pt,
                            const vect< double, 3 >& p );
