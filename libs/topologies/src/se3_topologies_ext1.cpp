...
template metric_space_array< se3_0th_order_rl_topology<double>::type, 1>::type joint_limits_mapping<double>::make_rl_joint_space(const metric_space_array< se3_0th_order_topology<double>::type, 1>::type&) const;
template metric_space_array< se3_1st_order_rl_topology<double>::type, 1>::type joint_limits_mapping<double>::make_rl_joint_space(const metric_space_array< se3_1st_order_topology<double>::type, 1>::type&) const;
template metric_space_array< se3_2nd_order_rl_topology<double>::type, 1>::type joint_limits_mapping<double>::make_rl_joint_space(const metric_space_array< se3_2nd_order_topology<double>::type, 1>::type&) const;

template metric_space_array< se3_0th_order_topology<double>::type, 1>::type joint_limits_mapping<double>::make_normal_joint_space(const metric_space_array< se3_0th_order_rl_topology<double>::type, 1>::type&) const;
template metric_space_array< se3_1st_order_topology<double>::type, 1>::type joint_limits_mapping<double>::make_normal_joint_space(const metric_space_array< se3_1st_order_rl_topology<double>::type, 1>::type&) const;
template metric_space_array< se3_2nd_order_topology<double>::type, 1>::type joint_limits_mapping<double>::make_normal_joint_space(const metric_space_array< se3_2nd_order_rl_topology<double>::type, 1>::type&) const;
