...
static void sap_Ndof_compute_interpolated_values_balanced( double start_position, double end_position,
  ...
  double dp_ramp1 = 0.5 * ( dt_vp1 + 2.0 * dt_ap1 ) * ( start_velocity + peak_velocity ) / max_velocity;
  ...
  double dp_ramp2 = 0.5 * ( dt_vp2 + 2.0 * dt_ap2 ) * ( end_velocity + peak_velocity ) / max_velocity;
  ...
  if( dt <= 0.0 ) {
    ...
    if( dt < dt_ap1 ) {
      ...
      result_pos = start_position + ( start_velocity + sgn_vp1 / 6.0 * dt * dt / max_acceleration ) * dt / max_velocity;
      ...
      result_pos = start_position + dp_ramp1
                   + ( peak_velocity - sgn_vp1 / 6.0 * mdt * mdt / max_acceleration ) * mdt / max_velocity;
    ...
    if( dt < ( 2.0 * dt_ap1 + dt_vp1 + dt_total + dt_ap2 ) ) {
      ...
      result_pos = end_position - dp_ramp2
                   + ( peak_velocity + sgn_vp2 / 6.0 * dt * dt / max_acceleration ) * dt / max_velocity;
      ...
      double mdt = dt - 2.0 * dt_ap1 - dt_vp1 - dt_total - 2.0 * dt_ap2 - dt_vp2;

      result_pos = end_position + ( end_velocity - sgn_vp2 / 6.0 * mdt * mdt / max_acceleration ) * mdt / max_velocity;
...
void sap_Ndof_compute_interpolated_values( double start_position, double end_position, double start_velocity,
  ...
  sap_Ndof_compute_interpolated_values_balanced( start_position, end_position, start_velocity, end_velocity,
...
struct sap_Ndof_no_cruise_calculator {
  ...
  sap_Ndof_no_cruise_calculator( double a_dp, double a_v1, double a_v2, double a_vmax, double a_amax )
...
static double sap_Ndof_compute_min_delta_time_numsolve( double start_position, double end_position,
                                                        double start_velocity, double end_velocity,
                                                        double& peak_velocity, double max_velocity,
  ...
  sap_Ndof_no_cruise_calculator nc_calc( end_position - start_position, start_velocity, end_velocity, max_velocity,
                                         max_acceleration );
...
struct sap_Ndof_pos_diff_calculator {
  ...
  sap_Ndof_pos_diff_calculator( double a_dp, double a_v1, double a_v2, double a_vmax, double a_amax, double a_dt )
...
static void sap_Ndof_compute_peak_velocity_numsolve( double start_position, double end_position, double start_velocity,
  ...
  double interest_pts[8]
    = {max_velocity,                                 sign_p1_p0 * start_velocity + max_acceleration,
       sign_p1_p0 * start_velocity,                  sign_p1_p0 * start_velocity - max_acceleration,
       sign_p1_p0 * end_velocity + max_acceleration, sign_p1_p0 * end_velocity,
       sign_p1_p0 * end_velocity - max_acceleration, -max_velocity};
...
void sap_Ndof_compute_peak_velocity( double start_position, double end_position, double start_velocity,
  ...
  sap_Ndof_compute_peak_velocity_numsolve( start_position, end_position, start_velocity, end_velocity, peak_velocity,
