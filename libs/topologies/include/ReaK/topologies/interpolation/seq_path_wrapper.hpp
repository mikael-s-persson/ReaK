...
protected:
  ...
  struct point_distance_iterator_impl : public base_pt_dist_iterator_impl {
    ...
    virtual base_pt_dist_iterator_impl* clone() const { return new point_distance_iterator_impl( base_it ); };
  };
...
public:
   ...
   */
  explicit seq_path_wrapper( const std::string& aName = "", const SequentialPath& aTraj = SequentialPath() )
