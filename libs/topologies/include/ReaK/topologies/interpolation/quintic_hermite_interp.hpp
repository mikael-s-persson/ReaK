...
inline typename boost::enable_if< boost::mpl::less< Idx, boost::mpl::size_t< 3 > >, void >::type
  quintic_hermite_interpolate_HOT_impl( PointType&, const PointDiff2&, const PointDiff2&, const PointDiff2&,
                                        const DiffSpace&, const TimeSpace&, double, double ){
...
inline typename boost::enable_if< boost::mpl::equal_to< Idx, boost::mpl::size_t< 3 > >, void >::type
  quintic_hermite_interpolate_HOT_impl( PointType& result, const PointDiff2& da1a0, const PointDiff2& da_term1,
                                        const PointDiff2& da_term2, const DiffSpace& space, const TimeSpace& t_space,
                                        double t_factor, double t_normal ) {

  // lift(
  get< 3 >( result ) = lift_to_space< 3 >(
    //   (5 - 30 t + 30 t^2) * ( diff( lift( 6 * diff( lift( diff( p1, p0 ) ), v0 ) ), a0 ) + diff( a1, lift( 6 * diff(
    //   v1, lift( diff( p1, p0 ) ) ) ) ) )
...
template < typename Idx, typename PointType, typename PointDiff2, typename DiffSpace, typename TimeSpace >
inline typename boost::enable_if< boost::mpl::equal_to< Idx, boost::mpl::size_t< 4 > >, void >::type
  quintic_hermite_interpolate_HOT_impl( PointType& result, const PointDiff2& da1a0, const PointDiff2& da_term1,
                                        const PointDiff2& da_term2, const DiffSpace& space, const TimeSpace& t_space,
                                        double t_factor, double t_normal ) {
  quintic_hermite_interpolate_HOT_impl< boost::mpl::size_t< 3 >, PointType, PointDiff2, DiffSpace, TimeSpace >(
    result, da1a0, da_term1, da_term2, space, t_space, t_factor, t_normal );

  // lift( diff(
  get< 4 >( result )
    = lift_to_space< 4 >( get_space< 3 >( space, t_space ).difference(
                            //   (-30 + 60 t) * (
...
template < typename Idx, typename PointType, typename PointDiff2, typename DiffSpace, typename TimeSpace >
inline typename boost::enable_if< boost::mpl::equal_to< Idx, boost::mpl::size_t< 5 > >, void >::type
  quintic_hermite_interpolate_HOT_impl( PointType& result, const PointDiff2& da1a0, const PointDiff2& da_term1,
                                        const PointDiff2& da_term2, const DiffSpace& space, const TimeSpace& t_space,
                                        double t_factor, double t_normal ) {
  quintic_hermite_interpolate_HOT_impl< boost::mpl::size_t< 4 >, PointType, PointDiff2, DiffSpace, TimeSpace >(
    result, da1a0, da_term1, da_term2, space, t_space, t_factor, t_normal );

  // lift( diff(
  get< 5 >( result ) = lift_to_space< 5 >(
    get_space< 4 >( space, t_space ).difference(
      //   lift( 60 * diff(
      lift_to_space< 4 >( 60.0
                          * get_space< 3 >( space, t_space ).difference(
...
template < typename Idx, typename PointType, typename PointDiff0, typename PointDiff1, typename PointDiff2,
           typename DiffSpace, typename TimeSpace >
inline typename boost::enable_if< boost::mpl::less< Idx, boost::mpl::size_t< 6 > >, void >::type
  quintic_hermite_interpolate_impl( PointType& result, const PointType& a, const PointType& b, const PointDiff0& dp1p0,
                                    const PointDiff1& dv1v0, const PointDiff1& d_ldp1p0_v0,
                                    const PointDiff1& d_v1_ldp1p0, const PointDiff1& i_a0, const PointDiff1& i_a1,
  ...
  */
  ...
  get< 0 >( result ) = get_space< 0 >( space, t_space ).adjust(
    ...
    * ( dp1p0
        - 0.5 * ( descend_to_space< 0 >( get< 1 >( a ), t_factor, space, t_space )
                  + descend_to_space< 0 >( get< 1 >( b ), t_factor, space, t_space ) ) )
    //   + t desc(v0 +
    + t_normal
      * descend_to_space< 0 >( get_space< 1 >( space, t_space ).adjust(
                                 get< 1 >( a ),
                                 //           (t^2 - 0.5 t^3) diff(v1,v0) + (0.5 t - 1.5 t^2 + 1.5 t^3 - 0.5 t^4)
                                 //           desc(a0) + (0.5 t^2 - t^3 + 0.5 t^4) desc(a1) )
                                 ( t2 - 0.5 * t3 ) * dv1v0 + ( 0.5 * ( t_normal - 3.0 * t2 + 3.0 * t3 - t4 ) ) * i_a0
  ...
  get< 1 >( result ) = get_space< 1 >( space, t_space ).adjust(
    ...
    + ( 3.0 * t2 - 2.0 * t3 ) * dv1v0 + ( t_normal - 4.5 * t2 + 6.0 * t3 - 2.5 * t4 ) * i_a0
  ...
  */
  ...
  get< 2 >( result ) = get_space< 2 >( space, t_space ).adjust(
    get< 2 >( a ),
    //   (5 t - 15 t^2 + 10 t^3) * (diff( lift( 6 * diff( lift( diff( p1, p0 ) ), v0 ) ), a0 ) + diff( a1, lift( 6 *
    //   diff( v1, lift( diff( p1, p0 ) ) ) ) ) )
  ...
  quintic_hermite_interpolate_HOT_impl< Idx, PointType, PointDiff2, DiffSpace, TimeSpace >(
    result, da1a0, da_term1, da_term2, space, t_space, t_factor, t_normal );
};
...
template < typename Idx, typename PointType, typename PointDiff0, typename PointDiff1, typename PointDiff2,
           typename DiffSpace, typename TimeSpace >
inline typename boost::enable_if< boost::mpl::greater< Idx, boost::mpl::size_t< 5 > >, void >::type
  quintic_hermite_interpolate_impl( PointType& result, const PointType& a, const PointType& b, const PointDiff0& dp1p0,
                                    const PointDiff1& dv1v0, const PointDiff1& d_ldp1p0_v0,
                                    const PointDiff1& d_v1_ldp1p0, const PointDiff1& i_a0, const PointDiff1& i_a1,
                                    const PointDiff2& da1a0, const PointDiff2& da_term1, const PointDiff2& da_term2,
                                    const DiffSpace& space, const TimeSpace& t_space, double t_factor,
                                    double t_normal ) {
  quintic_hermite_interpolate_impl< typename boost::mpl::prior< Idx >::type, PointType, PointDiff0, PointDiff1,
                                    PointDiff2, DiffSpace, TimeSpace >( result, a, b, dp1p0, dv1v0, d_ldp1p0_v0,
                                                                        d_v1_ldp1p0, i_a0, i_a1, da1a0, da_term1,
                                                                        da_term2, space, t_space, t_factor, t_normal );
...
PointType quintic_hermite_interpolate( const PointType& a, const PointType& b, double t, const Topology& space ) {
  ...
  PointDiff1 d_ldp1p0_v0
    = get_space< 1 >( space.get_space_topology(), space.get_time_topology() ).difference( ldp1p0, get< 1 >( a.pt ) );
  PointDiff1 d_v1_ldp1p0
    = get_space< 1 >( space.get_space_topology(), space.get_time_topology() ).difference( get< 1 >( b.pt ), ldp1p0 );
  PointDiff1 i_a0
    = descend_to_space< 1 >( get< 2 >( a.pt ), t_factor, space.get_space_topology(), space.get_time_topology() );
  PointDiff1 i_a1
    = descend_to_space< 1 >( get< 2 >( b.pt ), t_factor, space.get_space_topology(), space.get_time_topology() );

  PointType2 l6d_ldp1p0_v0
    = lift_to_space< 2 >( 6.0 * d_ldp1p0_v0, t_factor, space.get_space_topology(), space.get_time_topology() );
  PointType2 l6d_v1_ldp1p0
    = lift_to_space< 2 >( 6.0 * d_v1_ldp1p0, t_factor, space.get_space_topology(), space.get_time_topology() );
  PointDiff2 d_l6d_ldp1p0_v0_a0 = get_space< 2 >( space.get_space_topology(), space.get_time_topology() )
                                    .difference( l6d_ldp1p0_v0, get< 2 >( a.pt ) );
  PointDiff2 d_a1_l6d_v1_ldp1p0 = get_space< 2 >( space.get_space_topology(), space.get_time_topology() )
  ...
  PointDiff2 d_ldv1v0_a0
    = get_space< 2 >( space.get_space_topology(), space.get_time_topology() ).difference( ldv1v0, get< 2 >( a.pt ) );
  PointDiff2 d_a1_ldv1v0
    = get_space< 2 >( space.get_space_topology(), space.get_time_topology() ).difference( get< 2 >( b.pt ), ldv1v0 );
  PointDiff2 da1a0 = get_space< 2 >( space.get_space_topology(), space.get_time_topology() )
                       .difference( get< 2 >( b.pt ), get< 2 >( a.pt ) );

  PointDiff2 da_term1 = d_l6d_ldp1p0_v0_a0 + d_a1_l6d_v1_ldp1p0;
  PointDiff2 da_term2 = d_ldv1v0_a0 - d_a1_ldv1v0;

  detail::quintic_hermite_interpolate_impl< max_derivation_order< SpaceType, TimeSpaceType > >(
    result.pt, a.pt, b.pt, dp1p0, dv1v0, d_ldp1p0_v0, d_v1_ldp1p0, i_a0, i_a1, da1a0, da_term1, da_term2,
    space.get_space_topology(), space.get_time_topology(), t_factor, t_normal );
...
public:
  ...
  void compute_point( point_type& result, const point_type& start_point, const point_type& end_point,
    ...
    detail::quintic_hermite_interpolate_impl< max_derivation_order< SpaceType, TimeSpaceType > >(
      result, start_point, end_point, delta_first_order, delta_second_order, delta_lifted_first_and_second,
      delta_second_and_lifted_first, delta_integral_third_0, delta_integral_third_1, delta_third_order,
      third_order_term1, third_order_term2, space, t_space, dt_total, t_normal );
  };
...
struct get_tagged_temporal_interpolator< quintic_hermite_interpolation_tag, TemporalSpaceType > {
  typedef generic_interpolator< quintic_hermite_interp_factory< TemporalSpaceType >, quintic_hermite_interpolator >
    type;
};
...
class quintic_hermite_interp_traj
  : public interpolated_trajectory< Topology, quintic_hermite_interp_factory< Topology >, DistanceMetric > {
public:
  BOOST_CONCEPT_ASSERT( ( TemporalSpaceConcept< Topology > ) );
  BOOST_CONCEPT_ASSERT( ( TangentBundleConcept< typename temporal_space_traits< Topology >::space_topology, 2,
                                                typename temporal_space_traits< Topology >::time_topology > ) );

  typedef quintic_hermite_interp_traj< Topology, DistanceMetric > self;
  typedef interpolated_trajectory< Topology, quintic_hermite_interp_factory< Topology >, DistanceMetric >
    base_class_type;
...
public:
   ...
   */
  explicit quintic_hermite_interp_traj( const shared_ptr< topology >& aSpace = shared_ptr< topology >( new topology() ),
   ...
   * \param aDist The distance metric functor that the path should use.
   */
  quintic_hermite_interp_traj( const shared_ptr< topology >& aSpace, const point_type& aStart, const point_type& aEnd,
                               const distance_metric& aDist = distance_metric() )
  ...
  quintic_hermite_interp_traj( ForwardIter aBegin, ForwardIter aEnd, const shared_ptr< topology >& aSpace,
                               const distance_metric& aDist = distance_metric() )
