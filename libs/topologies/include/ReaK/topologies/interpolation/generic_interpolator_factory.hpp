...
template < template < typename, typename > class InterpolatorImpl, typename SpaceType, typename TimeSpaceType >
...
struct generic_interpolator_impl_tuple< arithmetic_tuple< S0, void, void, void, void, void, void, void, void, void >,
                                        InterpolatorImpl, TimeSpace > {
  typedef arithmetic_tuple< generic_interpolator_impl< InterpolatorImpl, S0, TimeSpace > > type;
};

template < typename S0, typename S1, template < typename, typename > class InterpolatorImpl, typename TimeSpace >
struct generic_interpolator_impl_tuple< arithmetic_tuple< S0, S1, void, void, void, void, void, void, void, void >,
                                        InterpolatorImpl, TimeSpace > {
  typedef arithmetic_tuple< generic_interpolator_impl< InterpolatorImpl, S0, TimeSpace >,
                            generic_interpolator_impl< InterpolatorImpl, S1, TimeSpace > > type;
};

template < typename S0, typename S1, typename S2, template < typename, typename > class InterpolatorImpl,
           typename TimeSpace >
struct generic_interpolator_impl_tuple< arithmetic_tuple< S0, S1, S2, void, void, void, void, void, void, void >,
                                        InterpolatorImpl, TimeSpace > {
  typedef arithmetic_tuple< generic_interpolator_impl< InterpolatorImpl, S0, TimeSpace >,
                            generic_interpolator_impl< InterpolatorImpl, S1, TimeSpace >,
                            generic_interpolator_impl< InterpolatorImpl, S2, TimeSpace > > type;
};

template < typename S0, typename S1, typename S2, typename S3, template < typename, typename > class InterpolatorImpl,
           typename TimeSpace >
struct generic_interpolator_impl_tuple< arithmetic_tuple< S0, S1, S2, S3, void, void, void, void, void, void >,
                                        InterpolatorImpl, TimeSpace > {
  typedef arithmetic_tuple< generic_interpolator_impl< InterpolatorImpl, S0, TimeSpace >,
                            generic_interpolator_impl< InterpolatorImpl, S1, TimeSpace >,
                            generic_interpolator_impl< InterpolatorImpl, S2, TimeSpace >,
                            generic_interpolator_impl< InterpolatorImpl, S3, TimeSpace > > type;
};
...
struct generic_interpolator_impl_tuple< arithmetic_tuple< S0, S1, S2, S3, S4, void, void, void, void, void >,
                                        InterpolatorImpl, TimeSpace > {
  typedef arithmetic_tuple< generic_interpolator_impl< InterpolatorImpl, S0, TimeSpace >,
                            generic_interpolator_impl< InterpolatorImpl, S1, TimeSpace >,
                            generic_interpolator_impl< InterpolatorImpl, S2, TimeSpace >,
                            generic_interpolator_impl< InterpolatorImpl, S3, TimeSpace >,
                            generic_interpolator_impl< InterpolatorImpl, S4, TimeSpace > > type;
};

template < typename S0, typename S1, typename S2, typename S3, typename S4, typename S5,
           template < typename, typename > class InterpolatorImpl, typename TimeSpace >
struct generic_interpolator_impl_tuple< arithmetic_tuple< S0, S1, S2, S3, S4, S5, void, void, void, void >,
                                        InterpolatorImpl, TimeSpace > {
  typedef arithmetic_tuple< generic_interpolator_impl< InterpolatorImpl, S0, TimeSpace >,
                            generic_interpolator_impl< InterpolatorImpl, S1, TimeSpace >,
                            generic_interpolator_impl< InterpolatorImpl, S2, TimeSpace >,
                            ...
                            generic_interpolator_impl< InterpolatorImpl, S5, TimeSpace > > type;
};

template < typename S0, typename S1, typename S2, typename S3, typename S4, typename S5, typename S6,
           template < typename, typename > class InterpolatorImpl, typename TimeSpace >
struct generic_interpolator_impl_tuple< arithmetic_tuple< S0, S1, S2, S3, S4, S5, S6, void, void, void >,
                                        InterpolatorImpl, TimeSpace > {
  typedef arithmetic_tuple< generic_interpolator_impl< InterpolatorImpl, S0, TimeSpace >,
                            generic_interpolator_impl< InterpolatorImpl, S1, TimeSpace >,
                            generic_interpolator_impl< InterpolatorImpl, S2, TimeSpace >,
                            ...
                            generic_interpolator_impl< InterpolatorImpl, S6, TimeSpace > > type;
};

template < typename S0, typename S1, typename S2, typename S3, typename S4, typename S5, typename S6, typename S7,
           template < typename, typename > class InterpolatorImpl, typename TimeSpace >
struct generic_interpolator_impl_tuple< arithmetic_tuple< S0, S1, S2, S3, S4, S5, S6, S7, void, void >,
                                        InterpolatorImpl, TimeSpace > {
  typedef arithmetic_tuple< generic_interpolator_impl< InterpolatorImpl, S0, TimeSpace >,
                            generic_interpolator_impl< InterpolatorImpl, S1, TimeSpace >,
                            generic_interpolator_impl< InterpolatorImpl, S2, TimeSpace >,
                            ...
                            generic_interpolator_impl< InterpolatorImpl, S7, TimeSpace > > type;
};

template < typename S0, typename S1, typename S2, typename S3, typename S4, typename S5, typename S6, typename S7,
           typename S8, template < typename, typename > class InterpolatorImpl, typename TimeSpace >
struct generic_interpolator_impl_tuple< arithmetic_tuple< S0, S1, S2, S3, S4, S5, S6, S7, S8, void >, InterpolatorImpl,
                                        TimeSpace > {
  typedef arithmetic_tuple< generic_interpolator_impl< InterpolatorImpl, S0, TimeSpace >,
                            generic_interpolator_impl< InterpolatorImpl, S1, TimeSpace >,
                            generic_interpolator_impl< InterpolatorImpl, S2, TimeSpace >,
                            ...
                            generic_interpolator_impl< InterpolatorImpl, S8, TimeSpace > > type;
};

template < typename S0, typename S1, typename S2, typename S3, typename S4, typename S5, typename S6, typename S7,
           typename S8, typename S9, template < typename, typename > class InterpolatorImpl, typename TimeSpace >
struct generic_interpolator_impl_tuple< arithmetic_tuple< S0, S1, S2, S3, S4, S5, S6, S7, S8, S9 >, InterpolatorImpl,
                                        TimeSpace > {
  typedef arithmetic_tuple< generic_interpolator_impl< InterpolatorImpl, S0, TimeSpace >,
                            generic_interpolator_impl< InterpolatorImpl, S1, TimeSpace >,
                            generic_interpolator_impl< InterpolatorImpl, S2, TimeSpace >,
                            ...
                            generic_interpolator_impl< InterpolatorImpl, S9, TimeSpace > > type;
};
...
struct gen_interp_impl_initializer {
  ...
  void operator()( Interpolator& interp, const Point& start_point, const Point& end_point, const Space& space ) const {
...
struct gen_interp_impl_computer {
  ...
  const Factory* p_factory;
  double dt, dt_total;
  gen_interp_impl_computer( const TimeSpace& t_space, const Factory& factory, double aDt, double aDtTotal )
      : p_t_space( &t_space ), p_factory( &factory ), dt( aDt ), dt_total( aDtTotal ){};
  template < typename Interpolator, typename Point, typename Space >
  void operator()( const Interpolator& interp, Point& result, const Point& start_point, const Point& end_point,
...
template < template < typename, typename > class InterpolatorImpl, typename TimeSpaceType, typename SpaceTuple,
...
public:
  typedef generic_interpolator_impl< InterpolatorImpl, metric_space_tuple< SpaceTuple, TupleDistMetric >,
                                     TimeSpaceType > self;
 ...
 */
template < typename Factory, template < typename, typename > class InterpolatorImpl >
...
private:
  ...
  void update_delta_value() {
    if( parent && start_point && end_point ) {
      ...
      interp.initialize( start_point->pt, end_point->pt, delta_time, parent->get_temporal_space()->get_space_topology(),
                         parent->get_temporal_space()->get_time_topology(), *parent );
    };
  };
...
public:
  ...
  point_type get_point_at_time( double t ) const {
    ...
    interp.compute_point( result.pt, start_point->pt, end_point->pt, parent->get_temporal_space()->get_space_topology(),
                          parent->get_temporal_space()->get_time_topology(), dt, dt_total, *parent );
