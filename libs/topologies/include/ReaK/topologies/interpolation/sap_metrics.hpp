...
struct sap_reach_time_metric : public serializable {

  typedef sap_reach_time_metric< TimeSpaceType, MakeProper > self;

  shared_ptr< TimeSpaceType > t_space;
  double tolerance;
  unsigned int maximum_iterations;

  sap_reach_time_metric( const shared_ptr< TimeSpaceType >& aTimeSpace
                         = shared_ptr< TimeSpaceType >( new TimeSpaceType() ),
                         double aTolerance = 1e-6, unsigned int aMaxIter = 60 )
      : t_space( aTimeSpace ), tolerance( aTolerance ), maximum_iterations( aMaxIter ){};
  ...
  *******************************************************************************/
  ...
  RK_RTTI_MAKE_ABSTRACT_1BASE( self, 0xC241000A, 1, "sap_reach_time_metric", serializable )
};
...
struct sap_reach_time_metric< TimeSpaceType, true > : public serializable {

  typedef sap_reach_time_metric< TimeSpaceType, true > self;

  shared_ptr< TimeSpaceType > t_space;
  double tolerance;
  unsigned int maximum_iterations;

  sap_reach_time_metric( const sap_reach_time_metric< TimeSpaceType, false >& aRHS )
      : t_space( aRHS.t_space ), tolerance( aRHS.tolerance ), maximum_iterations( aRHS.maximum_iterations ){};
...
template < typename TimeSpaceType >
struct is_metric_symmetric< sap_reach_time_metric< TimeSpaceType, false > > : boost::mpl::false_ {};

template < typename TimeSpaceType >
struct is_metric_symmetric< sap_reach_time_metric< TimeSpaceType, true > > : boost::mpl::true_ {};


template < typename TimeSpaceType, bool MakeProper >
struct get_proper_metric_from_metric< sap_reach_time_metric< TimeSpaceType, MakeProper > > {
  typedef sap_reach_time_metric< TimeSpaceType, true > type;
};
};
};
