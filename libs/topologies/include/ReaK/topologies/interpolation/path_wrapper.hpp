...
public:
   ...
   */
  explicit path_wrapper( const std::string& aName = "", const SpatialPath& aTraj = SpatialPath() )
   ...
   */
  virtual point_type get_start_point() const { return m_traj.get_start_point(); };
   ...
   */
  waypoint_pair get_start_waypoint() const { return m_traj.get_start_waypoint(); };
