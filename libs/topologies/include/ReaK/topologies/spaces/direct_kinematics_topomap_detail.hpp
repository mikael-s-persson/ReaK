...
typename boost::enable_if< is_normal_joint_space< InSpace >, void >::type
  write_one_joint_coord_impl( const PointType& pt, const InSpace&, std::size_t& gen_i, std::size_t&, std::size_t&,
...
typename boost::enable_if< is_se2_space< InSpace >, void >::type
  write_one_joint_coord_impl( const PointType& pt, const InSpace&, std::size_t&, std::size_t& f2d_i, std::size_t&,
                              const shared_ptr< kte::direct_kinematics_model >& model ) {
...
typename boost::enable_if< is_se3_space< InSpace >, void >::type
  write_one_joint_coord_impl( const PointType& pt, const InSpace&, std::size_t&, std::size_t&, std::size_t& f3d_i,
                              const shared_ptr< kte::direct_kinematics_model >& model ) {
...
typename boost::disable_if< boost::mpl::or_< is_normal_joint_space< InSpace >, is_se2_space< InSpace >,
                            ...
                            void >::type
  write_one_joint_coord_impl( const PointType& pt, const InSpace& space_in, std::size_t& gen_i, std::size_t& f2d_i,
                              std::size_t& f3d_i, const shared_ptr< kte::direct_kinematics_model >& model );

struct joint_coordinates_writer_impl {
  shared_ptr< kte::direct_kinematics_model > p_model;
  std::size_t* p_gen_i;
  std::size_t* p_f2d_i;
  std::size_t* p_f3d_i;
  joint_coordinates_writer_impl( const shared_ptr< kte::direct_kinematics_model >& model, std::size_t& gen_i,
  ...
  void operator()( const Point& pt, const Space& space ) const {
    write_one_joint_coord_impl( pt, space, *p_gen_i, *p_f2d_i, *p_f3d_i, p_model );
  };
};
...
typename boost::disable_if< boost::mpl::or_< is_normal_joint_space< InSpaceTuple >, is_se2_space< InSpaceTuple >,
                            ...
                            void >::type
  write_joint_coordinates_impl( const PointType& pt, const InSpaceTuple& space_in,
                                const shared_ptr< kte::direct_kinematics_model >& model ) {
  std::size_t gen_i = 0;
  std::size_t f2d_i = 0;
  std::size_t f3d_i = 0;
  tuple_for_each( pt, space_in, joint_coordinates_writer_impl( model, gen_i, f2d_i, f3d_i ) );
};
...
template < typename PointType, typename InSpace >
typename boost::enable_if< is_normal_joint_space< InSpace >, void >::type
  read_one_dependent_coord_impl( PointType& pt, const InSpace&, std::size_t& gen_i, std::size_t&, std::size_t&,
                                 const shared_ptr< kte::direct_kinematics_model >& model ) {
...
template < typename PointType, typename InSpace >
typename boost::enable_if< is_se2_space< InSpace >, void >::type
  read_one_dependent_coord_impl( PointType& pt, const InSpace&, std::size_t&, std::size_t& f2d_i, std::size_t&,
                                 const shared_ptr< kte::direct_kinematics_model >& model ) {
...
template < typename PointType, typename InSpace >
typename boost::enable_if< is_se3_space< InSpace >, void >::type
  read_one_dependent_coord_impl( PointType& pt, const InSpace&, std::size_t&, std::size_t&, std::size_t& f3d_i,
                                 const shared_ptr< kte::direct_kinematics_model >& model ) {
...
typename boost::disable_if< boost::mpl::or_< is_normal_joint_space< InSpace >, is_se2_space< InSpace >,
                                             is_se3_space< InSpace >, is_Ndof_space< InSpace > >,
                            void >::type
  read_one_dependent_coord_impl( PointType& pt, const InSpace& space_in, std::size_t& gen_i, std::size_t& f2d_i,
                                 std::size_t& f3d_i, const shared_ptr< kte::direct_kinematics_model >& model );

struct dep_coordinates_reader_impl {
  shared_ptr< kte::direct_kinematics_model > p_model;
  std::size_t* p_gen_i;
  std::size_t* p_f2d_i;
  std::size_t* p_f3d_i;
  dep_coordinates_reader_impl( const shared_ptr< kte::direct_kinematics_model >& model, std::size_t& gen_i,
                               std::size_t& f2d_i, std::size_t& f3d_i )
      : p_model( model ), p_gen_i( &gen_i ), p_f2d_i( &f2d_i ), p_f3d_i( &f3d_i ){};
  template < typename Point, typename Space >
  void operator()( Point& pt, const Space& space ) const {
    read_one_dependent_coord_impl( pt, space, *p_gen_i, *p_f2d_i, *p_f3d_i, p_model );
  };
};
...
typename boost::disable_if< boost::mpl::or_< is_normal_joint_space< InSpaceTuple >, is_se2_space< InSpaceTuple >,
                                             is_se3_space< InSpaceTuple >, is_Ndof_space< InSpaceTuple > >,
                            void >::type
  read_dependent_coordinates_impl( PointType& pt, const InSpaceTuple& space_in,
                                   const shared_ptr< kte::direct_kinematics_model >& model ) {
  std::size_t gen_i = 0;
  std::size_t f2d_i = 0;
  std::size_t f3d_i = 0;
  tuple_for_each( pt, space_in, dep_coordinates_reader_impl( model, gen_i, f2d_i, f3d_i ) );
};
