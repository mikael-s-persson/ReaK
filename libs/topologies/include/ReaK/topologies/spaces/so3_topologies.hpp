...
public:
   ...
   * Default constructor.
   */
  quaternion_topology( const std::string& aName = "quaternion_topology" ) : named_object() { setName( aName ); };
  ...
  * **********************************************************************/
   ...
   */
  virtual double norm( const point_difference_type& delta ) const { return ReaK::norm_2( delta ); };
...
public:
   ...
   */
  rate_limited_quat_space( const std::string& aName = "rate_limited_quat_space", double aMaxAngSpeed = 1.0 )
  ...
  * **********************************************************************/
   ...
   * Returns the norm of the difference between two points.
   */
  double norm( const point_difference_type& delta ) const { return ReaK::norm_2( delta ) / max_angular_speed; };
...
public:
   ...
   */
  ang_velocity_3D_topology( const std::string& aName = "ang_velocity_3D_topology", double aMaxAngSpeed = 1.0 )
...
public:
   ...
   */
  ang_accel_3D_topology( const std::string& aName = "ang_accel_3D_topology", double aMaxAngAcc = 1.0 )
  ...
  typedef typename boost::mpl::
    if_< boost::mpl::equal_to< boost::mpl::int_< 0 >, boost::mpl::int_< Order > >,
         ...
         typename boost::mpl::if_< boost::mpl::equal_to< boost::mpl::int_< 1 >, boost::mpl::int_< Order > >,
                                   ...
                                   typename so3_2nd_order_topology< T, DistanceMetric >::type >::type >::type type;
};
  ...
  typedef typename boost::mpl::
    if_< boost::mpl::equal_to< boost::mpl::int_< 0 >, boost::mpl::int_< Order > >,
         ...
         typename boost::mpl::if_< boost::mpl::equal_to< boost::mpl::int_< 1 >, boost::mpl::int_< Order > >,
                                   ...
                                   typename so3_2nd_order_rl_topology< T, DistanceMetric >::type >::type >::type type;
};
};
};
...
extern template class temporal_space< rate_limited_quat_space< double >, time_poisson_topology,
                                      reach_plus_time_metric >;
extern template class temporal_space< ang_velocity_3D_topology< double >, time_poisson_topology,
...
extern template class differentiable_space< time_topology, arithmetic_tuple< quaternion_topology< double > >,
...
// so3_0th_order_topology
extern template class temporal_space< differentiable_space< time_topology,
...
extern template class reach_time_diff_space< time_topology, arithmetic_tuple< rate_limited_quat_space< double > >,
                                             euclidean_tuple_distance >;
...
// so3_0th_order_rl_topology
extern template class temporal_space< reach_time_diff_space< time_topology,
