...
public:
  ...
  hyperbox_topology( const std::string& aName = "hyperbox_topology", const point_type& aLowerCorner = point_type(),
                     const point_type& aUpperCorner = point_type() )
      : vector_topology< Vector >( aName ), lower_corner( aLowerCorner ), upper_corner( aUpperCorner ){};
  ...
  *******************************************************************************/
  ...
  virtual void RK_CALL save( serialization::oarchive& A, unsigned int ) const {
    ...
    A& RK_SERIAL_SAVE_WITH_NAME( lower_corner ) & RK_SERIAL_SAVE_WITH_NAME( upper_corner );
  };

  virtual void RK_CALL load( serialization::iarchive& A, unsigned int ) {
    ReaK::named_object::load( A, named_object::getStaticObjectType()->TypeVersion() );
    A& RK_SERIAL_LOAD_WITH_NAME( lower_corner ) & RK_SERIAL_LOAD_WITH_NAME( upper_corner );
  };
...
template < typename Vector, typename DistanceMetric >
struct is_metric_symmetric< hyperbox_topology< Vector, DistanceMetric > > : is_metric_symmetric< DistanceMetric > {};
};
};
