...
struct Ndof_reach_time_differentiation : public serializable {
  ...
  Ndof_reach_time_differentiation( const Vector& aMaxRateReachTime = Vector() )
...
struct Ndof_space {
  typedef differentiable_space< time_topology,
                                arithmetic_tuple< hyperbox_topology< vect< T, Size >, manhattan_distance_metric > > >
    type;
};
...
struct Ndof_space< T, 0, 0 > {
  typedef differentiable_space< time_topology,
                                arithmetic_tuple< hyperbox_topology< vect_n< T >, manhattan_distance_metric > > > type;
};

template < typename T >
struct Ndof_space< T, 0, 1 > {
  typedef differentiable_space< time_topology,
                                arithmetic_tuple< hyperbox_topology< vect_n< T >, manhattan_distance_metric >,
                                                  hyperbox_topology< vect_n< T >, manhattan_distance_metric > > > type;
};
...
struct is_Ndof_space< differentiable_space< time_topology,
                                            arithmetic_tuple< hyperbox_topology< Vector,
...
typename Ndof_space< typename vect_traits< Vector1 >::value_type, Size, 0 >::type
  make_Ndof_space( const Vector1& aLowerBound, const Vector1& aUpperBound ) {
  typedef typename vect_traits< Vector1 >::value_type ValueType;
  typedef typename Ndof_space< ValueType, Size, 0 >::type result_type;
  return result_type( arithmetic_tuple< hyperbox_topology< vect< ValueType, Size >, manhattan_distance_metric > >(
    hyperbox_topology< vect< ValueType, Size >, manhattan_distance_metric >(
      "Ndof_0th_order_space", vect< ValueType, Size >( aLowerBound ), vect< ValueType, Size >( aUpperBound ) ) ) );
};
...
typename Ndof_space< typename vect_traits< Vector1 >::value_type, Size, 1 >::type
  make_Ndof_space( const Vector1& aLowerBound, const Vector1& aUpperBound, const Vector2& aSpeedLimit ) {
  typedef typename vect_traits< Vector1 >::value_type ValueType;
  ...
  return result_type( arithmetic_tuple< hyperbox_topology< vect< ValueType, Size >, manhattan_distance_metric >,
    ...
    hyperbox_topology< vect< ValueType, Size >, manhattan_distance_metric >(
      "Ndof_0th_order_space", vect< ValueType, Size >( aLowerBound ), vect< ValueType, Size >( aUpperBound ) ),
    hyperbox_topology< vect< ValueType, Size >, manhattan_distance_metric >(
      "Ndof_1st_order_space", vect< ValueType, Size >( -aSpeedLimit ), vect< ValueType, Size >( aSpeedLimit ) ) ) );
};
...
typename Ndof_space< typename vect_traits< Vector1 >::value_type, Size, 2 >::type
  make_Ndof_space( const Vector1& aLowerBound, const Vector1& aUpperBound, const Vector2& aSpeedLimit,
  ...
  return result_type( arithmetic_tuple< hyperbox_topology< vect< ValueType, Size >, manhattan_distance_metric >,
    ...
    hyperbox_topology< vect< ValueType, Size >, manhattan_distance_metric >(
      "Ndof_1st_order_space", vect< ValueType, Size >( -aSpeedLimit ), vect< ValueType, Size >( aSpeedLimit ) ),
    hyperbox_topology< vect< ValueType, Size >, manhattan_distance_metric >(
      "Ndof_2nd_order_space", vect< ValueType, Size >( -aAccelLimit ), vect< ValueType, Size >( aAccelLimit ) ) ) );
};
...
typename Ndof_space< typename vect_traits< Vector1 >::value_type, 0, 0 >::type
  make_Ndof_space( const Vector1& aLowerBound, const Vector1& aUpperBound ) {
  typedef typename vect_traits< Vector1 >::value_type ValueType;
  typedef typename Ndof_space< ValueType, 0, 0 >::type result_type;
  return result_type( arithmetic_tuple< hyperbox_topology< vect_n< ValueType >, manhattan_distance_metric > >(
    hyperbox_topology< vect_n< ValueType >, manhattan_distance_metric >(
      "Ndof_0th_order_space", vect_n< ValueType >( aLowerBound ), vect_n< ValueType >( aUpperBound ) ) ) );
};
...
typename Ndof_space< typename vect_traits< Vector1 >::value_type, 0, 1 >::type
  make_Ndof_space( const Vector1& aLowerBound, const Vector1& aUpperBound, const Vector2& aSpeedLimit ) {
  typedef typename vect_traits< Vector1 >::value_type ValueType;
  ...
  return result_type( arithmetic_tuple< hyperbox_topology< vect_n< ValueType >, manhattan_distance_metric >,
    ...
    hyperbox_topology< vect_n< ValueType >, manhattan_distance_metric >(
      "Ndof_0th_order_space", vect_n< ValueType >( aLowerBound ), vect_n< ValueType >( aUpperBound ) ),
    hyperbox_topology< vect_n< ValueType >, manhattan_distance_metric >(
      "Ndof_1st_order_space", vect_n< ValueType >( -aSpeedLimit ), vect_n< ValueType >( aSpeedLimit ) ) ) );
};
...
typename Ndof_space< typename vect_traits< Vector1 >::value_type, 0, 2 >::type
  make_Ndof_space( const Vector1& aLowerBound, const Vector1& aUpperBound, const Vector2& aSpeedLimit,
                   const Vector3& aAccelLimit ) {
  typedef typename vect_traits< Vector1 >::value_type ValueType;
  ...
  return result_type( arithmetic_tuple< hyperbox_topology< vect_n< ValueType >, manhattan_distance_metric >,
    ...
    hyperbox_topology< vect_n< ValueType >, manhattan_distance_metric >(
      "Ndof_1st_order_space", vect_n< ValueType >( -aSpeedLimit ), vect_n< ValueType >( aSpeedLimit ) ),
    hyperbox_topology< vect_n< ValueType >, manhattan_distance_metric >(
      "Ndof_2nd_order_space", vect_n< ValueType >( -aAccelLimit ), vect_n< ValueType >( aAccelLimit ) ) ) );
};
...
struct Ndof_rl_space {
  typedef differentiable_space< time_topology,
                                arithmetic_tuple< hyperbox_topology< vect< T, Size >, inf_norm_distance_metric > >,
                                manhattan_tuple_distance, Ndof_reach_time_differentiation< vect< T, Size > > > type;
};
...
struct Ndof_rl_space< T, 0, 0 > {
  typedef differentiable_space< time_topology,
                                ...
                                manhattan_tuple_distance, Ndof_reach_time_differentiation< vect_n< T > > > type;
};
 ...
 */
template < unsigned int Size, typename Vector1, typename Vector2 >
typename Ndof_rl_space< typename vect_traits< Vector1 >::value_type, Size, 0 >::type
  make_Ndof_rl_space( Vector1 aLowerBound, Vector1 aUpperBound, const Vector2& aSpeedLimit ) {
  typedef typename vect_traits< Vector1 >::value_type ValueType;
  ...
  return result_type( arithmetic_tuple< hyperbox_topology< vect< ValueType, Size >, inf_norm_distance_metric > >(
    hyperbox_topology< vect< ValueType, Size >, inf_norm_distance_metric >(
      "Ndof_0th_order_rl_space", vect< ValueType, Size >( aLowerBound ), vect< ValueType, Size >( aUpperBound ) ) ) );
};
 ...
 */
template < unsigned int Size, typename Vector1, typename Vector2, typename Vector3 >
typename Ndof_rl_space< typename vect_traits< Vector1 >::value_type, Size, 1 >::type
  make_Ndof_rl_space( Vector1 aLowerBound, Vector1 aUpperBound, Vector2 aSpeedLimit, const Vector3& aAccelLimit ) {
  typedef typename vect_traits< Vector1 >::value_type ValueType;
  ...
  return result_type(
    arithmetic_tuple< hyperbox_topology< vect< ValueType, Size >, inf_norm_distance_metric >,
      ...
      hyperbox_topology< vect< ValueType, Size >, inf_norm_distance_metric >(
        "Ndof_0th_order_rl_space", vect< ValueType, Size >( aLowerBound ), vect< ValueType, Size >( aUpperBound ) ),
      hyperbox_topology< vect< ValueType, Size >, inf_norm_distance_metric >(
        "Ndof_1st_order_rl_space", vect< ValueType, Size >( -aSpeedLimit ), vect< ValueType, Size >( aSpeedLimit ) ) ),
    manhattan_tuple_distance(), arithmetic_tuple< Ndof_reach_time_differentiation< vect< ValueType, Size > > >(
...
typename Ndof_rl_space< typename vect_traits< Vector1 >::value_type, Size, 2 >::type
  make_Ndof_rl_space( Vector1 aLowerBound, Vector1 aUpperBound, Vector2 aSpeedLimit, Vector3 aAccelLimit,
  ...
  return result_type(
    arithmetic_tuple< hyperbox_topology< vect< ValueType, Size >, inf_norm_distance_metric >,
      ...
      hyperbox_topology< vect< ValueType, Size >, inf_norm_distance_metric >(
        "Ndof_1st_order_rl_space", vect< ValueType, Size >( -aSpeedLimit ), vect< ValueType, Size >( aSpeedLimit ) ),
      hyperbox_topology< vect< ValueType, Size >, inf_norm_distance_metric >(
        "Ndof_2nd_order_rl_space", vect< ValueType, Size >( -aAccelLimit ), vect< ValueType, Size >( aAccelLimit ) ) ),
 ...
 */
template < typename Vector1, typename Vector2 >
typename Ndof_rl_space< typename vect_traits< Vector1 >::value_type, 0, 0 >::type
  make_Ndof_rl_space( Vector1 aLowerBound, Vector1 aUpperBound, const Vector2& aSpeedLimit ) {
  typedef typename vect_traits< Vector1 >::value_type ValueType;
  ...
  return result_type( arithmetic_tuple< hyperbox_topology< vect_n< ValueType >, inf_norm_distance_metric > >(
    hyperbox_topology< vect_n< ValueType >, inf_norm_distance_metric >(
      "Ndof_0th_order_rl_space", vect_n< ValueType >( aLowerBound ), vect_n< ValueType >( aUpperBound ) ) ) );
};
 ...
 */
template < typename Vector1, typename Vector2, typename Vector3 >
typename Ndof_rl_space< typename vect_traits< Vector1 >::value_type, 0, 1 >::type
  make_Ndof_rl_space( Vector1 aLowerBound, Vector1 aUpperBound, Vector2 aSpeedLimit, const Vector3& aAccelLimit ) {
  typedef typename vect_traits< Vector1 >::value_type ValueType;
  ...
  return result_type(
    arithmetic_tuple< hyperbox_topology< vect_n< ValueType >, inf_norm_distance_metric >,
      ...
      hyperbox_topology< vect_n< ValueType >, inf_norm_distance_metric >(
        "Ndof_0th_order_rl_space", vect_n< ValueType >( aLowerBound ), vect_n< ValueType >( aUpperBound ) ),
      hyperbox_topology< vect_n< ValueType >, inf_norm_distance_metric >(
        "Ndof_1st_order_rl_space", vect_n< ValueType >( -aSpeedLimit ), vect_n< ValueType >( aSpeedLimit ) ) ),
    manhattan_tuple_distance(),
...
typename Ndof_rl_space< typename vect_traits< Vector1 >::value_type, 0, 2 >::type
  make_Ndof_rl_space( Vector1 aLowerBound, Vector1 aUpperBound, Vector2 aSpeedLimit, Vector3 aAccelLimit,
                      const Vector4& aJerkLimit ) {
  typedef typename vect_traits< Vector1 >::value_type ValueType;
  ...
  return result_type(
    arithmetic_tuple< hyperbox_topology< vect_n< ValueType >, inf_norm_distance_metric >,
      ...
      hyperbox_topology< vect_n< ValueType >, inf_norm_distance_metric >(
        "Ndof_1st_order_rl_space", vect_n< ValueType >( -aSpeedLimit ), vect_n< ValueType >( aSpeedLimit ) ),
      hyperbox_topology< vect_n< ValueType >, inf_norm_distance_metric >(
        "Ndof_2nd_order_rl_space", vect_n< ValueType >( -aAccelLimit ), vect_n< ValueType >( aAccelLimit ) ) ),
    manhattan_tuple_distance(),
    arithmetic_tuple< Ndof_reach_time_differentiation< vect_n< ValueType > >,
...
template < typename T, unsigned int Size >
struct
  get_rate_illimited_space< differentiable_space< time_topology,
                                                  arithmetic_tuple< hyperbox_topology< vect< T, Size >,
                                                                                       inf_norm_distance_metric > >,
                                                  manhattan_tuple_distance,
...
template < typename T, unsigned int Size >
struct
  get_rate_limited_space< differentiable_space< time_topology,
                                                arithmetic_tuple< hyperbox_topology< vect< T, Size >,
                                                                                     manhattan_distance_metric > > > > {
  typedef differentiable_space< time_topology,
                                arithmetic_tuple< hyperbox_topology< vect< T, Size >, inf_norm_distance_metric > >,
...
struct
  get_rate_illimited_space< differentiable_space< time_topology,
                                                  arithmetic_tuple< hyperbox_topology< vect_n< T >,
                                                                                       inf_norm_distance_metric > >,
                                                  manhattan_tuple_distance,
...
template < typename Vector >
gen_coord< typename vect_traits< Vector >::value_type >
  get_gen_coord( const arithmetic_tuple< Vector, Vector, Vector >& pt, std::size_t i ) {
  return gen_coord< typename vect_traits< Vector >::value_type >( get< 0 >( pt )[i], get< 1 >( pt )[i],
                                                                  get< 2 >( pt )[i], 0.0 );
};

template < typename Vector >
gen_coord< typename vect_traits< Vector >::value_type > get_gen_coord( const arithmetic_tuple< Vector, Vector >& pt,
                                                                       std::size_t i ) {
  return gen_coord< typename vect_traits< Vector >::value_type >( get< 0 >( pt )[i], get< 1 >( pt )[i], 0.0, 0.0 );
};

template < typename Vector >
gen_coord< typename vect_traits< Vector >::value_type > get_gen_coord( const arithmetic_tuple< Vector >& pt,
                                                                       std::size_t i ) {
  return gen_coord< typename vect_traits< Vector >::value_type >( get< 0 >( pt )[i], 0.0, 0.0, 0.0 );
};
...
template < typename Vector >
const typename vect_traits< Vector >::value_type& get_position( const arithmetic_tuple< Vector, Vector, Vector >& pt,
                                                                std::size_t i ) {
  return get< 0 >( pt )[i];
};

template < typename Vector >
const typename vect_traits< Vector >::value_type& get_position( const arithmetic_tuple< Vector, Vector >& pt,
                                                                std::size_t i ) {
  return get< 0 >( pt )[i];
};

template < typename Vector >
const typename vect_traits< Vector >::value_type& get_position( const arithmetic_tuple< Vector >& pt, std::size_t i ) {
  return get< 0 >( pt )[i];
};
...
template < typename Vector >
const typename vect_traits< Vector >::value_type& get_velocity( const arithmetic_tuple< Vector, Vector, Vector >& pt,
                                                                std::size_t i ) {
  return get< 1 >( pt )[i];
};

template < typename Vector >
const typename vect_traits< Vector >::value_type& get_velocity( const arithmetic_tuple< Vector, Vector >& pt,
                                                                std::size_t i ) {
  return get< 1 >( pt )[i];
};
...
template < typename Vector >
const typename vect_traits< Vector >::value_type&
  get_acceleration( const arithmetic_tuple< Vector, Vector, Vector >& pt, std::size_t i ) {
  return get< 2 >( pt )[i];
};

template < typename Vector >
void set_acceleration( arithmetic_tuple< Vector, Vector, Vector >& pt, std::size_t i,
                       const typename vect_traits< Vector >::value_type& p ) {
  get< 2 >( pt )[i] = p;
};
};
...
#define RK_JOINT_SPACE_NDOF_LIMITS_EXT_MAKE_MEMBER_FUNC( NDOF )                                                \
                                                                                                               \
  extern template Ndof_rl_space< double, NDOF, 0 >::type joint_limits_mapping< double >::make_rl_joint_space(  \
    const Ndof_space< double, NDOF, 0 >::type& ) const;                                                        \
  extern template Ndof_rl_space< double, NDOF, 1 >::type joint_limits_mapping< double >::make_rl_joint_space(  \
    const Ndof_space< double, NDOF, 1 >::type& ) const;                                                        \
  extern template Ndof_rl_space< double, NDOF, 2 >::type joint_limits_mapping< double >::make_rl_joint_space(  \
    const Ndof_space< double, NDOF, 2 >::type& ) const;                                                        \
                                                                                                               \
  extern template Ndof_space< double, NDOF, 0 >::type joint_limits_mapping< double >::make_normal_joint_space( \
    const Ndof_rl_space< double, NDOF, 0 >::type& ) const;                                                     \
  extern template Ndof_space< double, NDOF, 1 >::type joint_limits_mapping< double >::make_normal_joint_space( \
    const Ndof_rl_space< double, NDOF, 1 >::type& ) const;                                                     \
  extern template Ndof_space< double, NDOF, 2 >::type joint_limits_mapping< double >::make_normal_joint_space( \
    const Ndof_rl_space< double, NDOF, 2 >::type& ) const;                                                     \
                                                                                                               \
  extern template topology_traits< Ndof_rl_space< double, NDOF, 0 >::type >::point_type                        \
  ...
  extern template topology_traits< Ndof_rl_space< double, NDOF, 1 >::type >::point_type                        \
    joint_limits_mapping< double >::map_to_space(                                                              \
  ...
  extern template topology_traits< Ndof_rl_space< double, NDOF, 2 >::type >::point_type                        \
    joint_limits_mapping< double >::map_to_space(                                                              \
      ...
      const Ndof_space< double, NDOF, 2 >::type&, const Ndof_rl_space< double, NDOF, 2 >::type& ) const;       \
                                                                                                               \
  extern template topology_traits< Ndof_space< double, NDOF, 0 >::type >::point_type                           \
    joint_limits_mapping< double >::map_to_space(                                                              \
  ...
  extern template topology_traits< Ndof_space< double, NDOF, 1 >::type >::point_type                           \
    joint_limits_mapping< double >::map_to_space(                                                              \
  ...
  extern template topology_traits< Ndof_space< double, NDOF, 2 >::type >::point_type                           \
    joint_limits_mapping< double >::map_to_space(                                                              \
