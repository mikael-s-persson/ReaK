...
\
extern template Ndof_rl_space<double,NDOF,0>::type joint_limits_mapping<double>::make_rl_joint_space(const Ndof_space<double,NDOF,0>::type&) const;\
extern template Ndof_rl_space<double,NDOF,1>::type joint_limits_mapping<double>::make_rl_joint_space(const Ndof_space<double,NDOF,1>::type&) const;\
extern template Ndof_rl_space<double,NDOF,2>::type joint_limits_mapping<double>::make_rl_joint_space(const Ndof_space<double,NDOF,2>::type&) const;\
\
extern template Ndof_space<double,NDOF,0>::type joint_limits_mapping<double>::make_normal_joint_space(const Ndof_rl_space<double,NDOF,0>::type&) const;\
extern template Ndof_space<double,NDOF,1>::type joint_limits_mapping<double>::make_normal_joint_space(const Ndof_rl_space<double,NDOF,1>::type&) const;\
extern template Ndof_space<double,NDOF,2>::type joint_limits_mapping<double>::make_normal_joint_space(const Ndof_rl_space<double,NDOF,2>::type&) const;\
\
extern template \
topology_traits< Ndof_rl_space<double,NDOF,0>::type >::point_type \
  joint_limits_mapping<double>::map_to_space(const topology_traits< Ndof_space<double,NDOF,0>::type >::point_type& pt,\
...
topology_traits< Ndof_rl_space<double,NDOF,1>::type >::point_type \
  joint_limits_mapping<double>::map_to_space(const topology_traits< Ndof_space<double,NDOF,1>::type >::point_type& pt,\
...
topology_traits< Ndof_rl_space<double,NDOF,2>::type >::point_type \
  joint_limits_mapping<double>::map_to_space(const topology_traits< Ndof_space<double,NDOF,2>::type >::point_type& pt,\
...
topology_traits< Ndof_space<double,NDOF,0>::type >::point_type \
  joint_limits_mapping<double>::map_to_space(const topology_traits< Ndof_rl_space<double,NDOF,0>::type >::point_type& pt,\
...
topology_traits< Ndof_space<double,NDOF,1>::type >::point_type \
  joint_limits_mapping<double>::map_to_space(const topology_traits< Ndof_rl_space<double,NDOF,1>::type >::point_type& pt,\
...
topology_traits< Ndof_space<double,NDOF,2>::type >::point_type \
  joint_limits_mapping<double>::map_to_space(const topology_traits< Ndof_rl_space<double,NDOF,2>::type >::point_type& pt,\
