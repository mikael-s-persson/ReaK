...
struct default_differentiation_rule : public serializable {
  ...
  *******************************************************************************/
  ...
  RK_RTTI_MAKE_ABSTRACT_1BASE( default_differentiation_rule, 0xC2420000, 1, "default_differentiation_rule",
                               serializable )
};
...
struct differentiation_rule_array< 2, DiffRule > {
  typedef arithmetic_tuple< DiffRule, DiffRule > type;
};

template < typename DiffRule >
struct differentiation_rule_array< 3, DiffRule > {
  typedef arithmetic_tuple< DiffRule, DiffRule, DiffRule > type;
};

template < typename DiffRule >
struct differentiation_rule_array< 4, DiffRule > {
  typedef arithmetic_tuple< DiffRule, DiffRule, DiffRule, DiffRule > type;
};

template < typename DiffRule >
struct differentiation_rule_array< 5, DiffRule > {
  typedef arithmetic_tuple< DiffRule, DiffRule, DiffRule, DiffRule, DiffRule > type;
};

template < typename DiffRule >
struct differentiation_rule_array< 6, DiffRule > {
  typedef arithmetic_tuple< DiffRule, DiffRule, DiffRule, DiffRule, DiffRule, DiffRule > type;
};

template < typename DiffRule >
struct differentiation_rule_array< 7, DiffRule > {
  typedef arithmetic_tuple< DiffRule, DiffRule, DiffRule, DiffRule, DiffRule, DiffRule, DiffRule > type;
};

template < typename DiffRule >
struct differentiation_rule_array< 8, DiffRule > {
  typedef arithmetic_tuple< DiffRule, DiffRule, DiffRule, DiffRule, DiffRule, DiffRule, DiffRule, DiffRule > type;
};

template < typename DiffRule >
struct differentiation_rule_array< 9, DiffRule > {
  typedef arithmetic_tuple< DiffRule, DiffRule, DiffRule, DiffRule, DiffRule, DiffRule, DiffRule, DiffRule, DiffRule >
    type;
};
...
public:
  typedef typename differentiation_rule_array< arithmetic_tuple_size< SpaceTuple >::type::value - 1, DiffRule >::type
    diff_rule_tuple;
...
public:
  ...
  differentiable_space( const SpaceTuple& aSpaces = SpaceTuple(),
      ...
      : base_type( aSpaces, aDist ), m_diff_rules( aDiffRules ){};
...
struct is_metric_space< differentiable_space< IndependentSpace, SpaceTuple, TupleDistanceMetric, DiffRule > >
  : boost::mpl::true_ {};
...
template < typename IndependentSpace, typename SpaceTuple, typename TupleDistanceMetric, typename DiffRule >
struct is_point_distribution< differentiable_space< IndependentSpace, SpaceTuple, TupleDistanceMetric, DiffRule > >
  : boost::mpl::true_ {};
...
template < typename SpaceTuple, typename TupleDistanceMetric, typename DiffRule, typename IndependentSpace,
           typename IndependentSpace2, std::size_t Order >
struct derived_N_order_space< differentiable_space< IndependentSpace, SpaceTuple, TupleDistanceMetric, DiffRule >,
...
typename boost::enable_if< boost::is_convertible< const IndependentSpace2&, const IndependentSpace& >,
                           const typename arithmetic_tuple_element< Idx, SpaceTuple >::type& >::type
#endif
  get_space( const differentiable_space< IndependentSpace, SpaceTuple, TupleDistanceMetric, DiffRule >& s,
...
typename boost::enable_if< boost::is_convertible< const IndependentSpace2&, const IndependentSpace& >,
                           typename arithmetic_tuple_element< Idx, SpaceTuple >::type& >::type
#endif
  get_space( differentiable_space< IndependentSpace, SpaceTuple, TupleDistanceMetric, DiffRule >& s,
             const IndependentSpace2& ) {
  return get_space< Idx >( s );
};
...
typename boost::enable_if< boost::is_convertible< const IndependentSpace2&, const IndependentSpace& >,
                           const DiffRule& >::type
#endif
  get_diff_rule( const differentiable_space< IndependentSpace, SpaceTuple, TupleDistanceMetric, DiffRule >& s,
                 const IndependentSpace2& ) {
...
typename std::enable_if< std::is_convertible< const IndependentSpace2&, const IndependentSpace& >::value,
                         DiffRule& >::type
#else
typename boost::enable_if< boost::is_convertible< const IndependentSpace2&, const IndependentSpace& >, DiffRule& >::type
#endif
  get_diff_rule( differentiable_space< IndependentSpace, SpaceTuple, TupleDistanceMetric, DiffRule >& s,
                 const IndependentSpace2& ) {
  return s.template get_diff_rule_impl< Idx >();
};
...
#ifndef BOOST_NO_CXX11_HDR_TYPE_TRAITS
typename boost::
  lazy_enable_if< std::is_convertible< const IndependentSpace2&, const IndependentSpace& >,
                  arithmetic_tuple_element< Idx, typename differentiable_space< IndependentSpace, SpaceTuple,
                                                                                TupleDistanceMetric,
                                                                                DiffRule >::point_type > >::type
#else
typename boost::
  lazy_enable_if< boost::is_convertible< const IndependentSpace2&, const IndependentSpace& >,
                  arithmetic_tuple_element< Idx, typename differentiable_space< IndependentSpace, SpaceTuple,
                                                                                TupleDistanceMetric,
                                                                                DiffRule >::point_type > >::type
#endif
...
struct arithmetic_tuple_size< pp::differentiable_space< IndependentSpace, SpaceTuple, TupleDistanceMetric,
                                                        DiffRuleTuple > > : arithmetic_tuple_size< SpaceTuple > {};


/* Specialization, see general template docs. */
template < int Idx, typename IndependentSpace, typename SpaceTuple, typename TupleDistanceMetric,
           typename DiffRuleTuple >
struct arithmetic_tuple_element< Idx, pp::differentiable_space< IndependentSpace, SpaceTuple, TupleDistanceMetric,
                                                                DiffRuleTuple > > {
  typedef typename arithmetic_tuple_element< Idx, SpaceTuple >::type type;
};
...
template < int Idx, typename IndependentSpace, typename SpaceTuple, typename TupleDistanceMetric,
           typename DiffRuleTuple >
struct arithmetic_tuple_element< Idx, const pp::differentiable_space< IndependentSpace, SpaceTuple, TupleDistanceMetric,
                                                                      DiffRuleTuple > > {
...
template < int Idx, typename IndependentSpace, typename SpaceTuple, typename TupleDistanceMetric,
           typename DiffRuleTuple >
struct arithmetic_tuple_element< Idx, volatile pp::differentiable_space< IndependentSpace, SpaceTuple,
...
template < int Idx, typename IndependentSpace, typename SpaceTuple, typename TupleDistanceMetric,
           typename DiffRuleTuple >
struct arithmetic_tuple_element< Idx, const volatile pp::differentiable_space< IndependentSpace, SpaceTuple,
                                                                               TupleDistanceMetric, DiffRuleTuple > > {
