/**
 * \file manip_3R3R_workspaces.hpp
 *
...
#ifndef REAK_MANIP_3R3R_WORKSPACES_HPP
#define REAK_MANIP_3R3R_WORKSPACES_HPP
...
struct manip_pp_traits< kte::manip_3R3R_kinematics, Order > {
  ...
  typedef typename Ndof_rl_space< double, 6, Order >::type rl_jt_space_type;
  typedef typename Ndof_space< double, 6, Order >::type jt_space_type;
