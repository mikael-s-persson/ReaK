...
int main( int argc, char** argv ) {
  ...
  output_options.add_options()( "geometry", "specify that the geometry should be outputted (default is not)" )(
    "proxy",
    "specify that the proximity-query model (simplified bounding-geometry) should be outputted (default is not)" )(
    "kte-model", "specify that the KTE kinematics model should be outputted (with limits) (default is not)" )(
    "all-assembled", "specify that the KTE kinematics + geometry + proximity-query models should be outputted (with "
  ...
  if( vm.count( "help" ) || ( vm.count( "geometry" ) + vm.count( "proxy" ) + vm.count( "kte-model" )
                              + vm.count( "all-assembled" ) < 1 ) ) {
  ...
  if( vm.count( "geometry" ) + vm.count( "proxy" ) + vm.count( "all-assembled" ) > 0 ) {
    ...
    shared_ptr< coord_arrows_3D > robot_base_arrows(
      new coord_arrows_3D( "robot_base_arrows", shared_ptr< frame_3D< double > >(), pose_3D< double >(), 0.3 ) );
    shared_ptr< coord_arrows_3D > track_joint_arrows(
      new coord_arrows_3D( "track_joint_arrows", shared_ptr< frame_3D< double > >(), pose_3D< double >(), 0.3 ) );
    shared_ptr< coord_arrows_3D > arm_joint_1_arrows(
      new coord_arrows_3D( "arm_joint_1_arrows", shared_ptr< frame_3D< double > >(), pose_3D< double >(), 0.3 ) );
    shared_ptr< coord_arrows_3D > arm_joint_2_arrows(
      new coord_arrows_3D( "arm_joint_2_arrows", shared_ptr< frame_3D< double > >(), pose_3D< double >(), 0.3 ) );
    shared_ptr< coord_arrows_3D > arm_joint_3_arrows(
      new coord_arrows_3D( "arm_joint_3_arrows", shared_ptr< frame_3D< double > >(), pose_3D< double >(), 0.3 ) );
    shared_ptr< coord_arrows_3D > arm_joint_4_arrows(
      new coord_arrows_3D( "arm_joint_4_arrows", shared_ptr< frame_3D< double > >(), pose_3D< double >(), 0.3 ) );
    shared_ptr< coord_arrows_3D > arm_joint_5_arrows(
      new coord_arrows_3D( "arm_joint_5_arrows", shared_ptr< frame_3D< double > >(), pose_3D< double >(), 0.3 ) );
    shared_ptr< coord_arrows_3D > arm_joint_6_arrows(
      new coord_arrows_3D( "arm_joint_6_arrows", shared_ptr< frame_3D< double > >(), pose_3D< double >(), 0.3 ) );

    shared_ptr< capped_cylinder > link1_cyl( new capped_cylinder(
      "link1_cyl", shared_ptr< frame_3D< double > >(),
      pose_3D< double >( weak_ptr< pose_3D< double > >(), vect< double, 3 >( 0.0, 0.0, 0.15 ), quaternion< double >() ),
      0.3, 0.1 ) );
    shared_ptr< capped_cylinder > joint2_cyl( new capped_cylinder(
      "joint2_cyl", shared_ptr< frame_3D< double > >(),
      pose_3D< double >( weak_ptr< pose_3D< double > >(), vect< double, 3 >( 0.0, 0.0, 0.3302 ),
                         axis_angle< double >( M_PI * 0.5, vect< double, 3 >( 1.0, 0.0, 0.0 ) ).getQuaternion() ),
      0.34, 0.09 ) );
    shared_ptr< capped_cylinder > link2_cyl( new capped_cylinder(
      "link2_cyl", shared_ptr< frame_3D< double > >(),
      pose_3D< double >( weak_ptr< pose_3D< double > >(), vect< double, 3 >( 0.0, 0.0, 0.15 ), quaternion< double >() ),
      0.3, 0.07 ) );
    shared_ptr< capped_cylinder > link3_cyl(
      new capped_cylinder( "link3_cyl", shared_ptr< frame_3D< double > >(),
                           pose_3D< double >( weak_ptr< pose_3D< double > >(), vect< double, 3 >( 0.0, 0.0, 0.165 ),
                                              quaternion< double >() ),
                           0.33, 0.07 ) );
    shared_ptr< capped_cylinder > link3_wire_cyl( new capped_cylinder(
      "link3_wire_cyl", shared_ptr< frame_3D< double > >(),
      pose_3D< double >( weak_ptr< pose_3D< double > >(), vect< double, 3 >( 0.0, 0.1, 0.05 ),
                         axis_angle< double >( M_PI * 0.5, vect< double, 3 >( 1.0, 0.0, 0.0 ) ).getQuaternion() ),
      0.15, 0.075 ) );
    shared_ptr< capped_cylinder > link5_cyl(
      new capped_cylinder( "link5_cyl", shared_ptr< frame_3D< double > >(),
                           pose_3D< double >( weak_ptr< pose_3D< double > >(), vect< double, 3 >( 0.0, 0.0, 0.0381 ),
                                              quaternion< double >() ),
                           0.0762, 0.05 ) );
    shared_ptr< sphere > EE_sphere(
      new sphere( "EE_sphere", shared_ptr< frame_3D< double > >(),
                  pose_3D< double >( weak_ptr< pose_3D< double > >(), vect< double, 3 >( -0.04, 0.0, 0.05 ),
                                     quaternion< double >() ),
                  0.11 ) );

    shared_ptr< box > EE_bumblebee(
      new box( "EE_bumblebee", shared_ptr< frame_3D< double > >(),
               pose_3D< double >( weak_ptr< pose_3D< double > >(), vect< double, 3 >( -0.105, 0.0, 0.0483 ),
                                  quaternion< double >() ),
               vect< double, 3 >( 0.04, 0.14, 0.04 ) ) );
    shared_ptr< box > EE_bumblebee_support(
      new box( "EE_bumblebee_support", shared_ptr< frame_3D< double > >(),
               pose_3D< double >( weak_ptr< pose_3D< double > >(), vect< double, 3 >( -0.0525, 0.0, 0.0393 ),
                                  quaternion< double >() ),
               vect< double, 3 >( 0.065, 0.06, 0.03 ) ) );
    shared_ptr< box > EE_gripper_box(
      new box( "EE_gripper_box", shared_ptr< frame_3D< double > >(),
               pose_3D< double >( weak_ptr< pose_3D< double > >(), vect< double, 3 >( 0.0, 0.0, 0.0669 ),
                                  quaternion< double >() ),
               vect< double, 3 >( 0.04, 0.08, 0.1338 ) ) );
    shared_ptr< box > EE_gripper_fingers(
      new box( "EE_gripper_fingers", shared_ptr< frame_3D< double > >(),
               pose_3D< double >( weak_ptr< pose_3D< double > >(), vect< double, 3 >( 0.0, 0.0, 0.1588 ),
                                  quaternion< double >() ),
  ...
  if( vm.count( "kte-model" ) + vm.count( "all-assembled" ) > 0 ) {
    ...
    shared_ptr< manip_P3R3R_kinematics > kte_model( new manip_P3R3R_kinematics(
      "CRS_A465_kte_model",
      ...
      vect_n< double >( // aJointLowerBounds
        0.0, -3.05432619099, -1.57079632679, -1.91986217719, -3.14159265359, -1.83259571459, -3.14159265359 ),
      vect_n< double >( // aJointUpperBounds
        3.0, 3.05432619099, 1.57079632679, 1.91986217719, 3.14159265359, 1.83259571459, 3.14159265359 ) ) );
