...
class KTEModelViewerEditor : public QMainWindow {
  ...
  private:
    ...
    void saveKTEChainGeometry(serialization::oarchive& out, const std::string& mdl_name, const shared_ptr< kte::kte_chain_geometry_3D >& kte_geom);
    void saveGeometricModel(serialization::oarchive& out, const std::string& mdl_name, const shared_ptr< geom::colored_model_3D >& geom_mdl);
    void saveProximityModel(serialization::oarchive& out, const std::string& mdl_name, const shared_ptr< geom::proxy_query_model_3D >& prox_mdl);
    void saveDirectKinModel(serialization::oarchive& out, const std::string& mdl_name, const shared_ptr< kte::direct_kinematics_model >& dk_mdl);
    void saveInverseKinModel(serialization::oarchive& out, const std::string& mdl_name, const shared_ptr< kte::inverse_kinematics_model >& ik_mdl);
    void saveDynamicsModel(serialization::oarchive& out, const std::string& mdl_name, const shared_ptr< kte::inverse_dynamics_model >& dyn_mdl);
