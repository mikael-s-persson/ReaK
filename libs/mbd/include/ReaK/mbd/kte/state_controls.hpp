...
public:
   ...
   */
  position_control_gen( const std::string& aName, const shared_ptr< ReaK::gen_coord< double > >& aAnchor )
      : kte_map( aName ), system_input( aName ), mAnchor( aAnchor ), mPosDesired( 0.0 ){};
...
public:
  ...
  position_control_2D( const std::string& aName = "" )
      : kte_map( aName ), system_input( aName ), mAnchor(), mPosDesired(){};
   ...
   * \param aAnchor the coordinate from which position is measured.
   */
  position_control_2D( const std::string& aName, const shared_ptr< ReaK::frame_2D< double > >& aAnchor )
      : kte_map( aName ), system_input( aName ), mAnchor( aAnchor ), mPosDesired(){};
...
public:
   ...
   * \param aAnchor the coordinate from which position is measured.
   */
  position_control_3D( const std::string& aName, const shared_ptr< ReaK::frame_3D< double > >& aAnchor )
      : kte_map( aName ), system_input( aName ), mAnchor( aAnchor ), mPosDesired(){};
...
public:
  ...
  rotation_control_2D( const std::string& aName = "" )
      : kte_map( aName ), system_input( aName ), mAnchor(), mAngleDesired(){};
   ...
   * \param aAnchor the coordinate from which position is measured.
   */
  rotation_control_2D( const std::string& aName, const shared_ptr< ReaK::frame_2D< double > >& aAnchor )
      : kte_map( aName ), system_input( aName ), mAnchor( aAnchor ), mAngleDesired(){};
...
public:
  ...
  rotation_control_3D( const std::string& aName = "" )
      : kte_map( aName ), system_input( aName ), mAnchor(), mQuatDesired(){};
   ...
   * \param aAnchor the coordinate from which position is measured.
   */
  rotation_control_3D( const std::string& aName, const shared_ptr< ReaK::frame_3D< double > >& aAnchor )
      : kte_map( aName ), system_input( aName ), mAnchor( aAnchor ), mQuatDesired(){};
...
public:
  ...
  velocity_control_gen( const std::string& aName = "" )
      : kte_map( aName ), system_input( aName ), mAnchor(), mVelDesired( 0.0 ){};
   ...
   * \param aAnchor the coordinate from which position is measured.
   */
  velocity_control_gen( const std::string& aName, const shared_ptr< ReaK::gen_coord< double > >& aAnchor )
      : kte_map( aName ), system_input( aName ), mAnchor( aAnchor ), mVelDesired( 0.0 ){};
...
public:
  ...
  velocity_control_2D( const std::string& aName = "" )
      : kte_map( aName ), system_input( aName ), mAnchor(), mVelDesired(){};
   ...
   * \param aAnchor the coordinate from which position is measured.
   */
  velocity_control_2D( const std::string& aName, const shared_ptr< ReaK::frame_2D< double > >& aAnchor )
      : kte_map( aName ), system_input( aName ), mAnchor( aAnchor ), mVelDesired(){};
...
public:
   ...
   * \param aAnchor the coordinate from which position is measured.
   */
  velocity_control_3D( const std::string& aName, const shared_ptr< ReaK::frame_3D< double > >& aAnchor )
      : kte_map( aName ), system_input( aName ), mAnchor( aAnchor ), mVelDesired(){};
...
public:
  ...
  virtual unsigned int getInputCount() const { return 1; };
  virtual void setInput( unsigned int i, double aValue ) { mAngVelDesired = aValue; };
  virtual double getInput( unsigned int i ) const { return mAngVelDesired; };

  /**
   * Default constructor.
   */
  ang_velocity_control_2D( const std::string& aName = "" )
      : kte_map( aName ), system_input( aName ), mAnchor(), mAngVelDesired(){};
   ...
   * \param aAnchor the coordinate from which position is measured.
   */
  ang_velocity_control_2D( const std::string& aName, const shared_ptr< ReaK::frame_2D< double > >& aAnchor )
      : kte_map( aName ), system_input( aName ), mAnchor( aAnchor ), mAngVelDesired(){};
  ...
  RK_RTTI_MAKE_CONCRETE_2BASE( ang_velocity_control_2D, 0xC210004B, 1, "ang_velocity_control_2D", kte_map,
                               system_input )
};
...
public:
   ...
   * \param aAnchor the coordinate from which position is measured.
   */
  ang_velocity_control_3D( const std::string& aName, const shared_ptr< ReaK::frame_3D< double > >& aAnchor )
      : kte_map( aName ), system_input( aName ), mAnchor( aAnchor ), mAngVelDesired(){};
  ...
  RK_RTTI_MAKE_CONCRETE_2BASE( ang_velocity_control_3D, 0xC210004C, 1, "ang_velocity_control_3D", kte_map,
                               system_input )
};
};
};
