...
public:
  ...
  */
   ...
   */
  vmc_revolute_joint_2D( const std::string& aName, const shared_ptr< gen_coord< double > >& aAngle,
...
public:
   ...
   * \param aSlipVelocity the micro-slip tolerance in joint speed.
   */
  vmc_revolute_joint_3D( const std::string& aName, const shared_ptr< gen_coord< double > >& aAngle,
