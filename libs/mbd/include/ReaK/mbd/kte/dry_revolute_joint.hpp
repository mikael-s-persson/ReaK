...
class dry_revolute_joint_2D : public revolute_joint_2D {
  ...
  public:
     ...
     * Default constructor.
     */
    dry_revolute_joint_2D(const std::string& aName = "") : revolute_joint_2D(aName), mStictionCoef(0.5), mSlipCoef(0.3), mSlipVelocity(1E-5) { };
...
class dry_revolute_joint_3D : public revolute_joint_3D {
  ...
  public:
     ...
     * Default constructor.
     */
    dry_revolute_joint_3D(const std::string& aName = "") : revolute_joint_3D(aName), mStictionCoef(0.5), mSlipCoef(0.3), mSlipVelocity(1E-5) { };
