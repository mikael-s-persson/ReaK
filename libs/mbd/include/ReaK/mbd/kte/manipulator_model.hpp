...
public:
  ...
  manipulator_kinematics_model( const std::string& aName = "" )
      : kte_map( aName ), mCoords(), mFrames2D(), mFrames3D(), mDependentGenCoords(), mDependent2DFrames(),
        mDependent3DFrames(), mModel(){};
...
public:
  ...
  RK_RTTI_MAKE_CONCRETE_2BASE( manipulator_dynamics_model, 0xC210FFFF, 1, "manipulator_dynamics_model",
                               manipulator_kinematics_model, state_rate_function< double > )
};
};
};
