...
public:
  ...
  manip_SSRMS_kinematics(
    ...
    = vect_n< double >( -1.5 * M_PI, -1.5 * M_PI, -1.5 * M_PI, -1.5 * M_PI, -1.5 * M_PI, -1.5 * M_PI, -1.5 * M_PI ),
  ...
  RK_RTTI_MAKE_CONCRETE_1BASE( manip_SSRMS_kinematics, 0xC2100056, 1, "manip_SSRMS_kinematics",
