...
public:
  ...
  virtual shared_ptr< frame_2D< double > > getFrame2D( std::size_t i ) const { return m_state_frame; };
  ...
  RK_RTTI_MAKE_CONCRETE_1BASE( free_floater_2D_kinematics, 0xC210005B, 1, "free_floater_2D_kinematics",
...
public:
  ...
  virtual shared_ptr< frame_3D< double > > getFrame3D( std::size_t i ) const { return m_state_frame; };
  ...
  RK_RTTI_MAKE_CONCRETE_1BASE( free_floater_3D_kinematics, 0xC210005C, 1, "free_floater_3D_kinematics",
                               inverse_kinematics_model )
};
};
};
