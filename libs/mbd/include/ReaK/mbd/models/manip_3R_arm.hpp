...
public:
  ...
  manip_3R_2D_kinematics( const std::string& aName = "",
                          ...
                          double aLink1Length = 1.0, double aLink2Length = 1.0, double aLink3Length = 0.0 );
  ...
  virtual shared_ptr< joint_dependent_frame_2D > getDependentFrame2D( std::size_t i ) const { return m_EE; };
  ...
  RK_RTTI_MAKE_CONCRETE_1BASE( manip_3R_2D_kinematics, 0xC2100052, 1, "manip_3R_2D_kinematics",
...
public:
  ...
  manip_3R_3D_kinematics( const std::string& aName = "",
                          ...
                          double aLink1Length = 1.0, double aLink1DZ = 0.0, double aLink2Length = 1.0,
                          double aLink2DZ = 0.0, double aLink3Length = 0.0, double aLink3DZ = 0.0 );
  ...
  RK_RTTI_MAKE_CONCRETE_1BASE( manip_3R_3D_kinematics, 0xC2100053, 1, "manip_3R_3D_kinematics",
                               inverse_kinematics_model )
};
};
};
