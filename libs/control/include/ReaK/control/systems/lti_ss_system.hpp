...
public:
   ...
   */
  lti_system_ss( const self& rhs ) : A( rhs.A ), B( rhs.B ), C( rhs.C ), D( rhs.D ) { setName( rhs.getName() ); };
  ...
  lti_system_ss(
    const MatrixA& aA, const MatrixB& aB, const MatrixC& aC, const MatrixD& aD, const std::string& aName = "",
  ...
  typename boost::enable_if_c< is_writable_matrix< MatrixA >::value && is_writable_matrix< MatrixB >::value
                               && is_writable_matrix< MatrixC >::value && is_writable_matrix< MatrixD >::value,
                               void >::type
    get_linear_blocks( MatrixA& aA, MatrixB& aB, MatrixC& aC, MatrixD& aD ) const {
    aA = A;
    aB = B;
    aC = C;
    aD = D;
  ...
  typename boost::enable_if_c< is_writable_matrix< MatrixA >::value && is_writable_matrix< MatrixB >::value
                               && is_writable_matrix< MatrixC >::value && is_writable_matrix< MatrixD >::value,
                               void >::type
    get_linear_blocks( MatrixA& aA, MatrixB& aB, MatrixC& aC, MatrixD& aD, const StateSpaceType&, const time_type& = 0,
  ...
  virtual void RK_CALL save( ReaK::serialization::oarchive& aA, unsigned int ) const {
    ...
    aA& RK_SERIAL_SAVE_WITH_NAME( A ) & RK_SERIAL_SAVE_WITH_NAME( B ) & RK_SERIAL_SAVE_WITH_NAME( C )
  ...
  virtual void RK_CALL load( ReaK::serialization::iarchive& aA, unsigned int ) {
    ...
    aA& RK_SERIAL_LOAD_WITH_NAME( A ) & RK_SERIAL_LOAD_WITH_NAME( B ) & RK_SERIAL_LOAD_WITH_NAME( C )
