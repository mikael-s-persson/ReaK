...
public:
   ...
   */
  quadrotor_system( const std::string& aName = "", double aMass = 1.0,
   ...
   */
  point_derivative_type get_state_derivative( const state_space_type& space, const point_type& x, const input_type& u,
   ...
   * \param x The current state of the quad-rotor.
   */
  void get_linear_blocks( matrixA_type& A, matrixB_type& B, matrixC_type& C, matrixD_type& D,
                          const state_space_type& space, const time_type& t, const point_type& x,
