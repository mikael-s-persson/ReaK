...
struct invariant_system_traits {
  ...
  BOOST_STATIC_CONSTANT( std::size_t,
                         invariant_correction_dimensions = InvariantSystem::invariant_correction_dimensions );
};
...
struct InvariantDiscreteSystemConcept
  : DiscreteLinearSSSConcept< InvariantDiscreteSystem, StateSpaceType, DiscreteLinearizedSystemType > {
  ...
  BOOST_CONCEPT_USAGE( InvariantDiscreteSystemConcept ) {
    ...
    typedef typename mat_traits< typename invariant_system_traits< InvariantDiscreteSystem >::invariant_frame_type >::
...
struct InvariantContinuousSystemConcept
  : LinearSSSystemConcept< InvariantContinuousSystem, StateSpaceType, LinearizedSystemType > {
  ...
  BOOST_CONCEPT_USAGE( InvariantContinuousSystemConcept ) {
    ...
    typedef typename mat_traits< typename invariant_system_traits< InvariantContinuousSystem >::invariant_frame_type >::
      value_type ValueType;
