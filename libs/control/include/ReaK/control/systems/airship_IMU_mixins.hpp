...
public:
  state_space_type create_state_space() const {
    return pp::hyperball_topology< vect< double, 3 > >( "gyros_bias_param_space", vect< double, 3 >( 0.0, 0.0, 0.0 ),
...
public:
  ...
  typename boost::enable_if< typename FlyWeight::state_models_type::template has_system< gyros_bias_state_model >,
                             void >::type
    add_output_from_state_for_gb( const FlyWeight& params, const StateSpaceType& space,
    ...
    if( !is_inv_err )
      y[range( start_index, start_index + 3 )]
        += params.get_state_models().template get_state_for_system< gyros_bias_state_model >( x );
    else
  ...
  template < typename FlyWeight, typename StateSpaceType >
  typename boost::disable_if< typename FlyWeight::state_models_type::template has_system< gyros_bias_state_model >,
                              void >::type
    add_output_from_state_for_gb( const FlyWeight&, const StateSpaceType&,
                                  const typename pp::topology_traits< StateSpaceType >::point_type&, output_type&,
                                  bool ) const {};
  ...
  typename boost::enable_if< typename FlyWeight::state_models_type::template has_system< gyros_bias_state_model >,
                             void >::type
    add_output_block_for_gb( MatrixC& C, const FlyWeight& params ) const {
    // if there is an estimate of the gyro-bias, use it:
    const std::size_t gb_index
      = params.get_state_models().template get_system< gyros_bias_state_model >().get_inv_corr_start_index();
  ...
  typename boost::disable_if< typename FlyWeight::state_models_type::template has_system< gyros_bias_state_model >,
                              void >::type
    add_output_block_for_gb( MatrixC&, const FlyWeight& ) const {};
...
public:
  state_space_type create_state_space() const {
    return pp::hyperball_topology< vect< double, 3 > >( "accel_bias_param_space", vect< double, 3 >( 0.0, 0.0, 0.0 ),
                                                        std::numeric_limits< double >::infinity() );
  };
  ...
  void apply_correction_to_state( const FlyWeight& params, const StateSpaceType& space,
                                  ...
                                  const InputType& u, const time_type& t ) const {
    const point_type& ab
      = params.get_state_models().template get_state_for_system< accelerometer_bias_state_model >( x );
  ...
  *******************************************************************************/
  ...
  RK_RTTI_MAKE_CONCRETE_1BASE( accelerometer_bias_state_model, 0xC231002D, 1, "accelerometer_bias_state_model",
                               named_object )
};
...
public:
  ...
  template < typename FlyWeight, typename StateSpaceType >
  typename boost::
    enable_if< typename FlyWeight::state_models_type::template has_system< accelerometer_bias_state_model >,
               void >::type
    add_output_from_state_for_ab( const FlyWeight& params, const StateSpaceType& space,
                                  const typename pp::topology_traits< StateSpaceType >::point_type& x, output_type& y,
                                  bool is_inv_err ) const {
    // if there is an estimate of the gyro-bias, use it:
    if( !is_inv_err )
  ...
  template < typename FlyWeight, typename StateSpaceType >
  typename boost::
    disable_if< typename FlyWeight::state_models_type::template has_system< accelerometer_bias_state_model >,
                void >::type
    add_output_from_state_for_ab( const FlyWeight&, const StateSpaceType&,
                                  const typename pp::topology_traits< StateSpaceType >::point_type&, output_type&,
                                  bool ) const {};
  ...
  void set_output_from_state( const FlyWeight& params, const StateSpaceType& space,
    ...
    y[range( start_index, start_index + 3 )] = invert( get_quaternion( x_se3 ).as_rotation() )
  ...
  typename boost::
    enable_if< typename FlyWeight::state_models_type::template has_system< accelerometer_bias_state_model >,
               void >::type
    add_output_block_for_ab( MatrixC& C, const FlyWeight& params ) const {
    // if there is an estimate of the accel-bias, use it:
    const std::size_t accel_bias_index
      = params.get_state_models().template get_system< accelerometer_bias_state_model >().get_inv_corr_start_index();
  ...
  typename boost::
    disable_if< typename FlyWeight::state_models_type::template has_system< accelerometer_bias_state_model >,
                void >::type
    add_output_block_for_ab( MatrixC&, const FlyWeight& ) const {};
  ...
  *******************************************************************************/
  ...
  RK_RTTI_MAKE_CONCRETE_1BASE( sat_accelerometer_output_model, 0xC231002E, 1, "sat_accelerometer_output_model",
                               named_object )
};
...
public:
  state_space_type create_state_space() const {
    return pp::hyperball_topology< vect< double, 3 > >(
      "magnetometer_bias_param_space", vect< double, 3 >( 0.0, 0.0, 0.0 ), std::numeric_limits< double >::infinity() );
  };
  ...
  void apply_correction_to_state( const FlyWeight& params, const StateSpaceType& space,
                                  ...
                                  const InputType& u, const time_type& t ) const {
    const point_type& mb
      = params.get_state_models().template get_state_for_system< magnetometer_bias_state_model >( x );
  ...
  *******************************************************************************/
  ...
  RK_RTTI_MAKE_CONCRETE_1BASE( magnetometer_bias_state_model, 0xC231002F, 1, "magnetometer_bias_state_model",
                               named_object )
};
...
public:
  ...
  template < typename FlyWeight, typename StateSpaceType >
  typename boost::
    enable_if< typename FlyWeight::state_models_type::template has_system< magnetometer_bias_state_model >, void >::type
    add_output_from_state_for_mb( const FlyWeight& params, const StateSpaceType& space,
                                  const typename pp::topology_traits< StateSpaceType >::point_type& x, output_type& y,
                                  bool is_inv_err ) const {
    // if there is an estimate of the gyro-bias, use it:
    if( !is_inv_err )
  ...
  template < typename FlyWeight, typename StateSpaceType >
  typename boost::
    disable_if< typename FlyWeight::state_models_type::template has_system< magnetometer_bias_state_model >,
                void >::type
    add_output_from_state_for_mb( const FlyWeight&, const StateSpaceType&,
                                  const typename pp::topology_traits< StateSpaceType >::point_type&, output_type&,
                                  bool ) const {};
  ...
  typename boost::
    enable_if< typename FlyWeight::state_models_type::template has_system< magnetometer_bias_state_model >, void >::type
    add_output_block_for_mb( MatrixC& C, const FlyWeight& params ) const {
    // if there is a mag-bias estimate, use it:
    const std::size_t mag_bias_index
      = params.get_state_models().template get_system< magnetometer_bias_state_model >().get_inv_corr_start_index();
  ...
  typename boost::
    disable_if< typename FlyWeight::state_models_type::template has_system< magnetometer_bias_state_model >,
                void >::type
    add_output_block_for_mb( MatrixC&, const FlyWeight& ) const {};
  ...
  *******************************************************************************/
  ...
  RK_RTTI_MAKE_CONCRETE_1BASE( sat_magnetometer_output_model, 0xC2310030, 1, "sat_magnetometer_output_model",
                               named_object )
};
};
};
