...
class sat_gyros_output_model : public named_object {
  ...
  public:
    ...
    typename boost::enable_if<
      typename FlyWeight::state_models_type::template has_system<gyros_bias_state_model>,
...
class sat_accelerometer_output_model : public named_object {
  ...
  public:
    ...
    template <typename FlyWeight, typename StateSpaceType>
    typename boost::enable_if<
      typename FlyWeight::state_models_type::template has_system<accelerometer_bias_state_model>,
...
class sat_magnetometer_output_model : public named_object {
  ...
  public:
    ...
    template <typename FlyWeight, typename StateSpaceType>
    typename boost::enable_if<
      typename FlyWeight::state_models_type::template has_system<magnetometer_bias_state_model>,
