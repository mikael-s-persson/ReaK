...
template class state_space_system_tuple< airship_parameter_pack, arithmetic_tuple< satellite_state_model >,
...
template class state_space_system_tuple< airship_parameter_pack,
