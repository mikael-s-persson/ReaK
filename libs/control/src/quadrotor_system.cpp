...
quadrotor_system::quadrotor_system(const std::string& aName, 
                                   double aMass, 
...
quadrotor_system::point_derivative_type quadrotor_system::get_state_derivative(const state_space_type&, const point_type& x, const input_type& u, time_type) const {
  using std::fabs;
...
void quadrotor_system::get_linear_blocks(matrixA_type& A, matrixB_type& B, matrixC_type& C, matrixD_type& D, const state_space_type&, const time_type&, const point_type& x, const input_type& u) const {
  using std::fabs;
