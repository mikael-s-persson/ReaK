...
int main( int argc, char** argv ) {
  ...
  shared_ptr< quadrotor_system > quad_sys(
    new quadrotor_system( "Quadrotor_system",
                          2.025, // aMass,
                          mat< double, mat_structure::symmetric >( mat< double, mat_structure::diagonal >(
  ...
  mat< double, mat_structure::diagonal > Rscale(
    vect< double, 4 >( v_max / u_max[0], w_max / u_max[1], w_max / u_max[2], w_max / u_max[3] ) );
  ...
  mat< double, mat_structure::diagonal > Qscale( vect_n< double >(
    u_max[0] * v_max / char_length_sqr, u_max[0] * v_max / char_length_sqr, u_max[0] * v_max / char_length_sqr,
    u_max[0] / v_max, u_max[0] / v_max, u_max[0] / v_max, u_max[0] * v_max, u_max[0] * v_max, u_max[0] * v_max,
    u_max[0] * char_length_sqr / v_max, u_max[0] * char_length_sqr / v_max, u_max[0] * char_length_sqr / v_max ) );
  ...
  shared_ptr< IHAQR_space_type > quad_space(
    new IHAQR_space_type( "Quadrotor_IHAQR_topology", quad_sys, make_se3_space( "Quadrotor_state_space",
  ...
  shared_ptr< MEAQR_space_type > quad_MEAQR_space( new MEAQR_space_type( "QuadRotor_MEAQR_topology", quad_space,
