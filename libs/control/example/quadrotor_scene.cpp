...
int main( int argc, char** argv ) {
...

  {
    MEAQR_space_type::point_type p1( make_arithmetic_tuple(
      make_arithmetic_tuple( vect< double, 3 >( 0.0, 0.0, -1.0 ), vect< double, 3 >( 0.0, 0.0, 0.0 ) ),
      make_arithmetic_tuple( unit_quat< double >( 1.0, 0.0, 0.0, 0.0 ), vect< double, 3 >( 0.0, 0.0, 0.0 ) ) ) );
    MEAQR_space_type::point_type p2( make_arithmetic_tuple(
      make_arithmetic_tuple( vect< double, 3 >( 0.3, 0.0, -1.3 ), vect< double, 3 >( 0.0, 0.0, 0.0 ) ),
      make_arithmetic_tuple( unit_quat< double >( 1.0, 0.0, 0.0, 0.0 ), vect< double, 3 >( 0.0, 0.0, 0.0 ) ) ) );
