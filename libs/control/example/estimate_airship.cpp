...
int main( int argc, char** argv ) {
  ...
  a_params.IMU_orientation
    = quaternion< double >( vect< double, 4 >( 1.0, 0.0, 0.0, 0.0 ) ); // relative to body-fixed frame.
  ...
  tryphon_sgam_me sys(
    ...
    arithmetic_tuple< satellite_state_model, near_buoyancy_state_model, eccentricity_state_model >(),
    arithmetic_tuple< airship3D_6dof_thrusters >(),
    arithmetic_tuple< sonars_in_room_output_model, sat_gyros_output_model, sat_accelerometer_output_model,
