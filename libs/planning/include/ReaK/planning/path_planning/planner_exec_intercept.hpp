...
void execute_intercept_planner( const shared_ptr< Topology >& world_topo,
                                const planning_option_collection& plan_options, std::size_t world_dimensionality,
                                double time_horizon, double time_step, PlanEngine& engine,
  ...
  motion_plan_intercept_query< Topology, GoalTrajType > pp_query( "intercept_query", world_topo, p_start, goal_traj,
                                                                  time_horizon, time_step, plan_options.max_results );
