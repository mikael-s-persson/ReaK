...
private:
  ...
  typedef boost::
    multi_index_container< vertex_tuple,
                           boost::multi_index::
                             indexed_by< boost::multi_index::
                                           ordered_non_unique< boost::multi_index::tag< backward >,
                                                               boost::multi_index::
                                                                 member< vertex_tuple, double,
                                                                         &vertex_tuple::backward_reach > >,
                                         boost::multi_index::
                                           ordered_non_unique< boost::multi_index::tag< forward >,
                                                               boost::multi_index::
                                                                 member< vertex_tuple, double,
...
public:
  ...
  reachability_sorted_set< Graph, PositionMap, ReachabilityTopology >&
    operator=( reachability_sorted_set< Graph, PositionMap, ReachabilityTopology > rhs ) {
    swap( *this, rhs );
    return *this;
  };
        ...
        if( ( dist < std::numeric_limits< double >::infinity() ) && ( dist < max_radius ) ) {
          ...
          pred_list.insert( std::lower_bound( pred_list.begin(), pred_list.end(), tmp,
                                              boost::bind( std::less< double >(),
                                                           ...
                                                           boost::bind( &std::pair< double, Vertex >::first, _2 ) ) ),
                            tmp );
  ...
  iterator insert( iterator pos, Vertex u ) {
    Point p = boost::get( m_position, u );
    return iterator(
      m_map.insert( pos.base(), vertex_tuple( u, m_space.backward_reach( p ), m_space.forward_reach( p ) ) ),
      vertex_access() );
  };
