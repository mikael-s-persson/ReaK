 ...
 * all the elements in the range with respect to the distance metric).
  */
template < typename DistanceValue, typename ForwardIterator, typename GetDistanceFunction, typename CompareFunction >
inline ForwardIterator min_dist_linear_search( ForwardIterator first, ForwardIterator last,
...
template < typename InputIterator, typename DistanceValue, typename PairQueue, typename OutputIterator >
inline typename boost::enable_if< boost::is_same< typename std::iterator_traits< OutputIterator >::value_type,
                                                  typename std::iterator_traits< InputIterator >::value_type >,
                                  OutputIterator >::type
  copy_neighbors_from_queue( const PairQueue& Q, OutputIterator result ) {
...
inline typename boost::
  enable_if< boost::is_same< typename std::iterator_traits< OutputIterator >::value_type,
 ...
 * dereferencing.
  ...
  */
template < typename DistanceValue, typename ForwardIterator, typename OutputIterator, typename GetDistanceFunction,
           typename CompareFunction >
inline OutputIterator
  min_dist_linear_search( ForwardIterator first, ForwardIterator last, OutputIterator output_first,
                          GetDistanceFunction distance, CompareFunction compare, std::size_t max_neighbors = 1,
  ...
  for( typename std::vector< std::pair< DistanceValue, ForwardIterator > >::const_iterator it = output_queue.begin();
 ...
 * dereferencing.
  ...
  */
template < typename DistanceValue, typename ForwardIterator, typename OutputIterator, typename GetDistanceFunction >
inline OutputIterator min_dist_linear_search( ForwardIterator first, ForwardIterator last, OutputIterator output_first,
                                              GetDistanceFunction distance, std::size_t max_neighbors = 1,
                                              DistanceValue radius
                                              = std::numeric_limits< DistanceValue >::infinity() ) {
  return min_dist_linear_search( first, last, output_first, distance, std::less< DistanceValue >(), max_neighbors,
                                 radius );
};
 ...
 * dereferencing.
  ...
  * \return The output-iterator to the end of the list of nearest neighbors (starting from "output_first").
  */
template < typename DistanceValue, typename PointType, typename ForwardIterator, typename OutputIterator,
           typename GetDistanceFunction, typename CompareFunction >
inline std::pair< OutputIterator, OutputIterator >
  min_dist_linear_search( const PointType& query_point, ForwardIterator first, ForwardIterator last,
                          OutputIterator pred_first, OutputIterator succ_first, GetDistanceFunction distance,
                          CompareFunction compare, std::size_t max_neighbors = 1,
                          DistanceValue radius = std::numeric_limits< DistanceValue >::infinity() ) {
  if( first == last )
  ...
  for( typename std::vector< std::pair< DistanceValue, ForwardIterator > >::const_iterator it = pred_queue.begin();
       it != pred_queue.end(); ++it )
    *( pred_first++ ) = *( it->second );
  std::sort_heap( succ_queue.begin(), succ_queue.end(), p_compare );
  for( typename std::vector< std::pair< DistanceValue, ForwardIterator > >::const_iterator it = succ_queue.begin();
       it != succ_queue.end(); ++it )
...
inline std::pair< OutputIterator, OutputIterator >
  min_dist_linear_search( const PointType& query_point, ForwardIterator first, ForwardIterator last,
                          ...
                          DistanceValue radius = std::numeric_limits< DistanceValue >::infinity() ) {
  return min_dist_linear_search( query_point, first, last, pred_first, succ_first, distance,
                                 std::less< DistanceValue >(), max_neighbors, radius );
};
...
struct linear_neighbor_search_distance_functor {
  ...
  linear_neighbor_search_distance_functor( const PointType* pPoint, const Topology* pSpace, PositionMap aPosition )
...
struct linear_neighbor_search_base {
  ...
  typename boost::graph_traits< Graph >::vertex_descriptor
    operator()( const typename boost::property_traits< PositionMap >::value_type& p, Graph& g, const Topology& space,
    ...
    return *( min_dist_linear_search(
      ui, ui_end, detail::linear_neighbor_search_distance_functor< Topology, PositionMap >( &p, &space, position ),
  ...
  OutputIterator operator()( const typename boost::property_traits< PositionMap >::value_type& p,
                             OutputIterator output_first, Graph& g, const Topology& space, PositionMap position,
                             std::size_t max_neighbors = 1,
    ...
    return min_dist_linear_search(
      ...
      detail::linear_neighbor_search_distance_functor< Topology, PositionMap >( &p, &space, position ), m_compare,
  ...
  ForwardIter operator()( const typename boost::property_traits< PositionMap >::value_type& p, ForwardIter first,
                          ForwardIter last, const Topology& space, PositionMap position ) const {
    BOOST_CONCEPT_ASSERT( (MetricSpaceConcept< Topology >));
    return min_dist_linear_search(
      first, last, detail::linear_neighbor_search_distance_functor< Topology, PositionMap >( &p, &space, position ),
      m_compare, std::numeric_limits< double >::infinity() );
  };
  ...
  OutputIterator operator()( const typename boost::property_traits< PositionMap >::value_type& p, ForwardIter first,
                             ForwardIter last, OutputIterator output_first, const Topology& space, PositionMap position,
                             std::size_t max_neighbors = 1,
                             double radius = std::numeric_limits< double >::infinity() ) const {
    BOOST_CONCEPT_ASSERT( (MetricSpaceConcept< Topology >));
    return min_dist_linear_search(
...
struct linear_neighbor_search_base< Graph, CompareFunction, true > {
  ...
  std::pair< OutputIterator, OutputIterator >
    operator()( const typename boost::property_traits< PositionMap >::value_type& p, OutputIterator pred_first,
                OutputIterator succ_first, Graph& g, const Topology& space, PositionMap position,
  ...
  template < typename ForwardIter, typename Topology, typename PositionMap, typename OutputIterator >
  std::pair< OutputIterator, OutputIterator >
    operator()( const typename boost::property_traits< PositionMap >::value_type& p, ForwardIter first,
                ForwardIter last, OutputIterator pred_first, OutputIterator succ_first, const Topology& space,
...
struct linear_neighbor_search
  : linear_neighbor_search_base< Graph, CompareFunction, boost::is_directed_graph< Graph >::type::value > {
  /**
    * Default constructor.
    * \param compare The comparison functor for ordering the distances (strict weak ordering).
    */
  linear_neighbor_search( CompareFunction compare = CompareFunction() )
      : linear_neighbor_search_base< Graph, CompareFunction, boost::is_directed_graph< Graph >::type::value >(
          compare ){};
};
...
struct linear_pred_succ_search : linear_neighbor_search_base< Graph, CompareFunction, true > {
  /**
    ...
    * \param compare The comparison functor for ordering the distances (strict weak ordering).
    */
  linear_pred_succ_search( CompareFunction compare = CompareFunction() )
...
struct best_only_neighbor_search {
  ...
  double distance( const typename boost::property_traits< PositionMap >::value_type& p, Vertex u, const Topology& space,
                   PositionMap position ) const {
  ...
  void search( const typename boost::property_traits< PositionMap >::value_type& p,
               typename boost::graph_traits< Graph >::vertex_descriptor& u, double& d_min, Graph& g,
  ...
  void search( const typename boost::property_traits< PositionMap >::value_type& p,
               typename boost::graph_traits< Graph >::vertex_descriptor u, PriorityQueue& output,
               PriorityCompare p_compare, double d_min, Graph& g, const Topology& space, PositionMap position,
  ...
  OutputIterator operator()( const typename boost::property_traits< PositionMap >::value_type& p,
    ...
    for( typename std::vector< std::pair< double, Vertex > >::const_iterator it = output.begin(); it != output.end();
         ++it )
      *( output_first++ ) = it->second;
    return output_first;
  };
