...
public:
  ...
  std::size_t get_space_order() const { return space_options & PLANNING_SPACE_ORDER_MASK; };
  ...
  std::size_t get_interp_id() const { return ( space_options & PLANNING_SPACE_INTERPOLATOR_MASK ) >> 3; };
  ...
  bool is_temporal_space() const { return space_options & PLAN_IN_TEMPORAL_SPACE; };
  ...
  bool is_rate_limited() const { return space_options & PLAN_IN_RATE_LIMITED_SPACE; };
  ...
  std::size_t get_output_space_order() const { return output_space_options & PLANNING_SPACE_ORDER_MASK; };
  ...
  std::size_t get_output_interp_id() const { return ( output_space_options & PLANNING_SPACE_INTERPOLATOR_MASK ) >> 3; };
  ...
  bool is_temporal_output_space() const { return output_space_options & PLAN_IN_TEMPORAL_SPACE; };
  ...
  bool is_output_rate_limited() const { return output_space_options & PLAN_IN_RATE_LIMITED_SPACE; };
  ...
  *******************************************************************************/
  ...
  virtual void RK_CALL save( serialization::oarchive& A, unsigned int ) const {
    ...
    A& RK_SERIAL_SAVE_WITH_NAME( space_options ) & RK_SERIAL_SAVE_WITH_NAME( output_space_options )
      & RK_SERIAL_SAVE_WITH_NAME( min_travel ) & RK_SERIAL_SAVE_WITH_NAME( max_travel );
  };

  virtual void RK_CALL load( serialization::iarchive& A, unsigned int ) {
    shared_object::load( A, shared_object::getStaticObjectType()->TypeVersion() );
    A& RK_SERIAL_LOAD_WITH_NAME( space_options ) & RK_SERIAL_LOAD_WITH_NAME( output_space_options )
