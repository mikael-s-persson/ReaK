...
boost::program_options::options_description get_planning_space_options_po_desc() {
  ...
  planning_space_options.add_options()( "space-definition", po::value< std::string >(),
    ...
    ( "space-order", po::value< std::size_t >(), "differential order of the planning space (0,1,2,...)." )(
      ...
      "the interpolation method to use in the planning (can be: linear, cubic, quintic, svp, sap)." )
    ...
    ( "min-travel-dist", po::value< double >(),
      "minimum distance to travel between 'distinct' points in the planning-space." )(
      "max-travel-dist", po::value< double >(),
      "maximum distance to travel between points in the planning-space (max reachable)." )
    ...
    ( "output-space-order", po::value< std::size_t >(), "differential order of the output-space (0,1,2,...)." )(
      ...
      "the interpolation method to use in the output (can be: linear, cubic, quintic, svp, sap)." )(
