...
#define RK_SBASTAR_MANIP_PLANNERS_MAKE_STATIC_MANIP_EXTERN_DECL( NDOF )                                               \
  extern template class sbastar_planner< manip_quasi_static_env< typename Ndof_rl_space< double, NDOF, 0 >::type > >; \
  extern template class sbastar_planner< manip_quasi_static_env< typename Ndof_rl_space< double, NDOF, 1 >::type > >; \
  extern template class sbastar_planner< manip_quasi_static_env< typename Ndof_rl_space< double, NDOF, 2 >::type > >;
...
#define RK_SBASTAR_MANIP_PLANNERS_MAKE_DYNAMIC_MANIP_EXTERN_DECL( NDOF )                                         \
  extern template class sbastar_planner< manip_dynamic_env< typename Ndof_rl_space< double, NDOF, 0 >::type > >; \
  extern template class sbastar_planner< manip_dynamic_env< typename Ndof_rl_space< double, NDOF, 1 >::type > >; \
  extern template class sbastar_planner< manip_dynamic_env< typename Ndof_rl_space< double, NDOF, 2 >::type > >;
