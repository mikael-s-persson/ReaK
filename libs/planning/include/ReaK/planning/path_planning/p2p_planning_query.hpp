...
public:
  ...
  typedef typename boost::mpl::
    if_< is_steerable_space< space_type >,
         typename boost::mpl::if_< is_temporal_space< space_type >,
         ...
         typename boost::mpl::if_< is_temporal_space< space_type >,
                                   ...
                                   seq_path_wrapper< point_to_point_path< super_space_type > > >::type >::type
      solution_path_wrapper;
...
protected:
  virtual solution_record_ptr register_solution_from_optimal_mg( graph::any_graph::vertex_descriptor start_node,
    ...
    return detail::register_optimal_solution_path_impl< solution_path_wrapper >(
      *( this->space ), g, start_node, goal_node, goal_pos, goal_distance, solutions );
  };
...
public:
   ...
   */
  path_planning_p2p_query( const std::string& aName, const shared_ptr< space_type >& aWorld,
                           const point_type& aStartPos, const point_type& aGoalPos, std::size_t aMaxNumResults = 1 )
  ...
  *******************************************************************************/
  ...
  virtual void RK_CALL save( serialization::oarchive& A, unsigned int ) const {
    ...
    A& RK_SERIAL_SAVE_WITH_NAME( start_pos ) & RK_SERIAL_SAVE_WITH_NAME( goal_pos )
      & RK_SERIAL_SAVE_WITH_NAME( max_num_results );
  };

  virtual void RK_CALL load( serialization::iarchive& A, unsigned int ) {
    base_type::load( A, base_type::getStaticObjectType()->TypeVersion() );
    A& RK_SERIAL_LOAD_WITH_NAME( start_pos ) & RK_SERIAL_LOAD_WITH_NAME( goal_pos )
