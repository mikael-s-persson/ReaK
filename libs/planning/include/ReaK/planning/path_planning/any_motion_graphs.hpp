...
template < typename Topology, typename Graph >
typename boost::disable_if< is_steerable_space< Topology >, int >::type&
  try_get_steer_record( Graph&, typename boost::graph_traits< Graph >::edge_descriptor ) {
...
protected:
  ...
  virtual void* get_property_by_ptr( const std::string& aProperty, const boost::any& aElement ) const {
    ...
    if( aProperty == "vertex_position" )
      return static_cast< void* >(
        &( ( *( this->p_graph ) )[boost::any_cast< real_vertex_desc >( aElement )].position ) );
    if( aProperty == "edge_steer_record" )
      return static_cast< void* >( &( detail::try_get_steer_record< Topology >(
        *( this->p_graph ), boost::any_cast< real_edge_desc >( aElement ) ) ) );
  ...
  virtual boost::any get_property_by_any( const std::string& aProperty, const boost::any& aElement ) const {
    ...
    if( aProperty == "edge_steer_record" )
      return boost::any(
        detail::try_get_steer_record< Topology >( *( this->p_graph ), boost::any_cast< real_edge_desc >( aElement ) ) );
...
protected:
  ...
  virtual void* get_property_by_ptr( const std::string& aProperty, const boost::any& aElement ) const {
    ...
    if( aProperty == "vertex_distance_accum" )
      return static_cast< void* >(
        &( ( *( this->p_graph ) )[boost::any_cast< real_vertex_desc >( aElement )].distance_accum ) );
    if( aProperty == "vertex_predecessor" )
      return static_cast< void* >(
        &( ( *( this->p_graph ) )[boost::any_cast< real_vertex_desc >( aElement )].predecessor ) );
...
protected:
  ...
  virtual void* get_property_by_ptr( const std::string& aProperty, const boost::any& aElement ) const {
    ...
    if( aProperty == "vertex_fwd_distance_accum" )
      return static_cast< void* >(
        &( ( *( this->p_graph ) )[boost::any_cast< real_vertex_desc >( aElement )].fwd_distance_accum ) );
    if( aProperty == "vertex_successor" )
      return static_cast< void* >(
        &( ( *( this->p_graph ) )[boost::any_cast< real_vertex_desc >( aElement )].successor ) );
...
void print_mg_vertex( std::ostream& out, const astar_mg_vertex< Topology >& vp ) {
  ...
  for( std::size_t i = 0; i < v_pos.size(); ++i )
    out << " " << std::setw( 10 ) << v_pos[i];
  out << " " << std::setw( 10 ) << vp.distance_accum << " " << std::setw( 10 ) << vp.heuristic_value << " "
...
protected:
  ...
  virtual void* get_property_by_ptr( const std::string& aProperty, const boost::any& aElement ) const {
    ...
    if( aProperty == "vertex_heuristic_value" )
      return static_cast< void* >(
        &( ( *( this->p_graph ) )[boost::any_cast< real_vertex_desc >( aElement )].heuristic_value ) );
    if( aProperty == "vertex_key_value" )
      return static_cast< void* >(
        &( ( *( this->p_graph ) )[boost::any_cast< real_vertex_desc >( aElement )].key_value ) );
    if( aProperty == "vertex_astar_color" )
      return static_cast< void* >(
        &( ( *( this->p_graph ) )[boost::any_cast< real_vertex_desc >( aElement )].astar_color ) );
...
void print_mg_vertex( std::ostream& out, const bidir_astar_mg_vertex< Topology >& vp ) {
  ...
  for( std::size_t i = 0; i < v_pos.size(); ++i )
    out << " " << std::setw( 10 ) << v_pos[i];
  out << " " << std::setw( 10 ) << vp.distance_accum << " " << std::setw( 10 ) << vp.fwd_distance_accum << " "
      << std::setw( 10 ) << vp.key_value;
};
...
protected:
  ...
  virtual void* get_property_by_ptr( const std::string& aProperty, const boost::any& aElement ) const {
    ...
    if( aProperty == "vertex_density" )
      return static_cast< void* >(
        &( ( *( this->p_graph ) )[boost::any_cast< real_vertex_desc >( aElement )].density ) );
...
void print_mg_vertex( std::ostream& out, const recursive_dense_mg_vertex< BaseVertex >& vp ) {
  print_mg_vertex( out, static_cast< const BaseVertex& >( vp ) );
  out << " " << std::setw( 10 ) << vp.density << " " << std::setw( 10 ) << vp.expansion_trials << " " << std::setw( 10 )
      << vp.constriction << " " << std::setw( 10 ) << vp.collision_count;
};
...
protected:
  ...
  virtual void* get_property_by_ptr( const std::string& aProperty, const boost::any& aElement ) const {
    ...
    if( aProperty == "vertex_constriction" )
      return static_cast< void* >(
        &( ( *( this->p_graph ) )[boost::any_cast< real_vertex_desc >( aElement )].constriction ) );
    if( aProperty == "vertex_expansion_trials" )
      return static_cast< void* >(
        &( ( *( this->p_graph ) )[boost::any_cast< real_vertex_desc >( aElement )].expansion_trials ) );
    if( aProperty == "vertex_collision_count" )
      return static_cast< void* >(
        &( ( *( this->p_graph ) )[boost::any_cast< real_vertex_desc >( aElement )].collision_count ) );
...
struct te_mg_selector {
  ...
  typedef typename boost::mpl::
    if_< IsBasicMG,
         typename boost::mpl::if_< IsOptimMG, typename boost::mpl::if_< IsAStarMG, astar_mg_vertex< Topology >,
  ...
  typedef typename boost::mpl::
    if_< IsBasicMG,
         typename boost::mpl::if_< IsOptimMG,
                                   typename boost::mpl::if_< IsAStarMG, any_astar_motion_graph< Topology, Graph >,
  ...
  typedef typename boost::mpl::if_< IsDenseMG, any_dense_motion_graph< BaseMG >,
                                    typename boost::mpl::if_< IsRecDenseMG, any_recursive_dense_mg< BaseMG >,
...
struct any_mg_vertex_printer : serializable {
  ...
  void operator()( std::ostream& out, graph::any_graph::vertex_descriptor u, const graph::any_graph& g ) const {
    ...
    if( graph_kind & DENSE_MOTION_GRAPH_KIND ) {
      ...
      out << " " << std::setw( 10 ) << get_dyn_prop< const double& >( "vertex_density", u, g ) << " " << std::setw( 10 )
          << get_dyn_prop< const std::size_t& >( "vertex_expansion_trials", u, g ) << " " << std::setw( 10 )
          << get_dyn_prop< const double& >( "vertex_constriction", u, g ) << " " << std::setw( 10 )
  ...
  virtual void RK_CALL load( serialization::iarchive& A, unsigned int ) { A& RK_SERIAL_LOAD_WITH_NAME( graph_kind ); };
