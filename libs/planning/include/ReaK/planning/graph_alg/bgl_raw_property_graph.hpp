...
struct raw_vertex_propgraph_map : public put_get_helper< T&, raw_vertex_propgraph_map< T, Graph > > {
private:
  Graph* pg;
 ...
 */
template < typename T, typename Graph >
struct raw_edge_propgraph_map : public put_get_helper< T&, raw_edge_propgraph_map< T, Graph > > {
private:
  Graph* pg;
