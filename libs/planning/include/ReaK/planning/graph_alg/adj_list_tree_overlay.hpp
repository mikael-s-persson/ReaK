...
struct tree_vertex_properties_impl {
  ...
  friend bool operator<( const self& lhs, const self& rhs ) { return lhs.partner_node < rhs.partner_node; };
  friend bool operator<=( const self& lhs, const self& rhs ) { return lhs.partner_node <= rhs.partner_node; };
  friend bool operator>( const self& lhs, const self& rhs ) { return lhs.partner_node > rhs.partner_node; };
  friend bool operator>=( const self& lhs, const self& rhs ) { return lhs.partner_node >= rhs.partner_node; };
  friend bool operator==( const self& lhs, const self& rhs ) { return lhs.partner_node == rhs.partner_node; };
...
template < typename TreeVertexProperty, typename AdjVertexProperty >
boost::data_member_property_map< const std::size_t,
  ...
  return boost::data_member_property_map< const std::size_t,
                                          const tree_vertex_properties_impl< TreeVertexProperty, AdjVertexProperty > >(
    &tree_vertex_properties_impl< TreeVertexProperty, AdjVertexProperty >::partner_node );
};

template < typename TreeVertexProperty, typename AdjVertexProperty >
boost::data_member_property_map< AdjVertexProperty,
  ...
  return boost::data_member_property_map< AdjVertexProperty,
                                          tree_vertex_properties_impl< TreeVertexProperty, AdjVertexProperty > >(
    &tree_vertex_properties_impl< TreeVertexProperty, AdjVertexProperty >::user_data );
};
 ...
 */
template < typename AdjListType, typename VertexProperty, typename TreeVertexProperty, typename TreeEdgeProperty,
...
template < typename OutEdgeListS = boost::vecBC, typename DirectedS = boost::directedS,
           typename VertexProperty = boost::no_property, typename AdjEdgeProperty = boost::no_property,
           typename AdjEdgeListS = boost::vecBC, typename TreeStorageTag = boost::bfl_d_ary_tree_storage< 2 > >
struct adj_list_on_tree_tag {
  ...
  struct alt {
    ...
    typedef TreeEdgeProperty tree_edge_properties;
    typedef typename boost::tree_storage< tree_vertex_properties, tree_edge_properties, TreeStorageTag >::type
      tree_type;
    ...
    typedef boost::adjacency_list_BC< OutEdgeListS, boost::poolBC, DirectedS, adj_vertex_properties,
                                      adj_edge_properties > adj_list_type;

    typedef detail::adj_list_on_tree< adj_list_type, VertexProperty, TreeVertexProperty, TreeEdgeProperty,
                                      TreeStorageTag > type;
  };
};
...
template < typename TreeVertexProperty, typename TreeEdgeProperty, typename OutEdgeListS, typename DirectedS,
           typename VertexProperty, typename AdjEdgeProperty, typename AdjEdgeListS, typename TreeStorageTag >
struct tree_storage< TreeVertexProperty, TreeEdgeProperty,
                     ReaK::graph::adj_list_on_tree_tag< OutEdgeListS, DirectedS, VertexProperty, AdjEdgeProperty,
                                                        AdjEdgeListS, TreeStorageTag > > {
  typedef ReaK::graph::adj_list_on_tree_tag< OutEdgeListS, DirectedS, VertexProperty, AdjEdgeProperty, AdjEdgeListS,
                                             TreeStorageTag > alt_tag_type;
  typedef ReaK::graph::alt_tree_view< typename alt_tag_type::template alt< TreeVertexProperty,
                                                                           TreeEdgeProperty >::type > type;
};


template < typename OutEdgeListS, typename DirectedS, typename VertexProperty, typename AdjEdgeProperty,
           typename AdjEdgeListS, typename TreeStorageTag >
struct tree_storage_traits< ReaK::graph::adj_list_on_tree_tag< OutEdgeListS, DirectedS, VertexProperty, AdjEdgeProperty,
                                                               AdjEdgeListS, TreeStorageTag > >
...
public:
  ...
  vertex_bundled& operator[]( const vertex_descriptor& v_i ) { return m_alt->m_tree[v_i].tree_data; };
  const vertex_bundled& operator[]( const vertex_descriptor& v_i ) const { return m_alt->m_tree[v_i].tree_data; };
  edge_bundled& operator[]( const edge_descriptor& e_i ) { return m_alt->m_tree[e_i]; };
  const edge_bundled& operator[]( const edge_descriptor& e_i ) const { return m_alt->m_tree[e_i]; };


  friend vertex_property_type& get_raw_vertex_property( self& g, const vertex_descriptor& v_i ) {
    return g.get_tree()[v_i];
  };
  friend const vertex_property_type& get_raw_vertex_property( const self& g, const vertex_descriptor& v_i ) {
    return g.get_tree()[v_i];
  };
  friend edge_property_type& get_raw_edge_property( self& g, const edge_descriptor& e_i ) { return g.get_tree()[e_i]; };
  friend const edge_property_type& get_raw_edge_property( const self& g, const edge_descriptor& e_i ) {
    return g.get_tree()[e_i];
  };


  friend const vertex_bundled& get( const self& g, const vertex_descriptor& v_i ) { return g[v_i]; };

  friend void put( self& g, const vertex_descriptor& v_i, const vertex_bundled& value ) { g[v_i] = value; };

  friend const edge_bundled& get( const self& g, const edge_descriptor& e_i ) { return g[e_i]; };

  friend void put( self& g, const edge_descriptor& e_i, const edge_bundled& value ) { g[e_i] = value; };

  template < typename T, typename Bundle >
  friend typename boost::property_map< self, T Bundle::* >::type get( T Bundle::*p, self& g ) {
    return typename boost::property_map< self, T Bundle::* >::type( &g, p );
  };

  template < typename T, typename Bundle >
  friend typename boost::property_map< self, T Bundle::* >::const_type get( T Bundle::*p, const self& g ) {
  ...
  std::pair< vertex_descriptor, edge_descriptor >
    add_child_vertex_impl( vertex_descriptor v, const vertex_property_type& vp,
  ...
  std::pair< vertex_descriptor, edge_descriptor > add_child_vertex_impl( vertex_descriptor v,
  ...
  std::pair< vertex_descriptor, edge_descriptor > add_child_vertex_impl( vertex_descriptor v, vertex_property_type&& vp,
                                                                         edge_property_type&& ep ) {
    std::pair< vertex_descriptor, edge_descriptor > result
...
struct raw_vertex_property_map< ReaK::graph::alt_tree_view< AdjListOnTreeType > > {
  typedef boost::
    raw_vertex_propgraph_map< typename ReaK::graph::alt_tree_view< AdjListOnTreeType >::vertex_property_type,
                              ReaK::graph::alt_tree_view< AdjListOnTreeType > > type;
  typedef boost::
    raw_vertex_propgraph_map< const typename ReaK::graph::alt_tree_view< AdjListOnTreeType >::vertex_property_type,
...
struct raw_edge_property_map< ReaK::graph::alt_tree_view< AdjListOnTreeType > > {
  typedef boost::raw_edge_propgraph_map< typename ReaK::graph::alt_tree_view< AdjListOnTreeType >::edge_property_type,
                                         ReaK::graph::alt_tree_view< AdjListOnTreeType > > type;
  typedef boost::
    raw_edge_propgraph_map< const typename ReaK::graph::alt_tree_view< AdjListOnTreeType >::edge_property_type,
                            const ReaK::graph::alt_tree_view< AdjListOnTreeType > > const_type;
};

template < typename AdjListOnTreeType >
struct raw_vertex_to_bundle_map< ReaK::graph::alt_tree_view< AdjListOnTreeType > > {
  typedef data_member_property_map< typename ReaK::graph::alt_tree_view< AdjListOnTreeType >::vertex_bundled,
                                    typename ReaK::graph::alt_tree_view< AdjListOnTreeType >::vertex_property_type >
    type;
  typedef data_member_property_map< const typename ReaK::graph::alt_tree_view< AdjListOnTreeType >::vertex_bundled,
                                    const typename ReaK::graph::alt_tree_view< AdjListOnTreeType >::
                                      vertex_property_type > const_type;
};
...
struct property_map< ReaK::graph::alt_tree_view< AdjListOnTreeType >, T Bundle::* > {
  ...
  typedef is_convertible< typename ReaK::graph::alt_tree_view< AdjListOnTreeType >::vertex_bundled*, non_const_Bundle* >
    is_vertex_bundle;
...
public:
  ...
  explicit alt_graph_view( GraphMutationVisitor aVis )
      : m_alt( new AdjListOnTreeType() ), m_vis( new mutation_visitor< GraphMutationVisitor >( aVis ) ){};
  ...
  edge_bundled& operator[]( const edge_descriptor& e_i ) { return m_alt->m_adj_list[e_i]; };
  const edge_bundled& operator[]( const edge_descriptor& e_i ) const { return m_alt->m_adj_list[e_i]; };
  ...
  vertex_descriptor source_impl( edge_descriptor e ) const { return source( e, m_alt->m_adj_list ); };
  vertex_descriptor target_impl( edge_descriptor e ) const { return target( e, m_alt->m_adj_list ); };
  degree_size_type out_degree_impl( vertex_descriptor v ) const { return out_degree( v, m_alt->m_adj_list ); };
  ...
  degree_size_type in_degree_impl( vertex_descriptor v ) const { return in_degree( v, m_alt->m_adj_list ); };
  degree_size_type degree_impl( edge_descriptor e ) const { return degree( e, m_alt->m_adj_list ); };
  ...
  std::pair< vertex_iterator, vertex_iterator > vertices_impl() const { return vertices( m_alt->m_adj_list ); };
  vertices_size_type num_vertices_impl() const { return num_vertices( m_alt->m_adj_list ); };

  // EdgeListGraph concept

  std::pair< edge_iterator, edge_iterator > edges_impl() const { return edges( m_alt->m_adj_list ); };
  edges_size_type num_edges_impl() const { return num_edges( m_alt->m_adj_list ); };
  ...
  void clear_vertex_impl( vertex_descriptor v ) { clear_vertex( v, m_alt->m_adj_list ); };
  ...
  void remove_edge_impl( vertex_descriptor u, vertex_descriptor v ) { remove_edge( u, v, m_alt->m_adj_list ); };

  void remove_edge_impl( edge_descriptor e ) { remove_edge( e, m_alt->m_adj_list ); };

  void remove_edge_impl( edge_iterator e_iter ) { remove_edge( e_iter, m_alt->m_adj_list ); };
  ...
  void remove_edge_impl( edge_descriptor e, edge_property_type& ep ) { remove_edge( e, ep, m_alt->m_adj_list ); };
...
template < typename AdjListOnTreeType >
alt_tree_view< AdjListOnTreeType >::alt_tree_view( const alt_graph_view< AdjListOnTreeType >& g )
    : m_alt( g.m_alt ){};
...
alt_graph_view< AdjListOnTreeType >::alt_graph_view( const alt_tree_view< AdjListOnTreeType >& t,
    ...
    : m_alt( t.m_alt ),
      m_vis(
        new typename alt_graph_view< AdjListOnTreeType >::template mutation_visitor< GraphMutationVisitor >( aVis ) ){};


template < typename AdjListOnTreeType, typename GraphMutationVisitor >
alt_graph_view< AdjListOnTreeType > make_graph_view( const alt_tree_view< AdjListOnTreeType >& t,
                                                     GraphMutationVisitor aVis ) {
...
struct property_map< ReaK::graph::detail::tree_vertex_properties_impl< TreeVertexProperty, AdjVertexProperty >,
                     vertex_key_t > {
  typedef data_member_property_map< std::size_t, ReaK::graph::detail::tree_vertex_properties_impl< TreeVertexProperty,
                                                                                                   AdjVertexProperty > >
    type;
  typedef data_member_property_map< const std::size_t,
                                    const ReaK::graph::detail::tree_vertex_properties_impl< TreeVertexProperty,
                                                                                            AdjVertexProperty > >
    const_type;
};
...
struct property_map< ReaK::graph::detail::tree_vertex_properties_impl< TreeVertexProperty, AdjVertexProperty >,
  ...
  typedef data_member_property_map< AdjVertexProperty,
                                    ReaK::graph::detail::tree_vertex_properties_impl< TreeVertexProperty,
                                                                                      AdjVertexProperty > > type;
  typedef data_member_property_map< const AdjVertexProperty,
                                    const ReaK::graph::detail::tree_vertex_properties_impl< TreeVertexProperty,
                                                                                            AdjVertexProperty > >
    const_type;
};
...
struct property_map< ReaK::graph::alt_graph_view< AdjListOnTreeType >, T Bundle::* > {
  typedef typename remove_const< Bundle >::type non_const_Bundle;
  typedef typename remove_const< T >::type non_const_T;
  typedef is_convertible< typename ReaK::graph::alt_graph_view< AdjListOnTreeType >::vertex_bundled*,
                          non_const_Bundle* > is_vertex_bundle;
