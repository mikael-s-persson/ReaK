...
struct asbastar_visitor_archetype : sbastar_visitor_archetype< Topology >, anytime_heuristic_visitor_archetype {};
...
/**
  ...
  */
template < typename Visitor, typename Graph, typename Topology >
struct ASBAStarBidirVisitorConcept : ASBAStarVisitorConcept< Visitor, Graph, Topology > {
...
/**
  ...
  */
template < typename Topology >
struct asbastar_bidir_visitor_archetype : asbastar_visitor_archetype< Topology >,
...
/**
  ...
  */
template < typename Topology >
struct asbarrtstar_visitor_archetype : sbarrtstar_visitor_archetype< Topology >, anytime_heuristic_visitor_archetype {};
...
/**
  ...
  */
template < typename Visitor, typename Graph, typename Topology >
struct ASBARRTStarBidirVisitorConcept : ASBARRTStarVisitorConcept< Visitor, Graph, Topology > {
...
/**
  ...
  */
template < typename Topology >
struct asbarrtstar_bidir_visitor_archetype : asbarrtstar_visitor_archetype< Topology >,
...
template < typename Graph, typename UniformCostVisitor, typename UpdatableQueue, typename IndexInHeapMap,
           typename KeyMap, typename PositionMap, typename WeightMap, typename DensityMap, typename ConstrictionMap,
...
struct anytime_sbastar_bfs_visitor
  : sbastar_bfs_visitor< Graph, UniformCostVisitor, UpdatableQueue, IndexInHeapMap, KeyMap, PositionMap, WeightMap,
                         DensityMap, ConstrictionMap, DistanceMap, PredecessorMap, FwdDistanceMap, SuccessorMap > {
  typedef sbastar_bfs_visitor< Graph, UniformCostVisitor, UpdatableQueue, IndexInHeapMap, KeyMap, PositionMap,
                               WeightMap, DensityMap, ConstrictionMap, DistanceMap, PredecessorMap, FwdDistanceMap,
                               SuccessorMap > base_type;
  ...
  anytime_sbastar_bfs_visitor( double current_relax, UniformCostVisitor vis, UpdatableQueue& Q,
                               IndexInHeapMap index_in_heap, KeyMap key, PositionMap pos, WeightMap weight,
                               DensityMap density, ConstrictionMap constriction, DistanceMap dist, PredecessorMap pred,
                               FwdDistanceMap fwd_dist, SuccessorMap succ = SuccessorMap() )
      : base_type( vis, Q, index_in_heap, key, pos, weight, density, constriction, dist, pred, fwd_dist, succ ),
  ...
  void update_key( Vertex u, Graph& g ) const {
    ...
    if( get( this->m_successor, g[u] ) == boost::graph_traits< Graph >::null_vertex() )
      put( this->m_key, u, ( ( g_u + h_u ) / ( 1.0 - get( this->m_constriction, g[u] ) ) )
                           / ( 1.0 - get( this->m_density, g[u] ) ) + m_current_relaxation * h_u );
    else
      put( this->m_key, u, ( ( g_u + h_u ) / ( 1.0 - get( this->m_constriction, g[u] ) ) )
                           / ( 1.0 - get( this->m_density, g[u] ) ) + m_current_relaxation * g_u );
  };
...
template < typename Graph, typename Topology, typename ASBAStarVisitor, typename NodeConnector, typename KeyMap,
           typename PositionMap, typename WeightMap, typename DensityMap, typename ConstrictionMap,
           typename DistanceMap, typename PredecessorMap, typename FwdDistanceMap, typename NcSelector >
void generate_anytime_sbastar_no_init_impl(
  Graph& g, typename boost::graph_traits< Graph >::vertex_descriptor start_vertex, const Topology& super_space,
  ASBAStarVisitor vis, NodeConnector connect_vertex, KeyMap key, PositionMap position, WeightMap weight,
  DensityMap density, ConstrictionMap constriction, DistanceMap distance, PredecessorMap predecessor,
  FwdDistanceMap fwd_distance, NcSelector select_neighborhood, double init_relaxation ) {
  typedef typename boost::graph_traits< Graph >::vertex_descriptor Vertex;
  ...
  anytime_sbastar_bfs_visitor< Graph, ASBAStarVisitor, MutableQueue, IndexInHeapMap, KeyMap, PositionMap, WeightMap,
                               DensityMap, ConstrictionMap, DistanceMap, PredecessorMap, FwdDistanceMap >
    sba_bfs_vis( init_relaxation, vis, Q, index_in_heap, key, position, weight, density, constriction, distance,
...
template < typename Graph, typename Topology, typename SBAStarVisitor, typename NodeConnector, typename PositionMap,
           typename WeightMap, typename DensityMap, typename ConstrictionMap, typename DistanceMap,
           typename PredecessorMap, typename FwdDistanceMap, typename SuccessorMap, typename KeyMap,
           typename NcSelector >
void generate_anytime_sbastar_bidir_no_init_impl(
  Graph& g, typename boost::graph_traits< Graph >::vertex_descriptor start_vertex,
  typename boost::graph_traits< Graph >::vertex_descriptor goal_vertex, const Topology& super_space, SBAStarVisitor vis,
  NodeConnector connect_vertex, KeyMap key, PositionMap position, WeightMap weight, DensityMap density,
  ConstrictionMap constriction, DistanceMap distance, PredecessorMap predecessor, FwdDistanceMap fwd_distance,
  SuccessorMap successor, NcSelector select_neighborhood, double init_relaxation ) {
  typedef typename boost::graph_traits< Graph >::vertex_descriptor Vertex;
  ...
  anytime_sbastar_bfs_visitor< Graph, SBAStarVisitor, MutableQueue, IndexInHeapMap, KeyMap, PositionMap, WeightMap,
                               DensityMap, ConstrictionMap, DistanceMap, PredecessorMap, FwdDistanceMap, SuccessorMap >
    sba_bfs_vis( init_relaxation, vis, Q, index_in_heap, key, position, weight, density, constriction, distance,
...
template < typename Graph, typename Topology, typename ASBARRTStarVisitor, typename NodeConnector, typename KeyMap,
           typename PositionMap, typename WeightMap, typename DensityMap, typename ConstrictionMap,
           typename DistanceMap, typename PredecessorMap, typename FwdDistanceMap, typename RandomSampler,
           typename NcSelector >
void generate_anytime_sbarrtstar_no_init_impl(
  Graph& g, typename boost::graph_traits< Graph >::vertex_descriptor start_vertex, const Topology& super_space,
  ASBARRTStarVisitor vis, NodeConnector connect_vertex, KeyMap key, PositionMap position, WeightMap weight,
  DensityMap density, ConstrictionMap constriction, DistanceMap distance, PredecessorMap predecessor,
  FwdDistanceMap fwd_distance, RandomSampler get_sample, NcSelector select_neighborhood, double init_relaxation,
  ...
  anytime_sbastar_bfs_visitor< Graph, ASBARRTStarVisitor, MutableQueue, IndexInHeapMap, KeyMap, PositionMap, WeightMap,
                               DensityMap, ConstrictionMap, DistanceMap, PredecessorMap, FwdDistanceMap >
    sba_bfs_vis( init_relaxation, vis, Q, index_in_heap, key, position, weight, density, constriction, distance,
                 predecessor, fwd_distance );
  ...
  sbarrtstar_search_loop(
    ...
    rrg_node_generator< Topology, RandomSampler, NcSelector >( &super_space, get_sample, select_neighborhood ), Q,
...
void generate_anytime_sbarrtstar_bidir_no_init_impl(
  Graph& g, typename boost::graph_traits< Graph >::vertex_descriptor start_vertex,
  typename boost::graph_traits< Graph >::vertex_descriptor goal_vertex, const Topology& super_space,
  ASBARRTStarVisitor vis, NodeConnector connect_vertex, KeyMap key, PositionMap position, WeightMap weight,
  DensityMap density, ConstrictionMap constriction, DistanceMap distance, PredecessorMap predecessor,
  FwdDistanceMap fwd_distance, SuccessorMap successor, RandomSampler get_sample, NcSelector select_neighborhood,
  ...
  sbarrtstar_bidir_loop( g, super_space, sba_bfs_vis, connect_vertex, sba_bidir_node_generator(),
                         rrg_bidir_generator< Topology, RandomSampler, NcSelector, PredecessorMap, SuccessorMap >(
                           &super_space, get_sample, select_neighborhood, predecessor, successor ),
...
void generate_anytime_sbastar_no_init( const SBAStarBundle& bdl, double init_relaxation ) {
  detail::generate_anytime_sbastar_no_init_impl( *( bdl.m_g ), bdl.m_start_vertex, *( bdl.m_super_space ), bdl.m_vis,
...
/**
  ...
  */
template < typename SBAStarBundle >
void generate_anytime_sbastar( const SBAStarBundle& bdl, double init_relaxation ) {
...
/**
  ...
  */
template < typename SBAStarBundle >
void generate_anytime_sbastar_bidir_no_init( const SBAStarBundle& bdl, double init_relaxation ) {
  detail::generate_anytime_sbastar_bidir_no_init_impl(
    *( bdl.m_g ), bdl.m_start_vertex, bdl.m_goal_vertex, *( bdl.m_super_space ), bdl.m_vis, pruned_node_connector(),
    bdl.m_key, bdl.m_position, bdl.m_weight, bdl.m_density, bdl.m_constriction, bdl.m_distance, bdl.m_predecessor,
...
/**
  ...
  */
template < typename SBAStarBundle >
void generate_anytime_sbastar_bidir( const SBAStarBundle& bdl, double init_relaxation ) {
  detail::initialize_sbastar_nodes( *( bdl.m_g ), bdl.m_vis, bdl.m_key, bdl.m_distance, bdl.m_predecessor,
...
/**
  ...
  */
template < typename SBAStarBundle >
void generate_anytime_lazy_sbastar_no_init( const SBAStarBundle& bdl, double init_relaxation ) {
  detail::generate_anytime_sbastar_no_init_impl( *( bdl.m_g ), bdl.m_start_vertex, *( bdl.m_super_space ), bdl.m_vis,
...
/**
  ...
  */
template < typename SBAStarBundle >
void generate_anytime_lazy_sbastar( const SBAStarBundle& bdl, double init_relaxation ) {
  detail::initialize_sbastar_nodes( *( bdl.m_g ), bdl.m_vis, bdl.m_key, bdl.m_distance, bdl.m_predecessor );
...
/**
  ...
  */
template < typename SBAStarBundle >
void generate_anytime_lazy_sbastar_bidir_no_init( const SBAStarBundle& bdl, double init_relaxation ) {
  detail::generate_anytime_sbastar_bidir_no_init_impl(
    *( bdl.m_g ), bdl.m_start_vertex, bdl.m_goal_vertex, *( bdl.m_super_space ), bdl.m_vis, lazy_node_connector(),
    bdl.m_key, bdl.m_position, bdl.m_weight, bdl.m_density, bdl.m_constriction, bdl.m_distance, bdl.m_predecessor,
    bdl.m_fwd_distance, bdl.m_successor, bdl.m_select_neighborhood, init_relaxation );
};
 ...
 * search.
  ...
  */
template < typename SBAStarBundle >
void generate_anytime_lazy_sbastar_bidir( const SBAStarBundle& bdl, double init_relaxation ) {
  detail::initialize_sbastar_nodes( *( bdl.m_g ), bdl.m_vis, bdl.m_key, bdl.m_distance, bdl.m_predecessor,
                                    bdl.m_fwd_distance, bdl.m_successor );
...
/**
  ...
  */
template < typename SBAStarBundle >
void generate_anytime_lazy_bnb_sbastar_no_init( const SBAStarBundle& bdl, double init_relaxation ) {
  BOOST_CONCEPT_ASSERT(
    (ASBAStarVisitorConcept< typename SBAStarBundle::visitor_type, typename SBAStarBundle::graph_type,
                             typename SBAStarBundle::topology_type >));
  ...
  if( bdl.m_goal_vertex == boost::graph_traits< typename SBAStarBundle::graph_type >::null_vertex() ) {
    ...
    bnb_ordering_data< typename SBAStarBundle::graph_type > bnb_data( *( bdl.m_g ), bdl.m_start_vertex,
                                                                      bdl.m_goal_vertex );
    detail::generate_anytime_sbastar_no_init_impl( *( bdl.m_g ), bdl.m_start_vertex, *( bdl.m_super_space ), bdl.m_vis,
                                                   bnb_connector< typename SBAStarBundle::graph_type >( bnb_data ),
                                                   bdl.m_key, bdl.m_position, bdl.m_weight, bdl.m_density,
                                                   bdl.m_constriction, bdl.m_distance, bdl.m_predecessor,
                                                   bdl.m_fwd_distance, bdl.m_select_neighborhood, init_relaxation );
  };
};
...
/**
  ...
  */
template < typename SBAStarBundle >
void generate_anytime_lazy_bnb_sbastar( const SBAStarBundle& bdl, double init_relaxation ) {
  detail::initialize_sbastar_nodes( *( bdl.m_g ), bdl.m_vis, bdl.m_key, bdl.m_distance, bdl.m_predecessor );
...
/**
  ...
  */
template < typename SBAStarBundle >
void generate_anytime_lazy_bnb_sbastar_bidir_no_init( const SBAStarBundle& bdl, double init_relaxation ) {
  if( bdl.m_goal_vertex == boost::graph_traits< typename SBAStarBundle::graph_type >::null_vertex() ) {
    detail::generate_anytime_sbastar_bidir_no_init_impl(
      *( bdl.m_g ), bdl.m_start_vertex, bdl.m_goal_vertex, *( bdl.m_super_space ), bdl.m_vis, lazy_node_connector(),
      bdl.m_key, bdl.m_position, bdl.m_weight, bdl.m_density, bdl.m_constriction, bdl.m_distance, bdl.m_predecessor,
    ...
    detail::generate_anytime_sbastar_bidir_no_init_impl(
      *( bdl.m_g ), bdl.m_start_vertex, bdl.m_goal_vertex, *( bdl.m_super_space ), bdl.m_vis,
      bnb_connector< typename SBAStarBundle::graph_type >( bnb_data ), bdl.m_key, bdl.m_position, bdl.m_weight,
      bdl.m_density, bdl.m_constriction, bdl.m_distance, bdl.m_predecessor, bdl.m_fwd_distance, bdl.m_successor,
 ...
 * search.
  ...
  */
template < typename SBAStarBundle >
void generate_anytime_lazy_bnb_sbastar_bidir( const SBAStarBundle& bdl, double init_relaxation ) {
  detail::initialize_sbastar_nodes( *( bdl.m_g ), bdl.m_vis, bdl.m_key, bdl.m_distance, bdl.m_predecessor,
                                    bdl.m_fwd_distance, bdl.m_successor );
...
void generate_anytime_sbarrtstar_no_init( const SBAStarBundle& bdl, RandomSampler get_sample, double init_relaxation,
                                          double SA_init_temperature = 0.0 ) {
  detail::generate_anytime_sbarrtstar_no_init_impl(
    *( bdl.m_g ), bdl.m_start_vertex, *( bdl.m_super_space ), bdl.m_vis, pruned_node_connector(), bdl.m_key,
    bdl.m_position, bdl.m_weight, bdl.m_density, bdl.m_constriction, bdl.m_distance, bdl.m_predecessor,
    bdl.m_fwd_distance, get_sample, bdl.m_select_neighborhood, init_relaxation, SA_init_temperature );
};
...
/**
  ...
  */
template < typename SBAStarBundle, typename RandomSampler >
void generate_anytime_sbarrtstar( const SBAStarBundle& bdl, RandomSampler get_sample, double init_relaxation,
                                  double SA_init_temperature = 0.0 ) {
  detail::initialize_sbastar_nodes( *( bdl.m_g ), bdl.m_vis, bdl.m_key, bdl.m_distance, bdl.m_predecessor );
...
/**
  ...
  */
template < typename SBAStarBundle, typename RandomSampler >
void generate_anytime_sbarrtstar_bidir_no_init( const SBAStarBundle& bdl, RandomSampler get_sample,
                                                double init_relaxation, double SA_init_temperature = 0.0 ) {
  detail::generate_anytime_sbarrtstar_bidir_no_init_impl(
    *( bdl.m_g ), bdl.m_start_vertex, bdl.m_goal_vertex, *( bdl.m_super_space ), bdl.m_vis, pruned_node_connector(),
    bdl.m_key, bdl.m_position, bdl.m_weight, bdl.m_density, bdl.m_constriction, bdl.m_distance, bdl.m_predecessor,
    bdl.m_fwd_distance, bdl.m_successor, get_sample, bdl.m_select_neighborhood, init_relaxation, SA_init_temperature );
};
 ...
 * search.
  ...
  */
template < typename SBAStarBundle, typename RandomSampler >
void generate_anytime_sbarrtstar_bidir( const SBAStarBundle& bdl, RandomSampler get_sample, double init_relaxation,
                                        double SA_init_temperature = 0.0 ) {
  detail::initialize_sbastar_nodes( *( bdl.m_g ), bdl.m_vis, bdl.m_key, bdl.m_distance, bdl.m_predecessor,
                                    bdl.m_fwd_distance, bdl.m_successor );
  generate_anytime_sbarrtstar_bidir_no_init( bdl, get_sample, init_relaxation, SA_init_temperature );
};
...
/**
  ...
  */
template < typename SBAStarBundle, typename RandomSampler >
void generate_anytime_lazy_sbarrtstar_no_init( const SBAStarBundle& bdl, RandomSampler get_sample,
                                               double init_relaxation, double SA_init_temperature = 0.0 ) {
  BOOST_CONCEPT_ASSERT(
    (SBARRTStarVisitorConcept< typename SBAStarBundle::visitor_type, typename SBAStarBundle::graph_type,
                               typename SBAStarBundle::topology_type >));
  BOOST_CONCEPT_ASSERT(
    (ASBAStarVisitorConcept< typename SBAStarBundle::visitor_type, typename SBAStarBundle::graph_type,
                             typename SBAStarBundle::topology_type >));
  ...
  detail::generate_anytime_sbarrtstar_no_init_impl(
    *( bdl.m_g ), bdl.m_start_vertex, *( bdl.m_super_space ), bdl.m_vis, lazy_node_connector(), bdl.m_key,
    bdl.m_position, bdl.m_weight, bdl.m_density, bdl.m_constriction, bdl.m_distance, bdl.m_predecessor,
    bdl.m_fwd_distance, get_sample, bdl.m_select_neighborhood, init_relaxation, SA_init_temperature );
};
...
/**
  ...
  */
template < typename SBAStarBundle, typename RandomSampler >
void generate_anytime_lazy_sbarrtstar( const SBAStarBundle& bdl, RandomSampler get_sample, double init_relaxation,
                                       double SA_init_temperature = 0.0 ) {
  BOOST_CONCEPT_ASSERT(
    (SBARRTStarVisitorConcept< typename SBAStarBundle::visitor_type, typename SBAStarBundle::graph_type,
                               typename SBAStarBundle::topology_type >));
...
/**
  ...
  */
template < typename SBAStarBundle, typename RandomSampler >
void generate_anytime_lazy_sbarrtstar_bidir_no_init( const SBAStarBundle& bdl, RandomSampler get_sample,
                                                     double init_relaxation, double SA_init_temperature = 0.0 ) {
  BOOST_CONCEPT_ASSERT(
    (SBARRTStarVisitorConcept< typename SBAStarBundle::visitor_type, typename SBAStarBundle::graph_type,
                               typename SBAStarBundle::topology_type >));
 ...
 * the search.
  ...
  */
template < typename SBAStarBundle, typename RandomSampler >
void generate_anytime_lazy_sbarrtstar_bidir( const SBAStarBundle& bdl, RandomSampler get_sample, double init_relaxation,
                                             double SA_init_temperature = 0.0 ) {
  BOOST_CONCEPT_ASSERT(
    (SBARRTStarVisitorConcept< typename SBAStarBundle::visitor_type, typename SBAStarBundle::graph_type,
                               typename SBAStarBundle::topology_type >));
  ...
  detail::initialize_sbastar_nodes( *( bdl.m_g ), bdl.m_vis, bdl.m_key, bdl.m_distance, bdl.m_predecessor,
                                    bdl.m_fwd_distance, bdl.m_successor );
  generate_anytime_lazy_sbarrtstar_bidir_no_init( bdl, get_sample, init_relaxation, SA_init_temperature );
};
...
/**
  ...
  */
template < typename SBAStarBundle, typename RandomSampler >
void generate_anytime_lazy_bnb_sbarrtstar_no_init( const SBAStarBundle& bdl, RandomSampler get_sample,
                                                   double init_relaxation, double SA_init_temperature = 0.0 ) {
  BOOST_CONCEPT_ASSERT(
    (SBARRTStarVisitorConcept< typename SBAStarBundle::visitor_type, typename SBAStarBundle::graph_type,
                               typename SBAStarBundle::topology_type >));
  ...
  if( bdl.m_goal_vertex == boost::graph_traits< typename SBAStarBundle::graph_type >::null_vertex() ) {
    ...
    detail::generate_anytime_sbarrtstar_no_init_impl(
      *( bdl.m_g ), bdl.m_start_vertex, *( bdl.m_super_space ), bdl.m_vis,
      bnb_connector< typename SBAStarBundle::graph_type >( bnb_data ), bdl.m_key, bdl.m_position, bdl.m_weight,
      bdl.m_density, bdl.m_constriction, bdl.m_distance, bdl.m_predecessor, bdl.m_fwd_distance, get_sample,
...
/**
  ...
  */
template < typename SBAStarBundle, typename RandomSampler >
void generate_anytime_lazy_bnb_sbarrtstar( const SBAStarBundle& bdl, RandomSampler get_sample, double init_relaxation,
                                           double SA_init_temperature = 0.0 ) {
  BOOST_CONCEPT_ASSERT(
    (SBARRTStarVisitorConcept< typename SBAStarBundle::visitor_type, typename SBAStarBundle::graph_type,
                               typename SBAStarBundle::topology_type >));
  ...
  detail::initialize_sbastar_nodes( *( bdl.m_g ), bdl.m_vis, bdl.m_key, bdl.m_distance, bdl.m_predecessor );
  generate_anytime_lazy_bnb_sbarrtstar_no_init( bdl, get_sample, init_relaxation, SA_init_temperature );
};
 ...
 * existing graph.
  ...
  */
template < typename SBAStarBundle, typename RandomSampler >
void generate_anytime_lazy_bnb_sbarrtstar_bidir_no_init( const SBAStarBundle& bdl, RandomSampler get_sample,
                                                         double init_relaxation, double SA_init_temperature = 0.0 ) {
  BOOST_CONCEPT_ASSERT(
    (SBARRTStarVisitorConcept< typename SBAStarBundle::visitor_type, typename SBAStarBundle::graph_type,
                               typename SBAStarBundle::topology_type >));
  ...
  if( bdl.m_goal_vertex == boost::graph_traits< typename SBAStarBundle::graph_type >::null_vertex() ) {
    detail::generate_anytime_sbarrtstar_bidir_no_init_impl(
      *( bdl.m_g ), bdl.m_start_vertex, bdl.m_goal_vertex, *( bdl.m_super_space ), bdl.m_vis, lazy_node_connector(),
      bdl.m_key, bdl.m_position, bdl.m_weight, bdl.m_density, bdl.m_constriction, bdl.m_distance, bdl.m_predecessor,
      bdl.m_fwd_distance, bdl.m_successor, get_sample, bdl.m_select_neighborhood, init_relaxation,
      SA_init_temperature );
  } else {
    bnb_ordering_data< typename SBAStarBundle::graph_type > bnb_data( *( bdl.m_g ), bdl.m_start_vertex,
                                                                      bdl.m_goal_vertex );
    detail::generate_anytime_sbarrtstar_bidir_no_init_impl(
      *( bdl.m_g ), bdl.m_start_vertex, bdl.m_goal_vertex, *( bdl.m_super_space ), bdl.m_vis,
      bnb_connector< typename SBAStarBundle::graph_type >( bnb_data ), bdl.m_key, bdl.m_position, bdl.m_weight,
      bdl.m_density, bdl.m_constriction, bdl.m_distance, bdl.m_predecessor, bdl.m_fwd_distance, bdl.m_successor,
      get_sample, bdl.m_select_neighborhood, init_relaxation, SA_init_temperature );
  };
};
 ...
 * existing graph to (re)start the search.
  ...
  */
template < typename SBAStarBundle, typename RandomSampler >
void generate_anytime_lazy_bnb_sbarrtstar_bidir( const SBAStarBundle& bdl, RandomSampler get_sample,
                                                 double init_relaxation, double SA_init_temperature = 0.0 ) {
  BOOST_CONCEPT_ASSERT(
    (SBARRTStarVisitorConcept< typename SBAStarBundle::visitor_type, typename SBAStarBundle::graph_type,
                               typename SBAStarBundle::topology_type >));
  ...
  detail::initialize_sbastar_nodes( *( bdl.m_g ), bdl.m_vis, bdl.m_key, bdl.m_distance, bdl.m_predecessor,
                                    bdl.m_fwd_distance, bdl.m_successor );
  generate_anytime_lazy_bnb_sbarrtstar_bidir_no_init( bdl, get_sample, init_relaxation, SA_init_temperature );
};
};
};
