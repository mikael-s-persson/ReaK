...
struct sbarrtstar_visitor_archetype : sbastar_visitor_archetype< Topology >, node_pulling_visitor_archetype {};
 ...
 */
template < typename Topology >
struct sbarrtstar_bidir_visitor_archetype : sbarrtstar_visitor_archetype< Topology >,
...
template < typename Graph, typename Topology, typename SBARRTStarVisitor, typename MotionGraphConnector,
           typename SBANodeGenerator, typename RRTNodeGenerator, typename MutableQueue, typename NcSelector >
void sbarrtstar_search_loop( Graph& g, const Topology& super_space, SBARRTStarVisitor& sba_vis,
                             MotionGraphConnector connect_vertex, SBANodeGenerator sba_generate_node,
                             RRTNodeGenerator rrt_generate_node, MutableQueue& Q, NcSelector select_neighborhood,
...
template < typename Graph, typename Topology, typename SBARRTStarVisitor, typename MotionGraphConnector,
           typename SBANodeGenerator, typename RRTNodeGenerator, typename MutableQueue, typename NcSelector >
void sbarrtstar_bidir_loop( Graph& g, const Topology& super_space, SBARRTStarVisitor& sba_vis,
                            MotionGraphConnector connect_vertex, SBANodeGenerator sba_generate_node,
                            RRTNodeGenerator rrt_generate_node, MutableQueue& Q, NcSelector select_neighborhood,
                            double initial_temperature ) {
  typedef typename ReaK::pp::topology_traits< Topology >::point_type PositionValue;
...
template < typename Graph, typename Topology, typename SBARRTStarVisitor, typename NodeConnector, typename KeyMap,
           ...
           typename NcSelector >
void generate_sbarrtstar_no_init_impl( Graph& g, typename boost::graph_traits< Graph >::vertex_descriptor start_vertex,
                                       const Topology& super_space, SBARRTStarVisitor vis, NodeConnector connect_vertex,
  ...
  sbastar_bfs_visitor< Graph, SBARRTStarVisitor, MutableQueue, IndexInHeapMap, KeyMap, PositionMap, WeightMap,
                       DensityMap, ConstrictionMap, DistanceMap, PredecessorMap,
...
void generate_sbarrtstar_bidir_no_init_impl(
  ...
  SBARRTStarVisitor vis, NodeConnector connect_vertex, KeyMap key, PositionMap position, WeightMap weight,
...
void generate_sbarrtstar_no_init( const SBAStarBundle& bdl, RandomSampler get_sample,
                                  double SA_init_temperature = 0.0 ) {
...
/**
  ...
  */
template < typename SBAStarBundle, typename RandomSampler >
void generate_sbarrtstar( const SBAStarBundle& bdl, RandomSampler get_sample, double SA_init_temperature = 0.0 ) {
  BOOST_CONCEPT_ASSERT(
    (SBARRTStarVisitorConcept< typename SBAStarBundle::visitor_type, typename SBAStarBundle::graph_type,
                               typename SBAStarBundle::topology_type >));
...
/**
  ...
  */
template < typename SBAStarBundle, typename RandomSampler >
void generate_sbarrtstar_bidir_no_init( const SBAStarBundle& bdl, RandomSampler get_sample,
                                        double SA_init_temperature = 0.0 ) {
...
/**
  ...
  */
template < typename SBAStarBundle, typename RandomSampler >
void generate_sbarrtstar_bidir( const SBAStarBundle& bdl, RandomSampler get_sample, double SA_init_temperature = 0.0 ) {
  detail::initialize_sbastar_nodes( *( bdl.m_g ), bdl.m_vis, bdl.m_key, bdl.m_distance, bdl.m_predecessor,
...
/**
  ...
  */
template < typename SBAStarBundle, typename RandomSampler >
void generate_lazy_sbarrtstar_no_init( const SBAStarBundle& bdl, RandomSampler get_sample,
                                       double SA_init_temperature = 0.0 ) {
  BOOST_CONCEPT_ASSERT(
    (SBARRTStarVisitorConcept< typename SBAStarBundle::visitor_type, typename SBAStarBundle::graph_type,
                               typename SBAStarBundle::topology_type >));
...
/**
  ...
  */
template < typename SBAStarBundle, typename RandomSampler >
void generate_lazy_sbarrtstar( const SBAStarBundle& bdl, RandomSampler get_sample, double SA_init_temperature = 0.0 ) {
  BOOST_CONCEPT_ASSERT(
    (SBARRTStarVisitorConcept< typename SBAStarBundle::visitor_type, typename SBAStarBundle::graph_type,
                               typename SBAStarBundle::topology_type >));
...
/**
  ...
  */
template < typename SBAStarBundle, typename RandomSampler >
void generate_lazy_sbarrtstar_bidir_no_init( const SBAStarBundle& bdl, RandomSampler get_sample,
                                             double SA_init_temperature = 0.0 ) {
  detail::generate_sbarrtstar_bidir_no_init_impl(
...
/**
  ...
  */
template < typename SBAStarBundle, typename RandomSampler >
void generate_lazy_sbarrtstar_bidir( const SBAStarBundle& bdl, RandomSampler get_sample,
                                     double SA_init_temperature = 0.0 ) {
  detail::initialize_sbastar_nodes( *( bdl.m_g ), bdl.m_vis, bdl.m_key, bdl.m_distance, bdl.m_predecessor,
                                    bdl.m_fwd_distance, bdl.m_successor );
...
/**
  ...
  */
template < typename SBAStarBundle, typename RandomSampler >
void generate_lazy_bnb_sbarrtstar_no_init( const SBAStarBundle& bdl, RandomSampler get_sample,
                                           double SA_init_temperature = 0.0 ) {
  if( bdl.m_goal_vertex == boost::graph_traits< typename SBAStarBundle::graph_type >::null_vertex() ) {
    ...
    bnb_ordering_data< typename SBAStarBundle::graph_type > bnb_data( *( bdl.m_g ), bdl.m_start_vertex,
                                                                      bdl.m_goal_vertex );
    detail::generate_sbarrtstar_no_init_impl( *( bdl.m_g ), bdl.m_start_vertex, *( bdl.m_super_space ), bdl.m_vis,
                                              ...
                                              get_sample, bdl.m_select_neighborhood, SA_init_temperature );
  };
};
...
/**
  ...
  */
template < typename SBAStarBundle, typename RandomSampler >
void generate_lazy_bnb_sbarrtstar( const SBAStarBundle& bdl, RandomSampler get_sample,
                                   double SA_init_temperature = 0.0 ) {
  detail::initialize_sbastar_nodes( *( bdl.m_g ), bdl.m_vis, bdl.m_key, bdl.m_distance, bdl.m_predecessor );
...
/**
  ...
  */
template < typename SBAStarBundle, typename RandomSampler >
void generate_lazy_bnb_sbarrtstar_bidir_no_init( const SBAStarBundle& bdl, RandomSampler get_sample,
                                                 double SA_init_temperature = 0.0 ) {
  if( bdl.m_goal_vertex == boost::graph_traits< typename SBAStarBundle::graph_type >::null_vertex() ) {
    detail::generate_sbarrtstar_bidir_no_init_impl(
      *( bdl.m_g ), bdl.m_start_vertex, bdl.m_goal_vertex, *( bdl.m_super_space ), bdl.m_vis, lazy_node_connector(),
...
/**
  ...
  */
template < typename SBAStarBundle, typename RandomSampler >
void generate_lazy_bnb_sbarrtstar_bidir( const SBAStarBundle& bdl, RandomSampler get_sample,
                                         double SA_init_temperature = 0.0 ) {
  detail::initialize_sbastar_nodes( *( bdl.m_g ), bdl.m_vis, bdl.m_key, bdl.m_distance, bdl.m_predecessor,
                                    bdl.m_fwd_distance, bdl.m_successor );
