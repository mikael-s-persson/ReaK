...
// edge is useful as an in-edge to (*it).
  ...
  template < typename Vertex, typename Graph, typename ConnectorVisitor, typename DistanceMap, typename PredecessorMap,
             typename WeightMap >
  static void update_successors( Vertex v, Graph& g, const ConnectorVisitor& conn_vis, DistanceMap distance,
  ...
  template < typename Vertex, typename Graph, typename ConnectorVisitor, typename FwdDistanceMap, typename SuccessorMap,
             typename WeightMap >
  static void update_predecessors( Vertex v, Graph& g, const ConnectorVisitor& conn_vis, FwdDistanceMap fwd_distance,
  ...
  template < typename Vertex, typename EdgeProp, typename Graph, typename ConnectorVisitor, typename DistanceMap,
             typename PredecessorMap, typename WeightMap >
  static void create_pred_edge( Vertex v, Vertex& x_near, EdgeProp& eprop, Graph& g, const ConnectorVisitor& conn_vis,
  ...
  template < typename Vertex, typename EdgeProp, typename Graph, typename ConnectorVisitor, typename FwdDistanceMap,
             typename SuccessorMap, typename WeightMap >
  static void create_succ_edge( Vertex v, Vertex& x_near, EdgeProp& eprop, Graph& g, const ConnectorVisitor& conn_vis,
                                FwdDistanceMap fwd_distance, SuccessorMap successor, WeightMap weight ) {
    typedef typename boost::graph_traits< Graph >::edge_descriptor Edge;
