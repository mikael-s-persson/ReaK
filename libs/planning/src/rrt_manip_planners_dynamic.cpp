...
#define RK_RRT_MANIP_PLANNERS_MAKE_DYNAMIC_MANIP_EXTERN_INSTANCES( NDOF )                             \
  template class rrt_planner< manip_dynamic_env< typename Ndof_rl_space< double, NDOF, 0 >::type > >; \
  template class rrt_planner< manip_dynamic_env< typename Ndof_rl_space< double, NDOF, 1 >::type > >; \
  template class rrt_planner< manip_dynamic_env< typename Ndof_rl_space< double, NDOF, 2 >::type > >;
