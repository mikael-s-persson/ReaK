...
#   echo "$SR_OPTIONS --sba-star --sba-density-cutoff=0.1 --sba-relaxation=5.0 --sba-with-voronoi-pull $SR_STRUCTS" > pp_results/$1/sbastar_rrtstar/info.txt
  ...
  echo "$SR_OPTIONS --sba-star --sba-density-cutoff=0.1 --sba-relaxation=5.0 --sba-with-voronoi-pull --sba-sa-temperature=2.0 $SR_STRUCTS" > pp_results/$1/sbastar_lazy_any_sa/info.txt

#   ./test_planners -i $1.bmp -o pp_results/$1 $SR_OPTIONS --sba-star --sba-density-cutoff=0.1 --sba-relaxation=5.0 --sba-with-voronoi-pull --sba-sa-temperature=2.0 --sba-with-bnb $SR_STRUCTS
#   echo "$SR_OPTIONS --sba-star --sba-density-cutoff=0.1 --sba-relaxation=5.0 --sba-with-voronoi-pull --sba-sa-temperature=2.0 --sba-with-bnb $SR_STRUCTS" > pp_results/$1/sbastar_lazy_any_sa_bnb/info.txt
