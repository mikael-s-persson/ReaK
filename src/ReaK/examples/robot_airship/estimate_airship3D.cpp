...
int main(int argc, char** argv) {
  ...
  ctrl::airship3D_lin2_dt_system mdl_lin_dt("airship3D_linear_discrete",mass,inertia_tensor,time_step);
  ctrl::airship3D_inv2_dt_system mdl_inv_dt("airship3D_invariant_discrete",mass,inertia_tensor,time_step);
