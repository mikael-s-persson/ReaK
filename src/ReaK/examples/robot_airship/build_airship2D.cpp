...
int main() {
  ...
  boost::shared_ptr< frame_2D<double> > 
  ...
  boost::shared_ptr< jacobian_2D_2D<double> >
    airship2D_joint_jac( new jacobian_2D_2D<double>(), scoped_deleter());
  
  boost::shared_ptr< kte::free_joint_2D > 
  ...
  boost::shared_ptr< kte::inertia_2D >
