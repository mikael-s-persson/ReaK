...
void X8_quadrotor_kinematics::doInverseMotion() {
...
void X8_quadrotor_kinematics::getJacobianMatrix(mat<double,mat_structure::rectangular>& Jac) const {
...
vect_n<double> X8_quadrotor_kinematics::getJointPositions() const {
...
void X8_quadrotor_kinematics::setJointPositions(const vect_n<double>& aJointPositions) {
...
vect_n<double> X8_quadrotor_kinematics::getJointVelocities() const {
...
void X8_quadrotor_kinematics::setJointVelocities(const vect_n<double>& aJointVelocities) {
...
vect_n<double> X8_quadrotor_kinematics::getJointAccelerations() const {
...
void X8_quadrotor_kinematics::setJointAccelerations(const vect_n<double>& aJointAccelerations) {
...
vect_n<double> X8_quadrotor_kinematics::getDependentPositions() const {
...
void X8_quadrotor_kinematics::setDependentPositions(const vect_n<double>& aDepPositions) {
...
vect_n<double> X8_quadrotor_kinematics::getDependentVelocities() const {
  return vect_n<double>(
...
void X8_quadrotor_kinematics::setDependentVelocities(const vect_n<double>& aDepVelocities) {
...
vect_n<double> X8_quadrotor_kinematics::getDependentAccelerations() const {
  return vect_n<double>(
...
void X8_quadrotor_kinematics::setDependentAccelerations(const vect_n<double>& aDepAccelerations) {
...
void RK_CALL X8_quadrotor_kinematics::save(serialization::oarchive& A, unsigned int) const {
...
void RK_CALL X8_quadrotor_kinematics::load(serialization::iarchive& A, unsigned int) {
