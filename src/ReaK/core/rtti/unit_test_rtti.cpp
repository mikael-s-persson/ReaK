...
class dummy_rtti_test : public ReaK::shared_object {
  public:
    ...
    virtual void RK_CALL save(ReaK::serialization::oarchive& A, unsigned int) const {
      ReaK::shared_object::save(A,ReaK::shared_object::getStaticObjectType()->TypeVersion());
    };
    virtual void RK_CALL load(ReaK::serialization::iarchive& A, unsigned int) {
      ReaK::shared_object::load(A,ReaK::shared_object::getStaticObjectType()->TypeVersion());
    };
    
    RK_RTTI_MAKE_CONCRETE_1BASE(dummy_rtti_test,0xFFFFFFF0,1,"dummy_rtti_test",ReaK::shared_object)
...
class dummy_rtti_template : public ReaK::shared_object {
  public:
    ...
    RK_RTTI_MAKE_CONCRETE_1BASE(self,0xFFFFFFF1,1,"dummy_rtti_template",ReaK::shared_object)
...
struct get_type_info< dummy_rtti_template<N, T>, Tail > {
  typedef type_id< dummy_rtti_template<N, T> , typename get_type_info<boost::mpl::int_<N>, 
                                                   get_type_info<T, Tail> >::type > type;
#ifdef RK_RTTI_USE_CONSTEXPR_STRINGS
  BOOST_STATIC_CONSTEXPR auto type_name = get_type_id< dummy_rtti_template<N, T> >::type_name 
    + lsl_left_bracket + get_type_id< boost::mpl::int_<N> >::type_name + lsl_comma 
    + get_type_id<T>::type_name + lsl_right_bracket
    + get_type_name_tail<Tail>::value;
#else
  static std::string type_name() { 
    std::string result = get_type_id< dummy_rtti_template<N, T> >::type_name();
    result += "<";
    result += get_type_id< boost::mpl::int_<N> >::type_name();
    result += ",";
...
class dummy_rtti_template2 : public ReaK::shared_object {
  public:
    ...
    RK_RTTI_MAKE_CONCRETE_1BASE(self,0xFFFFFFF2,1,"dummy_rtti_template2",ReaK::shared_object)
...
class dummy_rtti_base1 : public virtual ReaK::shared_object {
  public:
    ...
    RK_RTTI_MAKE_CONCRETE_1BASE(dummy_rtti_base1,0xFFFFFFF3,1,"dummy_rtti_base1",ReaK::shared_object)
...
class dummy_rtti_base2 : public virtual ReaK::shared_object {
  public:
    ...
    RK_RTTI_MAKE_CONCRETE_1BASE(dummy_rtti_base2,0xFFFFFFF4,1,"dummy_rtti_base2",ReaK::shared_object)
    
};

class dummy_rtti_multi_inherit : public dummy_rtti_base1, public dummy_rtti_base2 {
  public:
    
    dummy_rtti_multi_inherit() : dummy_rtti_base1(), dummy_rtti_base2() { };
    
    virtual void RK_CALL save(ReaK::serialization::oarchive& A, unsigned int) const {
      dummy_rtti_base1::save(A,dummy_rtti_base1::getStaticObjectType()->TypeVersion());
      dummy_rtti_base2::save(A,dummy_rtti_base2::getStaticObjectType()->TypeVersion());
    };
    virtual void RK_CALL load(ReaK::serialization::iarchive& A, unsigned int) {
      dummy_rtti_base1::load(A,dummy_rtti_base1::getStaticObjectType()->TypeVersion());
      dummy_rtti_base2::load(A,dummy_rtti_base2::getStaticObjectType()->TypeVersion());
    };
    
    RK_RTTI_MAKE_CONCRETE_2BASE(dummy_rtti_multi_inherit,0xFFFFFFF5,1,"dummy_rtti_multi_inherit",dummy_rtti_base1,dummy_rtti_base2)
...
BOOST_AUTO_TEST_CASE( rtti_test )
{
  ...
  
  {
    ...
    rtti::so_type* p_so_tp = p_tp->findAncestor(shared_object::getStaticObjectType());
    BOOST_REQUIRE( p_so_tp );
    
    rtti::so_type* p_so_tp_2 = p_tp->findAncestor(shared_object::getStaticObjectType()->TypeID_begin());
    ...
    rtti::so_type* p_tp_4 = rtti::so_type_repo::getInstance().findType(p_tp->TypeID_begin());
    ...
    shared_ptr< shared_object > p_obj = p_tp->CreateObject();
    BOOST_REQUIRE( p_obj );
    
    void* p_obj_raw = p_obj->castTo(p_tp);
    BOOST_CHECK( p_obj_raw );
    
    shared_ptr< dummy_rtti_test > p_obj_statcast = rtti::rk_static_ptr_cast<dummy_rtti_test>(p_obj);
    BOOST_CHECK( p_obj_statcast );
    BOOST_CHECK_EQUAL( p_obj_statcast.get(), p_obj_raw );
    
    shared_ptr< dummy_rtti_test > p_obj_dyncast = rtti::rk_dynamic_ptr_cast<dummy_rtti_test>(p_obj);
  ...
  
  {
    ...
    shared_ptr< dummy_rtti_template<10,dummy_rtti_test> > p_obj_statcast = rtti::rk_static_ptr_cast< dummy_rtti_template<10,dummy_rtti_test> >(p_obj);
    BOOST_CHECK( p_obj_statcast );
    BOOST_CHECK_EQUAL( p_obj_statcast.get(), p_obj_raw );
    
    shared_ptr< dummy_rtti_template<10,dummy_rtti_test> > p_obj_dyncast = rtti::rk_dynamic_ptr_cast< dummy_rtti_template<10,dummy_rtti_test> >(p_obj);
    BOOST_CHECK( p_obj_dyncast );
    BOOST_CHECK_EQUAL( p_obj_dyncast.get(), p_obj_statcast.get() );
    BOOST_CHECK_EQUAL( p_obj_dyncast.get(), p_obj_raw );
  };
  ...
  
  {
    ...
    shared_ptr< dummy_rtti_template2<int,dummy_rtti_test> > p_obj_statcast = rtti::rk_static_ptr_cast< dummy_rtti_template2<int,dummy_rtti_test> >(p_obj);
    BOOST_CHECK( p_obj_statcast );
    BOOST_CHECK_EQUAL( p_obj_statcast.get(), p_obj_raw );
    
    shared_ptr< dummy_rtti_template2<int,dummy_rtti_test> > p_obj_dyncast = rtti::rk_dynamic_ptr_cast< dummy_rtti_template2<int,dummy_rtti_test> >(p_obj);
    BOOST_CHECK( p_obj_dyncast );
    BOOST_CHECK_EQUAL( p_obj_dyncast.get(), p_obj_statcast.get() );
    BOOST_CHECK_EQUAL( p_obj_dyncast.get(), p_obj_raw );
  };
  
  {
    ...
    rtti::so_type* p_b1_tp = p_tp->findAncestor(dummy_rtti_base1::getStaticObjectType());
    BOOST_CHECK( p_b1_tp );
    
    rtti::so_type* p_b2_tp = p_tp->findAncestor(dummy_rtti_base2::getStaticObjectType());
    BOOST_CHECK( p_b2_tp );
    ...
    shared_ptr< dummy_rtti_multi_inherit > p_obj_dyncast = rtti::rk_dynamic_ptr_cast< dummy_rtti_multi_inherit >(p_obj);
    BOOST_CHECK( p_obj_dyncast );
    BOOST_CHECK_EQUAL( p_obj_dyncast.get(), p_obj_raw );
    ...
    shared_ptr< dummy_rtti_base1 > p_b1_obj_dyncast = rtti::rk_dynamic_ptr_cast< dummy_rtti_base1 >(p_obj);
    ...
    shared_ptr< dummy_rtti_base2 > p_b2_obj_dyncast = rtti::rk_dynamic_ptr_cast< dummy_rtti_base2 >(p_obj);
