...
class mat_sub_block {
  ...
  private:
    ...
    size_type colCount;
  public:
    mat_sub_block(Matrix& aM) : m(aM), rowOffset(0), colOffset(0), rowCount(aM.get_row_count()), colCount(aM.get_col_count()) { };
...
class mat_const_sub_block {
  ...
  public:
    mat_const_sub_block(const Matrix& aM) : m(aM), rowOffset(0), colOffset(0), rowCount(aM.get_row_count()), colCount(aM.get_col_count()) { };
