...
extern template vect<double,2> operator *(const mat<double,mat_structure::symmetric>& M,const vect<double,2>& V);
extern template vect<double,3> operator *(const mat<double,mat_structure::symmetric>& M,const vect<double,3>& V);
extern template vect<double,4> operator *(const mat<double,mat_structure::symmetric>& M,const vect<double,4>& V);
extern template vect<double,6> operator *(const mat<double,mat_structure::symmetric>& M,const vect<double,6>& V);

extern template vect<double,2> operator *(const vect<double,2>& V,const mat<double,mat_structure::symmetric>& M);
extern template vect<double,3> operator *(const vect<double,3>& V,const mat<double,mat_structure::symmetric>& M);
extern template vect<double,4> operator *(const vect<double,4>& V,const mat<double,mat_structure::symmetric>& M);
extern template vect<double,6> operator *(const vect<double,6>& V,const mat<double,mat_structure::symmetric>& M);
...
extern template vect<float,2> operator *(const mat<float,mat_structure::symmetric>& M,const vect<float,2>& V);
extern template vect<float,3> operator *(const mat<float,mat_structure::symmetric>& M,const vect<float,3>& V);
extern template vect<float,4> operator *(const mat<float,mat_structure::symmetric>& M,const vect<float,4>& V);
extern template vect<float,6> operator *(const mat<float,mat_structure::symmetric>& M,const vect<float,6>& V);

extern template vect<float,2> operator *(const vect<float,2>& V,const mat<float,mat_structure::symmetric>& M);
extern template vect<float,3> operator *(const vect<float,3>& V,const mat<float,mat_structure::symmetric>& M);
extern template vect<float,4> operator *(const vect<float,4>& V,const mat<float,mat_structure::symmetric>& M);
extern template vect<float,6> operator *(const vect<float,6>& V,const mat<float,mat_structure::symmetric>& M);
