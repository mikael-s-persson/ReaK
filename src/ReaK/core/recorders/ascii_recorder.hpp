...
class ascii_recorder : public data_recorder {
  ...
  public:
     ...
     */
    ascii_recorder(const std::string& aFileName, const std::string& aDelimiter = " ") : data_recorder(), delimiter(aDelimiter) {
...
class ascii_extractor : public data_extractor {
  ...
  public:
     ...
     * Constructor that opens a file with name aFileName.
     */
    ascii_extractor(const std::string& aFileName, const std::string& aDelimiter = " ") : data_extractor(), delimiter(aDelimiter) {
      setFileName(aFileName);
    };
