...
vect_n<double> manipulator_dynamics_model::getJointStates() const {
  ...
  manip_kin_mdl_joint_io(shared_ptr<const direct_kinematics_model>(this,null_deleter())).getJointVelocities(&result[getJointPositionsCount()]);
...
void manipulator_dynamics_model::setJointStates(const vect_n<double>& aJointStates) {
  ...
  manip_kin_mdl_joint_io(shared_ptr<const direct_kinematics_model>(this,null_deleter())).setJointPositions(&aJointStates[0]);
  manip_kin_mdl_joint_io(shared_ptr<const direct_kinematics_model>(this,null_deleter())).setJointVelocities(&aJointStates[getJointPositionsCount()]);
...
vect_n<double> manipulator_dynamics_model::getDependentStates() const {
  ...
  manip_kin_mdl_joint_io(shared_ptr<const direct_kinematics_model>(this,null_deleter())).getDependentVelocities(&result[getDependentPositionsCount()]);
