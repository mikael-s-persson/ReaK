...
class direct_kinematics_model : public virtual named_object {
  public:
     ...
     * Default constructor.
     */
    direct_kinematics_model(const std::string& aName = "") { setName(aName); };
    
    /**
     * Default destructor.
     */
    virtual ~direct_kinematics_model() { };
    ...
    virtual shared_ptr< gen_coord<double> > getCoord(std::size_t i) const { 
      return shared_ptr< gen_coord<double> >();
    };
    ...
    virtual shared_ptr< frame_2D<double> > getFrame2D(std::size_t i) const { 
      return shared_ptr< frame_2D<double> >();
    };
    ...
    virtual shared_ptr< frame_3D<double> > getFrame3D(std::size_t i) const { 
      return shared_ptr< frame_3D<double> >();
    };
    ...
    virtual shared_ptr< joint_dependent_gen_coord > getDependentCoord(std::size_t i) const { 
      return shared_ptr< joint_dependent_gen_coord >();
    };
    ...
    virtual shared_ptr< joint_dependent_frame_2D > getDependentFrame2D(std::size_t i) const { 
      return shared_ptr< joint_dependent_frame_2D >();
    };
    ...
    virtual shared_ptr< joint_dependent_frame_3D > getDependentFrame3D(std::size_t i) const { 
      return shared_ptr< joint_dependent_frame_3D >();
    };
     ...
     */
    virtual vect_n<double> getJointPositions() const { return vect_n<double>(); };
     ...
     */
    virtual vect_n<double> getJointVelocities() const { return vect_n<double>(); };
     ...
     */
    virtual vect_n<double> getJointAccelerations() const { return vect_n<double>(); };
     ...
     */
    virtual vect_n<double> getDependentPositions() const { return vect_n<double>(); };
     ...
     */
    virtual vect_n<double> getDependentVelocities() const { return vect_n<double>(); };
     ...
     */
    virtual vect_n<double> getDependentAccelerations() const { return vect_n<double>(); };
