...
namespace detail {
  ...
  struct svp_Ndof_reach_topo_impl {
    ...
    typedef svp_Ndof_reach_time_metric<time_topology> rt_metric_type;
    typedef generic_sampler<svp_Ndof_rate_limited_sampler<time_topology>, BaseTopology> sampler_type;
  ...
  struct svp_Ndof_reach_topo_impl<BaseTopology, true> {
    ...
    typedef svp_Ndof_reach_time_metric< base_time_topo > rt_metric_type;
    typedef generic_sampler<svp_Ndof_rate_limited_sampler< base_time_topo >, base_space_topo > sampler_type;
    
    static rt_metric_type make_rt_metric(const BaseTopology& b_space) {
      return rt_metric_type(shared_ptr<base_time_topo>(&const_cast<base_time_topo&>(b_space.get_time_topology()), null_deleter()));
    };
    
    static sampler_type make_sampler(const BaseTopology& b_space) {
      return sampler_type(shared_ptr<base_time_topo>(&const_cast<base_time_topo&>(b_space.get_time_topology()), null_deleter()));
    };
  ...
  struct svp_Ndof_reach_topo_selector {
    typedef svp_Ndof_reach_topo_impl<BaseTopology, is_temporal_space<BaseTopology>::type::value > type;
  };
...
class interpolated_topology<BaseTopology, svp_Ndof_interpolation_tag> : public interpolated_topology_base<BaseTopology> {
  ...
  protected:
    ...
    typedef typename detail::svp_Ndof_reach_topo_selector<BaseTopology>::type Impl;
