...
namespace detail {
  ...
  static
  double svp_compute_slack_time(double beta, double dt, double beta_0, double norm_delta, const double (&coefs)[5]) {
    using std::sqrt;
    using std::fabs;
  ...
  static
  double svp_compute_derivative_slack_time(double beta, double dt, double beta_0, double norm_delta, const double (&coefs)[5]) {
    using std::sqrt;
    using std::fabs;
  ...
  static
  double svp_compute_travel_time(double beta, double beta_0, double norm_delta, const double (&coefs)[5]) {
    using std::sqrt;
    using std::fabs;
  ...
  static
  double svp_compute_derivative_travel_time(double beta, double beta_0, double norm_delta, const double (&coefs)[5]) {
    using std::sqrt;
    using std::fabs;
