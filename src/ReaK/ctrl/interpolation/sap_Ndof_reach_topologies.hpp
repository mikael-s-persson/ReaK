...
class sap_Ndof_reach_topology : public BaseTopology
{
  public:
  ...
  public:
    ...
    sap_Ndof_reach_topology(const BaseTopology& aTopo) : 
                            BaseTopology(aTopo),
    ...
    sap_Ndof_reach_topology(Args&&... args) : 
                            BaseTopology(std::forward<Args>(args)...),
                            t_space(new time_topology),
                            rt_dist(t_space), 
                            rl_sampler(sap_Ndof_rate_limited_sampler<time_topology>(t_space)) { };
#else
    sap_Ndof_reach_topology() : 
                            BaseTopology(),
                            t_space(new time_topology),
                            rt_dist(t_space), 
                            rl_sampler(sap_Ndof_rate_limited_sampler<time_topology>(t_space)) { };
...
*******************************************************************************/
    ...
    RK_RTTI_MAKE_ABSTRACT_1BASE(self,0xC240002F,1,"sap_Ndof_reach_topology",BaseTopology)
...
/* Specialization, see general template docs. */
  template <typename BaseTopology>
  class tuple_size< ReaK::pp::sap_Ndof_reach_topology<BaseTopology> > : 
    public tuple_size< BaseTopology > { };
    
/* Specialization, see general template docs. */
  template <typename BaseTopology>
  class tuple_size< const ReaK::pp::sap_Ndof_reach_topology<BaseTopology> > : 
    public tuple_size< const BaseTopology > { };
    
/* Specialization, see general template docs. */
  template <typename BaseTopology>
  class tuple_size< volatile ReaK::pp::sap_Ndof_reach_topology<BaseTopology> > : 
    public tuple_size< volatile BaseTopology > { };
    
/* Specialization, see general template docs. */
  template <typename BaseTopology>
  class tuple_size< const volatile ReaK::pp::sap_Ndof_reach_topology<BaseTopology> > : 
    public tuple_size< const volatile BaseTopology > { };
  
  
/* Specialization, see general template docs. */
  template <int Idx, typename BaseTopology>
  class tuple_element< Idx, ReaK::pp::sap_Ndof_reach_topology<BaseTopology> > :
    public tuple_element< Idx, BaseTopology > { };
  
/* Specialization, see general template docs. */
  template <int Idx, typename BaseTopology>
  class tuple_element< Idx, const ReaK::pp::sap_Ndof_reach_topology<BaseTopology> > :
    public tuple_element< Idx, const BaseTopology > { };
  
/* Specialization, see general template docs. */
  template <int Idx, typename BaseTopology>
  class tuple_element< Idx, volatile ReaK::pp::sap_Ndof_reach_topology<BaseTopology> > : 
    public tuple_element< Idx, volatile BaseTopology > { };
  
/* Specialization, see general template docs. */
  template <int Idx, typename BaseTopology>
  class tuple_element< Idx, const volatile ReaK::pp::sap_Ndof_reach_topology<BaseTopology> > :
...
/* Specialization, see general template docs. */
  template <typename BaseTopology>
  struct length< ReaK::pp::sap_Ndof_reach_topology<BaseTopology> > : 
    ReaK::arithmetic_tuple_size< BaseTopology > { };
    
/* Specialization, see general template docs. */
  template <typename BaseTopology>
  struct length< const ReaK::pp::sap_Ndof_reach_topology<BaseTopology> > : 
    ReaK::arithmetic_tuple_size< BaseTopology > { };
    
/* Specialization, see general template docs. */
  template <typename BaseTopology>
  struct length< volatile ReaK::pp::sap_Ndof_reach_topology<BaseTopology> > : 
    ReaK::arithmetic_tuple_size< BaseTopology > { };
    
/* Specialization, see general template docs. */
  template <typename BaseTopology>
  struct length< const volatile ReaK::pp::sap_Ndof_reach_topology<BaseTopology> > : 
    ReaK::arithmetic_tuple_size< BaseTopology > { };
  
/* Specialization, see general template docs. */
  template <int Idx, typename BaseTopology>
  struct element< Idx, ReaK::pp::sap_Ndof_reach_topology<BaseTopology> > :
    public element< Idx, BaseTopology > { };
  
/* Specialization, see general template docs. */
  template <int Idx, typename BaseTopology>
  struct element< Idx, const ReaK::pp::sap_Ndof_reach_topology<BaseTopology> > :
    public element< Idx, const BaseTopology > { };
  
/* Specialization, see general template docs. */
  template <int Idx, typename BaseTopology>
  class element< Idx, volatile ReaK::pp::sap_Ndof_reach_topology<BaseTopology> > :
    public element< Idx, volatile BaseTopology > { };
  
/* Specialization, see general template docs. */
  template <int Idx, typename BaseTopology>
  class element< Idx, const volatile ReaK::pp::sap_Ndof_reach_topology<BaseTopology> > :
...
/* Specialization, see general template docs. */
  template <int Idx, typename BaseTopology>
  class arithmetic_tuple_element< Idx, pp::sap_Ndof_reach_topology<BaseTopology> > :
    public arithmetic_tuple_element< Idx, BaseTopology > { };
  
/* Specialization, see general template docs. */
  template <int Idx, typename BaseTopology>
  class arithmetic_tuple_element< Idx, const pp::sap_Ndof_reach_topology<BaseTopology> > : 
    public arithmetic_tuple_element< Idx, const BaseTopology > { };
  
/* Specialization, see general template docs. */
  template <int Idx, typename BaseTopology>
  class arithmetic_tuple_element< Idx, volatile pp::sap_Ndof_reach_topology<BaseTopology> > : 
    public arithmetic_tuple_element< Idx, volatile BaseTopology > { };
  
/* Specialization, see general template docs. */
  template <int Idx, typename BaseTopology>
  class arithmetic_tuple_element< Idx, const volatile pp::sap_Ndof_reach_topology<BaseTopology> > : 
