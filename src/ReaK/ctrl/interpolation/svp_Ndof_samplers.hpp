...
#ifndef REAK_SVP_NDOF_SAMPLERS_HPP
#define REAK_SVP_NDOF_SAMPLERS_HPP
...
struct svp_Ndof_rate_limited_sampler : public serialization::serializable {
  
  typedef svp_Ndof_rate_limited_sampler<TimeSpaceType> self;
  
  shared_ptr<const TimeSpaceType> t_space;
  
  svp_Ndof_rate_limited_sampler(const shared_ptr<const TimeSpaceType>& aTimeSpace = shared_ptr<const TimeSpaceType>(new TimeSpaceType())) : 
                                t_space(aTimeSpace) { };
...
*******************************************************************************/
  ...
  RK_RTTI_MAKE_ABSTRACT_1BASE(self,0xC2450003,1,"svp_Ndof_rate_limited_sampler",serialization::serializable)
};
