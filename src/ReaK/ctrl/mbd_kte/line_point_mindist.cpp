...
#include "line_point_mindist.hpp"
...
void line_point_mindist_2D::doMotion(kte_pass_flag aFlag, boost::shared_ptr<frame_storage> aStorage) {
  if((!mBase) || (!mEnd))
    return;
...
void line_point_mindist_2D::doForce(kte_pass_flag aFlag, boost::shared_ptr<frame_storage> aStorage) {
  if((!mBase) || (!mEnd))
    return;
...
void line_point_mindist_3D::doMotion(kte_pass_flag aFlag, boost::shared_ptr<frame_storage> aStorage) {
  if((!mBase) || (!mEnd))
    return;
...
void line_point_mindist_3D::doForce(kte_pass_flag aFlag, boost::shared_ptr<frame_storage> aStorage) {
  if((!mBase) || (!mEnd))
    return;
