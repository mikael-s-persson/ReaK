...
#ifndef PLANE_POINT_MINDIST_HPP
#define PLANE_POINT_MINDIST_HPP
...
class plane_point_mindist_3D : public kte_map {
  private:
    ...
    boost::shared_ptr< frame_3D<double> > mEnd; ///< Holds the end-frame, or kinematic output, or min-dist point to base-frame, on the plane.
