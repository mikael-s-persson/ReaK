...
void manip_kin_mdl_joint_io::setJointPositions(const double* aJointPositions) {
  ...
  for( std::size_t i = 0; i < model->getFrames3DCount(); ++i ) {
    ...
    i_ptr->Quat = quaternion<double>( vect<double,4>( aJointPositions[0],
                                                      aJointPositions[1],
                                                      aJointPositions[2],
                                                      aJointPositions[3] ) ); 
    aJointPositions += 4;
...
void manip_kin_mdl_jac_calculator::getJacobianMatrixAndDerivativeImpl( mat<double,mat_structure::rectangular>& Jac, mat<double,mat_structure::rectangular>* JacDot ) const {
