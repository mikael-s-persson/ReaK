...
void rigid_link_gen::doMotion(kte_pass_flag aFlag, boost::shared_ptr<frame_storage> aStorage) {
  if((!mBase) || (!mEnd))
    return;
...
void rigid_link_gen::doForce(kte_pass_flag aFlag, boost::shared_ptr<frame_storage> aStorage) {
  if((!mBase) || (!mEnd))
    return;
...
void rigid_link_2D::doMotion(kte_pass_flag aFlag, boost::shared_ptr<frame_storage> aStorage) {
  if((!mBase) || (!mEnd))
    return;
...
void rigid_link_2D::doForce(kte_pass_flag aFlag, boost::shared_ptr<frame_storage> aStorage) {
  if((!mBase) || (!mEnd))
    return;
...
void rigid_link_3D::doMotion(kte_pass_flag aFlag, boost::shared_ptr<frame_storage> aStorage) {
  if((!mBase) || (!mEnd))
    return;
...
void rigid_link_3D::doForce(kte_pass_flag aFlag, boost::shared_ptr<frame_storage> aStorage) {
  if((!mBase) || (!mEnd))
    return;
