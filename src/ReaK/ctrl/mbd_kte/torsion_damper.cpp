...
void torsion_damper_2D::doMotion(kte_pass_flag aFlag, boost::shared_ptr<frame_storage> aStorage) {
...
void torsion_damper_2D::doForce(kte_pass_flag aFlag, boost::shared_ptr<frame_storage> aStorage) { RK_UNUSED(aFlag); RK_UNUSED(aStorage);
  if((!mAnchor1) || (!mAnchor2))
    return;
...
void torsion_damper_3D::doMotion(kte_pass_flag aFlag, boost::shared_ptr<frame_storage> aStorage) {
  if((!mAnchor1) || (!mAnchor2))
    return;
...
void torsion_damper_3D::doForce(kte_pass_flag aFlag, boost::shared_ptr<frame_storage> aStorage) { RK_UNUSED(aFlag); RK_UNUSED(aStorage);
  if((!mAnchor1) || (!mAnchor2))
    return;
