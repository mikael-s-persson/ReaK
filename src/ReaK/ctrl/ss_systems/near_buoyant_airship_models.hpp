...
class airship3D_imdt_emd_sys : public named_object {
  ...
  public:  
     ...
     * \param aGravityAcc The gravitational acceleration vector (usually (0,0,-9.8) for a z-up world).
     */
    airship3D_imdt_emd_sys(const std::string& aName = "", 
                           double aMass = 1.0, 
                           const mat<double,mat_structure::symmetric>& aInertiaMoment = (mat<double,mat_structure::symmetric>(mat<double,mat_structure::identity>(3))),
                           double aDt = 0.01,
                           const vect<double,3>& aGravityAcc = (vect<double,3>(0.0,0.0,-9.81))); 
...
class airship3D_imdt_emdJ_sys : public named_object {
  ...
  public:  
     ...
     * \param aGravityAcc The gravitational acceleration vector (usually (0,0,-9.8) for a z-up world).
     */
    airship3D_imdt_emdJ_sys(const std::string& aName = "", 
                            double aMass = 1.0, 
                            const mat<double,mat_structure::symmetric>& aInertiaMoment = (mat<double,mat_structure::symmetric>(mat<double,mat_structure::identity>(3))),
                            double aDt = 0.01,
                            const vect<double,3>& aGravityAcc = (vect<double,3>(0.0,0.0,-9.81))); 
...
class airship3D_gyro_imdt_emdJ_sys : public airship3D_imdt_emdJ_sys {
  ...
  public:  
     ...
     * \param aGravityAcc The gravitational acceleration vector (usually (0,0,-9.8) for a z-up world).
     */
    airship3D_gyro_imdt_emdJ_sys(const std::string& aName = "", 
                                 double aMass = 1.0, 
                                 const mat<double,mat_structure::symmetric>& aInertiaMoment = (mat<double,mat_structure::symmetric>(mat<double,mat_structure::identity>(3))),
                                 double aDt = 0.01,
                                 const vect<double,3>& aGravityAcc = (vect<double,3>(0.0,0.0,-9.81))) : 
...
*******************************************************************************/
    ...
    RK_RTTI_MAKE_CONCRETE_1BASE(airship3D_gyro_imdt_emdJ_sys,0xC231001E,1,"airship3D_gyro_imdt_emdJ_sys",airship3D_imdt_emdJ_sys)
