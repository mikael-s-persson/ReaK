...
namespace detail {
  ...
  inline typename boost::enable_if< boost::is_undirected_graph<Graph> >::type 
    ...
    while((num_vertices(g) < max_vertex_count) && (vis.keep_going())) {
      ...
      boost::tie(x_near, p_new, eprop) = node_generator_func(g, vis, boost::bundle_prop_to_vertex_prop(position, g));
  ...
  inline typename boost::enable_if< boost::is_directed_graph<Graph> >::type 
    ...
    while((num_vertices(g) < max_vertex_count) && (vis.keep_going())) {
      ...
      select_neighborhood(p_new, std::back_inserter(Pred), std::back_inserter(Succ), g, space, boost::bundle_prop_to_vertex_prop(position, g));
