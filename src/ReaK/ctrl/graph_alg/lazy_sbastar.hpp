...
void generate_lazy_sbastar_bidir_no_init(const SBAStarBundle& bdl) {
  detail::generate_sbastar_bidir_no_init_impl(
    ...
    *(bdl.m_super_space), bdl.m_vis, lazy_node_connector(),
 ...
 */
template <typename SBAStarBundle>
void generate_lazy_bnb_sbastar_no_init(const SBAStarBundle& bdl, typename SBAStarBundle::vertex_type goal_vertex) {
 ...
 */
template <typename SBAStarBundle>
void generate_lazy_bnb_sbastar(const SBAStarBundle& bdl, typename SBAStarBundle::vertex_type goal_vertex) {
  detail::initialize_sbastar_nodes(*(bdl.m_g), bdl.m_vis, bdl.m_distance, bdl.m_predecessor, bdl.m_key);
