...
/**
  ...
  * \tparam RRTStarVisitor The type of the RRT* visitor to be used, should model the RRTStarVisitorConcept.
...
rrtstar_bundle<Graph, Topology, RRTStarVisitor, NcSelector, PositionMap, WeightMap,
  ...
  BOOST_CONCEPT_ASSERT((RRTStarVisitorConcept<RRTStarVisitor,Graph,Topology>));
...
rrtstar_bundle<Graph, Topology, RRTStarVisitor, NcSelector, PositionMap, WeightMap,
  ...
  BOOST_CONCEPT_ASSERT((boost::VertexListGraphConcept<Graph>));
  BOOST_CONCEPT_ASSERT((ReaK::pp::MetricSpaceConcept<Topology>));
  BOOST_CONCEPT_ASSERT((RRTStarBidirVisitorConcept<RRTStarVisitor,Graph,Topology>));
...
struct rrtstar_bundle_factory {
  ...
  struct ls_motion_graph {
    ...
    typedef int space_part_type;
    static space_part_type get_space_part(type&, shared_ptr<const super_space_type>) {
      return 0xDEADBEEF;
    };
    static space_part_type get_space_part(shared_ptr<const super_space_type>) {
      return 0xDEADBEEF;
    };
