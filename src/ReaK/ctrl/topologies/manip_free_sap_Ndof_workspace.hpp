/**
 * \file manip_free_sap_Ndof_workspace.hpp
 * 
...
#ifndef REAK_MANIP_FREE_SAP_NDOF_WORKSPACE_HPP
#define REAK_MANIP_FREE_SAP_NDOF_WORKSPACE_HPP
...
extern template class manip_quasi_static_env< Ndof_rl_space<double, NDOF, 2>::type, sap_Ndof_interpolation_tag>;
