/**
 * \file manip_free_svp_dynamic_workspace.hpp
 * 
...
#ifndef REAK_MANIP_FREE_SVP_DYNAMIC_WORKSPACE_HPP
#define REAK_MANIP_FREE_SVP_DYNAMIC_WORKSPACE_HPP
...
RK_MANIP_FREE_SVP_WORKSPACE_MAKE_DYN_ENV_FOR_JOINTS(3)
RK_MANIP_FREE_SVP_WORKSPACE_MAKE_DYN_ENV_FOR_JOINTS(4)
RK_MANIP_FREE_SVP_WORKSPACE_MAKE_DYN_ENV_FOR_JOINTS(5)
RK_MANIP_FREE_SVP_WORKSPACE_MAKE_DYN_ENV_FOR_JOINTS(6)
RK_MANIP_FREE_SVP_WORKSPACE_MAKE_DYN_ENV_FOR_JOINTS(7)
