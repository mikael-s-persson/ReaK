...
template class interpolated_topology< Ndof_rl_space<double,NDOF,2>::type, sap_Ndof_interpolation_tag >; \
 \
template class interpolated_topology< temporal_space< Ndof_rl_space<double,NDOF,2>::type, time_poisson_topology, reach_plus_time_metric>, sap_Ndof_interpolation_tag >;
...
template class interpolated_topology< temporal_space< Ndof_rl_space<double,0,2>::type, time_poisson_topology, reach_plus_time_metric>, sap_Ndof_interpolation_tag >;
