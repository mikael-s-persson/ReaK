...
#include "topologies/manip_free_dynamic_workspace.tpp"
...
RK_MANIP_FREE_WORKSPACE_MAKE_QUINTIC_DYN_ENV_FOR_JOINTS_DEFS(3)
RK_MANIP_FREE_WORKSPACE_MAKE_QUINTIC_DYN_ENV_FOR_JOINTS_DEFS(4)
RK_MANIP_FREE_WORKSPACE_MAKE_QUINTIC_DYN_ENV_FOR_JOINTS_DEFS(5)
RK_MANIP_FREE_WORKSPACE_MAKE_QUINTIC_DYN_ENV_FOR_JOINTS_DEFS(6)
RK_MANIP_FREE_WORKSPACE_MAKE_QUINTIC_DYN_ENV_FOR_JOINTS_DEFS(7)
RK_MANIP_FREE_WORKSPACE_MAKE_QUINTIC_DYN_ENV_FOR_JOINTS_DEFS(8)
RK_MANIP_FREE_WORKSPACE_MAKE_QUINTIC_DYN_ENV_FOR_JOINTS_DEFS(9)
RK_MANIP_FREE_WORKSPACE_MAKE_QUINTIC_DYN_ENV_FOR_JOINTS_DEFS(10)
...
void dummy_manip_free_dynamic_workspace_externs_3_symbol() { };
