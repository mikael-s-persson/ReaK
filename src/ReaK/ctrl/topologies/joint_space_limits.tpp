...
typename get_rate_limited_space< NormalSpaceType >::type 
  joint_limits_collection<T>::make_rl_joint_space(const NormalSpaceType& j_space) const {
...
typename get_rate_illimited_space< RateLimitedSpaceType >::type 
  joint_limits_collection<T>::make_normal_joint_space(const RateLimitedSpaceType& j_space) const {
...
typename topology_traits< typename get_rate_limited_space< NormalSpaceType >::type >::point_type 
  joint_limits_collection<T>::map_to_space(
