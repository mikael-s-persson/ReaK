...
extern template class interpolated_topology< Ndof_rl_space<double,NDOF,2>::type, quintic_hermite_interpolation_tag >; \
 \
extern template class interpolated_topology< temporal_space< Ndof_rl_space<double,NDOF,2>::type, time_poisson_topology, reach_plus_time_metric>, quintic_hermite_interpolation_tag >;
...
extern template class interpolated_topology< temporal_space< Ndof_rl_space<double,0,2>::type, time_poisson_topology, reach_plus_time_metric>, quintic_hermite_interpolation_tag >;
