...
class lti_discrete_sys : public named_object {
  ...
  public:
     ...
     */
    lti_discrete_sys(size_type aX_size = 0, size_type aU_size = 0, size_type aY_size = 0, const time_difference_type& aDt = 1, const std::string& aName = "") :
    ...
    lti_discrete_sys(const MatrixA& aA, const MatrixB& aB, const MatrixC& aC, const MatrixD& aD, const time_difference_type& aDt, const std::string& aName = "",
     ...
     */
    void setDt(const time_difference_type& aDt) {
      dt = aDt;
    };
    ...
    void >::type get_linear_blocks(const time_difference_type&, MatrixA& aA, MatrixB& aB, MatrixC& aC, MatrixD& aD) const {
      aA = A;
      aB = B;
      aC = C;
      aD = D;
    ...
    typename boost::enable_if_c< is_writable_matrix<MatrixA>::value &&
                                 ...
                                 is_writable_matrix<MatrixC>::value &&
                                 is_writable_matrix<MatrixD>::value,
    void >::type get_linear_blocks(const time_type&, const time_difference_type&, MatrixA& aA, MatrixB& aB, MatrixC& aC, MatrixD& aD) const {
      aA = A;
      aB = B;
      aC = C;
      aD = D;
    ...
    typename boost::enable_if_c< is_writable_matrix<MatrixA>::value &&
                                 ...
                                 is_writable_matrix<MatrixC>::value &&
                                 is_writable_matrix<MatrixD>::value,
    void >::type get_linear_blocks(const point_type&, const input_type&, const time_type&, const time_difference_type&, MatrixA& aA, MatrixB& aB, MatrixC& aC, MatrixD& aD) const {
      aA = A;
      aB = B;
      aC = C;
      aD = D;
