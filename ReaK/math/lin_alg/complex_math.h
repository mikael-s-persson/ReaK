...
#ifndef REAK_MATH_LIN_ALG_COMPLEX_MATH_H_
#define REAK_MATH_LIN_ALG_COMPLEX_MATH_H_
...
constexpr float conj(float x) noexcept {
  return x;
}
/// Complex conjugate for a real value.
constexpr double conj(double x) noexcept {
  return x;
}

/// Complex square magnitude for a real value.
constexpr float norm_2(float x) noexcept {
  using std::abs;
  return abs(x);
}
/// Complex square magnitude for a real value.
constexpr double norm_2(double x) noexcept {
  using std::abs;
  return abs(x);
}

/// Complex square magnitude for a real value.
constexpr float norm_2_sqr(float x) noexcept {
  return x * x;
}
/// Complex square magnitude for a real value.
constexpr double norm_2_sqr(double x) noexcept {
  return x * x;
}

/// Complex square magnitude for a real value.
constexpr float sqr_mag(float x) noexcept {
  return x * x;
}
/// Complex square magnitude for a real value.
constexpr double sqr_mag(double x) noexcept {
  return x * x;
}

}  // namespace ReaK

#endif  // REAK_MATH_LIN_ALG_COMPLEX_MATH_H_
