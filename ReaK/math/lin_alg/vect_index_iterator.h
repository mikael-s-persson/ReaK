...
#ifndef REAK_MATH_LIN_ALG_VECT_INDEX_ITERATOR_H_
#define REAK_MATH_LIN_ALG_VECT_INDEX_ITERATOR_H_
...
#endif  // REAK_MATH_LIN_ALG_VECT_INDEX_ITERATOR_H_
