...
void export_kinetostatics() {
  ...
  def("create_gen_coord", std::make_shared<ReaK::gen_coord<double>>);
  def("create_gen_coord",
      std::make_shared<ReaK::gen_coord<double>, const double&, const double&,
  ...
  def("create_pose_2d", std::make_shared<ReaK::pose_2D<double>>);
  def("create_pose_2d",
      std::make_shared<
  ...
  def("create_frame_2d", std::make_shared<ReaK::frame_2D<double>>);
  def("create_frame_2d",
      std::make_shared<
  ...
  def("create_pose_3d", std::make_shared<ReaK::pose_3D<double>>);
  def("create_pose_3d",
      std::make_shared<
  ...
  def("create_frame_3d", std::make_shared<ReaK::frame_3D<double>>);
  def("create_frame_3d",
      std::make_shared<
  ...
  def("create_jacobian_gen_gen",
      std::make_shared<ReaK::jacobian_gen_gen<double>>);
  ...
  def("create_jacobian_gen_2D",
      std::make_shared<ReaK::jacobian_gen_2D<double>>);
  ...
  def("create_jacobian_gen_3D",
      std::make_shared<ReaK::jacobian_gen_3D<double>>);
  ...
  def("create_jacobian_2D_gen",
      std::make_shared<ReaK::jacobian_2D_gen<double>>);
  ...
  def("create_jacobian_2D_2D", std::make_shared<ReaK::jacobian_2D_2D<double>>);
  ...
  def("create_jacobian_2D_3D", std::make_shared<ReaK::jacobian_2D_3D<double>>);
  ...
  def("create_jacobian_3D_gen",
      std::make_shared<ReaK::jacobian_3D_gen<double>>);
  ...
  def("create_jacobian_3D_2D", std::make_shared<ReaK::jacobian_3D_2D<double>>);
  ...
  def("create_jacobian_3D_3D", std::make_shared<ReaK::jacobian_3D_3D<double>>);
...
BOOST_PYTHON_MODULE(libreak_py_lin_alg) {
