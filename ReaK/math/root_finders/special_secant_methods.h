...
#ifndef REAK_MATH_ROOT_FINDERS_SPECIAL_SECANT_METHODS_H_
#define REAK_MATH_ROOT_FINDERS_SPECIAL_SECANT_METHODS_H_
...
#endif  // REAK_MATH_ROOT_FINDERS_SPECIAL_SECANT_METHODS_H_
