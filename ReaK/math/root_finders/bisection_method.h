...
#ifndef REAK_MATH_ROOT_FINDERS_BISECTION_METHOD_H_
#define REAK_MATH_ROOT_FINDERS_BISECTION_METHOD_H_
...
#endif  // REAK_MATH_ROOT_FINDERS_BISECTION_METHOD_H_
