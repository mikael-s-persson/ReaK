...
#ifndef REAK_MATH_INTEGRATORS_INTEGRATION_EXCEPTIONS_H_
#define REAK_MATH_INTEGRATORS_INTEGRATION_EXCEPTIONS_H_
...
#endif  // REAK_MATH_INTEGRATORS_INTEGRATION_EXCEPTIONS_H_
