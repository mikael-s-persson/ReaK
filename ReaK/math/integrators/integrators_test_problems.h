...
class iv_problem : public state_rate_function<T> {
 public:
  ...
  using self = iv_problem<T>;
  using base_type = state_rate_function<T>;
...
class HIRES_iv_problem : public iv_problem<T> {
 public:
  ~HIRES_iv_problem() override = default;

  void computeStateRate(double, const ReaK::vect_n<T>& aState,
                        ReaK::vect_n<T>& aStateRate) override {
    aStateRate[0] =
  ...
  double getInitialTime() const override { return 0.0; }

  vect_n<T> getInitialValue() const override {
    vect_n<T> result(8);
    result[0] = 1.0;
    result[1] = 0.0;
    result[2] = 0.0;
  ...
  double getFinalTime() const override { return 321.8122; }

  vect_n<T> getFinalValue() const override {
    vect_n<T> result(8);
  ...
  using self = HIRES_iv_problem<T>;
  using base_type = iv_problem<T>;
...
class Pollution_iv_problem : public iv_problem<T> {
 public:
  ~Pollution_iv_problem() override = default;
  ...
  double getFinalTime() const override { return 60.0; }
  ...
  using self = Pollution_iv_problem<T>;
  using base_type = iv_problem<T>;
...
class RingModulator_iv_problem : public iv_problem<T> {
 public:
  ~RingModulator_iv_problem() override = default;

  void computeStateRate(double aTime, const ReaK::vect_n<T>& aState,
                        ReaK::vect_n<T>& aStateRate) override {
    using std::exp;
    using std::sin;
  ...
  vect_n<T> getInitialValue() const override { return vect_n<T>(15, T(0.0)); }

  double getFinalTime() const override { return 1.0e-3; }
  ...
  using self = RingModulator_iv_problem<T>;
  using base_type = iv_problem<T>;
...
class AkzoNobel_iv_problem : public iv_problem<T> {
 public:
  ~AkzoNobel_iv_problem() override = default;
  ...
  double getFinalTime() const override { return 20.0; }
  ...
  using self = AkzoNobel_iv_problem<T>;
  using base_type = iv_problem<T>;
...
class Pleiades_iv_problem : public iv_problem<T> {
 public:
  ~Pleiades_iv_problem() override = default;

  void computeStateRate(double aTime, const vect_n<T>& aState,
                        vect_n<T>& aStateRate) override {
    using std::pow;
  ...
  double getFinalTime() const override { return 3.0; }
  ...
  using self = Pleiades_iv_problem<T>;
  using base_type = iv_problem<T>;
...
class VanDerPol_iv_problem : public iv_problem<T> {
 public:
  ~VanDerPol_iv_problem() override = default;
  ...
  double getFinalTime() const override { return 2.0; }
  ...
  using self = VanDerPol_iv_problem<T>;
  using base_type = iv_problem<T>;
...
class VanDerPolMod_iv_problem : public iv_problem<T> {
 public:
  ~VanDerPolMod_iv_problem() override = default;
  ...
  double getFinalTime() const override { return 2.0e3; }
  ...
  using self = VanDerPolMod_iv_problem<T>;
  using base_type = iv_problem<T>;
...
class Orego_iv_problem : public iv_problem<T> {
 public:
  ~Orego_iv_problem() override = default;
  ...
  double getFinalTime() const override { return 360.0; }
...
class Rober_iv_problem : public iv_problem<T> {
 public:
  ~Rober_iv_problem() override = default;
  ...
  double getFinalTime() const override { return 1.0e11; }
...
class E5_iv_problem : public iv_problem<T> {
 public:
  ~E5_iv_problem() override = default;
  ...
  double getFinalTime() const override { return 1.0e13; }
...
#endif  // REAK_MATH_INTEGRATORS_INTEGRATORS_TEST_PROBLEMS_H_
