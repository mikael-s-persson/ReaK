...
#ifndef REAK_MBD_KTE_VMC_REVOLUTE_JOINT_H_
#define REAK_MBD_KTE_VMC_REVOLUTE_JOINT_H_
...
class vmc_revolute_joint_2D : public revolute_joint_2D {
  ...
  * Default constructor.
  */
  explicit vmc_revolute_joint_2D(const std::string& aName = "")
   ...
   * Default destructor.
   */
  ~vmc_revolute_joint_2D() override = default;
  ...
  RK_RTTI_MAKE_CONCRETE_1BASE(vmc_revolute_joint_2D, 0xC2100026, 1,
                              "vmc_revolute_joint_2D", revolute_joint_2D)
};
...
class vmc_revolute_joint_3D : public revolute_joint_3D {
 ...
 public:
   ...
   * Default constructor.
   */
  explicit vmc_revolute_joint_3D(const std::string& aName = "")
   ...
   * Default destructor.
   */
  ~vmc_revolute_joint_3D() override = default;
  ...
  RK_RTTI_MAKE_CONCRETE_1BASE(vmc_revolute_joint_3D, 0xC2100027, 1,
                              "vmc_revolute_joint_3D", revolute_joint_3D)
};

}  // namespace ReaK::kte

#endif  // REAK_MBD_KTE_VMC_REVOLUTE_JOINT_H_
