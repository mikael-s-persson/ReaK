...
#ifndef REAK_MBD_KTE_SPRING_H_
#define REAK_MBD_KTE_SPRING_H_
...
class spring_gen : public kte_map {
 ...
 public:
   ...
   * \param aStiffness stiffness coefficient (in N/m for a linear generalized coord. or Nm/rad for an angular
   * generalized coord.).
