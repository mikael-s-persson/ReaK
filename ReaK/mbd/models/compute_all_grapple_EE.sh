    ...
    f  //meas_}
      ...
      exp_num  //.ssv}
        ...
        exp_num  //$1}
            ...
            pose_to_grapple-- input $f-- output $ {
          f  //meas_/grapple_}
                  ./
              pose_to_grapple-- input $ {
            f  //meas_/pred_} --output ${f//meas_/grapple_pred_}
                    ./
                ...
                f  //jtctrl_}
                  ...
                  exp_num  //.ssv}
                    ...
                    exp_num  //$1}
                        ...
                        CRS_jtctrl_to_EE-- input $f-- output $ {
                      f  //jtctrl_/EE_}
                          done
