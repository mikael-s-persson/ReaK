...
#ifndef REAK_MBD_MODELS_FREE_FLOATING_PLATFORM_H_
#define REAK_MBD_MODELS_FREE_FLOATING_PLATFORM_H_
...
#endif  // REAK_MBD_MODELS_FREE_FLOATING_PLATFORM_H_
