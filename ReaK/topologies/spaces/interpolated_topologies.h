/**
 * \file interpolated_topologies.h
 *
 *
 *
...
struct interp_topo_base_temporal_topos
    : interp_topo_base_get_temporal_topos<BaseTopology,
                                          TemporalSpace<BaseTopology>> {};
};  // namespace detail

/**
 * This class wraps an interpolated topology which is a topology with a new travel function, distance metric and
 * sampler.
 * \tparam BaseTopology The topology underlying this space, should model Topology.
 */
template <Topology BaseTopology>
...
template <typename InterpMethodTag, Topology BaseTopology>
topology_point_type_t<BaseTopology> interp_topo_move_pt_impl(
    ...
    double dist_tot) {
  if constexpr (TemporalSpace<BaseTopology>) {
 ...
 * \tparam BaseTopology The topology underlying this space, should model Topology.
 */
template <Topology BaseTopology, typename InterpMethodTag>
...
#endif  // REAK_TOPOLOGIES_INTERPOLATION_INTERPOLATED_TOPOLOGIES_H_
