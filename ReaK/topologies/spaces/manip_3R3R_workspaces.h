...
#ifndef REAK_TOPOLOGIES_SPACES_MANIP_3R3R_WORKSPACES_H_
#define REAK_TOPOLOGIES_SPACES_MANIP_3R3R_WORKSPACES_H_
...
struct manip_pp_traits<kte::manip_3R3R_kinematics, Order> {
  ...
  using rl_jt_space_type = Ndof_rl_space_t<double, 6, Order>;
  using jt_space_type = Ndof_space_t<double, 6, Order>;
  using ee_space_type = se3_topology_t<double, Order>;
};

}  // namespace ReaK::pp

#endif  // REAK_TOPOLOGIES_SPACES_MANIP_3R3R_WORKSPACES_H_
