...
#ifndef REAK_TOPOLOGIES_SPACES_MANIP_SSRMS_WORKSPACES_H_
#define REAK_TOPOLOGIES_SPACES_MANIP_SSRMS_WORKSPACES_H_
...
#endif  // REAK_TOPOLOGIES_SPACES_MANIP_SSRMS_WORKSPACES_H_
