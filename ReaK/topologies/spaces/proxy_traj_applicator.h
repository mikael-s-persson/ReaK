...
#include "ReaK/topologies/interpolation/spatial_trajectory_concept.h"  // for SpatialTrajectoryConcept
...
#endif  // REAK_TOPOLOGIES_SPACES_PROXY_TRAJ_APPLICATOR_H_
