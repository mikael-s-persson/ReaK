...
#ifndef REAK_TOPOLOGIES_SPACES_VECT_DISTANCE_METRICS_H_
#define REAK_TOPOLOGIES_SPACES_VECT_DISTANCE_METRICS_H_
...
#endif  // REAK_TOPOLOGIES_SPACES_VECT_DISTANCE_METRICS_H_
