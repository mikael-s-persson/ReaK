...
#ifndef REAK_TOPOLOGIES_INTERPOLATION_NDOF_QUINTIC_SPACES_H_
#define REAK_TOPOLOGIES_INTERPOLATION_NDOF_QUINTIC_SPACES_H_
...
#endif  // REAK_TOPOLOGIES_INTERPOLATION_NDOF_QUINTIC_SPACES_H_
