...
#ifndef REAK_TOPOLOGIES_INTERPOLATION_NDOF_CUBIC_SPACES_H_
#define REAK_TOPOLOGIES_INTERPOLATION_NDOF_CUBIC_SPACES_H_
...
#endif  // REAK_TOPOLOGIES_INTERPOLATION_NDOF_CUBIC_SPACES_H_
