/**
 * \file svp_Ndof_reach_topologies.h
 *
 *
...
#ifndef REAK_TOPOLOGIES_INTERPOLATION_SVP_NDOF_REACH_TOPOLOGIES_H_
#define REAK_TOPOLOGIES_INTERPOLATION_SVP_NDOF_REACH_TOPOLOGIES_H_
...
struct svp_Ndof_reach_topo_impl {
  ...
  using rt_metric_type = svp_Ndof_reach_time_metric<time_topology>;
  using sampler_type =
      generic_sampler<svp_Ndof_rate_limited_sampler<time_topology>,
                      BaseTopology>;
  ...
  static point_type move_pt_toward(const BaseTopology& b_space,
                                   ...
                                   const point_type& b) {
    try {
      generic_interpolator_impl<svp_Ndof_interpolator, BaseTopology,
                                time_topology>
          interp;
...
struct svp_Ndof_reach_topo_impl<BaseTopology, true> {
  ...
  using rt_metric_type = svp_Ndof_reach_time_metric<base_time_topo>;
  using sampler_type =
      generic_sampler<svp_Ndof_rate_limited_sampler<base_time_topo>,
                      base_space_topo>;
  ...
  static sampler_type make_sampler(const BaseTopology& b_space) {
    return sampler_type(svp_Ndof_rate_limited_sampler<base_time_topo>(
  ...
  static point_type move_pt_toward(const BaseTopology& b_space,
    ...
    try {
      generic_interpolator_impl<svp_Ndof_interpolator, base_space_topo,
                                base_time_topo>
          interp;
      double dt_total =
  ...
  static bool is_in_bounds(const BaseTopology& b_space, const point_type& a) {
    return svp_Ndof_is_in_bounds(a.pt, b_space.get_space_topology(),
...
template <typename BaseTopology>
struct svp_Ndof_reach_topo_selector {
  using type =
      svp_Ndof_reach_topo_impl<BaseTopology, is_temporal_space_v<BaseTopology>>;
};
 ...
 */
template <typename BaseTopology>
class interpolated_topology<BaseTopology, svp_Ndof_interpolation_tag>
    : public interpolated_topology_base<BaseTopology> {
 public:
  using base_type = interpolated_topology_base<BaseTopology>;
  using self = interpolated_topology<BaseTopology, svp_Ndof_interpolation_tag>;
 ...
 protected:
  using Impl =
      typename detail::svp_Ndof_reach_topo_selector<BaseTopology>::type;
...
struct get_tagged_spatial_interpolator<svp_Ndof_interpolation_tag, SpaceType,
                                       TimeTopology> {
  using type = detail::generic_interpolator_impl<svp_Ndof_interpolator,
                                                 SpaceType, TimeTopology>;
  using pseudo_factory_type = svp_Ndof_reach_time_metric<TimeTopology>;
};

template <typename TemporalSpaceType>
struct get_tagged_temporal_interpolator<svp_Ndof_interpolation_tag,
                                        TemporalSpaceType> {
  using type = generic_interpolator<svp_Ndof_interp_factory<TemporalSpaceType>,
                                    svp_Ndof_interpolator>;
};

}  // namespace ReaK::pp

#endif  // REAK_TOPOLOGIES_INTERPOLATION_SVP_NDOF_REACH_TOPOLOGIES_H_
