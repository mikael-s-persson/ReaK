/**
 * \file discrete_point_trajectory.h
 *
...
#ifndef REAK_TOPOLOGIES_INTERPOLATION_DISCRETE_POINT_TRAJECTORY_H_
...
class discrete_point_trajectory : public waypoint_container<Space, Metric> {
 public:
  using self = discrete_point_trajectory<Space, Metric>;
...
#endif  // REAK_TOPOLOGIES_INTERPOLATION_DISCRETE_POINT_TRAJECTORY_H_
