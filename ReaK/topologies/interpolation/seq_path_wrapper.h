...
#ifndef REAK_TOPOLOGIES_INTERPOLATION_SEQ_PATH_WRAPPER_H_
#define REAK_TOPOLOGIES_INTERPOLATION_SEQ_PATH_WRAPPER_H_
...
#endif  // REAK_TOPOLOGIES_INTERPOLATION_SEQ_PATH_WRAPPER_H_
