...
bool svp_Ndof_is_in_bounds(const topology_point_type_t<Topology>& pt,
...
class svp_Ndof_interp_factory : public serializable {
 public:
  using self = svp_Ndof_interp_factory<TemporalTopology>;
...
class svp_Ndof_interp_traj
    : public interpolated_trajectory<
          Topology, svp_Ndof_interp_factory<Topology>, DistanceMetric> {
 public:
  BOOST_CONCEPT_ASSERT((TemporalSpaceConcept<Topology>));

  using self = svp_Ndof_interp_traj<Topology, DistanceMetric>;
  using base_class_type =
      interpolated_trajectory<Topology, svp_Ndof_interp_factory<Topology>,
                              DistanceMetric>;
  ...
  explicit svp_Ndof_interp_traj(
      ...
      : base_class_type(aSpace, aDist,
                        svp_Ndof_interp_factory<Topology>(aSpace)) {}
