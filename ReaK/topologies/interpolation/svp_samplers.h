...
#ifndef REAK_TOPOLOGIES_INTERPOLATION_SVP_SAMPLERS_H_
#define REAK_TOPOLOGIES_INTERPOLATION_SVP_SAMPLERS_H_
...
#endif  // REAK_TOPOLOGIES_INTERPOLATION_SVP_SAMPLERS_H_
