...
#ifndef REAK_TOPOLOGIES_INTERPOLATION_SEQ_PATH_BASE_H_
#define REAK_TOPOLOGIES_INTERPOLATION_SEQ_PATH_BASE_H_
...
#endif  // REAK_TOPOLOGIES_INTERPOLATION_SEQ_PATH_BASE_H_
