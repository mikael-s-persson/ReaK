/**
 * \file midpoint_integrator_sys.h
 *
...
#ifndef REAK_CONTROL_INTEGRATORS_MIDPOINT_INTEGRATOR_SYS_H_
#define REAK_CONTROL_INTEGRATORS_MIDPOINT_INTEGRATOR_SYS_H_
...
class midpoint_integrator_factory : public named_object {
 public:
  using self =
      midpoint_integrator_factory<Space, StateSpaceSystem, InputTrajectory>;
...
#endif  // REAK_CONTROL_INTEGRATORS_MIDPOINT_INTEGRATOR_SYS_H_
