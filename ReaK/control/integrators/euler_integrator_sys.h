...
#ifndef REAK_CONTROL_INTEGRATORS_EULER_INTEGRATOR_SYS_H_
#define REAK_CONTROL_INTEGRATORS_EULER_INTEGRATOR_SYS_H_
...
void euler_integrate_impl(
  ...
  typedef typename pp::topology_traits<StateSpace>::point_difference_type
      PointDiffType;

  typedef typename pp::spatial_trajectory_traits<
      InputTrajectory>::const_waypoint_descriptor InputWaypoint;
  typedef typename pp::spatial_trajectory_traits<InputTrajectory>::point_type
      InputType;
...
class euler_integrator_factory : public named_object {
 public:
  typedef euler_integrator_factory<TemporalSpace, StateSpaceSystem,
                                   InputTrajectory>
      self;
  typedef TemporalSpace topology;
  typedef typename pp::topology_traits<TemporalSpace>::point_type point_type;

  typedef typename pp::temporal_space_traits<TemporalSpace>::space_topology
      space_topology;
  typedef typename pp::temporal_space_traits<TemporalSpace>::time_topology
      time_topology;
 ...
 public:
   ...
   */
  explicit euler_integrator_factory(
  ...
  euler_integrator_factory() : euler_integrator_factory("") {}
  ...
  *******************************************************************************/
  ...
  RK_RTTI_MAKE_CONCRETE_1BASE(self, 0xC2431001, 1, "euler_integrator_factory",
                              named_object)
};

}  // namespace ReaK::ctrl

#endif  // REAK_CONTROL_INTEGRATORS_EULER_INTEGRATOR_SYS_H_
