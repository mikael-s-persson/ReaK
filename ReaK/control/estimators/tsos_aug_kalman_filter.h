...
#ifndef REAK_CONTROL_CONTROLLERS_TSOS_AUG_KALMAN_FILTER_H_
#define REAK_CONTROL_CONTROLLERS_TSOS_AUG_KALMAN_FILTER_H_
...
void tsos_aug_kalman_predict(
  ...
  if constexpr (!AugmentedSystem<LinearSystem>) {
...
#endif  // REAK_CONTROL_CONTROLLERS_TSOS_AUG_KALMAN_FILTER_H_
