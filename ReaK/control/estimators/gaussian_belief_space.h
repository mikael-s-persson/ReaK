/**
 * \file gaussian_belief_space.h
 *
 * This library provides a class template which can join together a state-vector topology
 * and a covariance matrix topology (see covar_topology.h) to create a Gaussian belief-state
...
#ifndef REAK_CONTROL_CONTROLLERS_GAUSSIAN_BELIEF_SPACE_H_
#define REAK_CONTROL_CONTROLLERS_GAUSSIAN_BELIEF_SPACE_H_
...
#endif  // REAK_CONTROL_CONTROLLERS_GAUSSIAN_BELIEF_SPACE_H_
