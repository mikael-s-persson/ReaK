...
#ifndef REAK_CONTROL_SYSTEMS_SATELLITE_BASIC_MODELS_H_
#define REAK_CONTROL_SYSTEMS_SATELLITE_BASIC_MODELS_H_
...
#endif  // REAK_CONTROL_SYSTEMS_SATELLITE_BASIC_MODELS_H_
