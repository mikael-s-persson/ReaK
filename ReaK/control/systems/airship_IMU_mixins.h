...
#ifndef REAK_CONTROL_SYSTEMS_AIRSHIP_IMU_MIXINS_H_
#define REAK_CONTROL_SYSTEMS_AIRSHIP_IMU_MIXINS_H_
...
#endif  // REAK_CONTROL_SYSTEMS_AIRSHIP_IMU_MIXINS_H_
