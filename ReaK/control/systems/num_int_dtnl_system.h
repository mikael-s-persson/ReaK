...
#ifndef REAK_CONTROL_SYSTEMS_NUM_INT_DTNL_SYSTEM_H_
#define REAK_CONTROL_SYSTEMS_NUM_INT_DTNL_SYSTEM_H_
...
#endif  // REAK_CONTROL_SYSTEMS_NUM_INT_DTNL_SYSTEM_H_
