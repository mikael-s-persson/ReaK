...
#ifndef REAK_CORE_QT_OBJ_PROPERTIES_QTMODEL_H_
#define REAK_CORE_QT_OBJ_PROPERTIES_QTMODEL_H_
...
class ObjPropertiesQtModel : public QAbstractTableModel {
 ...
 public:
  ...
  void setDataNewObject(const QModelIndex& index,
                        const std::shared_ptr<shared_object>& aNewPtr);
 ...
 public:
   ...
   */
  const serialization::objtree_editor& get_object_editor() const {
    return obj_graph_editor;
  }
  serialization::objtree_editor& get_object_editor() {
    return obj_graph_editor;
  }
  /**
   ...
   */
  serialization::object_node_desc get_current_node() const {
    return current_node;
  }
   ...
   */
  const serialization::xml_field_editor& get_current_fields() const {
...
#endif  // REAK_CORE_QT_OBJ_PROPERTIES_QTMODEL_H_
