...
#ifndef REAK_CORE_SERIALIZATION_ARCHIVER_FACTORY_H_
#define REAK_CORE_SERIALIZATION_ARCHIVER_FACTORY_H_
...
#endif  // REAK_CORE_SERIALIZATION_ARCHIVER_FACTORY_H_
