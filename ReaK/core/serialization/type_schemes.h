...
#ifndef REAK_CORE_SERIALIZATION_TYPE_SCHEMES_H_
#define REAK_CORE_SERIALIZATION_TYPE_SCHEMES_H_
  ...
  *******************************************************************************/
  ...
  void load(serialization::iarchive& A, unsigned int /*Version*/) override {
    ...
    rtti::so_type* tmp_wptr =
        rtti::so_type_repo::get_instance().find_type(ID_vect.data());
    if (tmp_wptr == nullptr) {
      m_type_ID_ptr = nullptr;
    } else {
      m_type_ID_ptr = tmp_wptr->id_begin();
    }
  }
...
#endif  // REAK_CORE_SERIALIZATION_TYPE_SCHEMES_H_
