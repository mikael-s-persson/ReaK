...
#ifndef REAK_CORE_RPC_DETAIL_RPC_FUNCTION_HELPERS_H_
#define REAK_CORE_RPC_DETAIL_RPC_FUNCTION_HELPERS_H_
...
#endif  // REAK_CORE_RPC_DETAIL_RPC_FUNCTION_HELPERS_H_
