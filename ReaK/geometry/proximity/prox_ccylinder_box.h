...
#ifndef REAK_GEOMETRY_PROXIMITY_PROX_CCYLINDER_BOX_H_
#define REAK_GEOMETRY_PROXIMITY_PROX_CCYLINDER_BOX_H_
...
class prox_ccylinder_box : public proximity_finder_3D {
 ...
 public:
   ...
   */
  explicit prox_ccylinder_box(const capped_cylinder* aCCylinder = nullptr,
                              const box* aBox = nullptr);

  /** Destructor. */
  ~prox_ccylinder_box() override = default;
};

}  // namespace ReaK::geom

#endif  // REAK_GEOMETRY_PROXIMITY_PROX_CCYLINDER_BOX_H_
