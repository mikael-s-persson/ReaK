...
#ifndef REAK_GEOMETRY_PROXIMITY_PROX_SPHERE_CYLINDER_H_
#define REAK_GEOMETRY_PROXIMITY_PROX_SPHERE_CYLINDER_H_
...
class prox_sphere_cylinder : public proximity_finder_3D {
 ...
 public:
   ...
   */
  explicit prox_sphere_cylinder(const sphere* aSphere = nullptr,
                                const cylinder* aCylinder = nullptr);

  /** Destructor. */
  ~prox_sphere_cylinder() override = default;
};

}  // namespace ReaK::geom

#endif  // REAK_GEOMETRY_PROXIMITY_PROX_SPHERE_CYLINDER_H_
