...
#ifndef REAK_GEOMETRY_PROXIMITY_PROX_CIRCLE_CIRCLE_H_
#define REAK_GEOMETRY_PROXIMITY_PROX_CIRCLE_CIRCLE_H_
...
#endif  // REAK_GEOMETRY_PROXIMITY_PROX_CIRCLE_CIRCLE_H_
