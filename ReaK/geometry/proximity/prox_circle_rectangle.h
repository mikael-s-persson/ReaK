...
#ifndef REAK_GEOMETRY_PROXIMITY_PROX_CIRCLE_RECTANGLE_H_
#define REAK_GEOMETRY_PROXIMITY_PROX_CIRCLE_RECTANGLE_H_
...
#endif  // REAK_GEOMETRY_PROXIMITY_PROX_CIRCLE_RECTANGLE_H_
