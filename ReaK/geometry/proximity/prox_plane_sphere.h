...
#ifndef REAK_GEOMETRY_PROXIMITY_PROX_PLANE_SPHERE_H_
#define REAK_GEOMETRY_PROXIMITY_PROX_PLANE_SPHERE_H_
...
class prox_plane_sphere : public proximity_finder_3D {
 ...
 public:
   ...
   */
  explicit prox_plane_sphere(const plane* aPlane = nullptr,
                             const sphere* aSphere = nullptr);

  /** Destructor. */
  ~prox_plane_sphere() override = default;
};

}  // namespace ReaK::geom

#endif  // REAK_GEOMETRY_PROXIMITY_PROX_PLANE_SPHERE_H_
