...
#ifndef REAK_GEOMETRY_PROXIMITY_PROX_CYLINDER_BOX_H_
#define REAK_GEOMETRY_PROXIMITY_PROX_CYLINDER_BOX_H_
...
#endif  // REAK_GEOMETRY_PROXIMITY_PROX_CYLINDER_BOX_H_
