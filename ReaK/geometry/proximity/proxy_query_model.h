...
#ifndef REAK_GEOMETRY_PROXIMITY_PROXY_QUERY_MODEL_H_
#define REAK_GEOMETRY_PROXIMITY_PROXY_QUERY_MODEL_H_
...
#endif  // REAK_GEOMETRY_PROXIMITY_PROXY_QUERY_MODEL_H_
