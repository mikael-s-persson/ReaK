...
#ifndef REAK_GEOMETRY_PROXIMITY_PROX_PLANE_CCYLINDER_H_
#define REAK_GEOMETRY_PROXIMITY_PROX_PLANE_CCYLINDER_H_
...
class prox_plane_ccylinder : public proximity_finder_3D {
 ...
 public:
   ...
   */
  explicit prox_plane_ccylinder(const plane* aPlane = nullptr,
                                const capped_cylinder* aCCylinder = nullptr);

  /** Destructor. */
  ~prox_plane_ccylinder() override = default;
};

}  // namespace ReaK::geom

#endif  // REAK_GEOMETRY_PROXIMITY_PROX_PLANE_CCYLINDER_H_
