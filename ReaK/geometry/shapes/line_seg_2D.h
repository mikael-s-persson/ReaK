...
#ifndef REAK_GEOMETRY_SHAPES_LINE_SEG_2D_H_
#define REAK_GEOMETRY_SHAPES_LINE_SEG_2D_H_
...
class line_seg_2D : public geometry_2D {
 ...
 public:
   ...
   */
  explicit line_seg_2D(const std::string& aName = "",
  ...
  *******************************************************************************/
  ...
  RK_RTTI_MAKE_CONCRETE_1BASE(line_seg_2D, 0xC3100004, 1, "line_seg_2D",
                              geometry_2D)
};

}  // namespace ReaK::geom

#endif  // REAK_GEOMETRY_SHAPES_LINE_SEG_2D_H_
