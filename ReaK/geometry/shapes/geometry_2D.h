...
#ifndef REAK_GEOMETRY_SHAPES_GEOMETRY_2D_H_
#define REAK_GEOMETRY_SHAPES_GEOMETRY_2D_H_
...
class geometry_2D : public named_object {
 protected:
  std::shared_ptr<pose_2D<double>> mAnchor;
 ...
 public:
   ...
   */
  const std::shared_ptr<pose_2D<double>>& getAnchor() const { return mAnchor; }
  /**
   * This function sets the anchor of the geometry.
   * \param aAnchor A shared-pointer to the new anchor pose object.
   */
  void setAnchor(const std::shared_ptr<pose_2D<double>>& aAnchor);
   ...
   */
  explicit geometry_2D(const std::string& aName = "",
  ...
  *******************************************************************************/
  ...
  RK_RTTI_MAKE_CONCRETE_1BASE(geometry_2D, 0xC3100000, 1, "geometry_2D",
                              named_object)
};

}  // namespace ReaK::geom

#endif  // REAK_GEOMETRY_SHAPES_GEOMETRY_2D_H_
