...
#ifndef REAK_GEOMETRY_SHAPES_CYLINDER_H_
#define REAK_GEOMETRY_SHAPES_CYLINDER_H_
...
class cylinder : public shape_3D {
 ...
 public:
   ...
   */
  explicit cylinder(const std::string& aName = "",
...
#endif  // REAK_GEOMETRY_SHAPES_CYLINDER_H_
