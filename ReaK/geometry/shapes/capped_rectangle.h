...
#ifndef REAK_GEOMETRY_SHAPES_CAPPED_RECTANGLE_H_
#define REAK_GEOMETRY_SHAPES_CAPPED_RECTANGLE_H_
...
#endif  // REAK_GEOMETRY_SHAPES_CAPPED_RECTANGLE_H_
