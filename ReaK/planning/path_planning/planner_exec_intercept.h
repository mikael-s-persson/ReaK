...
#ifndef REAK_PLANNING_PATH_PLANNING_PLANNER_EXEC_INTERCEPT_H_
#define REAK_PLANNING_PATH_PLANNING_PLANNER_EXEC_INTERCEPT_H_
...
#endif  // REAK_PLANNING_PATH_PLANNING_PLANNER_EXEC_INTERCEPT_H_
