...
#RUNTYPE_CONFIG = "--single-run"
    ...
    PLANNER_CONFIG =
        "--planner-alg sba_star --knn-method bf4 --relaxation-factor 5 "
        "--with-voronoi-pull --sa-temperature 5" echo_and_run./
        run_CRS_planner ${OUTPUT_DEST_CONFIG} ${RUNTYPE_CONFIG} ${
            PLANNER_CONFIG} ${MODEL_CONFIG} ${START_CONFIG} ${TARGET_CONFIG} ${
            SPACE_CONFIG} ${STOP_CRITERIAS} mv pp_results /
        CRS_static / scene2_1c /
        sba_star__any_sa_adj_list_bf4_solutions.txt pp_results / CRS_static /
        scene2_1c /
        sba_star__any_sa_adj_list_bf4_r05_t05_solutions.txt mv pp_results /
        CRS_static / scene2_1c /
        sba_star__any_sa_adj_list_bf4_times.txt pp_results / CRS_static /
        scene2_1c /
        sba_star__any_sa_adj_list_bf4_r05_t05_times.txt

            PLANNER_CONFIG =
            "--planner-alg sba_star --knn-method bf4 --relaxation-factor 10 "
            "--with-voronoi-pull --sa-temperature 5" echo_and_run./
            run_CRS_planner ${OUTPUT_DEST_CONFIG} ${RUNTYPE_CONFIG} ${
            ...
            CRS_static / scene2_1c /
            sba_star__any_sa_adj_list_bf4_r10_t05_solutions.txt mv pp_results /
            CRS_static / scene2_1c /
            sba_star__any_sa_adj_list_bf4_times.txt pp_results / CRS_static /
            scene2_1c /
            sba_star__any_sa_adj_list_bf4_r10_t05_times.txt
                ...
                "10 --with-voronoi-pull --sa-temperature 10" echo_and_run./
                run_CRS_planner ${OUTPUT_DEST_CONFIG} ${RUNTYPE_CONFIG} ${
                    PLANNER_CONFIG} ${MODEL_CONFIG} ${START_CONFIG} ${
                ...
                sba_star__any_sa_adj_list_bf4_solutions.txt pp_results /
                CRS_static / scene2_1c /
                sba_star__any_sa_adj_list_bf4_r10_t10_solutions.txt mv
                    pp_results /
                CRS_static / scene2_1c /
