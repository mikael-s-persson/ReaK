...
#ifndef REAK_PLANNING_GRAPH_ALG_SIMPLE_GRAPH_TRAITS_H_
#define REAK_PLANNING_GRAPH_ALG_SIMPLE_GRAPH_TRAITS_H_
...
#endif  // REAK_PLANNING_GRAPH_ALG_SIMPLE_GRAPH_TRAITS_H_
