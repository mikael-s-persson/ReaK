...
#ifndef REAK_PLANNING_GRAPH_ALG_BGL_RAW_PROPERTY_GRAPH_H_
#define REAK_PLANNING_GRAPH_ALG_BGL_RAW_PROPERTY_GRAPH_H_
...
#endif  // REAK_PLANNING_GRAPH_ALG_BGL_RAW_PROPERTY_GRAPH_H_
