...
#ifndef REAK_PLANNING_QT_PLANNER_ALG_CONFIG_WIDGET_H_
#define REAK_PLANNING_QT_PLANNER_ALG_CONFIG_WIDGET_H_
...
#endif  // REAK_PLANNING_QT_PLANNER_ALG_CONFIG_WIDGET_H_
